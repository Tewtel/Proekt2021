...
namespace Newtonsoft.Json.Linq
{
    ...
    IDynamicMetaObjectProvider
  {
    ...
    public static explicit operator Uri?(JToken? value)
    {
      ...
      return (object) uri == null ? new Uri(Convert.ToString(jvalue.Value, (IFormatProvider) CultureInfo.InvariantCulture)) : uri;
    }
    ...
    public IEnumerable<T> Annotations<T>() where T : class
    {
      if (this._annotations != null)
      {
        if (this._annotations is object[] annotations4)
        {
          for (int i = 0; i < annotations4.Length; ++i)
          {
            object obj1 = annotations4[i];
            if (obj1 == null)
              break;
            if (obj1 is T obj5)
              yield return obj5;
        ...
        else if (this._annotations is T annotations5)
          yield return annotations5;
      }
    }
