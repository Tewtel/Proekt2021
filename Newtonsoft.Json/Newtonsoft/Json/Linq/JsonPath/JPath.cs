  ...
  internal class JPath
  {
    ...
    private QueryExpression ParseExpression()
    {
      ...
      while (this._currentIndex < this._expression.Length)
      {
        ...
        BooleanQueryExpression booleanQueryExpression = new BooleanQueryExpression(@operator, side, right);
        if (this._expression[this._currentIndex] == ')')
        {
          if (compositeExpression1 == null)
            return (QueryExpression) booleanQueryExpression;
          compositeExpression1.Expressions.Add((QueryExpression) booleanQueryExpression);
