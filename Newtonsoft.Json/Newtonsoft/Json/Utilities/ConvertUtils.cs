  ...
  internal static class ConvertUtils
  {
    ...
    private static Func<object?, object?>? CreateCastConverter(StructMultiKey<Type, Type> t)
    {
      ...
      if ((object) method == null)
        method = type2.GetMethod("op_Explicit", new Type[1]
        {
          type1
        });
...
label_9:
      ...
      if (num10 > 0)
      {
        ...
        if (num9 == 29)
        {
          if (num10 > 1)
          {
            value /= new Decimal(1, 0, 0, false, (byte) (num10 - 1));
          ...
          value /= new Decimal(1, 0, 0, false, (byte) num10);
      }
      else
      {
        char? nullable3 = nullable1;
        int? nullable4 = nullable3.HasValue ? new int?((int) nullable3.GetValueOrDefault()) : new int?();
        int num9 = 53;
        if (nullable4.GetValueOrDefault() >= num9 & nullable4.HasValue && num10 >= -28)
          ++value;
        if (num10 < 0)
        {
          if (num7 + num10 + 28 <= 0)
          ...
          else
          {
            ...
            value *= new Decimal(1, 0, 0, false, (byte) (-num10 - 28));
          }
        }
      }
      if (flag1)
