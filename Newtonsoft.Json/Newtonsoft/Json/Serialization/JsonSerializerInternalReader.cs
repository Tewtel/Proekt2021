  ...
  internal class JsonSerializerInternalReader : JsonSerializerInternalBase
  {
      ...
      switch (contract.ContractType)
      {
        ...
        case JsonContractType.Dictionary:
          ...
          if (existingValue == null)
          {
            ...
            if (newDictionary is IWrappedDictionary wrappedDictionary3)
              return wrappedDictionary3.UnderlyingDictionary;
            obj = (object) newDictionary;
          }
          else
            obj = this.PopulateDictionary(contract1.ShouldCreateWrapper || !(existingValue is IDictionary) ? (IDictionary) contract1.CreateWrapper(existingValue) : (IDictionary) existingValue, reader, contract1, member, id);
          return obj;
        case JsonContractType.Dynamic:
      ...
      out string? id)
    {
      ...
      if (reader.TokenType == JsonToken.StartObject)
      {
        ...
        if (jproperty != null)
        {
          ...
          if (reference != null)
          {
            JToken jtoken2 = jproperty.Next ?? jproperty.Previous;
            if (jtoken2 != null)
      ...
      string? id)
    {
      ...
      if (existingValue == null)
      {
        ...
        else if (list is IWrappedCollection wrappedCollection4)
          return wrappedCollection4.UnderlyingCollection;
        obj = (object) list;
      }
      else
      {
        ...
        obj = this.PopulateList(contract1.ShouldCreateWrapper || !(existingValue is IList list2) ? (IList) contract1.CreateWrapper(existingValue) : list2, reader, contract1, member, id);
      }
      return obj;
    }
      ...
      try
      {
        ...
        if (contract.IsEnum)
        {
          if (value is string str4)
            return EnumUtils.ParseEnum(contract.NonNullableUnderlyingType, (NamingStrategy) null, str4, false);
        ...
        {
          DateTime dt;
          if (contract.NonNullableUnderlyingType == typeof (DateTime) && value is string s4 && DateTimeUtils.TryParseDateTime(s4, reader.DateTimeZoneHandling, reader.DateFormatString, reader.Culture, out dt))
      ...
      string? id)
    {
      ...
      foreach (JsonSerializerInternalReader.CreatorPropertyContext creatorPropertyContext in source)
      {
        if (flag && creatorPropertyContext.Property != null && !creatorPropertyContext.Presence.HasValue)
        {
          ...
          JsonSerializerInternalReader.PropertyPresence propertyPresence = obj != null ? (!(obj is string s4) ? JsonSerializerInternalReader.PropertyPresence.Value : (JsonSerializerInternalReader.CoerceEmptyStringToNull(creatorPropertyContext.Property.PropertyType, creatorPropertyContext.Property.PropertyContract, s4) ? JsonSerializerInternalReader.PropertyPresence.Null : JsonSerializerInternalReader.PropertyPresence.Value)) : JsonSerializerInternalReader.PropertyPresence.Null;
      ...
      foreach (JsonSerializerInternalReader.CreatorPropertyContext creatorPropertyContext in source)
      {
        if (!creatorPropertyContext.Used && creatorPropertyContext.Property != null && !creatorPropertyContext.Property.Ignored)
        {
          ...
          if (!(presence.GetValueOrDefault() == propertyPresence & presence.HasValue))
          {
            ...
            if (this.ShouldSetPropertyValue(property, contract, obj2))
            {
              ...
              if (jsonContract.ContractType == JsonContractType.Array)
              {
                ...
                if (jsonArrayContract.CanDeserialize && !jsonArrayContract.IsReadOnlyOrFixedSize)
                {
                  ...
                  if (list1 != null)
                  {
                    ...
                    {
                      foreach (object obj3 in contract1.ShouldCreateWrapper ? (IEnumerable) contract1.CreateWrapper(obj2) : (IEnumerable) obj2)
                        list2.Add(obj3);
                    }
                  }
                }
              ...
              else if (jsonContract.ContractType == JsonContractType.Dictionary)
              {
                ...
                if (!dictionaryContract.IsReadOnlyOrFixedSize)
                {
                  ...
                  if (dictionary1 != null)
                  {
                    ...
                    {
                      if (enumerator is IDisposable disposable17)
