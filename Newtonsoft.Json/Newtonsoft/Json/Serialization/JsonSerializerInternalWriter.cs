        ...
        else
        {
          switch (valueContract.ContractType)
          {
            ...
            case JsonContractType.Dictionary:
              ...
              this.SerializeDictionary(writer, value is IDictionary dictionary5 ? dictionary5 : (IDictionary) contract2.CreateWrapper(value), contract2, member, containerContract, containerProperty);
              break;
      ...
      if (contract.ContractType == JsonContractType.Primitive)
      {
        ...
        switch (primitiveContract.TypeCode)
        {
          ...
          case PrimitiveTypeCode.DateTimeNullable:
            ...
            DateTimeUtils.WriteDateTimeString((TextWriter) stringWriter1, dateTime, writer.DateFormatHandling, writer.DateFormatString, writer.Culture);
            return stringWriter1.ToString();
          case PrimitiveTypeCode.DateTimeOffset:
          case PrimitiveTypeCode.DateTimeOffsetNullable:
            escape = false;
            StringWriter stringWriter2 = new StringWriter((IFormatProvider) CultureInfo.InvariantCulture);
            DateTimeUtils.WriteDateTimeOffsetString((TextWriter) stringWriter2, (DateTimeOffset) name, writer.DateFormatHandling, writer.DateFormatString, writer.Culture);
