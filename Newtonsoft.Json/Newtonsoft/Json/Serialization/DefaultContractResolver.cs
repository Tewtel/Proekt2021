  ...
  public class DefaultContractResolver : IContractResolver
  {
      ...
      Type objectType)
    {
      ...
      if (attributeConstructor != (ConstructorInfo) null)
      {
        ...
        Type type1;
        if (!(dictionaryContract.DictionaryKeyType != (Type) null) || !(dictionaryContract.DictionaryValueType != (Type) null))
    ...
    protected virtual JsonArrayContract CreateArrayContract(Type objectType)
    {
      ...
      if (attributeConstructor != (ConstructorInfo) null)
      {
        ParameterInfo[] parameters = attributeConstructor.GetParameters();
        Type type1;
        if (!(jsonArrayContract.CollectionItemType != (Type) null))
      ...
      Type objectType)
    {
      ...
      if (iserializableContract.IsInstantiable)
      {
    ...
    protected virtual JsonDynamicContract CreateDynamicContract(Type objectType)
    {
      ...
      {
        NamingStrategy namingStrategy = JsonTypeReflector.GetContainerNamingStrategy(attribute);
        jsonDynamicContract.PropertyNameResolver = (Func<string, string>) (s => namingStrategy.GetDictionaryKey(s));
      }
      else
