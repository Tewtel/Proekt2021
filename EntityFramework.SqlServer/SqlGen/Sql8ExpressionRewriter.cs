...
namespace System.Data.Entity.SqlServer.SqlGen
{
  internal class Sql8ExpressionRewriter : DbExpressionRebinder
  {
      ...
      string expr2BindingVariableName)
    {
      ...
      return string.Equals(instance1.VariableName, expr1BindingVariableName, StringComparison.Ordinal) && string.Equals(instance2.VariableName, expr2BindingVariableName, StringComparison.Ordinal);
    }
