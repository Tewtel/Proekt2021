...
// Type: System.Data.Entity.SqlServer.SqlSpatialFunctions
...
namespace System.Data.Entity.SqlServer
{
  ...
  public static class SqlSpatialFunctions
  {
    ...
    public static DbGeography PointGeography(
      double? latitude,
      double? longitude,
    ...
    public static DbGeography BufferWithTolerance(
    ...
    public static double? EnvelopeAngle(DbGeography geographyValue) => throw new NotSupportedException(Strings.ELinq_DbFunctionDirectCall);
    ...
    public static bool? Filter(DbGeography geographyValue, DbGeography geographyOther) => throw new NotSupportedException(Strings.ELinq_DbFunctionDirectCall);
    ...
    public static bool? InstanceOf(DbGeography geographyValue, string geometryTypeName) => throw new NotSupportedException(Strings.ELinq_DbFunctionDirectCall);
    ...
    public static int? NumRings(DbGeography geographyValue) => throw new NotSupportedException(Strings.ELinq_DbFunctionDirectCall);
    ...
    public static DbGeography RingN(DbGeography geographyValue, int? index) => throw new NotSupportedException(Strings.ELinq_DbFunctionDirectCall);
    ...
    /// <param name="relative">Specifying whether the tolerance value is relative or absolute.</param>
    [DbFunction("SqlServer", "BUFFERWITHTOLERANCE")]
    public static DbGeometry BufferWithTolerance(
    ...
    /// <param name="geometryTypeName">A string that specifies one of the 12 types exposed in the geography type hierarchy.</param>
    [DbFunction("SqlServer", "INSTANCEOF")]
    public static bool? InstanceOf(DbGeometry geometryValue, string geometryTypeName) => throw new NotSupportedException(Strings.ELinq_DbFunctionDirectCall);
    ...
    [DbFunction("SqlServer", "FILTER")]
    public static bool? Filter(DbGeometry geometryValue, DbGeometry geometryOther) => throw new NotSupportedException(Strings.ELinq_DbFunctionDirectCall);
