...
namespace System.Data.Entity.SqlServer
{
  ...
  public class SqlSpatialServices : DbSpatialServices
  {
    ...
    internal SqlSpatialServices(SqlTypesAssemblyLoader loader) => this._loader = loader;

    /// <inheritdoc />
    public override bool NativeTypesAvailable => (this._loader ?? SqlTypesAssemblyLoader.DefaultInstance).TryGetSqlTypesAssembly() != null;
...
label_12:
    ...
    internal SqlTypesAssembly SqlTypes => (this._loader ?? SqlTypesAssemblyLoader.DefaultInstance).GetSqlTypesAssembly();

    /// <inheritdoc />
    public override object CreateProviderValue(DbGeographyWellKnownValue wellKnownValue)
    {
      System.Data.Entity.SqlServer.Utilities.Check.NotNull<DbGeographyWellKnownValue>(wellKnownValue, nameof (wellKnownValue));
    ...
    {
      System.Data.Entity.SqlServer.Utilities.Check.NotNull<object>(providerValue, nameof (providerValue));
      object obj = this.NormalizeProviderValue(providerValue, this.SqlTypes.SqlGeographyType);
      return !this.SqlTypes.IsSqlGeographyNull(obj) ? DbSpatialServices.CreateGeography((DbSpatialServices) this, obj) : (DbGeography) null;
    }
    ...
    {
      System.Data.Entity.SqlServer.Utilities.Check.NotNull<DbGeography>(geographyValue, nameof (geographyValue));
    ...
    {
      System.Data.Entity.SqlServer.Utilities.Check.NotNull<DbGeometryWellKnownValue>(wellKnownValue, nameof (wellKnownValue));
      if (wellKnownValue.WellKnownText != null)
    ...
    public override DbGeometry GeometryFromProviderValue(object providerValue)
    {
      ...
      return !this.SqlTypes.IsSqlGeometryNull(obj) ? DbSpatialServices.CreateGeometry((DbSpatialServices) this, obj) : (DbGeometry) null;
    }
    ...
    {
      System.Data.Entity.SqlServer.Utilities.Check.NotNull<DbGeometry>(geometryValue, nameof (geometryValue));
    ...
    private object ConvertToSqlValue(DbGeography geographyValue, string argumentName) => geographyValue == null ? (object) null : this.SqlTypes.ConvertToSqlTypesGeography(geographyValue);

    private object ConvertToSqlValue(DbGeometry geometryValue, string argumentName) => geometryValue == null ? (object) null : this.SqlTypes.ConvertToSqlTypesGeometry(geometryValue);

    private object ConvertToSqlBytes(byte[] binaryValue, string argumentName) => binaryValue == null ? (object) null : this.SqlTypes.SqlBytesFromByteArray(binaryValue);

    private object ConvertToSqlChars(string stringValue, string argumentName) => stringValue == null ? (object) null : this.SqlTypes.SqlCharsFromString(stringValue);

    private object ConvertToSqlString(string stringValue, string argumentName) => stringValue == null ? (object) null : this.SqlTypes.SqlStringFromString(stringValue);

    private object ConvertToSqlXml(string stringValue, string argumentName) => stringValue == null ? (object) null : this.SqlTypes.SqlXmlFromString(stringValue);

    private bool ConvertSqlBooleanToBoolean(object sqlBoolean) => this.SqlTypes.SqlBooleanToBoolean(sqlBoolean);

    private bool? ConvertSqlBooleanToNullableBoolean(object sqlBoolean) => this.SqlTypes.SqlBooleanToNullableBoolean(sqlBoolean);

    private byte[] ConvertSqlBytesToBinary(object sqlBytes) => this.SqlTypes.SqlBytesToByteArray(sqlBytes);

    private string ConvertSqlCharsToString(object sqlCharsValue) => this.SqlTypes.SqlCharsToString(sqlCharsValue);

    private string ConvertSqlStringToString(object sqlCharsValue) => this.SqlTypes.SqlStringToString(sqlCharsValue);

    private double ConvertSqlDoubleToDouble(object sqlDoubleValue) => this.SqlTypes.SqlDoubleToDouble(sqlDoubleValue);

    private double? ConvertSqlDoubleToNullableDouble(object sqlDoubleValue) => this.SqlTypes.SqlDoubleToNullableDouble(sqlDoubleValue);

    private int ConvertSqlInt32ToInt(object sqlInt32Value) => this.SqlTypes.SqlInt32ToInt(sqlInt32Value);

    private int? ConvertSqlInt32ToNullableInt(object sqlInt32Value) => this.SqlTypes.SqlInt32ToNullableInt(sqlInt32Value);

    private string ConvertSqlXmlToString(object sqlXmlValue) => this.SqlTypes.SqlXmlToString(sqlXmlValue);

    /// <inheritdoc />
    public override DbGeography GeographyFromText(string wellKnownText) => this.GeographyFromProviderValue(this.SqlTypes.SmiSqlGeographyParse.Value.Invoke((object) null, new object[1]
    {
    ...
    /// <inheritdoc />
    public override DbGeography GeographyFromBinary(byte[] wellKnownBinary) => this.GeographyFromProviderValue(this.SqlTypes.SmiSqlGeographyStGeomFromWkb.Value.Invoke((object) null, new object[2]
    {
      this.ConvertToSqlBytes(wellKnownBinary, nameof (wellKnownBinary)),
      (object) 4326
    }));
    ...
    /// <inheritdoc />
    public override DbGeography GeographyFromGml(string geographyMarkup) => this.GeographyFromProviderValue(this.SqlTypes.SmiSqlGeographyGeomFromGml.Value.Invoke((object) null, new object[2]
    {
    ...
    /// <inheritdoc />
    public override DbGeometry GeometryFromText(string wellKnownText) => this.GeometryFromProviderValue(this.SqlTypes.SmiSqlGeometryParse.Value.Invoke((object) null, new object[1]
    {
      this.ConvertToSqlString(wellKnownText, nameof (wellKnownText))
    }));
    ...
    /// <inheritdoc />
    public override DbGeometry GeometryFromBinary(byte[] wellKnownBinary) => this.GeometryFromProviderValue(this.SqlTypes.SmiSqlGeometryStGeomFromWkb.Value.Invoke((object) null, new object[2]
    {
      this.ConvertToSqlBytes(wellKnownBinary, nameof (wellKnownBinary)),
      (object) 0
    }));
    ...
    /// <inheritdoc />
    public override DbGeometry GeometryFromGml(string geometryMarkup) => this.GeometryFromProviderValue(this.SqlTypes.SmiSqlGeometryGeomFromGml.Value.Invoke((object) null, new object[2]
    {
