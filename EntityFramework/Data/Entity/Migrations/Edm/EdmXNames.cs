...
namespace System.Data.Entity.Migrations.Edm
{
  internal static class EdmXNames
  {
    ...
    public static string ActionAttribute(this XElement element) => (string) element.Attribute((XName) "Action");

    public static string ColumnNameAttribute(this XElement element) => (string) element.Attribute((XName) "ColumnName");

    public static string EntitySetAttribute(this XElement element) => (string) element.Attribute((XName) "EntitySet");

    public static string NameAttribute(this XElement element) => (string) element.Attribute((XName) "Name");

    public static string NamespaceAttribute(this XElement element) => (string) element.Attribute((XName) "Namespace");

    public static string EntityTypeAttribute(this XElement element) => (string) element.Attribute((XName) "EntityType");

    public static string FromRoleAttribute(this XElement element) => (string) element.Attribute((XName) "FromRole");

    public static string ToRoleAttribute(this XElement element) => (string) element.Attribute((XName) "ToRole");

    public static string NullableAttribute(this XElement element) => (string) element.Attribute((XName) "Nullable");

    public static string MaxLengthAttribute(this XElement element) => (string) element.Attribute((XName) "MaxLength");

    public static string MultiplicityAttribute(this XElement element) => (string) element.Attribute((XName) "Multiplicity");

    public static string FixedLengthAttribute(this XElement element) => (string) element.Attribute((XName) "FixedLength");

    public static string PrecisionAttribute(this XElement element) => (string) element.Attribute((XName) "Precision");

    public static string ProviderAttribute(this XElement element) => (string) element.Attribute((XName) "Provider");

    public static string ProviderManifestTokenAttribute(this XElement element) => (string) element.Attribute((XName) "ProviderManifestToken");

    public static string RelationshipAttribute(this XElement element) => (string) element.Attribute((XName) "Relationship");

    public static string ScaleAttribute(this XElement element) => (string) element.Attribute((XName) "Scale");

    public static string StoreGeneratedPatternAttribute(this XElement element) => (string) element.Attribute((XName) "StoreGeneratedPattern");

    public static string UnicodeAttribute(this XElement element) => (string) element.Attribute((XName) "Unicode");

    public static string RoleAttribute(this XElement element) => (string) element.Attribute((XName) "Role");

    public static string SchemaAttribute(this XElement element) => (string) element.Attribute((XName) "Schema");

    public static string StoreEntitySetAttribute(this XElement element) => (string) element.Attribute((XName) "StoreEntitySet");

    public static string TableAttribute(this XElement element) => (string) element.Attribute((XName) "Table");

    public static string TypeAttribute(this XElement element) => (string) element.Attribute((XName) "Type");

    public static string TypeNameAttribute(this XElement element) => (string) element.Attribute((XName) "TypeName");

    public static string ValueAttribute(this XElement element) => (string) element.Attribute((XName) "Value");
    ...
    public static class Csdl
    {
      ...
      private static IEnumerable<XName> Names(string elementName) => (IEnumerable<XName>) new List<XName>()
      {
