...
namespace System.Data.Entity.Migrations
{
  ...
  public abstract class DbMigration : IDbMigration
  {
    ...
    {
      System.Data.Entity.Utilities.Check.NotEmpty(name, nameof (name));
      System.Data.Entity.Utilities.Check.NotNull<Func<ParameterBuilder, TParameters>>(parametersAction, nameof (parametersAction));
      ...
      {
        if (!(p.GetValue((object) parameters, (object[]) null) is ParameterModel parameterModel2))
          return;
        if (string.IsNullOrWhiteSpace(parameterModel2.Name))
          parameterModel2.Name = p.Name;
        createProcedureOperation.Parameters.Add(parameterModel2);
      }));
    }
      ...
      object anonymousArguments = null)
    {
      ...
      parameters.GetType().GetNonIndexerProperties().Each<PropertyInfo>((Action<PropertyInfo, int>) ((p, i) =>
      {
        ...
        if (string.IsNullOrWhiteSpace(parameterModel2.Name))
          parameterModel2.Name = p.Name;
        alterProcedureOperation.Parameters.Add(parameterModel2);
      }));
    }
    ...
    {
      System.Data.Entity.Utilities.Check.NotEmpty(name, nameof (name));
      System.Data.Entity.Utilities.Check.NotNull<Func<ColumnBuilder, TColumns>>(columnsAction, nameof (columnsAction));
      ...
      ICollection<ColumnModel> columnModels)
    {
      ...
      {
        if (!(p.GetValue((object) (TColumns) columns, (object[]) null) is ColumnModel columnModel2))
          return;
        columnModel2.ApiPropertyInfo = p;
        if (string.IsNullOrWhiteSpace(columnModel2.Name))
          columnModel2.Name = p.Name;
    ...
    protected internal void AddForeignKey(
      ...
      object anonymousArguments = null)
    {
      System.Data.Entity.Utilities.Check.NotEmpty(dependentTable, nameof (dependentTable));
      System.Data.Entity.Utilities.Check.NotEmpty(dependentColumn, nameof (dependentColumn));
      System.Data.Entity.Utilities.Check.NotEmpty(principalTable, nameof (principalTable));
    ...
    {
      System.Data.Entity.Utilities.Check.NotEmpty(dependentTable, nameof (dependentTable));
      System.Data.Entity.Utilities.Check.NotNull<string[]>(dependentColumns, nameof (dependentColumns));
      System.Data.Entity.Utilities.Check.NotEmpty(principalTable, nameof (principalTable));
      if (!((IEnumerable<string>) dependentColumns).Any<string>())
        throw new ArgumentException(System.Data.Entity.Resources.Strings.CollectionEmpty((object) nameof (dependentColumns), (object) nameof (AddForeignKey)));
      ...
      object anonymousArguments = null)
    {
      ...
      System.Data.Entity.Utilities.Check.NotEmpty(principalTable, nameof (principalTable));
      if (!((IEnumerable<string>) dependentColumns).Any<string>())
        throw new ArgumentException(System.Data.Entity.Resources.Strings.CollectionEmpty((object) nameof (dependentColumns), (object) nameof (DropForeignKey)));
      DropForeignKeyOperation foreignKeyOperation = new DropForeignKeyOperation(anonymousArguments);
      foreignKeyOperation.DependentTable = dependentTable;
      foreignKeyOperation.PrincipalTable = principalTable;
      ...
      object anonymousArguments = null)
    {
      System.Data.Entity.Utilities.Check.NotEmpty(table, nameof (table));
      System.Data.Entity.Utilities.Check.NotEmpty(name, nameof (name));
      System.Data.Entity.Utilities.Check.NotNull<Func<ColumnBuilder, ColumnModel>>(columnAction, nameof (columnAction));
    ...
    {
      System.Data.Entity.Utilities.Check.NotEmpty(table, nameof (table));
      System.Data.Entity.Utilities.Check.NotEmpty(column, nameof (column));
    ...
    {
      System.Data.Entity.Utilities.Check.NotEmpty(table, nameof (table));
      System.Data.Entity.Utilities.Check.NotNull<string[]>(columns, nameof (columns));
      if (!((IEnumerable<string>) columns).Any<string>())
        throw new ArgumentException(System.Data.Entity.Resources.Strings.CollectionEmpty((object) nameof (columns), (object) nameof (AddPrimaryKey)));
      ...
      object anonymousArguments = null)
    {
      ...
      System.Data.Entity.Utilities.Check.NotNull<string[]>(columns, nameof (columns));
      if (!((IEnumerable<string>) columns).Any<string>())
        throw new ArgumentException(System.Data.Entity.Resources.Strings.CollectionEmpty((object) nameof (columns), (object) nameof (CreateIndex)));
    ...
    protected internal void DropIndex(string table, string[] columns, object anonymousArguments = null)
    {
      ...
      System.Data.Entity.Utilities.Check.NotNull<string[]>(columns, nameof (columns));
      if (!((IEnumerable<string>) columns).Any<string>())
        throw new ArgumentException(System.Data.Entity.Resources.Strings.CollectionEmpty((object) nameof (columns), (object) nameof (DropIndex)));
    ...
    protected internal void SqlFile(
      ...
      object anonymousArguments = null)
    {
      System.Data.Entity.Utilities.Check.NotEmpty(sqlFile, nameof (sqlFile));
    ...
    protected internal void SqlResource(
      ...
      object anonymousArguments = null)
    {
      System.Data.Entity.Utilities.Check.NotEmpty(sqlResource, nameof (sqlResource));
      ...
      if (!((IEnumerable<string>) resourceAssembly.GetManifestResourceNames()).Contains<string>(sqlResource))
        throw new ArgumentException(System.Data.Entity.Resources.Strings.UnableToLoadEmbeddedResource((object) resourceAssembly.FullName, (object) sqlResource));
    ...
    /// <inheritdoc />
    void IDbMigration.AddOperation(MigrationOperation migrationOperation) => this.AddOperation(migrationOperation);

    internal void AddOperation(MigrationOperation migrationOperation)
    {
      System.Data.Entity.Utilities.Check.NotNull<MigrationOperation>(migrationOperation, nameof (migrationOperation));
      this._operations.Add(migrationOperation);
    }

    internal IEnumerable<MigrationOperation> Operations => (IEnumerable<MigrationOperation>) this._operations;

    internal void Reset() => this._operations.Clear();

    internal VersionedModel GetSourceModel() => this.GetModel((Func<IMigrationMetadata, string>) (mm => mm.Source));

    internal VersionedModel GetTargetModel() => this.GetModel((Func<IMigrationMetadata, string>) (mm => mm.Target));
