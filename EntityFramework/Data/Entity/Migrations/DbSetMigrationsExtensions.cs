...
namespace System.Data.Entity.Migrations
{
  ...
  public static class DbSetMigrationsExtensions
  {
    ...
    {
      System.Data.Entity.Utilities.Check.NotNull<IDbSet<TEntity>>(set, nameof (set));
      System.Data.Entity.Utilities.Check.NotNull<TEntity[]>(entities, nameof (entities));
      if (set is DbSet<TEntity> set1)
      {
    ...
    {
      System.Data.Entity.Utilities.Check.NotNull<IDbSet<TEntity>>(set, nameof (set));
      System.Data.Entity.Utilities.Check.NotNull<Expression<Func<TEntity, object>>>(identifierExpression, nameof (identifierExpression));
      System.Data.Entity.Utilities.Check.NotNull<TEntity[]>(entities, nameof (entities));
      if (set is DbSet<TEntity> set1)
      {
        InternalSet<TEntity> internalSet = (InternalSet<TEntity>) ((IInternalSetAdapter) set1).InternalSet;
