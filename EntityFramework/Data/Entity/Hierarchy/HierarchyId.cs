...
namespace System.Data.Entity.Hierarchy
{
  ...
  public class HierarchyId : IComparable
  {
    ...
    public short GetLevel() => this._nodes == null ? (short) 0 : (short) this._nodes.Length;

    /// <summary>Returns the root of the hierarchy tree.</summary>
    /// <returns>The root of the hierarchy tree.</returns>
    public static HierarchyId GetRoot() => DbHierarchyServices.GetRoot();
    ...
    private static string IntArrayToStirng(IEnumerable<int> array) => string.Join<int>(".", array);
    ...
    /// </returns>
    public static bool operator <(HierarchyId hid1, HierarchyId hid2) => HierarchyId.Compare(hid1, hid2) < 0;
    ...
    /// </returns>
    public static bool operator >(HierarchyId hid1, HierarchyId hid2) => hid2 < hid1;
    ...
    public static bool operator !=(HierarchyId hid1, HierarchyId hid2) => !(hid1 == hid2);
    ...
    protected bool Equals(HierarchyId other) => this == other;
    ...
    public override int GetHashCode() => this._hierarchyId == null ? 0 : this._hierarchyId.GetHashCode();
    ...
    {
      HierarchyId hid2 = obj as HierarchyId;
      return hid2 != (HierarchyId) null ? HierarchyId.Compare(this, hid2) : -1;
    }
  }
}
