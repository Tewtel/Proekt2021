...
namespace System.Data.Entity.Edm
{
  internal abstract class EdmModelVisitor
  {
    ...
    protected internal virtual void VisitEdmEntitySet(EntitySet item) => this.VisitMetadataItem((MetadataItem) item);
    ...
    protected virtual void VisitEdmAssociationSetEnd(EntitySet item) => this.VisitMetadataItem((MetadataItem) item);
    ...
    protected internal virtual void VisitFunctionImportParameter(FunctionParameter parameter) => this.VisitMetadataItem((MetadataItem) parameter);
    ...
    protected internal virtual void VisitFunctionImportReturnParameter(FunctionParameter parameter) => this.VisitMetadataItem((MetadataItem) parameter);
    ...
    protected virtual void VisitEntityTypes(IEnumerable<EntityType> entityTypes) => EdmModelVisitor.VisitCollection<EntityType>(entityTypes, new Action<EntityType>(this.VisitEdmEntityType));
    ...
    protected internal virtual void VisitFunctionParameter(FunctionParameter functionParameter) => this.VisitMetadataItem((MetadataItem) functionParameter);
    ...
    protected internal virtual void VisitPrimitiveType(PrimitiveType primitiveType) => this.VisitMetadataItem((MetadataItem) primitiveType);
    ...
    protected virtual void VisitKeyProperties(EntityType entityType, IList<EdmProperty> properties) => EdmModelVisitor.VisitCollection<EdmProperty>((IEnumerable<EdmProperty>) properties, new Action<EdmProperty>(this.VisitEdmProperty));
    ...
    protected internal virtual void VisitEdmProperty(EdmProperty item) => this.VisitMetadataItem((MetadataItem) item);

    protected virtual void VisitEdmEnumTypeMember(EnumMember item) => this.VisitMetadataItem((MetadataItem) item);

    protected virtual void VisitEdmAssociationEnd(RelationshipEndMember item) => this.VisitMetadataItem((MetadataItem) item);
    ...
    protected virtual void VisitEdmNavigationProperty(NavigationProperty item) => this.VisitMetadataItem((MetadataItem) item);
  }
}
