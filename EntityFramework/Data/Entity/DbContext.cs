...
namespace System.Data.Entity
{
  ...
  public class DbContext : IDisposable, IObjectContextAdapter
  {
    ...
    /// </summary>
    protected DbContext() => this.InitializeLazyInternalContext((IInternalConnection) new LazyInternalConnection(this, this.GetType().DatabaseName()));
    ...
    {
      System.Data.Entity.Utilities.Check.NotNull<DbCompiledModel>(model, nameof (model));
    ...
    public DbContext(string nameOrConnectionString)
    {
      ...
      this.InitializeLazyInternalContext((IInternalConnection) new LazyInternalConnection(this, nameOrConnectionString));
    }
    ...
    public DbContext(DbConnection existingConnection, bool contextOwnsConnection)
    {
      ...
      this.InitializeLazyInternalContext((IInternalConnection) new EagerInternalConnection(this, existingConnection, contextOwnsConnection));
    }
    ...
    {
      System.Data.Entity.Utilities.Check.NotNull<ObjectContext>(objectContext, nameof (objectContext));
    ...
    {
      DbConfigurationManager.Instance.EnsureLoadedForContext(this.GetType());
      this._internalContext = (InternalContext) new LazyInternalContext(this, internalConnection, model, DbConfiguration.DependencyResolver.GetService<Func<DbContext, IDbModelCacheKey>>(), DbConfiguration.DependencyResolver.GetService<System.Data.Entity.ModelConfiguration.Utilities.AttributeProvider>());
      this.DiscoverAndInitializeSets();
    }

    private void DiscoverAndInitializeSets() => new DbSetDiscoveryService(this).InitializeSets();
    ...
    internal void CallOnModelCreating(DbModelBuilder modelBuilder) => this.OnModelCreating(modelBuilder);
    ...
    public virtual DbSet<TEntity> Set<TEntity>() where TEntity : class => (DbSet<TEntity>) this.InternalContext.Set<TEntity>();
    ...
    /// to the database.
    /// </exception>
    public virtual int SaveChanges() => this.InternalContext.SaveChanges();
    ...
    /// to the database.
    /// </exception>
    public virtual Task<int> SaveChangesAsync() => this.SaveChangesAsync(CancellationToken.None);
    ...
    public virtual Task<int> SaveChangesAsync(CancellationToken cancellationToken) => this.InternalContext.SaveChangesAsync(cancellationToken);
    ...
    {
      System.Data.Entity.Utilities.Check.NotNull<DbEntityEntry>(entityEntry, nameof (entityEntry));
      return (uint) (entityEntry.State & (EntityState.Added | EntityState.Modified)) > 0U;
    }
    ...
    public DbChangeTracker ChangeTracker => new DbChangeTracker(this.InternalContext);

    /// <summary>
    /// Provides access to configuration options for the context.
    /// </summary>
    /// <value> An object used to access configuration options. </value>
    public DbContextConfiguration Configuration => new DbContextConfiguration(this.InternalContext);
