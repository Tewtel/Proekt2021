...
namespace System.Data.Entity
{
  ...
  {
    private static readonly Lazy<IDbConnectionFactory> _defaultDefaultConnectionFactory = new Lazy<IDbConnectionFactory>((Func<IDbConnectionFactory>) (() => AppConfig.DefaultInstance.TryGetDefaultConnectionFactory() ?? (IDbConnectionFactory) new LocalDbConnectionFactory()), true);
    ...
    public bool CompatibleWithModel(bool throwIfNoMetadata) => this.CompatibleWithModel(throwIfNoMetadata, DatabaseExistenceState.Unknown);

    internal bool CompatibleWithModel(bool throwIfNoMetadata, DatabaseExistenceState existenceState) => this._internalContext.CompatibleWithModel(throwIfNoMetadata, existenceState);
    ...
    /// </summary>
    public void Create() => this.Create(DatabaseExistenceState.Unknown);
    ...
    public bool Exists() => this._internalContext.DatabaseOperations.Exists(this._internalContext.Connection, this._internalContext.CommandTimeout, new Lazy<StoreItemCollection>(new Func<StoreItemCollection>(this.CreateStoreItemCollection)));
    ...
    public static IDbConnectionFactory DefaultConnectionFactory
    {
      ...
      set
      {
        System.Data.Entity.Utilities.Check.NotNull<IDbConnectionFactory>(value, nameof (value));
        Database._defaultConnectionFactory = new Lazy<IDbConnectionFactory>((Func<IDbConnectionFactory>) (() => value), true);
      }
    }

    internal static IDbConnectionFactory SetDefaultConnectionFactory => Database._defaultConnectionFactory.Value;

    internal static bool DefaultConnectionFactoryChanged => Database._defaultConnectionFactory != Database._defaultDefaultConnectionFactory;

    internal static void ResetDefaultConnectionFactory() => Database._defaultConnectionFactory = Database._defaultDefaultConnectionFactory;

    private static ObjectContext CreateEmptyObjectContext(DbConnection connection) => new DbModelBuilder().Build(connection).Compile().CreateObjectContext<ObjectContext>(connection);
      ...
      params object[] parameters)
    {
      ...
      System.Data.Entity.Utilities.Check.NotNull<object[]>(parameters, nameof (parameters));
    ...
    public DbRawSqlQuery SqlQuery(
      ...
      params object[] parameters)
    {
      System.Data.Entity.Utilities.Check.NotNull<Type>(elementType, nameof (elementType));
      System.Data.Entity.Utilities.Check.NotEmpty(sql, nameof (sql));
      System.Data.Entity.Utilities.Check.NotNull<object[]>(parameters, nameof (parameters));
    ...
    public int ExecuteSqlCommand(string sql, params object[] parameters) => this.ExecuteSqlCommand(this._internalContext.EnsureTransactionsForFunctionsAndCommands ? TransactionalBehavior.EnsureTransaction : TransactionalBehavior.DoNotEnsureTransaction, sql, parameters);
    ...
    /// </returns>
    public Task<int> ExecuteSqlCommandAsync(string sql, params object[] parameters) => this.ExecuteSqlCommandAsync(sql, CancellationToken.None, parameters);
    ...
    {
      get => this._internalContext.CommandTimeout;
      set
      {
        if (value.HasValue)
        {
    ...
    {
      get => this._internalContext.Log;
      set => this._internalContext.Log = value;
    }
  }
}
