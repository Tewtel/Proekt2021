...
namespace System.Data.Entity
{
  ...
  public static class QueryableExtensions
  {
    ...
    {
      System.Data.Entity.Utilities.Check.NotNull<IQueryable<T>>(source, nameof (source));
      System.Data.Entity.Utilities.Check.NotEmpty(path, nameof (path));
      switch (source)
      {
        case DbQuery<T> dbQuery:
          return (IQueryable<T>) dbQuery.Include(path);
        case ObjectQuery<T> objectQuery:
    ...
    public static IQueryable Include(this IQueryable source, string path)
    {
      ...
      System.Data.Entity.Utilities.Check.NotEmpty(path, nameof (path));
      return !(source is DbQuery dbQuery) ? QueryableExtensions.CommonInclude<IQueryable>(source, path) : (IQueryable) dbQuery.Include(path);
    }

    private static T CommonInclude<T>(T source, string path)
    {
      MethodInfo runtimeMethod = source.GetType().GetRuntimeMethod("Include", (Func<MethodInfo, bool>) (p => p.IsPublic && !p.IsStatic), new Type[1]
      {
        typeof (string)
      }, new Type[1]{ typeof (IComparable) }, new Type[1]
      {
        typeof (ICloneable)
      }, new Type[1]{ typeof (IComparable<string>) }, new Type[1]
      {
        typeof (IEnumerable<char>)
      }, new Type[1]{ typeof (IEnumerable) }, new Type[1]
      {
    ...
    {
      System.Data.Entity.Utilities.Check.NotNull<IQueryable<T>>(source, nameof (source));
      System.Data.Entity.Utilities.Check.NotNull<Expression<Func<T, TProperty>>>(path, nameof (path));
      string path1;
    ...
    {
      System.Data.Entity.Utilities.Check.NotNull<IQueryable<T>>(source, nameof (source));
      return !(source is DbQuery<T> dbQuery) ? QueryableExtensions.CommonAsNoTracking<IQueryable<T>>(source) : (IQueryable<T>) dbQuery.AsNoTracking();
    }
    ...
    {
      System.Data.Entity.Utilities.Check.NotNull<IQueryable>(source, nameof (source));
      return !(source is DbQuery dbQuery) ? QueryableExtensions.CommonAsNoTracking<IQueryable>(source) : (IQueryable) dbQuery.AsNoTracking();
    }
    ...
    private static T CommonAsNoTracking<T>(T source) where T : class
    {
      ...
      return publicInstanceMethod != (MethodInfo) null && typeof (T).IsAssignableFrom(publicInstanceMethod.ReturnType) ? (T) publicInstanceMethod.Invoke((object) source, (object[]) null) : source;
    }
    ...
    {
      System.Data.Entity.Utilities.Check.NotNull<IQueryable<T>>(source, nameof (source));
      return !(source is DbQuery<T> dbQuery) ? QueryableExtensions.CommonAsStreaming<IQueryable<T>>(source) : (IQueryable<T>) dbQuery.AsStreaming();
    }
    ...
    {
      System.Data.Entity.Utilities.Check.NotNull<IQueryable>(source, nameof (source));
      return !(source is DbQuery dbQuery) ? QueryableExtensions.CommonAsStreaming<IQueryable>(source) : (IQueryable) dbQuery.AsStreaming();
    }
    ...
    {
      System.Data.Entity.Utilities.Check.NotNull<IQueryable<T>>(source, nameof (source));
      return !(source is DbQuery<T> dbQuery) ? QueryableExtensions.CommonWithExecutionStrategy<IQueryable<T>>(source, executionStrategy) : (IQueryable<T>) dbQuery.WithExecutionStrategy(executionStrategy);
    }
    ...
    {
      System.Data.Entity.Utilities.Check.NotNull<IQueryable>(source, nameof (source));
      return !(source is DbQuery dbQuery) ? QueryableExtensions.CommonWithExecutionStrategy<IQueryable>(source, executionStrategy) : (IQueryable) dbQuery.WithExecutionStrategy(executionStrategy);
    }
    ...
    {
      System.Data.Entity.Utilities.Check.NotNull<IQueryable<T>>(source, nameof (source));
      System.Data.Entity.Utilities.Check.NotNull<Action<T>>(action, nameof (action));
    ...
    {
      System.Data.Entity.Utilities.Check.NotNull<IQueryable<TSource>>(source, nameof (source));
    ...
    {
      System.Data.Entity.Utilities.Check.NotNull<IQueryable<TSource>>(source, nameof (source));
      System.Data.Entity.Utilities.Check.NotNull<Func<TSource, TKey>>(keySelector, nameof (keySelector));
      ...
      Func<TSource, TElement> elementSelector)
    {
      System.Data.Entity.Utilities.Check.NotNull<IQueryable<TSource>>(source, nameof (source));
      System.Data.Entity.Utilities.Check.NotNull<Func<TSource, TKey>>(keySelector, nameof (keySelector));
      System.Data.Entity.Utilities.Check.NotNull<Func<TSource, TElement>>(elementSelector, nameof (elementSelector));
      ...
      CancellationToken cancellationToken)
    {
      ...
      if (!(source.Provider is IDbAsyncQueryProvider provider))
        throw System.Data.Entity.Resources.Error.IQueryable_Provider_Not_Async();
      MethodCallExpression methodCallExpression = Expression.Call((Expression) null, QueryableExtensions._first.MakeGenericMethod(typeof (TSource)), source.Expression);
      CancellationToken cancellationToken1 = cancellationToken;
      return provider.ExecuteAsync<TSource>((Expression) methodCallExpression, cancellationToken1);
    }
    ...
    {
      System.Data.Entity.Utilities.Check.NotNull<IQueryable<TSource>>(source, nameof (source));
      System.Data.Entity.Utilities.Check.NotNull<Expression<Func<TSource, bool>>>(predicate, nameof (predicate));
      ...
      CancellationToken cancellationToken)
    {
      ...
      if (!(source.Provider is IDbAsyncQueryProvider provider))
        throw System.Data.Entity.Resources.Error.IQueryable_Provider_Not_Async();
      MethodCallExpression methodCallExpression = Expression.Call((Expression) null, QueryableExtensions._first_Predicate.MakeGenericMethod(typeof (TSource)), new Expression[2]
      {
        source.Expression,
      ...
      CancellationToken cancellationToken)
    {
      ...
      if (!(source.Provider is IDbAsyncQueryProvider provider))
        throw System.Data.Entity.Resources.Error.IQueryable_Provider_Not_Async();
      MethodCallExpression methodCallExpression = Expression.Call((Expression) null, QueryableExtensions._firstOrDefault.MakeGenericMethod(typeof (TSource)), source.Expression);
      CancellationToken cancellationToken1 = cancellationToken;
      return provider.ExecuteAsync<TSource>((Expression) methodCallExpression, cancellationToken1);
    }
      ...
      CancellationToken cancellationToken)
    {
      ...
      if (!(source.Provider is IDbAsyncQueryProvider provider))
        throw System.Data.Entity.Resources.Error.IQueryable_Provider_Not_Async();
      MethodCallExpression methodCallExpression = Expression.Call((Expression) null, QueryableExtensions._firstOrDefault_Predicate.MakeGenericMethod(typeof (TSource)), new Expression[2]
      {
        source.Expression,
        (Expression) Expression.Quote((Expression) predicate)
      });
      ...
      CancellationToken cancellationToken)
    {
      ...
      if (!(source.Provider is IDbAsyncQueryProvider provider))
        throw System.Data.Entity.Resources.Error.IQueryable_Provider_Not_Async();
      MethodCallExpression methodCallExpression = Expression.Call((Expression) null, QueryableExtensions._single.MakeGenericMethod(typeof (TSource)), source.Expression);
      CancellationToken cancellationToken1 = cancellationToken;
      return provider.ExecuteAsync<TSource>((Expression) methodCallExpression, cancellationToken1);
    }
      ...
      CancellationToken cancellationToken)
    {
      ...
      if (!(source.Provider is IDbAsyncQueryProvider provider))
        throw System.Data.Entity.Resources.Error.IQueryable_Provider_Not_Async();
      MethodCallExpression methodCallExpression = Expression.Call((Expression) null, QueryableExtensions._single_Predicate.MakeGenericMethod(typeof (TSource)), new Expression[2]
      {
        source.Expression,
        (Expression) Expression.Quote((Expression) predicate)
      });
      ...
      CancellationToken cancellationToken)
    {
      ...
      if (!(source.Provider is IDbAsyncQueryProvider provider))
        throw System.Data.Entity.Resources.Error.IQueryable_Provider_Not_Async();
      MethodCallExpression methodCallExpression = Expression.Call((Expression) null, QueryableExtensions._singleOrDefault.MakeGenericMethod(typeof (TSource)), source.Expression);
      CancellationToken cancellationToken1 = cancellationToken;
      return provider.ExecuteAsync<TSource>((Expression) methodCallExpression, cancellationToken1);
    }
      ...
      CancellationToken cancellationToken)
    {
      ...
      if (!(source.Provider is IDbAsyncQueryProvider provider))
        throw System.Data.Entity.Resources.Error.IQueryable_Provider_Not_Async();
      MethodCallExpression methodCallExpression = Expression.Call((Expression) null, QueryableExtensions._singleOrDefault_Predicate.MakeGenericMethod(typeof (TSource)), new Expression[2]
      {
        source.Expression,
        (Expression) Expression.Quote((Expression) predicate)
      });
      ...
      CancellationToken cancellationToken)
    {
      ...
      if (!(source.Provider is IDbAsyncQueryProvider provider))
        throw System.Data.Entity.Resources.Error.IQueryable_Provider_Not_Async();
      MethodCallExpression methodCallExpression = Expression.Call((Expression) null, QueryableExtensions._contains.MakeGenericMethod(typeof (TSource)), new Expression[2]
      {
        source.Expression,
        (Expression) Expression.Constant((object) item, typeof (TSource))
      });
      CancellationToken cancellationToken1 = cancellationToken;
      return provider.ExecuteAsync<bool>((Expression) methodCallExpression, cancellationToken1);
    }
      ...
      CancellationToken cancellationToken)
    {
      ...
      if (!(source.Provider is IDbAsyncQueryProvider provider))
        throw System.Data.Entity.Resources.Error.IQueryable_Provider_Not_Async();
      MethodCallExpression methodCallExpression = Expression.Call((Expression) null, QueryableExtensions._any.MakeGenericMethod(typeof (TSource)), source.Expression);
      CancellationToken cancellationToken1 = cancellationToken;
      return provider.ExecuteAsync<bool>((Expression) methodCallExpression, cancellationToken1);
    }
      ...
      CancellationToken cancellationToken)
    {
      ...
      if (!(source.Provider is IDbAsyncQueryProvider provider))
        throw System.Data.Entity.Resources.Error.IQueryable_Provider_Not_Async();
      MethodCallExpression methodCallExpression = Expression.Call((Expression) null, QueryableExtensions._any_Predicate.MakeGenericMethod(typeof (TSource)), new Expression[2]
      {
        source.Expression,
        (Expression) Expression.Quote((Expression) predicate)
      });
      ...
      CancellationToken cancellationToken)
    {
      ...
      if (!(source.Provider is IDbAsyncQueryProvider provider))
        throw System.Data.Entity.Resources.Error.IQueryable_Provider_Not_Async();
      MethodCallExpression methodCallExpression = Expression.Call((Expression) null, QueryableExtensions._all_Predicate.MakeGenericMethod(typeof (TSource)), new Expression[2]
      {
        source.Expression,
        (Expression) Expression.Quote((Expression) predicate)
      });
      ...
      CancellationToken cancellationToken)
    {
      ...
      if (!(source.Provider is IDbAsyncQueryProvider provider))
        throw System.Data.Entity.Resources.Error.IQueryable_Provider_Not_Async();
      MethodCallExpression methodCallExpression = Expression.Call((Expression) null, QueryableExtensions._count.MakeGenericMethod(typeof (TSource)), source.Expression);
      CancellationToken cancellationToken1 = cancellationToken;
      return provider.ExecuteAsync<int>((Expression) methodCallExpression, cancellationToken1);
    }
      ...
      CancellationToken cancellationToken)
    {
      ...
      if (!(source.Provider is IDbAsyncQueryProvider provider))
        throw System.Data.Entity.Resources.Error.IQueryable_Provider_Not_Async();
      MethodCallExpression methodCallExpression = Expression.Call((Expression) null, QueryableExtensions._count_Predicate.MakeGenericMethod(typeof (TSource)), new Expression[2]
      {
        source.Expression,
        (Expression) Expression.Quote((Expression) predicate)
      });
      ...
      CancellationToken cancellationToken)
    {
      ...
      if (!(source.Provider is IDbAsyncQueryProvider provider))
        throw System.Data.Entity.Resources.Error.IQueryable_Provider_Not_Async();
      MethodCallExpression methodCallExpression = Expression.Call((Expression) null, QueryableExtensions._longCount.MakeGenericMethod(typeof (TSource)), source.Expression);
      CancellationToken cancellationToken1 = cancellationToken;
      return provider.ExecuteAsync<long>((Expression) methodCallExpression, cancellationToken1);
    }
      ...
      CancellationToken cancellationToken)
    {
      ...
      if (!(source.Provider is IDbAsyncQueryProvider provider))
        throw System.Data.Entity.Resources.Error.IQueryable_Provider_Not_Async();
      MethodCallExpression methodCallExpression = Expression.Call((Expression) null, QueryableExtensions._longCount_Predicate.MakeGenericMethod(typeof (TSource)), new Expression[2]
      {
        source.Expression,
        (Expression) Expression.Quote((Expression) predicate)
      });
      ...
      CancellationToken cancellationToken)
    {
      ...
      if (!(source.Provider is IDbAsyncQueryProvider provider))
        throw System.Data.Entity.Resources.Error.IQueryable_Provider_Not_Async();
      MethodCallExpression methodCallExpression = Expression.Call((Expression) null, QueryableExtensions._min.MakeGenericMethod(typeof (TSource)), source.Expression);
      CancellationToken cancellationToken1 = cancellationToken;
      return provider.ExecuteAsync<TSource>((Expression) methodCallExpression, cancellationToken1);
    }
    ...
    {
      System.Data.Entity.Utilities.Check.NotNull<IQueryable<TSource>>(source, nameof (source));
      System.Data.Entity.Utilities.Check.NotNull<Expression<Func<TSource, TResult>>>(selector, nameof (selector));
      ...
      CancellationToken cancellationToken)
    {
      ...
      if (!(source.Provider is IDbAsyncQueryProvider provider))
        throw System.Data.Entity.Resources.Error.IQueryable_Provider_Not_Async();
      MethodCallExpression methodCallExpression = Expression.Call((Expression) null, QueryableExtensions._min_Selector.MakeGenericMethod(typeof (TSource), typeof (TResult)), new Expression[2]
      {
        source.Expression,
      ...
      CancellationToken cancellationToken)
    {
      ...
      if (!(source.Provider is IDbAsyncQueryProvider provider))
        throw System.Data.Entity.Resources.Error.IQueryable_Provider_Not_Async();
      MethodCallExpression methodCallExpression = Expression.Call((Expression) null, QueryableExtensions._max.MakeGenericMethod(typeof (TSource)), source.Expression);
      CancellationToken cancellationToken1 = cancellationToken;
      return provider.ExecuteAsync<TSource>((Expression) methodCallExpression, cancellationToken1);
    }
      ...
      CancellationToken cancellationToken)
    {
      ...
      if (!(source.Provider is IDbAsyncQueryProvider provider))
        throw System.Data.Entity.Resources.Error.IQueryable_Provider_Not_Async();
      MethodCallExpression methodCallExpression = Expression.Call((Expression) null, QueryableExtensions._max_Selector.MakeGenericMethod(typeof (TSource), typeof (TResult)), new Expression[2]
      {
        source.Expression,
        (Expression) Expression.Quote((Expression) selector)
      });
    ...
    {
      System.Data.Entity.Utilities.Check.NotNull<IQueryable<int>>(source, nameof (source));
      ...
      CancellationToken cancellationToken)
    {
      ...
      if (!(source.Provider is IDbAsyncQueryProvider provider))
        throw System.Data.Entity.Resources.Error.IQueryable_Provider_Not_Async();
      MethodCallExpression methodCallExpression = Expression.Call((Expression) null, QueryableExtensions._sum_Int, source.Expression);
      CancellationToken cancellationToken1 = cancellationToken;
      return provider.ExecuteAsync<int>((Expression) methodCallExpression, cancellationToken1);
    }
      ...
      CancellationToken cancellationToken)
    {
      ...
      if (!(source.Provider is IDbAsyncQueryProvider provider))
        throw System.Data.Entity.Resources.Error.IQueryable_Provider_Not_Async();
      MethodCallExpression methodCallExpression = Expression.Call((Expression) null, QueryableExtensions._sum_IntNullable, source.Expression);
      CancellationToken cancellationToken1 = cancellationToken;
      return provider.ExecuteAsync<int?>((Expression) methodCallExpression, cancellationToken1);
    }
    ...
    {
      System.Data.Entity.Utilities.Check.NotNull<IQueryable<long>>(source, nameof (source));
      return source.SumAsync(CancellationToken.None);
    }
      ...
      CancellationToken cancellationToken)
    {
      ...
      if (!(source.Provider is IDbAsyncQueryProvider provider))
        throw System.Data.Entity.Resources.Error.IQueryable_Provider_Not_Async();
      MethodCallExpression methodCallExpression = Expression.Call((Expression) null, QueryableExtensions._sum_Long, source.Expression);
      CancellationToken cancellationToken1 = cancellationToken;
      return provider.ExecuteAsync<long>((Expression) methodCallExpression, cancellationToken1);
    }
      ...
      CancellationToken cancellationToken)
    {
      ...
      if (!(source.Provider is IDbAsyncQueryProvider provider))
        throw System.Data.Entity.Resources.Error.IQueryable_Provider_Not_Async();
      MethodCallExpression methodCallExpression = Expression.Call((Expression) null, QueryableExtensions._sum_LongNullable, source.Expression);
      CancellationToken cancellationToken1 = cancellationToken;
      return provider.ExecuteAsync<long?>((Expression) methodCallExpression, cancellationToken1);
    }
    ...
    {
      System.Data.Entity.Utilities.Check.NotNull<IQueryable<float>>(source, nameof (source));
      return source.SumAsync(CancellationToken.None);
    }
      ...
      CancellationToken cancellationToken)
    {
      ...
      if (!(source.Provider is IDbAsyncQueryProvider provider))
        throw System.Data.Entity.Resources.Error.IQueryable_Provider_Not_Async();
      MethodCallExpression methodCallExpression = Expression.Call((Expression) null, QueryableExtensions._sum_Float, source.Expression);
      CancellationToken cancellationToken1 = cancellationToken;
      return provider.ExecuteAsync<float>((Expression) methodCallExpression, cancellationToken1);
    }
      ...
      CancellationToken cancellationToken)
    {
      ...
      if (!(source.Provider is IDbAsyncQueryProvider provider))
        throw System.Data.Entity.Resources.Error.IQueryable_Provider_Not_Async();
      MethodCallExpression methodCallExpression = Expression.Call((Expression) null, QueryableExtensions._sum_FloatNullable, source.Expression);
      CancellationToken cancellationToken1 = cancellationToken;
      return provider.ExecuteAsync<float?>((Expression) methodCallExpression, cancellationToken1);
    }
    ...
    {
      System.Data.Entity.Utilities.Check.NotNull<IQueryable<double>>(source, nameof (source));
      return source.SumAsync(CancellationToken.None);
    }
      ...
      CancellationToken cancellationToken)
    {
      ...
      if (!(source.Provider is IDbAsyncQueryProvider provider))
        throw System.Data.Entity.Resources.Error.IQueryable_Provider_Not_Async();
      MethodCallExpression methodCallExpression = Expression.Call((Expression) null, QueryableExtensions._sum_Double, source.Expression);
      CancellationToken cancellationToken1 = cancellationToken;
      return provider.ExecuteAsync<double>((Expression) methodCallExpression, cancellationToken1);
    }
      ...
      CancellationToken cancellationToken)
    {
      ...
      if (!(source.Provider is IDbAsyncQueryProvider provider))
        throw System.Data.Entity.Resources.Error.IQueryable_Provider_Not_Async();
      MethodCallExpression methodCallExpression = Expression.Call((Expression) null, QueryableExtensions._sum_DoubleNullable, source.Expression);
      CancellationToken cancellationToken1 = cancellationToken;
      return provider.ExecuteAsync<double?>((Expression) methodCallExpression, cancellationToken1);
    }
    ...
    {
      System.Data.Entity.Utilities.Check.NotNull<IQueryable<Decimal>>(source, nameof (source));
      return source.SumAsync(CancellationToken.None);
    }
      ...
      CancellationToken cancellationToken)
    {
      ...
      if (!(source.Provider is IDbAsyncQueryProvider provider))
        throw System.Data.Entity.Resources.Error.IQueryable_Provider_Not_Async();
      MethodCallExpression methodCallExpression = Expression.Call((Expression) null, QueryableExtensions._sum_Decimal, source.Expression);
      CancellationToken cancellationToken1 = cancellationToken;
      return provider.ExecuteAsync<Decimal>((Expression) methodCallExpression, cancellationToken1);
    }
      ...
      CancellationToken cancellationToken)
    {
      ...
      if (!(source.Provider is IDbAsyncQueryProvider provider))
        throw System.Data.Entity.Resources.Error.IQueryable_Provider_Not_Async();
      MethodCallExpression methodCallExpression = Expression.Call((Expression) null, QueryableExtensions._sum_DecimalNullable, source.Expression);
      CancellationToken cancellationToken1 = cancellationToken;
      return provider.ExecuteAsync<Decimal?>((Expression) methodCallExpression, cancellationToken1);
    }
    ...
    {
      System.Data.Entity.Utilities.Check.NotNull<IQueryable<TSource>>(source, nameof (source));
      System.Data.Entity.Utilities.Check.NotNull<Expression<Func<TSource, int>>>(selector, nameof (selector));
      ...
      CancellationToken cancellationToken)
    {
      ...
      if (!(source.Provider is IDbAsyncQueryProvider provider))
        throw System.Data.Entity.Resources.Error.IQueryable_Provider_Not_Async();
      MethodCallExpression methodCallExpression = Expression.Call((Expression) null, QueryableExtensions._sum_Int_Selector.MakeGenericMethod(typeof (TSource)), new Expression[2]
      {
        source.Expression,
        (Expression) Expression.Quote((Expression) selector)
      });
      ...
      CancellationToken cancellationToken)
    {
      ...
      if (!(source.Provider is IDbAsyncQueryProvider provider))
        throw System.Data.Entity.Resources.Error.IQueryable_Provider_Not_Async();
      MethodCallExpression methodCallExpression = Expression.Call((Expression) null, QueryableExtensions._sum_IntNullable_Selector.MakeGenericMethod(typeof (TSource)), new Expression[2]
      {
        source.Expression,
        (Expression) Expression.Quote((Expression) selector)
      });
    ...
    {
      System.Data.Entity.Utilities.Check.NotNull<IQueryable<TSource>>(source, nameof (source));
      System.Data.Entity.Utilities.Check.NotNull<Expression<Func<TSource, long>>>(selector, nameof (selector));
      return source.SumAsync<TSource>(selector, CancellationToken.None);
    }
      ...
      CancellationToken cancellationToken)
    {
      ...
      if (!(source.Provider is IDbAsyncQueryProvider provider))
        throw System.Data.Entity.Resources.Error.IQueryable_Provider_Not_Async();
      MethodCallExpression methodCallExpression = Expression.Call((Expression) null, QueryableExtensions._sum_Long_Selector.MakeGenericMethod(typeof (TSource)), new Expression[2]
      {
        source.Expression,
        (Expression) Expression.Quote((Expression) selector)
      });
      ...
      CancellationToken cancellationToken)
    {
      ...
      if (!(source.Provider is IDbAsyncQueryProvider provider))
        throw System.Data.Entity.Resources.Error.IQueryable_Provider_Not_Async();
      MethodCallExpression methodCallExpression = Expression.Call((Expression) null, QueryableExtensions._sum_LongNullable_Selector.MakeGenericMethod(typeof (TSource)), new Expression[2]
      {
        source.Expression,
        (Expression) Expression.Quote((Expression) selector)
      });
    ...
    {
      System.Data.Entity.Utilities.Check.NotNull<IQueryable<TSource>>(source, nameof (source));
      System.Data.Entity.Utilities.Check.NotNull<Expression<Func<TSource, float>>>(selector, nameof (selector));
      return source.SumAsync<TSource>(selector, CancellationToken.None);
    }
      ...
      CancellationToken cancellationToken)
    {
      ...
      if (!(source.Provider is IDbAsyncQueryProvider provider))
        throw System.Data.Entity.Resources.Error.IQueryable_Provider_Not_Async();
      MethodCallExpression methodCallExpression = Expression.Call((Expression) null, QueryableExtensions._sum_Float_Selector.MakeGenericMethod(typeof (TSource)), new Expression[2]
      {
        source.Expression,
        (Expression) Expression.Quote((Expression) selector)
      });
      ...
      CancellationToken cancellationToken)
    {
      ...
      if (!(source.Provider is IDbAsyncQueryProvider provider))
        throw System.Data.Entity.Resources.Error.IQueryable_Provider_Not_Async();
      MethodCallExpression methodCallExpression = Expression.Call((Expression) null, QueryableExtensions._sum_FloatNullable_Selector.MakeGenericMethod(typeof (TSource)), new Expression[2]
      {
        source.Expression,
        (Expression) Expression.Quote((Expression) selector)
      });
    ...
    {
      System.Data.Entity.Utilities.Check.NotNull<IQueryable<TSource>>(source, nameof (source));
      System.Data.Entity.Utilities.Check.NotNull<Expression<Func<TSource, double>>>(selector, nameof (selector));
      return source.SumAsync<TSource>(selector, CancellationToken.None);
    }
      ...
      CancellationToken cancellationToken)
    {
      ...
      if (!(source.Provider is IDbAsyncQueryProvider provider))
        throw System.Data.Entity.Resources.Error.IQueryable_Provider_Not_Async();
      MethodCallExpression methodCallExpression = Expression.Call((Expression) null, QueryableExtensions._sum_Double_Selector.MakeGenericMethod(typeof (TSource)), new Expression[2]
      {
        source.Expression,
        (Expression) Expression.Quote((Expression) selector)
      });
      ...
      CancellationToken cancellationToken)
    {
      ...
      if (!(source.Provider is IDbAsyncQueryProvider provider))
        throw System.Data.Entity.Resources.Error.IQueryable_Provider_Not_Async();
      MethodCallExpression methodCallExpression = Expression.Call((Expression) null, QueryableExtensions._sum_DoubleNullable_Selector.MakeGenericMethod(typeof (TSource)), new Expression[2]
      {
        source.Expression,
        (Expression) Expression.Quote((Expression) selector)
      });
    ...
    {
      System.Data.Entity.Utilities.Check.NotNull<IQueryable<TSource>>(source, nameof (source));
      System.Data.Entity.Utilities.Check.NotNull<Expression<Func<TSource, Decimal>>>(selector, nameof (selector));
      return source.SumAsync<TSource>(selector, CancellationToken.None);
    }
      ...
      CancellationToken cancellationToken)
    {
      ...
      if (!(source.Provider is IDbAsyncQueryProvider provider))
        throw System.Data.Entity.Resources.Error.IQueryable_Provider_Not_Async();
      MethodCallExpression methodCallExpression = Expression.Call((Expression) null, QueryableExtensions._sum_Decimal_Selector.MakeGenericMethod(typeof (TSource)), new Expression[2]
      {
        source.Expression,
        (Expression) Expression.Quote((Expression) selector)
      });
      ...
      CancellationToken cancellationToken)
    {
      ...
      if (!(source.Provider is IDbAsyncQueryProvider provider))
        throw System.Data.Entity.Resources.Error.IQueryable_Provider_Not_Async();
      MethodCallExpression methodCallExpression = Expression.Call((Expression) null, QueryableExtensions._sum_DecimalNullable_Selector.MakeGenericMethod(typeof (TSource)), new Expression[2]
      {
        source.Expression,
        (Expression) Expression.Quote((Expression) selector)
      });
      ...
      CancellationToken cancellationToken)
    {
      ...
      if (!(source.Provider is IDbAsyncQueryProvider provider))
        throw System.Data.Entity.Resources.Error.IQueryable_Provider_Not_Async();
      MethodCallExpression methodCallExpression = Expression.Call((Expression) null, QueryableExtensions._average_Int, source.Expression);
      CancellationToken cancellationToken1 = cancellationToken;
      return provider.ExecuteAsync<double>((Expression) methodCallExpression, cancellationToken1);
    }
      ...
      CancellationToken cancellationToken)
    {
      ...
      if (!(source.Provider is IDbAsyncQueryProvider provider))
        throw System.Data.Entity.Resources.Error.IQueryable_Provider_Not_Async();
      MethodCallExpression methodCallExpression = Expression.Call((Expression) null, QueryableExtensions._average_IntNullable, source.Expression);
      CancellationToken cancellationToken1 = cancellationToken;
      return provider.ExecuteAsync<double?>((Expression) methodCallExpression, cancellationToken1);
    }
      ...
      CancellationToken cancellationToken)
    {
      ...
      if (!(source.Provider is IDbAsyncQueryProvider provider))
        throw System.Data.Entity.Resources.Error.IQueryable_Provider_Not_Async();
      MethodCallExpression methodCallExpression = Expression.Call((Expression) null, QueryableExtensions._average_Long, source.Expression);
      CancellationToken cancellationToken1 = cancellationToken;
      return provider.ExecuteAsync<double>((Expression) methodCallExpression, cancellationToken1);
    }
      ...
      CancellationToken cancellationToken)
    {
      ...
      if (!(source.Provider is IDbAsyncQueryProvider provider))
        throw System.Data.Entity.Resources.Error.IQueryable_Provider_Not_Async();
      MethodCallExpression methodCallExpression = Expression.Call((Expression) null, QueryableExtensions._average_LongNullable, source.Expression);
      CancellationToken cancellationToken1 = cancellationToken;
      return provider.ExecuteAsync<double?>((Expression) methodCallExpression, cancellationToken1);
    }
      ...
      CancellationToken cancellationToken)
    {
      ...
      if (!(source.Provider is IDbAsyncQueryProvider provider))
        throw System.Data.Entity.Resources.Error.IQueryable_Provider_Not_Async();
      MethodCallExpression methodCallExpression = Expression.Call((Expression) null, QueryableExtensions._average_Float, source.Expression);
      CancellationToken cancellationToken1 = cancellationToken;
      return provider.ExecuteAsync<float>((Expression) methodCallExpression, cancellationToken1);
    }
      ...
      CancellationToken cancellationToken)
    {
      ...
      if (!(source.Provider is IDbAsyncQueryProvider provider))
        throw System.Data.Entity.Resources.Error.IQueryable_Provider_Not_Async();
      MethodCallExpression methodCallExpression = Expression.Call((Expression) null, QueryableExtensions._average_FloatNullable, source.Expression);
      CancellationToken cancellationToken1 = cancellationToken;
      return provider.ExecuteAsync<float?>((Expression) methodCallExpression, cancellationToken1);
    }
      ...
      CancellationToken cancellationToken)
    {
      ...
      if (!(source.Provider is IDbAsyncQueryProvider provider))
        throw System.Data.Entity.Resources.Error.IQueryable_Provider_Not_Async();
      MethodCallExpression methodCallExpression = Expression.Call((Expression) null, QueryableExtensions._average_Double, source.Expression);
      CancellationToken cancellationToken1 = cancellationToken;
      return provider.ExecuteAsync<double>((Expression) methodCallExpression, cancellationToken1);
    }
      ...
      CancellationToken cancellationToken)
    {
      ...
      if (!(source.Provider is IDbAsyncQueryProvider provider))
        throw System.Data.Entity.Resources.Error.IQueryable_Provider_Not_Async();
      MethodCallExpression methodCallExpression = Expression.Call((Expression) null, QueryableExtensions._average_DoubleNullable, source.Expression);
      CancellationToken cancellationToken1 = cancellationToken;
      return provider.ExecuteAsync<double?>((Expression) methodCallExpression, cancellationToken1);
    }
      ...
      CancellationToken cancellationToken)
    {
      ...
      if (!(source.Provider is IDbAsyncQueryProvider provider))
        throw System.Data.Entity.Resources.Error.IQueryable_Provider_Not_Async();
      MethodCallExpression methodCallExpression = Expression.Call((Expression) null, QueryableExtensions._average_Decimal, source.Expression);
      CancellationToken cancellationToken1 = cancellationToken;
      return provider.ExecuteAsync<Decimal>((Expression) methodCallExpression, cancellationToken1);
    }
      ...
      CancellationToken cancellationToken)
    {
      ...
      if (!(source.Provider is IDbAsyncQueryProvider provider))
        throw System.Data.Entity.Resources.Error.IQueryable_Provider_Not_Async();
      MethodCallExpression methodCallExpression = Expression.Call((Expression) null, QueryableExtensions._average_DecimalNullable, source.Expression);
      CancellationToken cancellationToken1 = cancellationToken;
      return provider.ExecuteAsync<Decimal?>((Expression) methodCallExpression, cancellationToken1);
    }
      ...
      CancellationToken cancellationToken)
    {
      ...
      if (!(source.Provider is IDbAsyncQueryProvider provider))
        throw System.Data.Entity.Resources.Error.IQueryable_Provider_Not_Async();
      MethodCallExpression methodCallExpression = Expression.Call((Expression) null, QueryableExtensions._average_Int_Selector.MakeGenericMethod(typeof (TSource)), new Expression[2]
      {
        source.Expression,
        (Expression) Expression.Quote((Expression) selector)
      });
      ...
      CancellationToken cancellationToken)
    {
      ...
      if (!(source.Provider is IDbAsyncQueryProvider provider))
        throw System.Data.Entity.Resources.Error.IQueryable_Provider_Not_Async();
      MethodCallExpression methodCallExpression = Expression.Call((Expression) null, QueryableExtensions._average_IntNullable_Selector.MakeGenericMethod(typeof (TSource)), new Expression[2]
      {
        source.Expression,
        (Expression) Expression.Quote((Expression) selector)
      });
      ...
      CancellationToken cancellationToken)
    {
      ...
      if (!(source.Provider is IDbAsyncQueryProvider provider))
        throw System.Data.Entity.Resources.Error.IQueryable_Provider_Not_Async();
      MethodCallExpression methodCallExpression = Expression.Call((Expression) null, QueryableExtensions._average_Long_Selector.MakeGenericMethod(typeof (TSource)), new Expression[2]
      {
        source.Expression,
        (Expression) Expression.Quote((Expression) selector)
      });
      ...
      CancellationToken cancellationToken)
    {
      ...
      if (!(source.Provider is IDbAsyncQueryProvider provider))
        throw System.Data.Entity.Resources.Error.IQueryable_Provider_Not_Async();
      MethodCallExpression methodCallExpression = Expression.Call((Expression) null, QueryableExtensions._average_LongNullable_Selector.MakeGenericMethod(typeof (TSource)), new Expression[2]
      {
        source.Expression,
        (Expression) Expression.Quote((Expression) selector)
      });
      ...
      CancellationToken cancellationToken)
    {
      ...
      if (!(source.Provider is IDbAsyncQueryProvider provider))
        throw System.Data.Entity.Resources.Error.IQueryable_Provider_Not_Async();
      MethodCallExpression methodCallExpression = Expression.Call((Expression) null, QueryableExtensions._average_Float_Selector.MakeGenericMethod(typeof (TSource)), new Expression[2]
      {
        source.Expression,
        (Expression) Expression.Quote((Expression) selector)
      });
      ...
      CancellationToken cancellationToken)
    {
      ...
      if (!(source.Provider is IDbAsyncQueryProvider provider))
        throw System.Data.Entity.Resources.Error.IQueryable_Provider_Not_Async();
      MethodCallExpression methodCallExpression = Expression.Call((Expression) null, QueryableExtensions._average_FloatNullable_Selector.MakeGenericMethod(typeof (TSource)), new Expression[2]
      {
        source.Expression,
        (Expression) Expression.Quote((Expression) selector)
      });
      ...
      CancellationToken cancellationToken)
    {
      ...
      if (!(source.Provider is IDbAsyncQueryProvider provider))
        throw System.Data.Entity.Resources.Error.IQueryable_Provider_Not_Async();
      MethodCallExpression methodCallExpression = Expression.Call((Expression) null, QueryableExtensions._average_Double_Selector.MakeGenericMethod(typeof (TSource)), new Expression[2]
      {
        source.Expression,
        (Expression) Expression.Quote((Expression) selector)
      });
      ...
      CancellationToken cancellationToken)
    {
      ...
      if (!(source.Provider is IDbAsyncQueryProvider provider))
        throw System.Data.Entity.Resources.Error.IQueryable_Provider_Not_Async();
      MethodCallExpression methodCallExpression = Expression.Call((Expression) null, QueryableExtensions._average_DoubleNullable_Selector.MakeGenericMethod(typeof (TSource)), new Expression[2]
      {
        source.Expression,
        (Expression) Expression.Quote((Expression) selector)
      });
      ...
      CancellationToken cancellationToken)
    {
      ...
      if (!(source.Provider is IDbAsyncQueryProvider provider))
        throw System.Data.Entity.Resources.Error.IQueryable_Provider_Not_Async();
      MethodCallExpression methodCallExpression = Expression.Call((Expression) null, QueryableExtensions._average_Decimal_Selector.MakeGenericMethod(typeof (TSource)), new Expression[2]
      {
        source.Expression,
        (Expression) Expression.Quote((Expression) selector)
      });
      ...
      CancellationToken cancellationToken)
    {
      ...
      if (!(source.Provider is IDbAsyncQueryProvider provider))
        throw System.Data.Entity.Resources.Error.IQueryable_Provider_Not_Async();
      MethodCallExpression methodCallExpression = Expression.Call((Expression) null, QueryableExtensions._average_DecimalNullable_Selector.MakeGenericMethod(typeof (TSource)), new Expression[2]
      {
        source.Expression,
        (Expression) Expression.Quote((Expression) selector)
      });
    ...
    {
      System.Data.Entity.Utilities.Check.NotNull<IQueryable<TSource>>(source, nameof (source));
      System.Data.Entity.Utilities.Check.NotNull<Expression<Func<int>>>(countAccessor, nameof (countAccessor));
    ...
    internal static ObjectQuery TryGetObjectQuery(this IQueryable source)
    {
      switch (source)
      {
        ...
        case ObjectQuery objectQuery:
          return objectQuery;
        case IInternalQueryAdapter internalQueryAdapter:
    ...
    private static IDbAsyncEnumerable AsDbAsyncEnumerable(this IQueryable source) => source is IDbAsyncEnumerable dbAsyncEnumerable ? dbAsyncEnumerable : throw System.Data.Entity.Resources.Error.IQueryable_Not_Async((object) string.Empty);

    private static IDbAsyncEnumerable<T> AsDbAsyncEnumerable<T>(
      this IQueryable<T> source)
    {
      return source is IDbAsyncEnumerable<T> dbAsyncEnumerable ? dbAsyncEnumerable : throw System.Data.Entity.Resources.Error.IQueryable_Not_Async((object) ("<" + typeof (T)?.ToString() + ">"));
    }

    private static MethodInfo GetMethod(string methodName, Func<Type[]> getParameterTypes) => QueryableExtensions.GetMethod(methodName, (Delegate) getParameterTypes, 0);
    ...
    private static bool Matches(MethodInfo methodInfo, Type[] parameterTypes) => ((IEnumerable<ParameterInfo>) methodInfo.GetParameters()).Select<ParameterInfo, Type>((Func<ParameterInfo, Type>) (p => p.ParameterType)).SequenceEqual<Type>((IEnumerable<Type>) parameterTypes);
