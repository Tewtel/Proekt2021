...
namespace System.Data.Entity.Spatial
{
  ...
  {
    private static readonly Lazy<DbSpatialServices> _defaultServices = new Lazy<DbSpatialServices>((Func<DbSpatialServices>) (() => new SpatialServicesLoader(DbConfiguration.DependencyResolver).LoadDefaultServices()), true);
    ...
    public static DbSpatialServices Default => DbSpatialServices._defaultServices.Value;
    ...
    /// <see cref="M:System.Data.Entity.Spatial.DbSpatialServices.GeographyFromProviderValue(System.Object)" />
    ...
    {
      System.Data.Entity.Utilities.Check.NotNull<DbSpatialServices>(spatialServices, nameof (spatialServices));
    ...
    /// is not compatible with this spatial services implementation.
    /// </exception>
    public virtual string AsTextIncludingElevationAndMeasure(DbGeography geographyValue) => (string) null;
    ...
    /// <summary>
    /// This method is intended for use by derived implementations of
    /// <see cref="M:System.Data.Entity.Spatial.DbSpatialServices.GeometryFromProviderValue(System.Object)" />
    /// after suitable validation of the specified provider value to ensure it is suitable for use with the derived implementation.
    /// </summary>
    /// <returns>
    ...
    /// The identifier of the coordinate system that the new <see cref="T:System.Data.Entity.Spatial.DbGeometry" /> value should use.
    /// </param>
    public abstract DbGeometry GeometryFromText(
      string wellKnownText,
      int coordinateSystemId);
    ...
    /// is not compatible with this spatial services implementation.
    /// </exception>
    public virtual string AsTextIncludingElevationAndMeasure(DbGeometry geometryValue) => (string) null;
