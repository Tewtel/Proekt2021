...
namespace System.Data.Entity.Spatial
{
  ...
  public class DbGeometry
  {
    ...
    public static DbGeometry GeometryCollectionFromBinary(
      ...
      int coordinateSystemId)
    {
      System.Data.Entity.Utilities.Check.NotNull<byte[]>(geometryCollectionWellKnownBinary, nameof (geometryCollectionWellKnownBinary));
    ...
    public static DbGeometry GeometryCollectionFromText(
      ...
      int coordinateSystemId)
    {
      System.Data.Entity.Utilities.Check.NotNull<string>(geometryCollectionWellKnownText, nameof (geometryCollectionWellKnownText));
    ...
    public DbGeometry Boundary => this._spatialProvider.GetBoundary(this);
    ...
    public DbGeometry Envelope => this._spatialProvider.GetEnvelope(this);
    ...
    public bool IsSimple => this._spatialProvider.GetIsSimple(this);
    ...
    public bool IsValid => this._spatialProvider.GetIsValid(this);
    ...
    {
      System.Data.Entity.Utilities.Check.NotNull<DbGeometry>(other, nameof (other));
    ...
    {
      System.Data.Entity.Utilities.Check.NotNull<DbGeometry>(other, nameof (other));
      System.Data.Entity.Utilities.Check.NotNull<string>(matrix, nameof (matrix));
    ...
    public DbGeometry ConvexHull => this._spatialProvider.GetConvexHull(this);
    ...
    public DbGeometry ElementAt(int index) => this._spatialProvider.ElementAt(this, index);
    ...
    public double? XCoordinate => this._spatialProvider.GetXCoordinate(this);
    ...
    public double? YCoordinate => this._spatialProvider.GetYCoordinate(this);
    ...
    public DbGeometry StartPoint => this._spatialProvider.GetStartPoint(this);

    /// <summary> Gets a DbGeometry value representing the start point of this value, which may be null if this DbGeometry value does not represent a curve. </summary>
    /// <returns>A DbGeometry value representing the start point of this value.</returns>
    public DbGeometry EndPoint => this._spatialProvider.GetEndPoint(this);
    ...
    public bool? IsRing => this._spatialProvider.GetIsRing(this);
    ...
    /// <returns>An element of this DbGeometry value from a specific position.</returns>
    /// <param name="index">The index.</param>
    public DbGeometry PointAt(int index) => this._spatialProvider.PointAt(this, index);
    ...
    public DbGeometry Centroid => this._spatialProvider.GetCentroid(this);
    ...
    public DbGeometry PointOnSurface => this._spatialProvider.GetPointOnSurface(this);
    ...
    public DbGeometry ExteriorRing => this._spatialProvider.GetExteriorRing(this);
    ...
    public int? InteriorRingCount => this._spatialProvider.GetInteriorRingCount(this);
    ...
    /// <param name="index">The index.</param>
    public DbGeometry InteriorRingAt(int index) => this._spatialProvider.InteriorRingAt(this, index);
