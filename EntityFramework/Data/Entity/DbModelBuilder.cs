...
namespace System.Data.Entity
{
  ...
  public class DbModelBuilder
  {
    ...
    {
      System.Data.Entity.Utilities.Check.NotNull<IEnumerable<Type>>(types, nameof (types));
    ...
    public virtual EntityTypeConfiguration<TEntityType> Entity<TEntityType>() where TEntityType : class => new EntityTypeConfiguration<TEntityType>(this._modelConfiguration.Entity(typeof (TEntityType), true));
    ...
    public virtual ComplexTypeConfiguration<TComplexType> ComplexType<TComplexType>() where TComplexType : class => new ComplexTypeConfiguration<TComplexType>(this._modelConfiguration.ComplexType(typeof (TComplexType)));
    ...
    public PropertyConventionConfiguration Properties<T>()
    {
      if (!typeof (T).IsValidEdmScalarType())
        throw System.Data.Entity.Resources.Error.ModelBuilder_PropertyFilterTypeMustBePrimitive((object) typeof (T));
    ...
    /// </summary>
    public virtual ConventionsConfiguration Conventions => this._conventionsConfiguration;
    ...
    /// </summary>
    public virtual ConfigurationRegistrar Configurations => new ConfigurationRegistrar(this._modelConfiguration);
    ...
    {
      System.Data.Entity.Utilities.Check.NotNull<DbConnection>(providerConnection, nameof (providerConnection));
    ...
    {
      System.Data.Entity.Utilities.Check.NotNull<DbProviderInfo>(providerInfo, nameof (providerInfo));
      return this.Build(DbModelBuilder.GetProviderManifest(providerInfo), providerInfo);
    }

    internal DbModelBuilderVersion Version => this._modelBuilderVersion;
    ...
    {
      TypeMapper typeMapper = new TypeMapper(new MappingContext(this._modelConfiguration, this._conventionsConfiguration, model, this._modelBuilderVersion, DbConfiguration.DependencyResolver.GetService<System.Data.Entity.ModelConfiguration.Utilities.AttributeProvider>()));
      if (!(this._modelConfiguration.Entities is IList<Type> typeList1))
        typeList1 = (IList<Type>) this._modelConfiguration.Entities.ToList<Type>();
      IList<Type> typeList2 = typeList1;
      for (int index = 0; index < typeList2.Count; ++index)
      {
        Type type = typeList2[index];
        if (typeMapper.MapEntityType(type) == null)
          throw System.Data.Entity.Resources.Error.InvalidEntityType((object) type);
      }
      if (!(this._modelConfiguration.ComplexTypes is IList<Type> typeList3))
        typeList3 = (IList<Type>) this._modelConfiguration.ComplexTypes.ToList<Type>();
      IList<Type> typeList4 = typeList3;
      for (int index = 0; index < typeList4.Count; ++index)
      {
        Type type = typeList4[index];
        if (typeMapper.MapComplexType(type) == null)
          throw System.Data.Entity.Resources.Error.CodeFirstInvalidComplexType((object) type);
      }
    }

    internal System.Data.Entity.ModelConfiguration.Configuration.ModelConfiguration ModelConfiguration => this._modelConfiguration;
