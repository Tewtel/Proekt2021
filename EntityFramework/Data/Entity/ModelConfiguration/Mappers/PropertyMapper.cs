...
namespace System.Data.Entity.ModelConfiguration.Mappers
{
  internal sealed class PropertyMapper
  {
    ...
    public PropertyMapper(TypeMapper typeMapper) => this._typeMapper = typeMapper;
    ...
    {
      EdmProperty edmProperty = this.MapPrimitiveOrComplexOrEnumProperty(propertyInfo, (Func<StructuralTypeConfiguration>) entityTypeConfiguration);
      if (edmProperty != null)
      ...
      bool discoverComplexTypes = false)
    {
      ...
      if (property != null)
      {
        ...
        if (!property.IsComplexType)
          this._typeMapper.MappingContext.ConventionsConfiguration.ApplyPropertyConfiguration(propertyInfo, (Func<PropertyConfiguration>) (() => (PropertyConfiguration) structuralTypeConfiguration().Property(new PropertyPath(propertyInfo))), this._typeMapper.MappingContext.ModelConfiguration);
      }
      return property;
    }
  }
