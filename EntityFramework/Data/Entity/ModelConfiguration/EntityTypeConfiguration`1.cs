...
namespace System.Data.Entity.ModelConfiguration
{
    ...
    where TEntityType : class
  {
    ...
    internal EntityTypeConfiguration(EntityTypeConfiguration entityTypeConfiguration) => this._entityTypeConfiguration = entityTypeConfiguration;

    internal override StructuralTypeConfiguration Configuration => (StructuralTypeConfiguration) this._entityTypeConfiguration;

    internal override TPrimitivePropertyConfiguration Property<TPrimitivePropertyConfiguration>(
      LambdaExpression lambdaExpression)
    {
      return this.Configuration.Property<TPrimitivePropertyConfiguration>(lambdaExpression.GetComplexPropertyAccess(), (Func<TPrimitivePropertyConfiguration>) (() =>
      {
    ...
    {
      System.Data.Entity.Utilities.Check.NotNull<Expression<Func<TEntityType, TKey>>>(keyExpression, nameof (keyExpression));
    ...
    {
      System.Data.Entity.Utilities.Check.NotNull<Expression<Func<TEntityType, TKey>>>(keyExpression, nameof (keyExpression));
      System.Data.Entity.Utilities.Check.NotNull<Action<PrimaryKeyIndexConfiguration>>(buildAction, nameof (buildAction));
      this._entityTypeConfiguration.Key(keyExpression.GetSimplePropertyAccessList().Select<PropertyPath, PropertyInfo>((Func<PropertyPath, PropertyInfo>) (p => p.Single<PropertyInfo>())));
      buildAction(new PrimaryKeyIndexConfiguration(this._entityTypeConfiguration.ConfigureKey()));
      return this;
    }

    /// <summary>Configures index property(s) for this entity type.</summary>
    ...
    public IndexConfiguration HasIndex<TIndex>(
      Expression<Func<TEntityType, TIndex>> indexExpression)
    {
      System.Data.Entity.Utilities.Check.NotNull<Expression<Func<TEntityType, TIndex>>>(indexExpression, nameof (indexExpression));
      return new IndexConfiguration(this._entityTypeConfiguration.Index(new PropertyPath(indexExpression.GetSimplePropertyAccessList().Select<PropertyPath, PropertyInfo>((Func<PropertyPath, PropertyInfo>) (p => p.Single<PropertyInfo>())))));
    }
    ...
    {
      System.Data.Entity.Utilities.Check.NotNull<Action<ModificationStoredProceduresConfiguration<TEntityType>>>(modificationStoredProcedureMappingConfigurationAction, nameof (modificationStoredProcedureMappingConfigurationAction));
    ...
    {
      System.Data.Entity.Utilities.Check.NotNull<Action<EntityMappingConfiguration<TEntityType>>>(entityMappingConfigurationAction, nameof (entityMappingConfigurationAction));
      ...
      this._entityTypeConfiguration.AddMappingConfiguration(mappingConfiguration.EntityMappingConfigurationInstance);
      return this;
    }
    ...
    {
      System.Data.Entity.Utilities.Check.NotNull<Action<EntityMappingConfiguration<TDerived>>>(derivedTypeMapConfigurationAction, nameof (derivedTypeMapConfigurationAction));
    ...
    {
      System.Data.Entity.Utilities.Check.NotNull<Expression<Func<TEntityType, TTargetEntity>>>(navigationPropertyExpression, nameof (navigationPropertyExpression));
    ...
    public ManyNavigationPropertyConfiguration<TEntityType, TTargetEntity> HasMany<TTargetEntity>(
      ...
      where TTargetEntity : class
    {
      System.Data.Entity.Utilities.Check.NotNull<Expression<Func<TEntityType, ICollection<TTargetEntity>>>>(navigationPropertyExpression, nameof (navigationPropertyExpression));
