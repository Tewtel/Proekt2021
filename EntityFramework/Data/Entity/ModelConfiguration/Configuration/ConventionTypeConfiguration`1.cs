...
namespace System.Data.Entity.ModelConfiguration.Configuration
{
  ...
  public class ConventionTypeConfiguration<T> where T : class
  {
    ...
    /// </summary>
    public Type ClrType => this._configuration.ClrType;
    ...
    {
      System.Data.Entity.Utilities.Check.NotNull<Expression<Func<T, TProperty>>>(propertyExpression, nameof (propertyExpression));
    ...
    {
      System.Data.Entity.Utilities.Check.NotNull<Expression<Func<T, TProperty>>>(keyExpression, nameof (keyExpression));
    ...
    {
      System.Data.Entity.Utilities.Check.NotNull<Action<ModificationStoredProceduresConfiguration<T>>>(modificationStoredProceduresConfigurationAction, nameof (modificationStoredProceduresConfigurationAction));
