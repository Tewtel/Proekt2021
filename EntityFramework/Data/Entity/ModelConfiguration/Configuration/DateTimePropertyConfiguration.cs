...
namespace System.Data.Entity.ModelConfiguration.Configuration
{
  ...
  public class DateTimePropertyConfiguration : PrimitivePropertyConfiguration
  {
    ...
    /// </param>
    /// <returns> The same DateTimePropertyConfiguration instance so that multiple calls can be chained. </returns>
    public DateTimePropertyConfiguration HasDatabaseGeneratedOption(
    ...
    /// <returns> The same DateTimePropertyConfiguration instance so that multiple calls can be chained. </returns>
    public DateTimePropertyConfiguration HasColumnName(
      string columnName)
    {
    ...
    /// .
    ///             <returns>The same DateTimePropertyConfiguration instance so that multiple calls can be chained.</returns>
    public DateTimePropertyConfiguration HasColumnAnnotation(
      string name,
      object value)
    {
    ...
    /// <returns> The same DateTimePropertyConfiguration instance so that multiple calls can be chained. </returns>
    public DateTimePropertyConfiguration HasColumnType(
      string columnType)
    {
    ...
    /// <returns> The same DateTimePropertyConfiguration instance so that multiple calls can be chained. </returns>
    public DateTimePropertyConfiguration HasColumnOrder(
      int? columnOrder)
    {
    ...
    internal System.Data.Entity.ModelConfiguration.Configuration.Properties.Primitive.DateTimePropertyConfiguration Configuration => (System.Data.Entity.ModelConfiguration.Configuration.Properties.Primitive.DateTimePropertyConfiguration) base.Configuration;
  }
}
