...
namespace System.Data.Entity.ModelConfiguration.Configuration
{
  ...
  public class BinaryPropertyConfiguration : LengthPropertyConfiguration
  {
    ...
    /// <returns> The same BinaryPropertyConfiguration instance so that multiple calls can be chained. </returns>
    public BinaryPropertyConfiguration HasMaxLength(int? value)
    {
    ...
    /// </param>
    /// <returns> The same BinaryPropertyConfiguration instance so that multiple calls can be chained. </returns>
    public BinaryPropertyConfiguration HasDatabaseGeneratedOption(
    ...
    /// .
    ///             <returns>The same BinaryPropertyConfiguration instance so that multiple calls can be chained.</returns>
    public BinaryPropertyConfiguration HasColumnAnnotation(
      string name,
      object value)
    {
    ...
    /// <returns> The same BinaryPropertyConfiguration instance so that multiple calls can be chained. </returns>
    public BinaryPropertyConfiguration HasColumnOrder(int? columnOrder)
    {
    ...
    internal System.Data.Entity.ModelConfiguration.Configuration.Properties.Primitive.BinaryPropertyConfiguration Configuration => (System.Data.Entity.ModelConfiguration.Configuration.Properties.Primitive.BinaryPropertyConfiguration) base.Configuration;
  }
}
