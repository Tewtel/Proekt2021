...
namespace System.Data.Entity.ModelConfiguration.Configuration
{
  ...
  public class ValueConditionConfiguration
  {
    ...
    {
      if (value != null && !value.GetType().IsPrimitiveType(out PrimitiveType _))
        throw System.Data.Entity.Resources.Error.InvalidDiscriminatorType((object) value.GetType().Name);
    }
    ...
    internal static IEnumerable<MappingFragment> GetMappingFragmentsWithColumnAsDefaultDiscriminator(
      ...
      EdmProperty column)
    {
      return databaseMapping.EntityContainerMappings.SelectMany<EntityContainerMapping, EntitySetMapping>((Func<EntityContainerMapping, IEnumerable<EntitySetMapping>>) (ecm => ecm.EntitySetMappings)).SelectMany<EntitySetMapping, EntityTypeMapping>((Func<EntitySetMapping, IEnumerable<EntityTypeMapping>>) (esm => (IEnumerable<EntityTypeMapping>) esm.EntityTypeMappings)).SelectMany<EntityTypeMapping, MappingFragment>((Func<EntityTypeMapping, IEnumerable<MappingFragment>>) (etm => (IEnumerable<MappingFragment>) etm.MappingFragments)).Where<MappingFragment>((Func<MappingFragment, bool>) (tmf => tmf.Table == table && tmf.GetDefaultDiscriminator() == column));
    }
      ...
      DbProviderManifest providerManifest)
    {
      ...
      if (configuration != null && (configuration.OverridableConfigurationParts & OverridableConfigurationParts.OverridableInCSpace) != OverridableConfigurationParts.OverridableInCSpace && !configuration.IsCompatible(this._configuration, true, out errorMessage))
        throw System.Data.Entity.Resources.Error.ConflictingColumnConfiguration((object) edmProperty, (object) fragment.Table, (object) errorMessage);
      if (this._configuration.IsNullable.HasValue)
        edmProperty.Nullable = this._configuration.IsNullable.Value;
      this._configuration.Configure(edmProperty, fragment.Table, providerManifest);
    }
      ...
      EdmProperty discriminatorColumn)
    {
      ...
      if (existingConfiguration != null && !discriminatorColumn.TypeName.Equals(edmType.Name, StringComparison.OrdinalIgnoreCase))
        throw System.Data.Entity.Resources.Error.ConflictingInferredColumnType((object) discriminatorColumn.Name, (object) discriminatorColumn.TypeName, (object) edmType.Name);
