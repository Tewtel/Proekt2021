...
namespace System.Data.Entity.ModelConfiguration.Configuration
{
  internal class ModificationStoredProcedureConfiguration
  {
    ...
    public virtual ModificationStoredProcedureConfiguration Clone() => new ModificationStoredProcedureConfiguration(this);
    ...
    public void RowsAffectedParameter(string name) => this._rowsAffectedParameter = name;

    public string RowsAffectedParameterName => this._rowsAffectedParameter;

    public IEnumerable<Tuple<string, string>> ParameterNames => (IEnumerable<Tuple<string, string>>) this._parameterNames.Values;

    public void ClearParameterNames() => this._parameterNames.Clear();

    public Dictionary<PropertyInfo, string> ResultBindings => this._resultBindings;
    ...
    public void Result(PropertyPath propertyPath, string columnName) => this._resultBindings[propertyPath.Single<PropertyInfo>()] = columnName;
      ...
      foreach (KeyValuePair<ModificationStoredProcedureConfiguration.ParameterKey, Tuple<string, string>> parameterName in this._parameterNames)
      {
        ...
        if (list.Count == 1)
        {
          ...
          if (!string.IsNullOrWhiteSpace(str2) && parameterBinding.IsCurrent)
            throw System.Data.Entity.Resources.Error.ModificationFunctionParameterNotFoundOriginal((object) propertyPath, (object) modificationStoredProcedureMapping.Function.FunctionName);
        ...
        {
          if (list.Count != 2)
            throw System.Data.Entity.Resources.Error.ModificationFunctionParameterNotFound((object) propertyPath, (object) modificationStoredProcedureMapping.Function.FunctionName);
      ...
      ModificationFunctionMapping modificationStoredProcedureMapping)
    {
      foreach (KeyValuePair<PropertyInfo, string> resultBinding in this._resultBindings)
      {
        ...
        if (functionResultBinding == null)
          throw System.Data.Entity.Resources.Error.ResultBindingNotFound((object) propertyInfo.Name, (object) modificationStoredProcedureMapping.Function.FunctionName);
        functionResultBinding.ColumnName = str;
      }
    }

    public bool IsCompatibleWith(ModificationStoredProcedureConfiguration other) => (this._name == null || other._name == null || string.Equals(this._name, other._name, StringComparison.OrdinalIgnoreCase)) && (this._schema == null || other._schema == null || string.Equals(this._schema, other._schema, StringComparison.OrdinalIgnoreCase)) && !this._parameterNames.Join<KeyValuePair<ModificationStoredProcedureConfiguration.ParameterKey, Tuple<string, string>>, KeyValuePair<ModificationStoredProcedureConfiguration.ParameterKey, Tuple<string, string>>, ModificationStoredProcedureConfiguration.ParameterKey, bool>((IEnumerable<KeyValuePair<ModificationStoredProcedureConfiguration.ParameterKey, Tuple<string, string>>>) other._parameterNames, (Func<KeyValuePair<ModificationStoredProcedureConfiguration.ParameterKey, Tuple<string, string>>, ModificationStoredProcedureConfiguration.ParameterKey>) (kv1 => kv1.Key), (Func<KeyValuePair<ModificationStoredProcedureConfiguration.ParameterKey, Tuple<string, string>>, ModificationStoredProcedureConfiguration.ParameterKey>) (kv2 => kv2.Key), (Func<KeyValuePair<ModificationStoredProcedureConfiguration.ParameterKey, Tuple<string, string>>, KeyValuePair<ModificationStoredProcedureConfiguration.ParameterKey, Tuple<string, string>>, bool>) ((kv1, kv2) => !object.Equals((object) kv1.Value, (object) kv2.Value))).Any<bool>((Func<bool, bool>) (j => j));
      ...
      bool allowOverride)
    {
      ...
      foreach (KeyValuePair<ModificationStoredProcedureConfiguration.ParameterKey, Tuple<string, string>> keyValuePair in modificationStoredProcedureConfiguration._parameterNames.Where<KeyValuePair<ModificationStoredProcedureConfiguration.ParameterKey, Tuple<string, string>>>((Func<KeyValuePair<ModificationStoredProcedureConfiguration.ParameterKey, Tuple<string, string>>, bool>) (parameterName => allowOverride || !this._parameterNames.ContainsKey(parameterName.Key))))
        this._parameterNames[keyValuePair.Key] = keyValuePair.Value;
      foreach (KeyValuePair<PropertyInfo, string> keyValuePair in modificationStoredProcedureConfiguration.ResultBindings.Where<KeyValuePair<PropertyInfo, string>>((Func<KeyValuePair<PropertyInfo, string>, bool>) (resultBinding => allowOverride || !this._resultBindings.ContainsKey(resultBinding.Key))))
    ...
    private sealed class ParameterKey
    {
      ...
      public PropertyPath PropertyPath => this._propertyPath;

      public bool IsRightKey => this._rightKey;
      ...
      public override int GetHashCode() => this._propertyPath.GetHashCode() * 397 ^ this._rightKey.GetHashCode();
    }
  }
}
