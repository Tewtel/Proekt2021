...
namespace System.Data.Entity.ModelConfiguration.Configuration.Mapping
{
  internal class EntityMappingConfiguration
  {
    ...
    internal virtual EntityMappingConfiguration Clone() => new EntityMappingConfiguration(this);
    ...
    internal IDictionary<PropertyPath, System.Data.Entity.ModelConfiguration.Configuration.Properties.Primitive.PrimitivePropertyConfiguration> PrimitivePropertyConfigurations => (IDictionary<PropertyPath, System.Data.Entity.ModelConfiguration.Configuration.Properties.Primitive.PrimitivePropertyConfiguration>) this._primitivePropertyConfigurations;
    ...
    public List<ValueConditionConfiguration> ValueConditions => this._valueConditions;
    ...
    {
      get => this._notNullConditions;
      set => value.Each<NotNullConditionConfiguration>(new Action<NotNullConditionConfiguration>(this.AddNullabilityCondition));
    }
    ...
    public bool MapsAnyInheritedProperties(EntityType entityType)
    {
      ...
      return this.MapInheritedProperties || properties.Any<EdmPropertyPath>((Func<EdmPropertyPath, bool>) (x => !entityType.KeyProperties().Contains<EdmProperty>(x.First<EdmProperty>()) && !entityType.DeclaredProperties.Contains(x.First<EdmProperty>())));
    }
      ...
      IDictionary<string, object> commonAnnotations)
    {
      ...
      foreach (EdmPropertyPath edmPropertyPath in contain)
      {
        ...
        list.Remove(typeMappingFragment1.ColumnMappings.SingleOrDefault<ColumnMappingBuilder>((Func<ColumnMappingBuilder, bool>) (pm => pm.PropertyPath.SequenceEqual<EdmProperty>((IEnumerable<EdmProperty>) propertyPath))) ?? throw System.Data.Entity.Resources.Error.EntityMappingConfiguration_DuplicateMappedProperty((object) entityType.Name, (object) propertyPath.ToString()));
      }
      if (!flag)
      {
        bool isSplitting;
        ...
        if (isMappingAnyInheritedProperty)
        {
          ...
          AssociationSetMapping associationSetMapping = databaseMapping.EntityContainerMappings.SelectMany<EntityContainerMapping, AssociationSetMapping>((Func<EntityContainerMapping, IEnumerable<AssociationSetMapping>>) (asm => asm.AssociationSetMappings)).FirstOrDefault<AssociationSetMapping>((Func<AssociationSetMapping, bool>) (a =>
          {
            if (!baseTables.Contains<EntityType>(a.Table))
              return false;
            return baseType == a.AssociationSet.ElementType.SourceEnd.GetEntityType() || baseType == a.AssociationSet.ElementType.TargetEnd.GetEntityType();
          }));
          if (associationSetMapping != null)
          {
            AssociationType elementType = associationSetMapping.AssociationSet.ElementType;
            throw System.Data.Entity.Resources.Error.EntityMappingConfiguration_TPCWithIAsOnNonLeafType((object) elementType.Name, (object) elementType.SourceEnd.GetEntityType().Name, (object) elementType.TargetEnd.GetEntityType().Name);
          }
      ...
      IDictionary<string, object> annotations)
    {
      foreach (KeyValuePair<string, object> annotation1 in (IEnumerable<KeyValuePair<string, object>>) annotations)
      {
        ...
        MetadataProperty metadataProperty = toTable.Annotations.FirstOrDefault<MetadataProperty>((Func<MetadataProperty, bool>) (a => a.Name == name && !object.Equals(a.Value, annotation.Value)));
        if (metadataProperty != null)
          throw new InvalidOperationException(System.Data.Entity.Resources.Strings.ConflictingTypeAnnotation((object) annotation.Key, annotation.Value, metadataProperty.Value, (object) toTable.Name));
      ...
      DbProviderManifest providerManifest)
    {
      ...
      else
      {
        if (this.MapInheritedProperties)
          throw System.Data.Entity.Resources.Error.EntityMappingConfiguration_DuplicateMapInheritedProperties((object) entityType.Name);
        if (this.Properties == null)
          throw System.Data.Entity.Resources.Error.EntityMappingConfiguration_DuplicateMappedProperties((object) entityType.Name);
        this.Properties.Each<PropertyPath>((Action<PropertyPath>) (p =>
        {
          if (EntityMappingConfiguration.PropertyPathToEdmPropertyPath(p, entityType).Any<EdmPropertyPath>((Func<EdmPropertyPath, bool>) (pp => !entityType.KeyProperties().Contains<EdmProperty>(pp.First<EdmProperty>()))))
            throw System.Data.Entity.Resources.Error.EntityMappingConfiguration_DuplicateMappedProperty((object) entityType.Name, (object) p.ToString());
        }));
      ...
      EntityType table)
    {
      ...
      if (!((IEnumerable<AssociationSetMapping>) array1).Any<AssociationSetMapping>() && !((IEnumerable<MappingFragment>) array2).Any<MappingFragment>())
      {
        ...
        ((IEnumerable<AssociationType>) databaseMapping.Database.AssociationTypes.Where<AssociationType>((Func<AssociationType, bool>) (t => t.SourceEnd.GetEntityType() == table || t.TargetEnd.GetEntityType() == table)).ToArray<AssociationType>()).Each<AssociationType>((Action<AssociationType>) (t => databaseMapping.Database.RemoveAssociationType(t)));
      }
      else
      {
        ...
        ((IEnumerable<ForeignKeyBuilder>) table.ForeignKeyBuilders.Where<ForeignKeyBuilder>((Func<ForeignKeyBuilder, bool>) (fk => fk.PrincipalTable == table && fk.DependentColumns.SequenceEqual<EdmProperty>((IEnumerable<EdmProperty>) table.KeyProperties))).ToArray<ForeignKeyBuilder>()).Each<ForeignKeyBuilder>(new Action<ForeignKeyBuilder>(table.RemoveForeignKey));
      }
    }
      ...
      EntityType entityType)
    {
      ...
      for (int i = 0; i < path.Count; i++)
      {
        ...
        if (edmProperty == null)
          throw System.Data.Entity.Resources.Error.EntityMappingConfiguration_CannotMapIgnoredProperty((object) entityType.Name, (object) path.ToString());
      ...
      MappingFragment fragment)
    {
      ...
      if (source1.Count > 0 && source1.Count == dictionary.Count)
      {
        ...
        throw System.Data.Entity.Resources.Error.EntityMappingConfiguration_InvalidTableSharing((object) entityType.Name, (object) source1.First<EntityType>().Name, tableName != null ? (object) tableName.Name : (object) databaseMapping.Database.GetEntitySet(toTable).Table);
      }
