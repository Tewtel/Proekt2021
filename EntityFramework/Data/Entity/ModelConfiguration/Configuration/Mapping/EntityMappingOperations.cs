        ...
        if (entityTypeMappings != null)
        {
          for (int index2 = 0; index2 < entityTypeMappings.Count; ++index2)
          {
            ...
            if (mappingFragments != null)
            {
              ...
              {
                if (mappingFragments[index3].ColumnMappings is IList<ColumnMappingBuilder> columnMappings7)
                {
                  for (int index4 = 0; index4 < columnMappings7.Count; ++index4)
                  {
                    ColumnMappingBuilder columnMappingBuilder = columnMappings7[index4];
