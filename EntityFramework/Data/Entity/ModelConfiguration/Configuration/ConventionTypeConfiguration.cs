...
namespace System.Data.Entity.ModelConfiguration.Configuration
{
  ...
  public class ConventionTypeConfiguration
  {
    ...
    /// </summary>
    public Type ClrType => this._type;
    ...
    public ConventionTypeConfiguration Ignore(string propertyName)
    {
      ...
      if (instanceProperty == (PropertyInfo) null)
        throw new InvalidOperationException(System.Data.Entity.Resources.Strings.NoSuchProperty((object) propertyName, (object) this._type.Name));
      ...
      string propertyName)
    {
      System.Data.Entity.Utilities.Check.NotEmpty(propertyName, nameof (propertyName));
      PropertyInfo instanceProperty = this._type.GetInstanceProperty(propertyName);
      return !(instanceProperty == (PropertyInfo) null) ? this.Property(instanceProperty) : throw new InvalidOperationException(System.Data.Entity.Resources.Strings.NoSuchProperty((object) propertyName, (object) this._type.Name));
    }
      ...
      PropertyPath propertyPath)
    {
      ...
      if (!propertyInfo.IsValidEdmScalarProperty())
        throw new InvalidOperationException(System.Data.Entity.Resources.Strings.LightweightEntityConfiguration_NonScalarProperty((object) propertyPath));
      System.Data.Entity.ModelConfiguration.Configuration.Properties.Primitive.PrimitivePropertyConfiguration propertyConfiguration = this._entityTypeConfiguration != null ? this._entityTypeConfiguration().Property(propertyPath) : (this._complexTypeConfiguration != null ? this._complexTypeConfiguration().Property(propertyPath) : (System.Data.Entity.ModelConfiguration.Configuration.Properties.Primitive.PrimitivePropertyConfiguration) null);
      ...
      string propertyName)
    {
      System.Data.Entity.Utilities.Check.NotEmpty(propertyName, nameof (propertyName));
      PropertyInfo instanceProperty = this._type.GetInstanceProperty(propertyName);
      return !(instanceProperty == (PropertyInfo) null) ? this.NavigationProperty(instanceProperty) : throw new InvalidOperationException(System.Data.Entity.Resources.Strings.NoSuchProperty((object) propertyName, (object) this._type.Name));
    }
      ...
      PropertyPath propertyPath)
    {
      ...
      if (!propertyInfo.IsValidEdmNavigationProperty())
        throw new InvalidOperationException(System.Data.Entity.Resources.Strings.LightweightEntityConfiguration_InvalidNavigationProperty((object) propertyPath));
    ...
    public ConventionTypeConfiguration HasKey(string propertyName)
    {
      System.Data.Entity.Utilities.Check.NotEmpty(propertyName, nameof (propertyName));
      PropertyInfo instanceProperty = this._type.GetInstanceProperty(propertyName);
      return !(instanceProperty == (PropertyInfo) null) ? this.HasKey(instanceProperty) : throw new InvalidOperationException(System.Data.Entity.Resources.Strings.NoSuchProperty((object) propertyName, (object) this._type.Name));
    }
    ...
    {
      System.Data.Entity.Utilities.Check.NotNull<IEnumerable<string>>(propertyNames, nameof (propertyNames));
      return this.HasKey((IEnumerable<PropertyInfo>) propertyNames.Select<string, PropertyInfo>((Func<string, PropertyInfo>) (n =>
      {
        ...
        return !(instanceProperty == (PropertyInfo) null) ? instanceProperty : throw new InvalidOperationException(System.Data.Entity.Resources.Strings.NoSuchProperty((object) n, (object) this._type.Name));
    ...
    {
      System.Data.Entity.Utilities.Check.NotNull<IEnumerable<PropertyInfo>>(keyProperties, nameof (keyProperties));
      EntityUtil.CheckArgumentContainsNull<PropertyInfo>(ref keyProperties, nameof (keyProperties));
      EntityUtil.CheckArgumentEmpty<PropertyInfo>(ref keyProperties, (Func<string, string>) (p => System.Data.Entity.Resources.Strings.CollectionEmpty((object) p, (object) nameof (HasKey))), nameof (keyProperties));
      this.ValidateConfiguration(ConventionTypeConfiguration.ConfigurationAspect.HasKey);
      if (this._entityTypeConfiguration != null && !this._entityTypeConfiguration().IsKeyConfigured)
    ...
    {
      System.Data.Entity.Utilities.Check.NotNull<Action<ConventionModificationStoredProceduresConfiguration>>(modificationStoredProceduresConfigurationAction, nameof (modificationStoredProceduresConfigurationAction));
      this.ValidateConfiguration(ConventionTypeConfiguration.ConfigurationAspect.MapToStoredProcedures);
      ...
      ConventionTypeConfiguration.ConfigurationAspect aspect)
    {
      ...
      if (this._currentConfigurationAspect.HasFlag((Enum) ConventionTypeConfiguration.ConfigurationAspect.IsComplexType) && ConventionTypeConfiguration.ConfigurationAspectsConflictingWithComplexType.Any<ConventionTypeConfiguration.ConfigurationAspect>((Func<ConventionTypeConfiguration.ConfigurationAspect, bool>) (ca => this._currentConfigurationAspect.HasFlag((Enum) ca))))
        throw new InvalidOperationException(System.Data.Entity.Resources.Strings.LightweightEntityConfiguration_ConfigurationConflict_ComplexType((object) ConventionTypeConfiguration.ConfigurationAspectsConflictingWithComplexType.First<ConventionTypeConfiguration.ConfigurationAspect>((Func<ConventionTypeConfiguration.ConfigurationAspect, bool>) (ca => this._currentConfigurationAspect.HasFlag((Enum) ca))), (object) this._type.Name));
    }
