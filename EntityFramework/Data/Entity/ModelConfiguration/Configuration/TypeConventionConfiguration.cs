...
namespace System.Data.Entity.ModelConfiguration.Configuration
{
  ...
  public class TypeConventionConfiguration
  {
    ...
    public TypeConventionWithHavingConfiguration<T> Having<T>(
      ...
      where T : class
    {
      System.Data.Entity.Utilities.Check.NotNull<Func<Type, T>>(capturingPredicate, nameof (capturingPredicate));
    ...
    {
      System.Data.Entity.Utilities.Check.NotNull<Action<ConventionTypeConfiguration>>(entityConfigurationAction, nameof (entityConfigurationAction));
