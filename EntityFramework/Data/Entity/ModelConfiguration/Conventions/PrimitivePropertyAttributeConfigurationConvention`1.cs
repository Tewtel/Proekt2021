...
namespace System.Data.Entity.ModelConfiguration.Conventions
{
    ...
    where TAttribute : Attribute
  {
    ...
    /// </summary>
    protected PrimitivePropertyAttributeConfigurationConvention() => this.Properties().Having<IEnumerable<TAttribute>>((Func<PropertyInfo, IEnumerable<TAttribute>>) (pi => this._attributeProvider.GetAttributes(pi).OfType<TAttribute>())).Configure((Action<ConventionPrimitivePropertyConfiguration, IEnumerable<TAttribute>>) ((configuration, attributes) =>
    {
