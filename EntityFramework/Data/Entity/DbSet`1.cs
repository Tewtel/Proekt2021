...
namespace System.Data.Entity
{
    ...
    where TEntity : class
  {
    ...
    public virtual TEntity Find(params object[] keyValues) => this.GetInternalSetWithCheck(nameof (Find)).Find(keyValues);
    ...
    /// <param name="keyValues"> The values of the primary key for the entity to be found. </param>
    /// <returns> A task that represents the asynchronous find operation. The task result contains the entity found, or null. </returns>
    public virtual Task<TEntity> FindAsync(params object[] keyValues) => this.FindAsync(CancellationToken.None, keyValues);

    /// <inheritdoc />
    public virtual ObservableCollection<TEntity> Local => this.GetInternalSetWithCheck(nameof (Local)).Local;
    ...
    /// <inheritdoc />
    public virtual TEntity Create() => this.GetInternalSetWithCheck(nameof (Create)).Create();

    /// <inheritdoc />
    public virtual TDerivedEntity Create<TDerivedEntity>() where TDerivedEntity : class, TEntity => (TDerivedEntity) (object) this.GetInternalSetWithCheck(nameof (Create)).Create(typeof (TDerivedEntity));
    ...
    {
      System.Data.Entity.Utilities.Check.NotNull<DbSet<TEntity>>(entry, nameof (entry));
    ...
    IInternalSet IInternalSetAdapter.InternalSet => (IInternalSet) this._internalSet;

    private InternalSet<TEntity> GetInternalSetWithCheck(string memberName) => this._internalSet != null ? this._internalSet : throw new NotImplementedException(System.Data.Entity.Resources.Strings.TestDoubleNotImplemented((object) memberName, (object) this.GetType().Name, (object) typeof (DbSet<>).Name));
