...
namespace System.Data.Entity
{
  ...
  public class DbConfiguration
  {
    ...
    {
      System.Data.Entity.Utilities.Check.NotNull<DbConfiguration>(configuration, nameof (configuration));
    ...
    {
      System.Data.Entity.Utilities.Check.NotNull<Assembly>(assemblyHint, nameof (assemblyHint));
    ...
    public static event EventHandler<DbConfigurationLoadedEventArgs> Loaded
    {
      add
      {
        System.Data.Entity.Utilities.Check.NotNull<EventHandler<DbConfigurationLoadedEventArgs>>(value, nameof (value));
    ...
    protected internal void AddDependencyResolver(IDbDependencyResolver resolver)
    {
      ...
      this._internalConfiguration.AddDependencyResolver(resolver);
    }
      ...
      DbProviderServices provider)
    {
      ...
      System.Data.Entity.Utilities.Check.NotNull<DbProviderServices>(provider, nameof (provider));
    ...
    {
      System.Data.Entity.Utilities.Check.NotEmpty(providerInvariantName, nameof (providerInvariantName));
      System.Data.Entity.Utilities.Check.NotNull<DbProviderFactory>(providerFactory, nameof (providerFactory));
      ...
      this._internalConfiguration.AddDependencyResolver((IDbDependencyResolver) new InvariantNameResolver(providerFactory, providerInvariantName));
    }
    ...
    {
      System.Data.Entity.Utilities.Check.NotEmpty(providerInvariantName, nameof (providerInvariantName));
      System.Data.Entity.Utilities.Check.NotNull<Func<IDbExecutionStrategy>>(getExecutionStrategy, nameof (getExecutionStrategy));
      this._internalConfiguration.CheckNotLocked(nameof (SetExecutionStrategy));
      this._internalConfiguration.AddDependencyResolver((IDbDependencyResolver) new ExecutionStrategyResolver<IDbExecutionStrategy>(providerInvariantName, (string) null, getExecutionStrategy));
    }
    ...
    {
      System.Data.Entity.Utilities.Check.NotEmpty(providerInvariantName, nameof (providerInvariantName));
      System.Data.Entity.Utilities.Check.NotEmpty(serverName, nameof (serverName));
      System.Data.Entity.Utilities.Check.NotNull<Func<IDbExecutionStrategy>>(getExecutionStrategy, nameof (getExecutionStrategy));
      this._internalConfiguration.CheckNotLocked(nameof (SetExecutionStrategy));
      this._internalConfiguration.AddDependencyResolver((IDbDependencyResolver) new ExecutionStrategyResolver<IDbExecutionStrategy>(providerInvariantName, serverName, getExecutionStrategy));
    }
      ...
      Func<TransactionHandler> transactionHandlerFactory)
    {
      ...
      this._internalConfiguration.AddDependencyResolver((IDbDependencyResolver) new TransactionHandlerResolver(transactionHandlerFactory, (string) null, (string) null));
    }
      ...
      Func<TransactionHandler> transactionHandlerFactory)
    {
      ...
      this._internalConfiguration.AddDependencyResolver((IDbDependencyResolver) new TransactionHandlerResolver(transactionHandlerFactory, providerInvariantName, (string) null));
    }
      ...
      string serverName)
    {
      ...
      System.Data.Entity.Utilities.Check.NotEmpty(serverName, nameof (serverName));
      this._internalConfiguration.CheckNotLocked(nameof (SetTransactionHandler));
      this._internalConfiguration.AddDependencyResolver((IDbDependencyResolver) new TransactionHandlerResolver(transactionHandlerFactory, providerInvariantName, serverName));
    }
    ...
    {
      System.Data.Entity.Utilities.Check.NotNull<IDbConnectionFactory>(connectionFactory, nameof (connectionFactory));
    ...
    {
      System.Data.Entity.Utilities.Check.NotNull<IPluralizationService>(pluralizationService, nameof (pluralizationService));
    ...
    {
      System.Data.Entity.Utilities.Check.NotEmpty(providerInvariantName, nameof (providerInvariantName));
      System.Data.Entity.Utilities.Check.NotNull<Func<MigrationSqlGenerator>>(sqlGenerator, nameof (sqlGenerator));
    ...
    {
      System.Data.Entity.Utilities.Check.NotNull<IManifestTokenResolver>(resolver, nameof (resolver));
      ...
      Func<IMetadataAnnotationSerializer> serializerFactory)
    {
      ...
      System.Data.Entity.Utilities.Check.NotNull<Func<IMetadataAnnotationSerializer>>(serializerFactory, nameof (serializerFactory));
    ...
    {
      System.Data.Entity.Utilities.Check.NotNull<IDbProviderFactoryResolver>(providerFactoryResolver, nameof (providerFactoryResolver));
    ...
    {
      System.Data.Entity.Utilities.Check.NotNull<Func<DbContext, IDbModelCacheKey>>(keyFactory, nameof (keyFactory));
    ...
    {
      System.Data.Entity.Utilities.Check.NotNull<DbSpatialServices>(spatialProvider, nameof (spatialProvider));
    ...
    {
      System.Data.Entity.Utilities.Check.NotNull<DbProviderInfo>(key, nameof (key));
      System.Data.Entity.Utilities.Check.NotNull<DbSpatialServices>(spatialProvider, nameof (spatialProvider));
    ...
    private void RegisterSpatialServices(
      ...
      DbSpatialServices spatialProvider)
    {
      this._internalConfiguration.RegisterSingleton<DbSpatialServices>(spatialProvider, (Func<object, bool>) (k => k is DbProviderInfo dbProviderInfo && dbProviderInfo.ProviderInvariantName == providerInvariantName));
    }
    ...
    {
      System.Data.Entity.Utilities.Check.NotNull<Func<DbContext, Action<string>, DatabaseLogFormatter>>(logFormatterFactory, nameof (logFormatterFactory));
    ...
    {
      System.Data.Entity.Utilities.Check.NotNull<Type>(contextType, nameof (contextType));
      System.Data.Entity.Utilities.Check.NotNull<Func<DbContext>>(factory, nameof (factory));
      if (!typeof (DbContext).IsAssignableFrom(contextType))
    ...
    {
      System.Data.Entity.Utilities.Check.NotNull<Func<TContext>>(factory, nameof (factory));
    ...
    {
      System.Data.Entity.Utilities.Check.NotNull<DbModelStore>(modelStore, nameof (modelStore));
      this._internalConfiguration.CheckNotLocked(nameof (SetModelStore));
    ...
    {
      System.Data.Entity.Utilities.Check.NotEmpty(providerInvariantName, nameof (providerInvariantName));
      System.Data.Entity.Utilities.Check.NotNull<TableExistenceChecker>(tableExistenceChecker, nameof (tableExistenceChecker));
    ...
    internal virtual InternalConfiguration InternalConfiguration => this._internalConfiguration;
