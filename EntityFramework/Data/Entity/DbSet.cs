...
namespace System.Data.Entity
{
  ...
  public abstract class DbSet : DbQuery, IInternalSetAdapter
  {
    ...
    public virtual object Find(params object[] keyValues) => throw new NotImplementedException(Strings.TestDoubleNotImplemented((object) nameof (Find), (object) this.GetType().Name, (object) typeof (DbSet).Name));
    ...
    /// <exception cref="T:System.InvalidOperationException">Thrown if the types of the key values do not match the types of the key values for the entity type to be found.</exception>
    /// <exception cref="T:System.InvalidOperationException">Thrown if the context has been disposed.</exception>
    public virtual Task<object> FindAsync(params object[] keyValues) => this.FindAsync(CancellationToken.None, keyValues);
    ...
    public virtual IList Local => throw new NotImplementedException(Strings.TestDoubleNotImplemented((object) nameof (Local), (object) this.GetType().Name, (object) typeof (DbSet).Name));
    ...
    {
      System.Data.Entity.Utilities.Check.NotNull<IEnumerable>(entities, nameof (entities));
    ...
    public virtual object Create() => throw new NotImplementedException(Strings.TestDoubleNotImplemented((object) nameof (Create), (object) this.GetType().Name, (object) typeof (DbSet).Name));
    ...
    /// <returns> The entity instance, which may be a proxy. </returns>
    public virtual object Create(Type derivedEntityType) => throw new NotImplementedException(Strings.TestDoubleNotImplemented((object) nameof (Create), (object) this.GetType().Name, (object) typeof (DbSet).Name));
    ...
    public DbSet<TEntity> Cast<TEntity>() where TEntity : class
    {
      ...
      return !(typeof (TEntity) != this.InternalSet.ElementType) ? (DbSet<TEntity>) this.InternalSet.InternalContext.Set<TEntity>() : throw Error.DbEntity_BadTypeForCast((object) typeof (DbSet).Name, (object) typeof (TEntity).Name, (object) this.InternalSet.ElementType.Name);
    }

    IInternalSet IInternalSetAdapter.InternalSet => this.InternalSet;

    internal virtual IInternalSet InternalSet => (IInternalSet) null;

    internal virtual IInternalSet GetInternalSetWithCheck(string memberName) => throw new NotImplementedException(Strings.TestDoubleNotImplemented((object) memberName, (object) this.GetType().Name, (object) typeof (DbSet).Name));
