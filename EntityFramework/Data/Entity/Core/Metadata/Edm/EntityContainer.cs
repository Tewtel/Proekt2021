...
namespace System.Data.Entity.Core.Metadata.Edm
{
  ...
  public class EntityContainer : GlobalItem
  {
    ...
    public ReadOnlyMetadataCollection<EntitySetBase> BaseEntitySets => this._baseEntitySets;
    ...
    public ReadOnlyMetadataCollection<EdmFunction> FunctionImports => this._functionImports;
    ...
    {
      if (this.BaseEntitySets.GetValue(name, ignoreCase) is EntitySet entitySet)
        return entitySet;
    ...
    {
      System.Data.Entity.Utilities.Check.NotNull<EntitySetBase>(entitySetBase, nameof (entitySetBase));
      Util.ThrowIfReadOnly((MetadataItem) this);
    ...
    internal virtual void NotifyItemIdentityChanged(EntitySetBase item, string initialIdentity) => this._baseEntitySets.Source.HandleIdentityChange(item, initialIdentity);
  }
}
