...
namespace System.Data.Entity.Core.Metadata.Edm
{
  ...
  public abstract class EntityTypeBase : StructuralType
  {
    ...
    public virtual ReadOnlyMetadataCollection<EdmMember> KeyMembers => this.BaseType != null && ((EntityTypeBase) this.BaseType).KeyMembers.Count != 0 ? ((EntityTypeBase) this.BaseType).KeyMembers : this._keyMembers;
    ...
    private void KeyMembersSourceAccessedEventHandler(object sender, EventArgs e) => this.ResetKeyPropertiesCache();
    ...
    internal static void CheckAndAddMembers(IEnumerable<EdmMember> members, EntityType entityType)
    {
      ...
      {
        if (member == null)
          throw new ArgumentException(System.Data.Entity.Resources.Strings.ADP_CollectionParameterElementIsNull((object) nameof (members)));
    ...
    internal void CheckAndAddKeyMembers(IEnumerable<string> keyMembers)
    {
      ...
      {
        if (keyMember == null)
          throw new ArgumentException(System.Data.Entity.Resources.Strings.ADP_CollectionParameterElementIsNull((object) nameof (keyMembers)));
        EdmMember member;
        if (!this.Members.TryGetValue(keyMember, false, out member))
          throw new ArgumentException(System.Data.Entity.Resources.Strings.InvalidKeyMember((object) keyMember));
