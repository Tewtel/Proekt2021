...
namespace System.Data.Entity.Core.Metadata.Edm
{
  internal static class EdmConstants
  {
    ...
    internal class Unbounded
    {
      ...
      internal static EdmConstants.Unbounded Instance => EdmConstants.Unbounded._instance;
    ...
    internal class Variable
    {
      ...
      internal static EdmConstants.Variable Instance => EdmConstants.Variable._instance;

      public override string ToString() => nameof (Variable);
    }
  }
}
