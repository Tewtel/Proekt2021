...
namespace System.Data.Entity.Core.Metadata.Edm
{
  internal sealed class MetadataPropertyCollection : MetadataCollection<MetadataProperty>
  {
    ...
    private class ItemTypeInformation
    {
      ...
      internal ItemTypeInformation(Type clrType) => this._itemProperties = MetadataPropertyCollection.ItemTypeInformation.GetItemProperties(clrType);
    ...
    private class ItemPropertyInfo
    {
      ...
      internal MetadataProperty GetMetadataProperty(MetadataItem item) => new MetadataProperty(this._propertyInfo.Name, this._attribute.Type, this._attribute.IsCollectionType, (object) new MetadataPropertyValue(this._propertyInfo, item));
    }
  }
}
