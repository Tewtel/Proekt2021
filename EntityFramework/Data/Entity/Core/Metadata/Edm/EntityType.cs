...
namespace System.Data.Entity.Core.Metadata.Edm
{
  ...
  public class EntityType : EntityTypeBase
  {
    ...
    internal IEnumerable<ForeignKeyBuilder> ForeignKeyBuilders => (IEnumerable<ForeignKeyBuilder>) this._foreignKeyBuilders;
    ...
    public ReadOnlyMetadataCollection<NavigationProperty> DeclaredNavigationProperties => this.GetDeclaredOnlyMembers<NavigationProperty>();
    ...
    public ReadOnlyMetadataCollection<EdmMember> DeclaredMembers => this.GetDeclaredOnlyMembers<EdmMember>();
      ...
      IEnumerable<MetadataProperty> metadataProperties)
    {
      System.Data.Entity.Utilities.Check.NotEmpty(name, nameof (name));
      System.Data.Entity.Utilities.Check.NotEmpty(namespaceName, nameof (namespaceName));
      System.Data.Entity.Utilities.Check.NotNull<EntityType>(baseType, nameof (baseType));
      ...
      if (metadataProperties != null)
        entityType2.AddMetadataProperties(metadataProperties);
    ...
    {
      System.Data.Entity.Utilities.Check.NotNull<NavigationProperty>(property, nameof (property));
