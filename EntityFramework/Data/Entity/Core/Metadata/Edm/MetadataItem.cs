...
namespace System.Data.Entity.Core.Metadata.Edm
{
  ...
  public abstract class MetadataItem
  {
    ...
    internal MetadataItem(MetadataItem.MetadataFlags flags) => this._flags = (int) flags;

    internal virtual IEnumerable<MetadataProperty> Annotations => this.GetMetadataProperties().Where<MetadataProperty>((Func<MetadataProperty, bool>) (p => p.IsAnnotation));
    ...
    public virtual ReadOnlyMetadataCollection<MetadataProperty> MetadataProperties => this.GetMetadataProperties().AsReadOnlyMetadataCollection();
    ...
    internal MetadataCollection<MetadataProperty> RawMetadataProperties => (MetadataCollection<MetadataProperty>) this._itemAttributes;
    ...
    internal virtual bool EdmEquals(MetadataItem item)
    {
      ...
      if (this == item)
        return true;
      return this.BuiltInTypeKind == item.BuiltInTypeKind && this.Identity == item.Identity;
    }

    internal bool IsReadOnly => this.GetFlag(MetadataItem.MetadataFlags.Readonly);
    ...
    internal virtual void BuildIdentity(StringBuilder builder) => builder.Append(this.Identity);

    internal void AddMetadataProperties(IEnumerable<MetadataProperty> metadataProperties) => this.GetMetadataProperties().AddRange(metadataProperties);
    ...
    internal bool GetFlag(MetadataItem.MetadataFlags flag) => flag == ((MetadataItem.MetadataFlags) this._flags & flag);
    ...
    internal void SetFlag(MetadataItem.MetadataFlags flag, bool value)
    {
      ...
      if ((flag & MetadataItem.MetadataFlags.Readonly) == MetadataItem.MetadataFlags.Readonly)
        return;
      throw new InvalidOperationException(System.Data.Entity.Resources.Strings.OperationOnReadOnlyItem);
label_3:;
    }
    ...
    internal static FacetDescription DefaultValueFacetDescription => MetadataItem._defaultValueFacetDescription;

    internal static FacetDescription CollectionKindFacetDescription => MetadataItem._collectionKindFacetDescription;

    internal static FacetDescription NullableFacetDescription => MetadataItem._nullableFacetDescription;
    ...
    /// </param>
    public static EdmType GetBuiltInType(BuiltInTypeKind builtInTypeKind) => MetadataItem._builtInTypes[(int) builtInTypeKind];
    ...
    /// </returns>
    public static ReadOnlyCollection<FacetDescription> GetGeneralFacetDescriptions() => MetadataItem._generalFacetDescriptions;
