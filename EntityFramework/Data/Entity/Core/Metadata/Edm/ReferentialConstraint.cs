...
namespace System.Data.Entity.Core.Metadata.Edm
{
  ...
  public sealed class ReferentialConstraint : MetadataItem
  {
    ...
    {
      System.Data.Entity.Utilities.Check.NotNull<RelationshipEndMember>(fromRole, nameof (fromRole));
      System.Data.Entity.Utilities.Check.NotNull<RelationshipEndMember>(toRole, nameof (toRole));
      System.Data.Entity.Utilities.Check.NotNull<IEnumerable<EdmProperty>>(fromProperties, nameof (fromProperties));
      System.Data.Entity.Utilities.Check.NotNull<IEnumerable<EdmProperty>>(toProperties, nameof (toProperties));
    ...
    internal override string Identity => this.FromRole.Name + "_" + this.ToRole.Name;
    ...
    internal AssociationEndMember PrincipalEnd => (AssociationEndMember) this.FromRole;

    internal AssociationEndMember DependentEnd => (AssociationEndMember) this.ToRole;
    ...
    /// </returns>
    [MetadataProperty(BuiltInTypeKind.EdmProperty, true)]
    public ReadOnlyMetadataCollection<EdmProperty> ToProperties => this._toProperties;
    ...
    /// .
    /// </returns>
    public override string ToString() => this.FromRole.Name + "_" + this.ToRole.Name;
    ...
    internal string BuildConstraintExceptionMessage()
    {
      ...
      return System.Data.Entity.Resources.Strings.RelationshipManager_InconsistentReferentialConstraintProperties((object) stringBuilder1.ToString(), (object) stringBuilder2.ToString());
    }
  }
}
