...
namespace System.Data.Entity.Core.Metadata.Edm
{
  ...
  public class AssociationType : RelationshipType
  {
    ...
    {
      get => this.ReferentialConstraints.SingleOrDefault<ReferentialConstraint>();
      set
      {
        System.Data.Entity.Utilities.Check.NotNull<ReferentialConstraint>(value, nameof (value));
    ...
    {
      get => this.KeyMembers.FirstOrDefault<EdmMember>() as AssociationEndMember;
      set
      {
        Util.ThrowIfReadOnly((MetadataItem) this);
    ...
    {
      get => this.KeyMembers.ElementAtOrDefault<EdmMember>(1) as AssociationEndMember;
      set
      {
        Util.ThrowIfReadOnly((MetadataItem) this);
    ...
    public ReadOnlyMetadataCollection<ReferentialConstraint> ReferentialConstraints => this._referentialConstraints;
    ...
    public bool IsForeignKey => this._isForeignKey;
    ...
    internal void AddReferentialConstraint(ReferentialConstraint referentialConstraint) => this.ReferentialConstraints.Source.Add(referentialConstraint);
