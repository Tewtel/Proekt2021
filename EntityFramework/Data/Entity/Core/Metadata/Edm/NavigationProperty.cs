...
namespace System.Data.Entity.Core.Metadata.Edm
{
  ...
  public sealed class NavigationProperty : EdmMember
  {
    ...
    internal AssociationType Association => (AssociationType) this.RelationshipType;

    internal AssociationEndMember ResultEnd => (AssociationEndMember) this.ToEndMember;

    internal NavigationPropertyAccessor Accessor => this._accessor;
