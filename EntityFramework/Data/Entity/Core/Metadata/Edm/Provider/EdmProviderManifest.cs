...
namespace System.Data.Entity.Core.Metadata.Edm.Provider
{
  internal class EdmProviderManifest : DbProviderManifest
  {
    ...
    internal static EdmProviderManifest Instance => EdmProviderManifest._instance;
      ...
      EdmType type)
    {
      ...
      return this._facetDescriptions.TryGetValue(type as PrimitiveType, out readOnlyCollection) ? readOnlyCollection : Helper.EmptyFacetDescriptionEnumerable;
    }
    ...
    private void InitializePrimitiveTypes()
    {
      ...
      primitiveTypeArray[31] = new PrimitiveType();
      ...
      this.InitializePrimitiveType(primitiveTypeArray[31], PrimitiveTypeKind.HierarchyId, "HierarchyId", typeof (HierarchyId));
    ...
    private void InitializePromotableTypes()
    {
      if (this._promotionTypes != null)
        return;
      ReadOnlyCollection<PrimitiveType>[] promotionTypes = new ReadOnlyCollection<PrimitiveType>[32];
    ...
    {
      this.InitializePrimitiveTypes();
      TypeUsage[] typeUsageArray = new TypeUsage[32];
      for (int index = 0; index < 32; ++index)
      {
    ...
    internal TypeUsage ForgetScalarConstraints(TypeUsage type) => type.EdmType is PrimitiveType edmType ? this.GetCanonicalModelTypeUsage(edmType.PrimitiveTypeKind) : type;
