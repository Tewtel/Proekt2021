...
namespace System.Data.Entity.Core.Metadata.Edm.Provider
{
  internal sealed class EdmProviderManifestFunctionBuilder
  {
    ...
    internal ReadOnlyCollection<EdmFunction> ToFunctionCollection() => new ReadOnlyCollection<EdmFunction>((IList<EdmFunction>) this.functions);
    ...
    internal void AddFunction(PrimitiveTypeKind returnType, string functionName) => this.AddFunction(returnType, functionName, new KeyValuePair<string, PrimitiveTypeKind>[0]);
