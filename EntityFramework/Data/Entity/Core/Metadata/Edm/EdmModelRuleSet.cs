...
namespace System.Data.Entity.Core.Metadata.Edm
{
  internal abstract class EdmModelRuleSet : DataModelValidationRuleSet
  {
      ...
      bool validateSyntax)
    {
      ...
      return object.Equals((object) version, (object) 3.0) ? (EdmModelRuleSet) new EdmModelRuleSet.V3RuleSet(validateSyntax) : (EdmModelRuleSet) null;
    }
    ...
    private EdmModelRuleSet(bool validateSyntax)
    {
      if (validateSyntax)
      {
        ...
        this.AddRule((DataModelValidationRule) EdmModelSyntacticValidationRules.EdmAssociationType_AssociationEndMustNotBeNull);
        ...
        this.AddRule((DataModelValidationRule) EdmModelSyntacticValidationRules.EdmNavigationProperty_AssociationMustNotBeNull);
