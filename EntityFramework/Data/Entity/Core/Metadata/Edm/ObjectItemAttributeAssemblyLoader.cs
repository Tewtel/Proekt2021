...
namespace System.Data.Entity.Core.Metadata.Edm
{
  internal sealed class ObjectItemAttributeAssemblyLoader : ObjectItemAssemblyLoader
  {
    ...
    private MutableAssemblyCacheEntry CacheEntry => (MutableAssemblyCacheEntry) base.CacheEntry;
    ...
    internal override void Load() => base.Load();

    protected override void AddToAssembliesLoaded() => this.SessionData.AssembliesLoaded.Add(this.SourceAssembly, this.CacheEntry);
    ...
    private bool TryGetLoadedType(Type clrType, out EdmType edmType)
    {
      if (this.SessionData.TypesInLoading.TryGetValue(clrType.FullName, out edmType) || this.TryGetCachedEdmType(clrType, out edmType))
      {
        if (!(edmType.ClrType != clrType))
          return true;
        this.SessionData.EdmItemErrors.Add(new EdmItemError(System.Data.Entity.Resources.Strings.NewTypeConflictsWithExistingType((object) clrType.AssemblyQualifiedName, (object) edmType.ClrType.AssemblyQualifiedName)));
      ...
      if (clrType.IsGenericType())
      {
        ...
        {
          if (!(edmType1 is EntityType entityType4))
            return false;
          edmType = (EdmType) entityType4.GetCollectionType();
        }
        else
          edmType = edmType1;
        return true;
      ...
      foreach (Type accessibleType in this.SourceAssembly.GetAccessibleTypes())
      {
        if (accessibleType.GetCustomAttributes<EdmTypeAttribute>(false).Any<EdmTypeAttribute>())
        {
          if (accessibleType.IsGenericType())
            this.SessionData.EdmItemErrors.Add(new EdmItemError(System.Data.Entity.Resources.Strings.GenericTypeNotSupported((object) accessibleType.FullName)));
          else
    ...
    private void LoadRelationshipTypes()
    {
      foreach (EdmRelationshipAttribute customAttribute in this.SourceAssembly.GetCustomAttributes<EdmRelationshipAttribute>())
      {
        if (!this.TryFindNullParametersInRelationshipAttribute(customAttribute))
        {
          ...
          {
            this.SessionData.EdmItemErrors.Add(new EdmItemError(System.Data.Entity.Resources.Strings.SameRoleNameOnRelationshipAttribute((object) customAttribute.RelationshipName, (object) customAttribute.Role2Name)));
            flag = true;
          }
          if (!flag)
          {
      ...
      RelationshipMultiplicity multiplicity)
    {
      ...
      if (!this.TryGetRelationshipEndEntityType(clrType, out entityType))
        this.SessionData.EdmItemErrors.Add(new EdmItemError(System.Data.Entity.Resources.Strings.RoleTypeInEdmRelationshipAttributeIsInvalidType((object) associationType.Name, (object) roleName, (object) clrType)));
      else
    ...
    private void LoadType(Type clrType)
    {
      ...
      if (clrType.IsNested)
      {
        this.SessionData.EdmItemErrors.Add(new EdmItemError(System.Data.Entity.Resources.Strings.NestedClassNotSupported((object) clrType.FullName, (object) clrType.Assembly().FullName)));
      }
      else
      {
        ...
        {
          this.SessionData.EdmItemErrors.Add(new EdmItemError(System.Data.Entity.Resources.Strings.Validator_TypeHasNoNamespace));
        }
        else
        {
          ...
          {
            if (!ClrProviderManifest.Instance.TryGetPrimitiveType(clrType.GetEnumUnderlyingType(), out PrimitiveType _))
            {
              this.SessionData.EdmItemErrors.Add(new EdmItemError(System.Data.Entity.Resources.Strings.Validator_UnsupportedEnumUnderlyingType((object) clrType.GetEnumUnderlyingType().FullName)));
              return;
            }
    ...
    private void AddTypeResolver(Action resolver) => this._referenceResolutions.Add(resolver);

    private EdmType ResolveBaseType(Type type)
    {
      EdmType edmType;
      return type.GetCustomAttributes<EdmEntityTypeAttribute>(false).Any<EdmEntityTypeAttribute>() && this.TryGetLoadedType(type, out edmType) ? edmType : (EdmType) null;
    }
    ...
    private bool TryFindNullParametersInRelationshipAttribute(EdmRelationshipAttribute roleAttribute)
    {
      ...
      {
        this.SessionData.EdmItemErrors.Add(new EdmItemError(System.Data.Entity.Resources.Strings.NullRelationshipNameforEdmRelationshipAttribute((object) this.SourceAssembly.FullName)));
        return true;
      }
      bool flag = false;
      if (roleAttribute.RelationshipNamespaceName == null)
      {
        this.SessionData.EdmItemErrors.Add(new EdmItemError(System.Data.Entity.Resources.Strings.NullParameterForEdmRelationshipAttribute((object) "RelationshipNamespaceName", (object) roleAttribute.RelationshipName)));
        flag = true;
      }
      if (roleAttribute.Role1Name == null)
      {
        this.SessionData.EdmItemErrors.Add(new EdmItemError(System.Data.Entity.Resources.Strings.NullParameterForEdmRelationshipAttribute((object) "Role1Name", (object) roleAttribute.RelationshipName)));
        flag = true;
      }
      if (roleAttribute.Role1Type == (Type) null)
      {
        this.SessionData.EdmItemErrors.Add(new EdmItemError(System.Data.Entity.Resources.Strings.NullParameterForEdmRelationshipAttribute((object) "Role1Type", (object) roleAttribute.RelationshipName)));
        flag = true;
      }
      if (roleAttribute.Role2Name == null)
      {
        this.SessionData.EdmItemErrors.Add(new EdmItemError(System.Data.Entity.Resources.Strings.NullParameterForEdmRelationshipAttribute((object) "Role2Name", (object) roleAttribute.RelationshipName)));
        flag = true;
      }
      if (roleAttribute.Role2Type == (Type) null)
      {
        this.SessionData.EdmItemErrors.Add(new EdmItemError(System.Data.Entity.Resources.Strings.NullParameterForEdmRelationshipAttribute((object) "Role2Type", (object) roleAttribute.RelationshipName)));
        flag = true;
      }
      return flag;
    }
    ...
    internal void ResolveNavigationProperty(StructuralType declaringType, PropertyInfo propertyInfo)
    {
      ...
      {
        this.SessionData.EdmItemErrors.Add(new EdmItemError(System.Data.Entity.Resources.Strings.Validator_OSpace_InvalidNavPropReturnType((object) propertyInfo.Name, (object) propertyInfo.DeclaringType.FullName, (object) propertyInfo.PropertyType.FullName)));
      }
      else
      {
        ...
        if (this.SessionData.TypesInLoading.TryGetValue(propertyAttribute.RelationshipNamespaceName + "." + propertyAttribute.RelationshipName, out type) && Helper.IsAssociationType(type))
        {
          ...
          if (associationType != null)
          {
            ...
            {
              this.SessionData.EdmItemErrors.Add(new EdmItemError(System.Data.Entity.Resources.Strings.TargetRoleNameInNavigationPropertyNotValid((object) propertyInfo.Name, (object) propertyInfo.DeclaringType.FullName, (object) propertyAttribute.TargetRoleName, (object) propertyAttribute.RelationshipName)));
            ...
            {
              this.SessionData.EdmItemErrors.Add(new EdmItemError(System.Data.Entity.Resources.Strings.NavigationPropertyRelationshipEndTypeMismatch((object) declaringType.FullName, (object) navigationProperty.Name, (object) associationType.FullName, (object) navigationProperty.FromEndMember.Name, (object) ((RefType) navigationProperty.FromEndMember.TypeUsage.EdmType).ElementType.ClrType)));
              member = (EdmMember) null;
            }
          }
        }
        else
          this.SessionData.EdmItemErrors.Add(new EdmItemError(System.Data.Entity.Resources.Strings.RelationshipNameInNavigationPropertyNotValid((object) propertyInfo.Name, (object) propertyInfo.DeclaringType.FullName, (object) propertyAttribute.RelationshipName)));
        if (member == null)
          return;
      ...
      out bool isEntityKeyProperty)
    {
      ...
      {
        this.SessionData.EdmItemErrors.Add(new EdmItemError(System.Data.Entity.Resources.Strings.Validator_OSpace_ScalarPropertyNotPrimitive((object) property.Name, (object) property.DeclaringType.FullName, (object) property.PropertyType.FullName)));
      }
      else
      {
    ...
    private void ResolveEnumTypeProperty(StructuralType declaringType, PropertyInfo clrProperty)
    {
      ...
      {
        this.SessionData.EdmItemErrors.Add(new EdmItemError(System.Data.Entity.Resources.Strings.Validator_OSpace_ScalarPropertyNotPrimitive((object) clrProperty.Name, (object) clrProperty.DeclaringType.FullName, (object) clrProperty.PropertyType.FullName)));
      }
      else
      {
    ...
    private void ResolveComplexTypeProperty(StructuralType type, PropertyInfo clrProperty)
    {
      ...
      {
        this.SessionData.EdmItemErrors.Add(new EdmItemError(System.Data.Entity.Resources.Strings.Validator_OSpace_ComplexPropertyNotComplex((object) clrProperty.Name, (object) clrProperty.DeclaringType.FullName, (object) clrProperty.PropertyType.FullName)));
      }
      else
      {
        EdmProperty edmProperty = new EdmProperty(clrProperty.Name, TypeUsage.Create(edmType, new FacetValues()
    ...
    internal static bool IsSchemaAttributePresent(Assembly assembly) => assembly.GetCustomAttributes<EdmSchemaAttribute>().Any<EdmSchemaAttribute>();

    internal static ObjectItemAssemblyLoader Create(
      Assembly assembly,
      ObjectItemLoadingSessionData sessionData)
    {
      return !ObjectItemAttributeAssemblyLoader.IsSchemaAttributePresent(assembly) ? (ObjectItemAssemblyLoader) new ObjectItemNoOpAssemblyLoader(assembly, sessionData) : (ObjectItemAssemblyLoader) new ObjectItemAttributeAssemblyLoader(assembly, sessionData);
    }
  }
}
