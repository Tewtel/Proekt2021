...
namespace System.Data.Entity.Core.Metadata.Edm
{
  internal abstract class OSpaceTypeFactory
  {
    ...
    public virtual EdmType TryCreateType(Type type, EdmType cspaceType)
    {
      ...
      {
        this.LogLoadMessage(System.Data.Entity.Resources.Strings.Validator_OSpace_Convention_SSpaceOSpaceTypeMismatch((object) cspaceType.FullName, (object) cspaceType.FullName), cspaceType);
        return (EdmType) null;
      }
      ...
      out EdmType newOSpaceType)
    {
      ...
      if (cspaceType.BaseType != null)
      {
        ...
        {
          this.LogLoadMessage(System.Data.Entity.Resources.Strings.Validator_OSpace_Convention_BaseTypeIncompatible((object) type.BaseType().FullName, (object) type.FullName, (object) cspaceType.BaseType.FullName), (EdmType) cspaceType);
          return false;
        }
      }
    ...
    internal static bool TypesMatchByConvention(Type type, EdmType cspaceType) => type.Name == cspaceType.Name;
    ...
    private bool UnderlyingEnumTypesMatch(Type enumType, EnumType cspaceEnumType)
    {
      ...
      {
        this.LogLoadMessage(System.Data.Entity.Resources.Strings.Validator_UnsupportedEnumUnderlyingType((object) enumType.GetEnumUnderlyingType().FullName), (EdmType) cspaceEnumType);
        return false;
      }
      if (primitiveType.PrimitiveTypeKind == cspaceEnumType.UnderlyingType.PrimitiveTypeKind)
        return true;
      this.LogLoadMessage(System.Data.Entity.Resources.Strings.Validator_OSpace_Convention_NonMatchingUnderlyingTypes, (EdmType) cspaceEnumType);
      return false;
    }
    ...
    private bool EnumMembersMatch(Type enumType, EnumType cspaceEnumType)
    {
      ...
      this.LogLoadMessage(System.Data.Entity.Resources.Strings.Mapping_Enum_OCMapping_MemberMismatch((object) enumType.FullName, (object) enumerator1.Current.Name, enumerator1.Current.Value, (object) cspaceEnumType.FullName), (EdmType) cspaceEnumType);
      return false;
    }
      ...
      List<Action> referenceResolutionListForCurrentType)
    {
      ...
      foreach (EdmProperty edmProperty in cspaceType.GetDeclaredOnlyMembers<EdmProperty>().Where<EdmProperty>((Func<EdmProperty, bool>) (m => Helper.IsComplexType(m.TypeUsage.EdmType))))
      {
        ...
        {
          this.LogLoadMessage(System.Data.Entity.Resources.Strings.Validator_OSpace_Convention_MissingRequiredProperty((object) cspaceProperty.Name, (object) type.FullName), (EdmType) cspaceType);
          return false;
        }
      }
    ...
    private EdmType ResolveBaseType(StructuralType baseCSpaceType, Type type)
    {
      ...
      if (!this.CspaceToOspace.TryGetValue((EdmType) baseCSpaceType, out edmType))
        this.LogError(System.Data.Entity.Resources.Strings.Validator_OSpace_Convention_BaseTypeNotLoaded((object) type, (object) baseCSpaceType), (EdmType) baseCSpaceType);
      return edmType;
    }
      ...
      foreach (EdmProperty edmProperty in cspaceType.GetDeclaredOnlyMembers<EdmProperty>().Where<EdmProperty>((Func<EdmProperty, bool>) (p => Helper.IsPrimitiveType(p.TypeUsage.EdmType))))
      {
        ...
        if (propertyInfo != (PropertyInfo) null)
        {
          ...
          if (OSpaceTypeFactory.TryGetPrimitiveType(propertyInfo.PropertyType, out primitiveType))
          {
            ...
            {
              this.LogLoadMessage(System.Data.Entity.Resources.Strings.Validator_OSpace_Convention_ScalarPropertyMissginGetterOrSetter((object) propertyInfo.Name, (object) type.FullName, (object) type.Assembly().FullName), (EdmType) cspaceType);
              return false;
            }
          }
          else
          {
            this.LogLoadMessage(System.Data.Entity.Resources.Strings.Validator_OSpace_Convention_NonPrimitiveTypeProperty((object) propertyInfo.Name, (object) type.FullName, (object) propertyInfo.PropertyType.FullName), (EdmType) cspaceType);
            return false;
          }
        }
        else
    ...
    private static bool MemberMatchesByConvention(PropertyInfo clrProperty, EdmMember cspaceMember) => clrProperty.Name == cspaceMember.Name;
      ...
      PropertyInfo clrProperty)
    {
      ...
      if (this.CspaceToOspace.TryGetValue(cspaceProperty.TypeUsage.EdmType, out edmType))
      {
        ...
        this.LogError(System.Data.Entity.Resources.Strings.Validator_OSpace_Convention_MissingOSpaceType((object) cspaceProperty.TypeUsage.EdmType.FullName), cspaceProperty.TypeUsage.EdmType);
    }
      ...
      NavigationProperty cspaceProperty)
    {
      ...
      else
      {
        ...
        this.LogError(System.Data.Entity.Resources.Strings.Validator_OSpace_Convention_RelationshipNotLoaded((object) cspaceProperty.RelationshipType.FullName, (object) entityTypeBase.FullName), (EdmType) entityTypeBase);
      }
    }
      ...
      PropertyInfo clrProperty)
    {
      ...
      if (this.CspaceToOspace.TryGetValue(cspaceProperty.TypeUsage.EdmType, out propertyType))
      {
        if (clrProperty.CanRead && clrProperty.CanWriteExtended())
          ...
          this.LogError(System.Data.Entity.Resources.Strings.Validator_OSpace_Convention_ScalarPropertyMissginGetterOrSetter((object) clrProperty.Name, (object) type.FullName, (object) type.Assembly().FullName), cspaceProperty.TypeUsage.EdmType);
      }
      else
        this.LogError(System.Data.Entity.Resources.Strings.Validator_OSpace_Convention_MissingOSpaceType((object) cspaceProperty.TypeUsage.EdmType.FullName), cspaceProperty.TypeUsage.EdmType);
    }
      ...
      EdmType propertyType)
    {
      ...
      int num = !Helper.IsEntityType((EdmType) declaringType) ? 0 : (((IEnumerable<string>) ((EntityTypeBase) declaringType).KeyMemberNames).Contains<string>(clrProperty.Name) ? 1 : 0);
      bool flag = num == 0 && (!clrProperty.PropertyType.IsValueType() || Nullable.GetUnderlyingType(clrProperty.PropertyType) != (Type) null);
      EdmProperty edmProperty = new EdmProperty(cspaceProperty.Name, TypeUsage.Create(propertyType, new FacetValues()
      {
        Nullable = (FacetValueContainer<bool?>) new bool?(flag)
      }), clrProperty, type);
      if (num != 0)
