...
namespace System.Data.Entity.Core
{
  ...
  public sealed class EntityKey : IEquatable<EntityKey>
  {
    ...
    {
      System.Data.Entity.Utilities.Check.NotEmpty(qualifiedEntitySetName, nameof (qualifiedEntitySetName));
      System.Data.Entity.Utilities.Check.NotNull<IEnumerable<KeyValuePair<string, object>>>(entityKeyValues, nameof (entityKeyValues));
      this.InitializeEntitySetName(qualifiedEntitySetName);
      this.InitializeKeyValues(entityKeyValues);
      this._isLocked = true;
    }
    ...
    {
      System.Data.Entity.Utilities.Check.NotEmpty(qualifiedEntitySetName, nameof (qualifiedEntitySetName));
      System.Data.Entity.Utilities.Check.NotNull<IEnumerable<EntityKeyMember>>(entityKeyValues, nameof (entityKeyValues));
      this.InitializeEntitySetName(qualifiedEntitySetName);
      this.InitializeKeyValues((IEnumerable<KeyValuePair<string, object>>) new EntityKey.KeyValueReader(entityKeyValues));
      this._isLocked = true;
    }
    ...
    {
      System.Data.Entity.Utilities.Check.NotEmpty(qualifiedEntitySetName, nameof (qualifiedEntitySetName));
      System.Data.Entity.Utilities.Check.NotEmpty(keyName, nameof (keyName));
    ...
    /// </summary>
    public static EntityKey NoEntitySetKey => EntityKey._noEntitySetKey;

    /// <summary>
    /// Gets a singleton EntityKey identifying an entity resulted from a failed TREAT.
    /// </summary>
    public static EntityKey EntityNotValidKey => EntityKey._entityNotValidKey;
    ...
    /// </returns>
    public bool IsTemporary => this.SingletonKeyValue == null && this.CompositeKeyValues == null;
    ...
    public EntitySet GetEntitySet(MetadataWorkspace metadataWorkspace)
    {
      ...
      if (string.IsNullOrEmpty(this._entityContainerName) || string.IsNullOrEmpty(this._entitySetName))
        throw new InvalidOperationException(System.Data.Entity.Resources.Strings.EntityKey_MissingEntitySetName);
    ...
    /// </param>
    public override bool Equals(object obj) => EntityKey.InternalEquals(this, obj as EntityKey, true);
    ...
    /// </param>
    public bool Equals(EntityKey other) => EntityKey.InternalEquals(this, other, true);
    ...
    /// A <see cref="T:System.Data.Entity.Core.EntityKey" /> to compare.
    /// </param>
    public static bool operator ==(EntityKey key1, EntityKey key2) => EntityKey.InternalEquals(key1, key2, true);
    ...
    internal static bool InternalEquals(EntityKey key1, EntityKey key2, bool compareEntitySets)
    {
      if ((object) key1 == (object) key2)
        return true;
      if ((object) key1 == null || (object) key2 == null || ((object) EntityKey.NoEntitySetKey == (object) key1 || (object) EntityKey.EntityNotValidKey == (object) key1) || ((object) EntityKey.NoEntitySetKey == (object) key2 || (object) EntityKey.EntityNotValidKey == (object) key2 || (key1.GetHashCode() != key2.GetHashCode() & compareEntitySets || key1._containsByteArray != key2._containsByteArray)))
        return false;
      ...
      EntitySet entitySet)
    {
      ...
      if (((EntitySetBase) entitySet).ElementType.KeyMembers.Count != num)
        throw new ArgumentException(System.Data.Entity.Resources.Strings.EntityKey_EntitySetDoesNotMatch((object) TypeHelpers.GetFullName(entitySet.EntityContainer.Name, entitySet.Name)), nameof (entitySet));
    ...
    internal void InitializeEntitySetName(string qualifiedEntitySetName)
    {
      ...
      this._entityContainerName = strArray.Length == 2 && !string.IsNullOrWhiteSpace(strArray[0]) && !string.IsNullOrWhiteSpace(strArray[1]) ? strArray[0] : throw new ArgumentException(System.Data.Entity.Resources.Strings.EntityKey_InvalidQualifiedEntitySetName, nameof (qualifiedEntitySetName));
    ...
    private static void ValidateName(string name)
    {
      if (!name.IsValidUndottedName())
        throw new ArgumentException(System.Data.Entity.Resources.Strings.EntityKey_InvalidName((object) name));
    }
      ...
      bool tokenizeStrings = false)
    {
      ...
      else if (length > 1)
      {
        ...
        throw new ArgumentException(System.Data.Entity.Resources.Strings.EntityKey_EntityKeyMustHaveValues, nameof (entityKeyValues));
      return length > 0;
    }
      ...
      bool tokenizeStrings)
    {
      if (EntityUtil.IsNull(keyValuePair.Value) || string.IsNullOrWhiteSpace(keyValuePair.Key))
        throw new ArgumentException(System.Data.Entity.Resources.Strings.EntityKey_NoNullsAllowedInKeyValuePairs, "entityKeyValues");
    ...
    private void InitializeKeyValues(EntitySet entitySet, IExtendedDataRecord record)
    {
      ...
      if (count == 1)
      {
        ...
        if (EntityUtil.IsNull(this._singletonKeyValue))
          throw new ArgumentException(System.Data.Entity.Resources.Strings.EntityKey_NoNullsAllowedInKeyValuePairs, nameof (record));
      }
      else
      {
    ...
    internal void ValidateEntityKey(MetadataWorkspace workspace, EntitySet entitySet) => this.ValidateEntityKey(workspace, entitySet, false, (string) null);
      ...
      string argumentName)
    {
      ...
      if (this._singletonKeyValue != null)
      {
        if (keyMembers.Count != 1)
        {
          if (isArgumentException)
            throw new ArgumentException(System.Data.Entity.Resources.Strings.EntityKey_IncorrectNumberOfKeyValuePairs((object) entitySet.ElementType.FullName, (object) keyMembers.Count, (object) 1), argumentName);
          throw new InvalidOperationException(System.Data.Entity.Resources.Strings.EntityKey_IncorrectNumberOfKeyValuePairs((object) entitySet.ElementType.FullName, (object) keyMembers.Count, (object) 1));
        }
        ...
        if (!(this._keyNames[0] != keyMembers[0].Name))
          return;
        if (isArgumentException)
          throw new ArgumentException(System.Data.Entity.Resources.Strings.EntityKey_MissingKeyValue((object) keyMembers[0].Name, (object) entitySet.ElementType.FullName), argumentName);
        throw new InvalidOperationException(System.Data.Entity.Resources.Strings.EntityKey_MissingKeyValue((object) keyMembers[0].Name, (object) entitySet.ElementType.FullName));
      }
      ...
      {
        if (isArgumentException)
          throw new ArgumentException(System.Data.Entity.Resources.Strings.EntityKey_IncorrectNumberOfKeyValuePairs((object) entitySet.ElementType.FullName, (object) keyMembers.Count, (object) this._compositeKeyValues.Length), argumentName);
        throw new InvalidOperationException(System.Data.Entity.Resources.Strings.EntityKey_IncorrectNumberOfKeyValuePairs((object) entitySet.ElementType.FullName, (object) keyMembers.Count, (object) this._compositeKeyValues.Length));
      }
      for (int index1 = 0; index1 < this._compositeKeyValues.Length; ++index1)
      {
        ...
        {
          if (isArgumentException)
            throw new ArgumentException(System.Data.Entity.Resources.Strings.EntityKey_MissingKeyValue((object) keyMember.Name, (object) entitySet.ElementType.FullName), argumentName);
          throw new InvalidOperationException(System.Data.Entity.Resources.Strings.EntityKey_MissingKeyValue((object) keyMember.Name, (object) entitySet.ElementType.FullName));
        }
      }
    }
      ...
      string argumentName)
    {
      ...
      if (Helper.IsPrimitiveType(edmType))
      {
        ...
        if (!(clrEquivalentType != keyValue.GetType()))
          return;
        if (isArgumentException)
          throw new ArgumentException(System.Data.Entity.Resources.Strings.EntityKey_IncorrectValueType((object) keyMember.Name, (object) clrEquivalentType.FullName, (object) keyValue.GetType().FullName), argumentName);
        throw new InvalidOperationException(System.Data.Entity.Resources.Strings.EntityKey_IncorrectValueType((object) keyMember.Name, (object) clrEquivalentType.FullName, (object) keyValue.GetType().FullName));
      }
      ...
      if (workspace.TryGetObjectSpaceType((EnumType) edmType, out objectSpaceType))
      {
        ...
        if (!(clrType != keyValue.GetType()))
          return;
        if (isArgumentException)
          throw new ArgumentException(System.Data.Entity.Resources.Strings.EntityKey_IncorrectValueType((object) keyMember.Name, (object) clrType.FullName, (object) keyValue.GetType().FullName), argumentName);
        throw new InvalidOperationException(System.Data.Entity.Resources.Strings.EntityKey_IncorrectValueType((object) keyMember.Name, (object) clrType.FullName, (object) keyValue.GetType().FullName));
      }
      if (isArgumentException)
        throw new ArgumentException(System.Data.Entity.Resources.Strings.EntityKey_NoCorrespondingOSpaceTypeForEnumKeyMember((object) keyMember.Name, (object) edmType.FullName), argumentName);
      throw new InvalidOperationException(System.Data.Entity.Resources.Strings.EntityKey_NoCorrespondingOSpaceTypeForEnumKeyMember((object) keyMember.Name, (object) edmType.FullName));
    }
    ...
    internal static string LookupSingletonName(string name) => !string.IsNullOrEmpty(name) ? EntityKey.NameLookup.GetOrAdd(name, (Func<string, string>) (n => n)) : (string) null;

    private void ValidateWritable(object instance)
    {
      if (this._isLocked || instance != null)
        throw new InvalidOperationException(System.Data.Entity.Resources.Strings.EntityKey_CannotChangeKey);
    }

    private bool RequiresDeserialization => this._deserializedMembers != null;
    ...
    private class KeyValueReader : IEnumerable<KeyValuePair<string, object>>, IEnumerable
    {
      ...
      public KeyValueReader(IEnumerable<EntityKeyMember> enumerator) => this._enumerator = enumerator;
