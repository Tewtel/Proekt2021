...
namespace System.Data.Entity.Core.Mapping.Update.Internal
{
  internal class ViewLoader
  {
    ...
    internal ViewLoader(StorageMappingItemCollection mappingCollection) => this.m_mappingCollection = mappingCollection;
      ...
      EntitySetMapping entitySetMapping)
    {
      ...
      {
        EntityTypeModificationFunctionMapping typeFunctionMapping = modificationFunctionMapping;
        ...
        {
          foreach (ModificationFunctionResultBinding resultBinding in typeFunctionMapping.UpdateFunctionMapping.ResultBindings)
            yield return (EdmMember) resultBinding.Property;
        }
        typeFunctionMapping = (EntityTypeModificationFunctionMapping) null;
      }
    }
      ...
      ReadOnlyCollection<PropertyMapping> propertyMappings)
    {
      ...
      {
        if (propertyMapping is ComplexPropertyMapping complexPropertyMapping1)
        {
          foreach (ComplexTypeMapping typeMapping in complexPropertyMapping1.TypeMappings)
          {
