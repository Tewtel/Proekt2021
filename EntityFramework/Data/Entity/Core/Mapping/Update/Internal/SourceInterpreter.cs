...
namespace System.Data.Entity.Core.Mapping.Update.Internal
{
  internal class SourceInterpreter
  {
    ...
    private bool ExtentInScope(EntitySetBase extent) => extent != null && this.m_translator.ViewLoader.GetAffectedTables(extent, this.m_translator.MetadataWorkspace).Contains(this.m_sourceTable);
  }
}
