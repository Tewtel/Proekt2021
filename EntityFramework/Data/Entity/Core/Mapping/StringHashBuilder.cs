...
namespace System.Data.Entity.Core.Mapping
{
  internal class StringHashBuilder
  {
    ...
    internal StringHashBuilder(HashAlgorithm hashAlgorithm) => this._hashAlgorithm = hashAlgorithm;
    ...
    internal int CharCount => this._totalLength;

    internal virtual void Append(string s) => this.InternalAppend(s);
