...
namespace System.Data.Entity.Core.Mapping.ViewGeneration
{
  internal abstract class ViewgenGatekeeper : InternalBase
  {
      ...
      out bool success)
    {
      ...
      EntityContainerMapping containerMapping1 = containerMapping;
      ErrorLog errorLog1 = ViewgenGatekeeper.EnsureAllCSpaceContainerSetsAreMapped((IEnumerable<Cell>) cells, containerMapping1);
      ...
      EntityContainerMapping containerMapping)
    {
      ...
      {
        if (!set.Contains(baseEntitySet) && !containerMapping.HasQueryViewForSetMap(baseEntitySet.Name) && (!(baseEntitySet is AssociationSet associationSet1) || !associationSet1.ElementType.IsForeignKey))
      ...
      if (entitySetBaseList.Count > 0)
      {
        ...
        string message = System.Data.Entity.Resources.Strings.ViewGen_Missing_Set_Mapping((object) stringBuilder);
        int num = -1;
        foreach (Cell cell in cells)
        {
