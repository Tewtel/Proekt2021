...
namespace System.Data.Entity.Core.Mapping.ViewGeneration.Structures
{
  internal class TypeRestriction : MemberRestriction
  {
    ...
    internal override BoolLiteral RemapBool(Dictionary<MemberPath, MemberPath> remap) => (BoolLiteral) new TypeRestriction(this.RestrictedMemberSlot.RemapSlot(remap), this.Domain);
