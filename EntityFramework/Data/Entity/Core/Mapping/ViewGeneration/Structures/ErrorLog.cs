...
namespace System.Data.Entity.Core.Mapping.ViewGeneration.Structures
{
  internal class ErrorLog : InternalBase
  {
    ...
    internal ErrorLog() => this.m_log = new List<ErrorLog.Record>();

    internal int Count => this.m_log.Count;
    ...
    internal class Record : InternalBase
    {
      ...
      internal EdmSchemaError Error => this.m_mappingError;

      internal override void ToCompactString(StringBuilder builder) => builder.Append(this.m_debugMessage);
        ...
        bool isInvariant)
      {
        ...
        if (isInvariant)
        {
          ...
          builder.Append(System.Data.Entity.Resources.Strings.ViewGen_ErrorLog2((object) lineBuilder.ToString()));
        else
          builder.Append(System.Data.Entity.Resources.Strings.ViewGen_ErrorLog((object) lineBuilder.ToString()));
        builder.AppendLine(message);
        return builder.ToString();
      }

      internal string ToUserString() => this.m_mappingError.ToString();
    }
  }
}
