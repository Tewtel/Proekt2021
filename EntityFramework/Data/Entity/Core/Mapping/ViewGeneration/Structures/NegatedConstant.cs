...
namespace System.Data.Entity.Core.Mapping.ViewGeneration.Structures
{
  internal sealed class NegatedConstant : Constant
  {
    ...
    internal NegatedConstant(IEnumerable<Constant> values) => this.m_negatedDomain = new Set<Constant>(values, Constant.EqualityComparer);

    internal IEnumerable<Constant> Elements => (IEnumerable<Constant>) this.m_negatedDomain;

    internal bool Contains(Constant constant) => this.m_negatedDomain.Contains(constant);
    ...
    internal override bool IsNotNull()
    {
      if (this == Constant.NotNull)
        return true;
      return this.m_negatedDomain.Count == 1 && this.m_negatedDomain.Contains(Constant.Null);
    }

    internal override bool IsUndefined() => false;

    internal override bool HasNotNull() => this.m_negatedDomain.Contains(Constant.Null);
    ...
    protected override bool IsEqualTo(Constant right) => right is NegatedConstant negatedConstant && this.m_negatedDomain.SetEquals(negatedConstant.m_negatedDomain);
