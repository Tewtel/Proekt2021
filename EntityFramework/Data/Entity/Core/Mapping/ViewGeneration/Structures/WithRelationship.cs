...
namespace System.Data.Entity.Core.Mapping.ViewGeneration.Structures
{
  internal sealed class WithRelationship : InternalBase
  {
    ...
    internal EntityType FromEndEntityType => this.m_fromEndEntityType;
    ...
    internal DbRelatedEntityRef AsCqt(DbExpression row) => DbExpressionBuilder.CreateRelatedEntityRef(this.m_fromEnd, this.m_toEnd, (DbExpression) this.m_toEndEntitySet.CreateRef(this.m_toEndEntityType, (IEnumerable<DbExpression>) this.m_toEndEntityKeyMemberPaths.Select<MemberPath, DbPropertyExpression>((Func<MemberPath, DbPropertyExpression>) (keyMember => row.Property(keyMember.CqlFieldAlias)))));
