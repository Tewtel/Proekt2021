...
namespace System.Data.Entity.Core.Mapping.ViewGeneration.Validation
{
  internal class ViewKeyConstraint : KeyConstraint<ViewCellRelation, ViewCellSlot>
  {
    ...
    internal Cell Cell => this.CellRelation.Cell;

    internal bool Implies(ViewKeyConstraint second)
    {
      if (this.CellRelation != second.CellRelation)
        return false;
    ...
    internal static ErrorLog.Record GetErrorRecord(ViewKeyConstraint rightKeyConstraint)
    {
      ...
      EntityType elementType = (EntityType) extent1.ElementType;
      ExtentKey keyForEntityType = ExtentKey.GetPrimaryKeyForEntityType(prefix1, elementType);
