  ...
  internal class CellGroupValidator
  {
      ...
      SchemaConstraints<BasicKeyConstraint> sConstraints)
    {
      ...
      foreach (Cell cell in this.m_cells)
      {
        ...
        SchemaConstraints<BasicKeyConstraint> constraints = sConstraints;
        CellGroupValidator.PopulateBaseConstraints(basicCellRelation2, constraints);
        ++cellNumber;
      }
    ...
    private bool CheckCellsWithDistinctFlag()
    {
      ...
      foreach (Cell cell1 in this.m_cells)
      {
        ...
        if (cell.SQuery.SelectDistinctFlag == CellQuery.SelectDistinct.Yes)
        {
          ...
          IEnumerable<Cell> cells = this.m_cells.Where<Cell>((Func<Cell, bool>) (otherCell => otherCell != cell)).Where<Cell>((Func<Cell, bool>) (otherCell => otherCell.CQuery.Extent == cExtent && otherCell.SQuery.Extent == sExtent));
          if (cells.Any<Cell>())
          {
            IEnumerable<Cell> sourceCells = Enumerable.Repeat<Cell>(cell, 1).Union<Cell>(cells);
            this.m_errorLog.AddEntry(new ErrorLog.Record(ViewGenErrorCode.MultipleFragmentsBetweenCandSExtentWithDistinct, System.Data.Entity.Resources.Strings.Viewgen_MultipleFragmentsBetweenCandSExtentWithDistinct((object) cExtent.Name, (object) sExtent.Name), sourceCells, string.Empty));
          }
        }
      }
    ...
    private bool PerformSingleCellChecks()
    {
      ...
      foreach (Cell cell in this.m_cells)
      {
        ...
        ErrorLog.Record record2 = cell.CQuery.VerifyKeysPresent(cell, new Func<object, object, string>(System.Data.Entity.Resources.Strings.ViewGen_EntitySetKey_Missing), new Func<object, object, object, string>(System.Data.Entity.Resources.Strings.ViewGen_AssociationSetKey_Missing), ViewGenErrorCode.KeyNotMappedForCSideExtent);
        if (record2 != null)
          this.m_errorLog.AddEntry(record2);
        ErrorLog.Record record3 = cell.SQuery.VerifyKeysPresent(cell, new Func<object, object, string>(System.Data.Entity.Resources.Strings.ViewGen_TableKey_Missing), (Func<object, object, object, string>) null, ViewGenErrorCode.KeyNotMappedForTable);
        if (record3 != null)
    ...
    private class ExtentPair
    {
      ...
      public override bool Equals(object obj)
      {
        if (this == obj)
          return true;
        return obj is CellGroupValidator.ExtentPair extentPair && extentPair.cExtent.Equals((object) this.cExtent) && extentPair.sExtent.Equals((object) this.sExtent);
      }

      public override int GetHashCode() => this.cExtent.GetHashCode() ^ this.sExtent.GetHashCode();
    }
  }
}
