...
namespace System.Data.Entity.Core.Mapping.ViewGeneration
{
  internal class DiscriminatorMap
  {
      ...
      out DiscriminatorMap discriminatorMap)
    {
      ...
      Action<DbComparisonExpression, object> onMatchedComparison = (Action<DbComparisonExpression, object>) ((equalsExp, discriminatorValue) => discriminatorDomain.Add(discriminatorValue));
      if (!ViewSimplifier.TryMatchDiscriminatorPredicate(expression1, onMatchedComparison))
        return false;
      ...
      for (int index = 0; index < projection.When.Count; ++index)
      {
        ...
        ref DbPropertyExpression local1 = ref propertyExpression;
        object key;
        ref object local2 = ref key;
        if (!ViewSimplifier.TryMatchPropertyEqualsValue(expression2, variableName, out local1, out local2))
          return false;
        if (edmProperty == null)
          edmProperty = (EdmProperty) propertyExpression.Property;
        else if (edmProperty != propertyExpression.Property)
          return false;
        discriminator = propertyExpression;
    ...
    private static bool ExpressionsCompatible(DbExpression x, DbExpression y)
    {
      ...
      switch (x.ExpressionKind)
      {
        ...
        case DbExpressionKind.Property:
          ...
          return propertyExpression1.Property == propertyExpression2.Property && DiscriminatorMap.ExpressionsCompatible(propertyExpression1.Instance, propertyExpression2.Instance);
        case DbExpressionKind.Ref:
          ...
          return dbRefExpression1.EntitySet.EdmEquals((MetadataItem) dbRefExpression2.EntitySet) && DiscriminatorMap.ExpressionsCompatible(dbRefExpression1.Argument, dbRefExpression2.Argument);
