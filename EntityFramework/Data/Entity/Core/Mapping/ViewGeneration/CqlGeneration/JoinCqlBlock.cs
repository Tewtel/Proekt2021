...
namespace System.Data.Entity.Core.Mapping.ViewGeneration.CqlGeneration
{
  internal sealed class JoinCqlBlock : CqlBlock
  {
    ...
    internal sealed class OnClause : InternalBase
    {
      ...
      internal OnClause() => this.m_singleClauses = new List<JoinCqlBlock.OnClause.SingleClause>();
      ...
      private sealed class SingleClause : InternalBase
      {
        ...
        internal DbExpression AsCqt(DbExpression leftRow, DbExpression rightRow) => (DbExpression) this.m_leftSlot.AsCqt(leftRow, this.m_leftSlotOutputMember).Equal(this.m_rightSlot.AsCqt(rightRow, this.m_rightSlotOutputMember));
