...
namespace System.Data.Entity.Core.Mapping.ViewGeneration.QueryRewriting
{
  internal class FragmentQueryKB : KnowledgeBase<DomainConstraint<BoolLiteral, Constant>>
  {
    ...
    internal BoolExpr<DomainConstraint<BoolLiteral, Constant>> KbExpression => this._kbExpression;
      ...
      EdmItemCollection edmItemCollection)
    {
      ...
      foreach (AssociationEndMember associationEndMember in associationSet.ElementType.AssociationEndMembers)
      {
        ...
        type.KeyMembers.All<EdmMember>((Func<EdmMember, bool>) (member => associationkeys.Add(new Pair<EdmMember, EntityType>(member, type)) || true));
      }
