...
namespace System.Data.Entity.Core.Mapping.ViewGeneration.QueryRewriting
{
  internal class RewritingSimplifier<T_Tile> where T_Tile : class
  {
      ...
      out T_Tile simplifiedRewriting)
    {
      ...
      return this.SimplifyRewritingOnce(tile1, remainingViews2, out simplifiedRewriting) || this.SimplifyRewritingOnce(tile2, remainingViews1, out simplifiedRewriting);
    }
