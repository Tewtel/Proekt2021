  ...
  internal class ViewGenerator : InternalBase
  {
      ...
      List<LeftCellWrapper> usedCells)
    {
      ...
      for (int index = 0; index < count; ++index)
        usedCells[index].RightCellQuery.InitializeBoolExpressions(count, index);
    ...
    internal override void ToCompactString(StringBuilder builder) => Cell.CellsToBuilder(builder, (IEnumerable<Cell>) this.m_cellGroup);
  }
}
