...
namespace System.Data.Entity.Core.Mapping
{
  internal class MappingItemLoader
  {
    ...
    internal double MappingVersion => this.m_version;

    internal IList<EdmSchemaError> ParsingErrors => (IList<EdmSchemaError>) this.m_parsingErrors;

    internal bool HasQueryViews => this.m_hasQueryViews;

    internal EntityContainerMapping ContainerMapping => this.m_containerMapping;

    private EdmItemCollection EdmItemCollection => this.m_storageMappingItemCollection.EdmItemCollection;

    private StoreItemCollection StoreItemCollection => this.m_storageMappingItemCollection.StoreItemCollection;
    ...
    private EntityContainerMapping LoadMappingItems(XmlReader innerReader)
    {
      ...
      try
      {
        ...
        return this.m_parsingErrors.Count != 0 && !MetadataHelper.CheckIfAllErrorsAreWarnings((IList<EdmSchemaError>) this.m_parsingErrors) ? (EntityContainerMapping) null : this.LoadMappingItems(xpathDocument.CreateNavigator().Clone());
      }
      catch (XmlException ex)
      {
        this.m_parsingErrors.Add(new EdmSchemaError(System.Data.Entity.Resources.Strings.Mapping_InvalidMappingSchema_Parsing((object) ex.Message), 2024, EdmSchemaErrorSeverity.Error, this.m_sourceLocation, ex.LineNumber, ex.LinePosition));
      }
    ...
    private EntityContainerMapping LoadMappingChildNodes(XPathNavigator nav)
    {
      ...
      return !flag ? (EntityContainerMapping) null : this.LoadEntityContainerMapping(nav.Clone());
    }
      ...
      XPathNavigator nav)
    {
      ...
      else
      {
        ...
        {
          MappingItemLoader.AddToSchemaErrorsWithMemberInfo(new Func<object, string>(System.Data.Entity.Resources.Strings.Mapping_AlreadyMapped_StorageEntityContainer), attributeValue2, MappingErrorCode.AlreadyMappedStorageEntityContainer, this.m_sourceLocation, lineInfo, (IList<EdmSchemaError>) this.m_parsingErrors);
          return (EntityContainerMapping) null;
        }
        ...
        if (entityContainer2 == null)
          MappingItemLoader.AddToSchemaErrorsWithMemberInfo(new Func<object, string>(System.Data.Entity.Resources.Strings.Mapping_InvalidContent_EntityContainer), attributeValue1, MappingErrorCode.InvalidEntityContainer, this.m_sourceLocation, lineInfo, (IList<EdmSchemaError>) this.m_parsingErrors);
        this.StoreItemCollection.TryGetEntityContainer(attributeValue2, out entityContainer1);
        if (entityContainer1 == null)
          MappingItemLoader.AddToSchemaErrorsWithMemberInfo(new Func<object, string>(System.Data.Entity.Resources.Strings.Mapping_InvalidContent_StorageEntityContainer), attributeValue2, MappingErrorCode.InvalidEntityContainer, this.m_sourceLocation, lineInfo, (IList<EdmSchemaError>) this.m_parsingErrors);
      ...
      System.Data.Entity.Core.Metadata.Edm.EntityContainer storageEntityContainerType)
    {
        ...
        do
        {
          switch (nav.LocalName)
          {
            ...
            case "FunctionImportMapping":
              ...
              break;
            default:
              MappingItemLoader.AddToSchemaErrors(System.Data.Entity.Resources.Strings.Mapping_InvalidContent_Container_SubElement, MappingErrorCode.SetMappingExpected, this.m_sourceLocation, lineInfo, (IList<EdmSchemaError>) this.m_parsingErrors);
              break;
          }
        }
      ...
      {
        MappingItemLoader.AddToSchemaErrorsWithMemberInfo(new Func<object, string>(System.Data.Entity.Resources.Strings.ViewGen_Missing_Sets_Mapping), entityContainerMapping.EdmEntityContainer.Name, MappingErrorCode.EmptyContainerMapping, this.m_sourceLocation, lineInfo, (IList<EdmSchemaError>) this.m_parsingErrors);
      }
      else
      {
      ...
      string elementName)
    {
      ...
      foreach (AssociationSetEnd expectedEnd in expectedEnds)
      {
        if (MetadataHelper.IsAssociationValidForEntityType(expectedEnd, entityTypeMapping.EntityType) && !set.Contains(expectedEnd))
          MappingItemLoader.AddToSchemaErrorWithMessage(System.Data.Entity.Resources.Strings.Mapping_ModificationFunction_AssociationSetNotMappedForOperation((object) entitySetMapping.Set.Name, (object) expectedEnd.ParentAssociationSet.Name, (object) elementName, (object) entityTypeMapping.EntityType.FullName), MappingErrorCode.InvalidModificationFunctionMappingAssociationSetNotMappedForOperation, this.m_sourceLocation, lineInfo, (IList<EdmSchemaError>) this.m_parsingErrors);
      }
      ...
      EntityContainerMapping entityContainerMapping)
    {
      ...
      if (0 >= stringList.Count)
        return;
      MappingItemLoader.AddToSchemaErrorsWithMemberInfo(new Func<object, string>(System.Data.Entity.Resources.Strings.Mapping_ModificationFunction_AssociationSetAmbiguous), StringUtil.ToCommaSeparatedString((IEnumerable) stringList), MappingErrorCode.AmbiguousModificationFunctionMappingForAssociationSet, this.m_sourceLocation, (IXmlLineInfo) nav, (IList<EdmSchemaError>) this.m_parsingErrors);
    }
      ...
      EntityContainerMapping entityContainerMapping)
    {
      ...
      {
        if (keyToListMap.ListForKey(key).Any<EntitySetBaseMapping>((Func<EntitySetBaseMapping, bool>) (s => s.HasModificationFunctionMapping || implicitMappedAssociationSets.Any<EntitySetBase>((Func<EntitySetBase, bool>) (aset => aset == s.Set)))) && keyToListMap.ListForKey(key).Any<EntitySetBaseMapping>((Func<EntitySetBaseMapping, bool>) (s => !s.HasModificationFunctionMapping && !implicitMappedAssociationSets.Any<EntitySetBase>((Func<EntitySetBase, bool>) (aset => aset == s.Set)))))
          MappingItemLoader.AddToSchemaErrorsWithMemberInfo(new Func<object, string>(System.Data.Entity.Resources.Strings.Mapping_ModificationFunction_MissingSetClosure), StringUtil.ToCommaSeparatedString((IEnumerable) keyToListMap.ListForKey(key).Where<EntitySetBaseMapping>((Func<EntitySetBaseMapping, bool>) (s => !s.HasModificationFunctionMapping)).Select<EntitySetBaseMapping, string>((Func<EntitySetBaseMapping, string>) (s => s.Set.Name))), MappingErrorCode.MissingSetClosureInModificationFunctionMapping, this.m_sourceLocation, (IXmlLineInfo) nav, (IList<EdmSchemaError>) this.m_parsingErrors);
      }
    }
      ...
      Set<EntitySetBase> additionalSetsInClosure)
    {
      ...
      do
      {
        ...
        {
          if (entitySetBase is AssociationSet associationSet6 && !associationSet6.ElementType.IsForeignKey)
          {
            foreach (AssociationSetEnd associationSetEnd in associationSet6.AssociationSetEnds)
            {
        ...
        {
          if (baseEntitySet is AssociationSet associationSet7 && !associationSet7.ElementType.IsForeignKey && !additionalSetsInClosure.Contains((EntitySetBase) associationSet7))
          {
            foreach (AssociationSetEnd associationSetEnd in associationSet7.AssociationSetEnds)
            {
              if (additionalSetsInClosure.Contains((EntitySetBase) associationSetEnd.EntitySet))
              {
                entitySetBaseList.Add((EntitySetBase) associationSet7);
                break;
              }
            }
          }
      ...
      System.Data.Entity.Core.Metadata.Edm.EntityContainer storageEntityContainerType)
    {
      ...
      if (entitySetMapping == null)
      {
        ...
        {
          MappingItemLoader.AddToSchemaErrorsWithMemberInfo(new Func<object, string>(System.Data.Entity.Resources.Strings.Mapping_InvalidContent_Entity_Set), resolvedAttributeValue1, MappingErrorCode.InvalidEntitySet, this.m_sourceLocation, lineInfo, (IList<EdmSchemaError>) this.m_parsingErrors);
          return;
        }
          ...
          do
          {
            switch (nav.LocalName)
            {
              ...
              case "QueryView":
                ...
                {
                  MappingItemLoader.AddToSchemaErrorsWithMemberInfo(new Func<object, string>(System.Data.Entity.Resources.Strings.Mapping_TableName_QueryView), resolvedAttributeValue1, MappingErrorCode.TableNameAttributeWithQueryView, this.m_sourceLocation, lineInfo, (IList<EdmSchemaError>) this.m_parsingErrors);
                  return;
                }
                ...
                break;
              default:
                MappingItemLoader.AddToSchemaErrors(System.Data.Entity.Resources.Strings.Mapping_InvalidContent_TypeMapping_QueryView, MappingErrorCode.InvalidContent, this.m_sourceLocation, lineInfo, (IList<EdmSchemaError>) this.m_parsingErrors);
                break;
            }
          }
          while (nav.MoveToNext(XPathNodeType.Element));
      ...
      if (!entitySetMapping.HasNoContent)
        return;
      MappingItemLoader.AddToSchemaErrorsWithMemberInfo(new Func<object, string>(System.Data.Entity.Resources.Strings.Mapping_InvalidContent_Emtpty_SetMap), entitySet.Name, MappingErrorCode.EmptySetMapping, this.m_sourceLocation, lineInfo, (IList<EdmSchemaError>) this.m_parsingErrors);
    }
      ...
      out Set<System.Data.Entity.Core.Metadata.Edm.EntityType> entityTypes)
    {
      ...
      foreach (string str1 in ((IEnumerable<string>) attributeValue.Split(chArray)).Select<string, string>((Func<string, string>) (s => s.Trim())))
      {
        ...
        if (flag)
        {
          ...
          {
            MappingItemLoader.AddToSchemaErrorWithMessage(System.Data.Entity.Resources.Strings.Mapping_InvalidContent_IsTypeOfNotTerminated, MappingErrorCode.InvalidEntityType, this.m_sourceLocation, lineInfo, (IList<EdmSchemaError>) this.m_parsingErrors);
            return false;
          }
        ...
        {
          MappingItemLoader.AddToSchemaErrorsWithMemberInfo(new Func<object, string>(System.Data.Entity.Resources.Strings.Mapping_InvalidContent_Entity_Type), aliasResolvedValue, MappingErrorCode.InvalidEntityType, this.m_sourceLocation, lineInfo, (IList<EdmSchemaError>) this.m_parsingErrors);
          return false;
        }
        ...
        if (element.Abstract)
        {
          if (flag)
          {
            ...
            {
              MappingItemLoader.AddToSchemaErrorsWithMemberInfo(new Func<object, string>(System.Data.Entity.Resources.Strings.Mapping_InvalidContent_AbstractEntity_IsOfType), element.FullName, MappingErrorCode.MappingOfAbstractType, this.m_sourceLocation, lineInfo, (IList<EdmSchemaError>) this.m_parsingErrors);
              return false;
            }
          }
          else
          {
            MappingItemLoader.AddToSchemaErrorsWithMemberInfo(new Func<object, string>(System.Data.Entity.Resources.Strings.Mapping_InvalidContent_AbstractEntity_Type), element.FullName, MappingErrorCode.MappingOfAbstractType, this.m_sourceLocation, lineInfo, (IList<EdmSchemaError>) this.m_parsingErrors);
            return false;
          }
        }
        if (flag)
      ...
      bool generateUpdateViews)
    {
      ...
      if (!this.TryParseEntityTypeAttribute(nav.Clone(), rootEntityType, (Func<System.Data.Entity.Core.Metadata.Edm.EntityType, string>) (e => System.Data.Entity.Resources.Strings.Mapping_InvalidContent_Entity_Type_For_Entity_Set((object) e.FullName, (object) rootEntityType.FullName, (object) entitySetMapping.Set.Name)), out isOfTypeEntityTypes, out entityTypes))
        return;
      ...
      if (string.IsNullOrEmpty(tableName))
      {
        ...
        do
        {
          ...
          {
            MappingItemLoader.AddToSchemaErrors(System.Data.Entity.Resources.Strings.Mapping_InvalidContent_Table_Expected, MappingErrorCode.TableMappingFragmentExpected, this.m_sourceLocation, lineInfo, (IList<EdmSchemaError>) this.m_parsingErrors);
          }
          else
          {
            bool boolAttributeValue = MappingItemLoader.GetBoolAttributeValue(nav.Clone(), "MakeColumnsDistinct", false);
            if (generateUpdateViews & boolAttributeValue)
              MappingItemLoader.AddToSchemaErrors(System.Data.Entity.Resources.Strings.Mapping_DistinctFlagInReadWriteContainer, MappingErrorCode.DistinctFragmentInReadWriteContainer, this.m_sourceLocation, lineInfo, (IList<EdmSchemaError>) this.m_parsingErrors);
      ...
      {
        if (nav.LocalName == "ModificationFunctionMapping")
          MappingItemLoader.AddToSchemaErrors(System.Data.Entity.Resources.Strings.Mapping_ModificationFunction_In_Table_Context, MappingErrorCode.InvalidTableNameAttributeWithModificationFunctionMapping, this.m_sourceLocation, lineInfo, (IList<EdmSchemaError>) this.m_parsingErrors);
      ...
      EntityTypeMapping entityTypeMapping)
    {
      ...
      {
        MappingItemLoader.AddToSchemaErrors(System.Data.Entity.Resources.Strings.Mapping_ModificationFunction_Multiple_Types, MappingErrorCode.InvalidModificationFunctionMappingForMultipleTypes, this.m_sourceLocation, lineInfo, (IList<EdmSchemaError>) this.m_parsingErrors);
      }
      else
      {
        ...
        if (type.Abstract)
        {
          MappingItemLoader.AddToSchemaErrorsWithMemberInfo(new Func<object, string>(System.Data.Entity.Resources.Strings.Mapping_InvalidContent_AbstractEntity_FunctionMapping), type.FullName, MappingErrorCode.MappingOfAbstractType, this.m_sourceLocation, lineInfo, (IList<EdmSchemaError>) this.m_parsingErrors);
        }
        else
        {
          foreach (EntityTypeModificationFunctionMapping modificationFunctionMapping in entitySetMapping.ModificationFunctionMappings)
          {
            ...
            {
              MappingItemLoader.AddToSchemaErrorsWithMemberInfo(new Func<object, string>(System.Data.Entity.Resources.Strings.Mapping_ModificationFunction_RedundantEntityTypeMapping), type.Name, MappingErrorCode.RedundantEntityTypeMappingInModificationFunctionMapping, this.m_sourceLocation, lineInfo, (IList<EdmSchemaError>) this.m_parsingErrors);
              return;
            }
          }
          ...
          if (deleteFunctionMapping != null)
            parameterBindings = Helper.Concat<ModificationFunctionParameterBinding>(parameterBindings, (IEnumerable<ModificationFunctionParameterBinding>) deleteFunctionMapping.ParameterBindings);
          if (insertFunctionMapping != null)
            parameterBindings = Helper.Concat<ModificationFunctionParameterBinding>(parameterBindings, (IEnumerable<ModificationFunctionParameterBinding>) insertFunctionMapping.ParameterBindings);
          if (updateFunctionMapping != null)
            parameterBindings = Helper.Concat<ModificationFunctionParameterBinding>(parameterBindings, (IEnumerable<ModificationFunctionParameterBinding>) updateFunctionMapping.ParameterBindings);
          ...
          foreach (ModificationFunctionParameterBinding parameterBinding in parameterBindings)
          {
            if (parameterBinding.MemberPath.AssociationSetEnd != null)
            {
              ...
              {
                MappingItemLoader.AddToSchemaErrorWithMessage(System.Data.Entity.Resources.Strings.Mapping_ModificationFunction_MultipleEndsOfAssociationMapped((object) associationEndMember1.Name, (object) associationEndMember2.Name, (object) parentAssociationSet.Name), MappingErrorCode.InvalidModificationFunctionMappingMultipleEndsOfAssociationMapped, this.m_sourceLocation, lineInfo, (IList<EdmSchemaError>) this.m_parsingErrors);
                return;
              }
    ...
    private bool LoadQueryView(XPathNavigator nav, EntitySetBaseMapping setMapping)
    {
      ...
      if (setMapping.QueryView == null)
      {
        if (str != null)
        {
          MappingItemLoader.AddToSchemaErrorsWithMemberInfo((Func<object, string>) (val => System.Data.Entity.Resources.Strings.Mapping_TypeName_For_First_QueryView), setMapping.Set.Name, MappingErrorCode.TypeNameForFirstQueryView, this.m_sourceLocation, lineInfo, (IList<EdmSchemaError>) this.m_parsingErrors);
          return false;
        }
        if (string.IsNullOrEmpty(viewString))
        {
          MappingItemLoader.AddToSchemaErrorsWithMemberInfo(new Func<object, string>(System.Data.Entity.Resources.Strings.Mapping_Empty_QueryView), setMapping.Set.Name, MappingErrorCode.EmptyQueryView, this.m_sourceLocation, lineInfo, (IList<EdmSchemaError>) this.m_parsingErrors);
          return false;
        }
      ...
      {
        MappingItemLoader.AddToSchemaErrorsWithMemberInfo(new Func<object, string>(System.Data.Entity.Resources.Strings.Mapping_QueryView_TypeName_Not_Defined), setMapping.Set.Name, MappingErrorCode.NoTypeNameForTypeSpecificQueryView, this.m_sourceLocation, lineInfo, (IList<EdmSchemaError>) this.m_parsingErrors);
        return false;
      }
      ...
      Set<System.Data.Entity.Core.Metadata.Edm.EntityType> isOfTypeEntityTypes;
      Set<System.Data.Entity.Core.Metadata.Edm.EntityType> entityTypes;
      if (!this.TryParseEntityTypeAttribute(nav.Clone(), rootEntityType, (Func<System.Data.Entity.Core.Metadata.Edm.EntityType, string>) (e => System.Data.Entity.Resources.Strings.Mapping_InvalidContent_Entity_Type_For_Entity_Set((object) e.FullName, (object) rootEntityType.FullName, (object) setMapping.Set.Name)), out isOfTypeEntityTypes, out entityTypes))
        return false;
      ...
      {
        MappingItemLoader.AddToSchemaErrorsWithMemberInfo(new Func<object, string>(System.Data.Entity.Resources.Strings.Mapping_QueryViewMultipleTypeInTypeName), setMapping.Set.ToString(), MappingErrorCode.TypeNameContainsMultipleTypesForQueryView, this.m_sourceLocation, lineInfo, (IList<EdmSchemaError>) this.m_parsingErrors);
        return false;
      }
      if (second && setMapping.Set.ElementType.EdmEquals((MetadataItem) entityType))
      {
        MappingItemLoader.AddToSchemaErrorWithMemberAndStructure(new Func<object, object, string>(System.Data.Entity.Resources.Strings.Mapping_QueryView_For_Base_Type), entityType.ToString(), setMapping.Set.ToString(), MappingErrorCode.IsTypeOfQueryViewForBaseType, this.m_sourceLocation, lineInfo, (IList<EdmSchemaError>) this.m_parsingErrors);
        return false;
      }
      if (string.IsNullOrEmpty(viewString))
      {
        if (second)
        {
          MappingItemLoader.AddToSchemaErrorWithMemberAndStructure(new Func<object, object, string>(System.Data.Entity.Resources.Strings.Mapping_Empty_QueryView_OfType), entityType.Name, setMapping.Set.Name, MappingErrorCode.EmptyQueryView, this.m_sourceLocation, lineInfo, (IList<EdmSchemaError>) this.m_parsingErrors);
          return false;
        }
        MappingItemLoader.AddToSchemaErrorWithMemberAndStructure(new Func<object, object, string>(System.Data.Entity.Resources.Strings.Mapping_Empty_QueryView_OfTypeOnly), setMapping.Set.Name, entityType.Name, MappingErrorCode.EmptyQueryView, this.m_sourceLocation, lineInfo, (IList<EdmSchemaError>) this.m_parsingErrors);
        return false;
      }
      ...
      {
        this.m_parsingErrors.Add(!second ? new EdmSchemaError(System.Data.Entity.Resources.Strings.Mapping_QueryView_Duplicate_OfTypeOnly((object) setMapping.Set, (object) entityType), 2082, EdmSchemaErrorSeverity.Error, this.m_sourceLocation, lineInfo.LineNumber, lineInfo.LinePosition) : new EdmSchemaError(System.Data.Entity.Resources.Strings.Mapping_QueryView_Duplicate_OfType((object) setMapping.Set, (object) entityType), 2082, EdmSchemaErrorSeverity.Error, this.m_sourceLocation, lineInfo.LineNumber, lineInfo.LinePosition));
        return false;
      }
      ...
      System.Data.Entity.Core.Metadata.Edm.EntityContainer storageEntityContainerType)
    {
      ...
      if (!(relationshipSet is AssociationSet associationSet))
        MappingItemLoader.AddToSchemaErrorsWithMemberInfo(new Func<object, string>(System.Data.Entity.Resources.Strings.Mapping_InvalidContent_Association_Set), resolvedAttributeValue1, MappingErrorCode.InvalidAssociationSet, this.m_sourceLocation, lineInfo, (IList<EdmSchemaError>) this.m_parsingErrors);
      else if (associationSet.ElementType.IsForeignKey)
      {
        ...
        if (associationSet.ElementType.ReferentialConstraints.Single<System.Data.Entity.Core.Metadata.Edm.ReferentialConstraint>().ToProperties.All<EdmProperty>((Func<EdmProperty, bool>) (p => dependentKeys.Contains<EdmMember>((EdmMember) p))))
          MappingItemLoader.AddToSchemaErrorsWithMemberInfo(new Func<object, string>(System.Data.Entity.Resources.Strings.Mapping_InvalidContent_ForeignKey_Association_Set_PKtoPK), resolvedAttributeValue1, MappingErrorCode.InvalidAssociationSet, this.m_sourceLocation, lineInfo, (IList<EdmSchemaError>) this.m_parsingErrors).Severity = EdmSchemaErrorSeverity.Warning;
        else
          MappingItemLoader.AddToSchemaErrorsWithMemberInfo(new Func<object, string>(System.Data.Entity.Resources.Strings.Mapping_InvalidContent_ForeignKey_Association_Set), resolvedAttributeValue1, MappingErrorCode.InvalidAssociationSet, this.m_sourceLocation, lineInfo, (IList<EdmSchemaError>) this.m_parsingErrors);
      }
      else if (entityContainerMapping.ContainsAssociationSetMapping(associationSet))
      {
        MappingItemLoader.AddToSchemaErrorsWithMemberInfo(new Func<object, string>(System.Data.Entity.Resources.Strings.Mapping_Duplicate_CdmAssociationSet_StorageMap), resolvedAttributeValue1, MappingErrorCode.DuplicateSetMapping, this.m_sourceLocation, lineInfo, (IList<EdmSchemaError>) this.m_parsingErrors);
      }
      else
      {
        ...
        if (!nav.MoveToChild(XPathNodeType.Element))
        {
          MappingItemLoader.AddToSchemaErrorsWithMemberInfo(new Func<object, string>(System.Data.Entity.Resources.Strings.Mapping_InvalidContent_Emtpty_SetMap), associationSet.Name, MappingErrorCode.EmptySetMapping, this.m_sourceLocation, lineInfo, (IList<EdmSchemaError>) this.m_parsingErrors);
        }
        else
        {
          ...
          {
            if (string.IsNullOrEmpty(resolvedAttributeValue2))
              MappingItemLoader.AddToSchemaErrors(System.Data.Entity.Resources.Strings.Mapping_InvalidContent_Association_Type_Empty, MappingErrorCode.InvalidAssociationType, this.m_sourceLocation, lineInfo, (IList<EdmSchemaError>) this.m_parsingErrors);
            else
          ...
          else
          {
            if (!(nav.LocalName == "Condition"))
              return;
            MappingItemLoader.AddToSchemaErrorsWithMemberInfo(new Func<object, string>(System.Data.Entity.Resources.Strings.Mapping_InvalidContent_AssociationSet_Condition), resolvedAttributeValue1, MappingErrorCode.InvalidContent, this.m_sourceLocation, lineInfo, (IList<EdmSchemaError>) this.m_parsingErrors);
          }
        }
      }
    }
      ...
      EntityContainerMapping entityContainerMapping)
    {
      ...
      else
      {
        ...
        if (structuralTypeMappingsList.Count > 0 && structuralTypeMappingsList.Count != functionImport.ReturnParameters.Count)
          MappingItemLoader.AddToSchemaErrors(System.Data.Entity.Resources.Strings.Mapping_FunctionImport_ResultMappingCountDoesNotMatchResultCount((object) functionImport.Identity), MappingErrorCode.FunctionResultMappingCountMismatch, this.m_sourceLocation, xmlLineInfo, (IList<EdmSchemaError>) this.m_parsingErrors);
        else if (functionImport.IsComposableAttribute)
        {
          ...
          {
            MappingItemLoader.AddToSchemaErrors(System.Data.Entity.Resources.Strings.Mapping_FunctionImport_ResultMapping_InvalidSType((object) functionImport.Identity), MappingErrorCode.MappingFunctionImportTVFExpected, this.m_sourceLocation, xmlLineInfo, (IList<EdmSchemaError>) this.m_parsingErrors);
          }
          else
          {
        ...
        else
        {
          ...
          for (int resultSetIndex = 0; resultSetIndex < mappingNonComposable.InternalResultMappings.Count; ++resultSetIndex)
          {
            ...
            if (MetadataHelper.TryGetFunctionImportReturnType<System.Data.Entity.Core.Metadata.Edm.EntityType>(functionImport, resultSetIndex, out returnType) && returnType.Abstract && mappingNonComposable.GetResultMapping(resultSetIndex).NormalizedEntityTypeMappings.Count == 0)
              MappingItemLoader.AddToSchemaErrorWithMemberAndStructure(new Func<object, object, string>(System.Data.Entity.Resources.Strings.Mapping_FunctionImport_ImplicitMappingForAbstractReturnType), returnType.FullName, functionImport.Identity, MappingErrorCode.MappingOfAbstractType, this.m_sourceLocation, xmlLineInfo, (IList<EdmSchemaError>) this.m_parsingErrors);
          }
      ...
      out EdmFunction targetFunction)
    {
      ...
      {
        MappingItemLoader.AddToSchemaErrorWithMessage(System.Data.Entity.Resources.Strings.Mapping_FunctionImport_StoreFunctionDoesNotExist((object) resolvedAttributeValue), MappingErrorCode.MappingFunctionImportStoreFunctionDoesNotExist, this.m_sourceLocation, lineInfo, (IList<EdmSchemaError>) this.m_parsingErrors);
        return false;
      }
      if (functions.Count > 1)
      {
        MappingItemLoader.AddToSchemaErrorWithMessage(System.Data.Entity.Resources.Strings.Mapping_FunctionImport_FunctionAmbiguous((object) resolvedAttributeValue), MappingErrorCode.MappingFunctionImportStoreFunctionAmbiguous, this.m_sourceLocation, lineInfo, (IList<EdmSchemaError>) this.m_parsingErrors);
        return false;
      }
      ...
      out EdmFunction functionImport)
    {
      ...
      {
        MappingItemLoader.AddToSchemaErrorWithMessage(System.Data.Entity.Resources.Strings.Mapping_FunctionImport_FunctionImportDoesNotExist((object) resolvedAttributeValue, (object) entityContainerMapping.EdmEntityContainer.Name), MappingErrorCode.MappingFunctionImportFunctionImportDoesNotExist, this.m_sourceLocation, lineInfo, (IList<EdmSchemaError>) this.m_parsingErrors);
        return false;
      }
      if (!entityContainerMapping.TryGetFunctionImportMapping(functionImport, out FunctionImportMapping _))
        return true;
      MappingItemLoader.AddToSchemaErrorWithMessage(System.Data.Entity.Resources.Strings.Mapping_FunctionImport_FunctionImportMappedMultipleTimes((object) resolvedAttributeValue), MappingErrorCode.MappingFunctionImportFunctionImportMappedMultipleTimes, this.m_sourceLocation, lineInfo, (IList<EdmSchemaError>) this.m_parsingErrors);
      return false;
    }
      ...
      EdmFunction functionImport)
    {
      ...
      foreach (FunctionParameter parameter in targetFunction.Parameters)
      {
        ...
        else
        {
          ...
          if (edmType == null)
          {
            MappingItemLoader.AddToSchemaErrorWithMessage(System.Data.Entity.Resources.Strings.Mapping_ProviderReturnsNullType((object) parameter.Name), MappingErrorCode.MappingStoreProviderReturnsNullEdmType, this.m_sourceLocation, lineInfo, (IList<EdmSchemaError>) this.m_parsingErrors);
            return;
          }
          if (edmType.PrimitiveTypeKind != type.PrimitiveTypeKind)
            MappingItemLoader.AddToSchemaErrorWithMessage(Helper.IsEnumType(functionParameter.TypeUsage.EdmType) ? System.Data.Entity.Resources.Strings.Mapping_FunctionImport_IncompatibleEnumParameterType((object) parameter.Name, (object) edmType.Name, (object) functionParameter.TypeUsage.EdmType.FullName, (object) Helper.GetUnderlyingEdmTypeForEnumType(functionParameter.TypeUsage.EdmType).Name) : System.Data.Entity.Resources.Strings.Mapping_FunctionImport_IncompatibleParameterType((object) parameter.Name, (object) edmType.Name, (object) type.Name), MappingErrorCode.MappingFunctionImportIncompatibleParameterType, this.m_sourceLocation, lineInfo, (IList<EdmSchemaError>) this.m_parsingErrors);
        }
      }
      foreach (FunctionParameter parameter in functionImport.Parameters)
      {
        if (!targetFunction.Parameters.TryGetValue(parameter.Name, false, out FunctionParameter _))
          MappingItemLoader.AddToSchemaErrorWithMessage(System.Data.Entity.Resources.Strings.Mapping_FunctionImport_ImportParameterHasNoCorrespondingTargetParameter((object) parameter.Name), MappingErrorCode.MappingFunctionImportImportParameterHasNoCorrespondingTargetParameter, this.m_sourceLocation, lineInfo, (IList<EdmSchemaError>) this.m_parsingErrors);
      }
    }
      ...
      if (nav.MoveToChild(XPathNodeType.Element))
      {
        do
        {
          ...
          if (nav.LocalName == "EntityTypeMapping")
          {
            ...
            {
              if (entitySet == null)
                MappingItemLoader.AddToSchemaErrors(System.Data.Entity.Resources.Strings.Mapping_FunctionImport_EntityTypeMappingForFunctionNotReturningEntitySet((object) "EntityTypeMapping", (object) functionImport.Identity), MappingErrorCode.MappingFunctionImportEntityTypeMappingForFunctionNotReturningEntitySet, this.m_sourceLocation, functionImportMappingLineInfo, (IList<EdmSchemaError>) this.m_parsingErrors);
              FunctionImportEntityTypeMapping typeMapping;
              if (this.TryLoadFunctionImportEntityTypeMapping(nav.Clone(), resultEntityType, (Func<System.Data.Entity.Core.Metadata.Edm.EntityType, string>) (e => System.Data.Entity.Resources.Strings.Mapping_FunctionImport_InvalidContentEntityTypeForEntitySet((object) e.FullName, (object) resultEntityType.FullName, (object) entitySet.Name, (object) functionImport.Identity)), out typeMapping))
                structuralTypeMappingList.Add((FunctionImportStructuralTypeMapping) typeMapping);
            }
            else
              MappingItemLoader.AddToSchemaErrors(System.Data.Entity.Resources.Strings.Mapping_FunctionImport_ResultMapping_InvalidCTypeETExpected((object) functionImport.Identity), MappingErrorCode.MappingFunctionImportUnexpectedEntityTypeMapping, this.m_sourceLocation, functionImportMappingLineInfo, (IList<EdmSchemaError>) this.m_parsingErrors);
          }
          else if (nav.LocalName == "ComplexTypeMapping")
          {
            ...
            if (MetadataHelper.TryGetFunctionImportReturnType<ComplexType>(functionImport, resultSetIndex, out returnType))
            {
              ...
              MappingItemLoader.AddToSchemaErrors(System.Data.Entity.Resources.Strings.Mapping_FunctionImport_ResultMapping_InvalidCTypeCTExpected((object) functionImport.Identity), MappingErrorCode.MappingFunctionImportUnexpectedComplexTypeMapping, this.m_sourceLocation, functionImportMappingLineInfo, (IList<EdmSchemaError>) this.m_parsingErrors);
          }
        }
        while (nav.MoveToNext(XPathNodeType.Element));
      }
      ...
      out FunctionImportComplexTypeMapping typeMapping)
    {
      ...
      if (!this.TryParseComplexTypeAttribute(nav, resultComplexType, functionImport, out complexType))
        return false;
      Collection<FunctionImportReturnTypePropertyMapping> properties = new Collection<FunctionImportReturnTypePropertyMapping>();
      XPathNavigator nav1 = nav.Clone();
      List<StructuralType> structuralTypeList = new List<StructuralType>();
      structuralTypeList.Add((StructuralType) complexType);
      Collection<FunctionImportReturnTypePropertyMapping> columnRenameMappings = properties;
      if (!this.LoadFunctionImportStructuralType(nav1, (IEnumerable<StructuralType>) structuralTypeList, columnRenameMappings, (List<FunctionImportEntityTypeMappingCondition>) null))
        return false;
      typeMapping = new FunctionImportComplexTypeMapping(complexType, properties, lineInfo);
      return true;
    }
      ...
      out ComplexType complexType)
    {
      ...
      {
        MappingItemLoader.AddToSchemaErrorsWithMemberInfo(new Func<object, string>(System.Data.Entity.Resources.Strings.Mapping_InvalidContent_Complex_Type), aliasResolvedValue, MappingErrorCode.InvalidComplexType, this.m_sourceLocation, lineInfo, (IList<EdmSchemaError>) this.m_parsingErrors);
        return false;
      }
      if (Helper.IsAssignableFrom((EdmType) resultComplexType, (EdmType) complexType))
        return true;
      MappingItemLoader.AddToSchemaErrorWithMessage(System.Data.Entity.Resources.Strings.Mapping_FunctionImport_ResultMapping_MappedTypeDoesNotMatchReturnType((object) functionImport.Identity, (object) complexType.FullName), MappingErrorCode.InvalidComplexType, this.m_sourceLocation, lineInfo, (IList<EdmSchemaError>) this.m_parsingErrors);
      return false;
    }
      ...
      List<FunctionImportEntityTypeMappingCondition> conditions)
    {
      ...
      if (conditions != null)
      {
        ...
        foreach (FunctionImportEntityTypeMappingCondition condition in conditions)
        {
          ...
          {
            MappingItemLoader.AddToSchemaErrorWithMessage(System.Data.Entity.Resources.Strings.Mapping_InvalidContent_Duplicate_Condition_Member((object) condition.ColumnName), MappingErrorCode.ConditionError, this.m_sourceLocation, lineInfo, (IList<EdmSchemaError>) this.m_parsingErrors);
            flag = true;
          }
        }
      }
      ...
      IEnumerable<StructuralType> currentTypes)
    {
      ...
      if (!currentTypes.All<StructuralType>((Func<StructuralType, bool>) (t => t.Members.Contains(memberName))))
        MappingItemLoader.AddToSchemaErrorWithMessage(System.Data.Entity.Resources.Strings.Mapping_InvalidContent_Cdm_Member((object) memberName), MappingErrorCode.InvalidEdmMember, this.m_sourceLocation, (IXmlLineInfo) lineInfo, (IList<EdmSchemaError>) this.m_parsingErrors);
      if (columnRenameMappings.Any<FunctionImportReturnTypePropertyMapping>((Func<FunctionImportReturnTypePropertyMapping, bool>) (m => m.CMember == memberName)))
        MappingItemLoader.AddToSchemaErrorWithMessage(System.Data.Entity.Resources.Strings.Mapping_InvalidContent_Duplicate_Cdm_Member((object) memberName), MappingErrorCode.DuplicateMemberMapping, this.m_sourceLocation, (IXmlLineInfo) lineInfo, (IList<EdmSchemaError>) this.m_parsingErrors);
      else
      ...
      List<FunctionImportEntityTypeMappingCondition> conditions)
    {
      ...
      if (resolvedAttributeValue3 != null && resolvedAttributeValue2 != null)
        MappingItemLoader.AddToSchemaErrors(System.Data.Entity.Resources.Strings.Mapping_InvalidContent_ConditionMapping_Both_Values, MappingErrorCode.ConditionError, this.m_sourceLocation, (IXmlLineInfo) lineInfo, (IList<EdmSchemaError>) this.m_parsingErrors);
      else if (resolvedAttributeValue3 == null && resolvedAttributeValue2 == null)
        MappingItemLoader.AddToSchemaErrors(System.Data.Entity.Resources.Strings.Mapping_InvalidContent_ConditionMapping_Either_Values, MappingErrorCode.ConditionError, this.m_sourceLocation, (IXmlLineInfo) lineInfo, (IList<EdmSchemaError>) this.m_parsingErrors);
      ...
      System.Data.Entity.Core.Metadata.Edm.EntityContainer storageEntityContainerType)
    {
      ...
      if (relation == null)
        MappingItemLoader.AddToSchemaErrorsWithMemberInfo(new Func<object, string>(System.Data.Entity.Resources.Strings.Mapping_InvalidContent_Association_Type), associationTypeName, MappingErrorCode.InvalidAssociationType, this.m_sourceLocation, lineInfo, (IList<EdmSchemaError>) this.m_parsingErrors);
      else if (!associationSetMapping.Set.ElementType.Equals((object) relation))
      {
        MappingItemLoader.AddToSchemaErrorWithMessage(System.Data.Entity.Resources.Strings.Mapping_Invalid_Association_Type_For_Association_Set((object) associationTypeName, (object) associationSetMapping.Set.ElementType.FullName, (object) associationSetMapping.Set.Name), MappingErrorCode.DuplicateTypeMapping, this.m_sourceLocation, lineInfo, (IList<EdmSchemaError>) this.m_parsingErrors);
      }
      else
      {
        ...
        {
          MappingItemLoader.AddToSchemaErrors(System.Data.Entity.Resources.Strings.Mapping_InvalidContent_Table_Expected, MappingErrorCode.InvalidTable, this.m_sourceLocation, lineInfo, (IList<EdmSchemaError>) this.m_parsingErrors);
        }
        else
        {
      ...
      bool distinctFlag)
    {
      ...
      {
        MappingItemLoader.AddToSchemaErrorsWithMemberInfo(new Func<object, string>(System.Data.Entity.Resources.Strings.Mapping_QueryView_PropertyMaps), typeMapping.SetMapping.Set.Name, MappingErrorCode.PropertyMapsWithQueryView, this.m_sourceLocation, navLineInfo, (IList<EdmSchemaError>) this.m_parsingErrors);
      ...
      if (entitySet == null)
      {
        MappingItemLoader.AddToSchemaErrorsWithMemberInfo(new Func<object, string>(System.Data.Entity.Resources.Strings.Mapping_InvalidContent_Table), tableName, MappingErrorCode.InvalidTable, this.m_sourceLocation, navLineInfo, (IList<EdmSchemaError>) this.m_parsingErrors);
        return (MappingFragment) null;
      }
        ...
        do
        {
          ...
          switch (nav.LocalName)
          {
            ...
            case "Condition":
              ...
              {
                mappingFragment.AddConditionProperty(conditionPropertyMap, (System.Action<EdmMember>) (member => MappingItemLoader.AddToSchemaErrorsWithMemberInfo(new Func<object, string>(System.Data.Entity.Resources.Strings.Mapping_InvalidContent_Duplicate_Condition_Member), member.Name, MappingErrorCode.ConditionError, this.m_sourceLocation, navLineInfo, (IList<EdmSchemaError>) this.m_parsingErrors)));
                break;
              }
              break;
            default:
              MappingItemLoader.AddToSchemaErrors(System.Data.Entity.Resources.Strings.Mapping_InvalidContent_General, MappingErrorCode.InvalidContent, this.m_sourceLocation, navLineInfo, (IList<EdmSchemaError>) this.m_parsingErrors);
              break;
          }
        }
        while (nav.MoveToNext(XPathNodeType.Element));
      ...
      do
      {
        switch (nav.LocalName)
        {
          case "EndProperty":
            if (setMapping.QueryView != null)
            {
              MappingItemLoader.AddToSchemaErrorsWithMemberInfo(new Func<object, string>(System.Data.Entity.Resources.Strings.Mapping_QueryView_PropertyMaps), setMapping.Set.Name, MappingErrorCode.PropertyMapsWithQueryView, this.m_sourceLocation, navLineInfo, (IList<EdmSchemaError>) this.m_parsingErrors);
              return (MappingFragment) null;
            }
            ...
            if (!(edmMember is AssociationEndMember end3))
            {
              MappingItemLoader.AddToSchemaErrorsWithMemberInfo(new Func<object, string>(System.Data.Entity.Resources.Strings.Mapping_InvalidContent_End), resolvedAttributeValue, MappingErrorCode.InvalidEdmMember, this.m_sourceLocation, navLineInfo, (IList<EdmSchemaError>) this.m_parsingErrors);
              break;
            }
            mappingFragment.AddPropertyMapping((PropertyMapping) this.LoadEndPropertyMapping(nav.Clone(), end3, tableType));
            break;
          case "Condition":
            if (setMapping.QueryView != null)
            {
      ...
      ReadOnlyMetadataCollection<EdmProperty> tableProperties)
    {
      ...
      if (!string.IsNullOrEmpty(resolvedAttributeValue1) && (containerType == null || !Helper.IsCollectionType((GlobalItem) containerType)))
      {
        ...
        if (edmProperty1 == null)
          MappingItemLoader.AddToSchemaErrorsWithMemberInfo(new Func<object, string>(System.Data.Entity.Resources.Strings.Mapping_InvalidContent_Cdm_Member), resolvedAttributeValue1, MappingErrorCode.InvalidEdmMember, this.m_sourceLocation, lineInfo, (IList<EdmSchemaError>) this.m_parsingErrors);
      }
      ...
      if (edmProperty2 == null)
        MappingItemLoader.AddToSchemaErrorsWithMemberInfo(new Func<object, string>(System.Data.Entity.Resources.Strings.Mapping_InvalidContent_Column), resolvedAttributeValue2, MappingErrorCode.InvalidStorageMember, this.m_sourceLocation, lineInfo, (IList<EdmSchemaError>) this.m_parsingErrors);
      ...
      {
        this.m_parsingErrors.Add(new EdmSchemaError(System.Data.Entity.Resources.Strings.Mapping_Invalid_CSide_ScalarProperty((object) edmProperty1.Name), 2085, EdmSchemaErrorSeverity.Error, this.m_sourceLocation, lineInfo.LineNumber, lineInfo.LinePosition));
        return (ScalarPropertyMapping) null;
      }
      ...
      ReadOnlyMetadataCollection<EdmProperty> tableProperties)
    {
      ...
      if (string.IsNullOrEmpty(resolvedAttributeValue2))
      {
        if (collectionType == null)
        {
          if (structuralType != null)
          {
            ...
            if (!(edmMember is EdmProperty property4))
              MappingItemLoader.AddToSchemaErrorsWithMemberInfo(new Func<object, string>(System.Data.Entity.Resources.Strings.Mapping_InvalidContent_Cdm_Member), resolvedAttributeValue1, MappingErrorCode.InvalidEdmMember, this.m_sourceLocation, lineInfo, (IList<EdmSchemaError>) this.m_parsingErrors);
            type = property4.TypeUsage.EdmType;
          }
          else
            MappingItemLoader.AddToSchemaErrorsWithMemberInfo(new Func<object, string>(System.Data.Entity.Resources.Strings.Mapping_InvalidContent_Cdm_Member), resolvedAttributeValue1, MappingErrorCode.InvalidEdmMember, this.m_sourceLocation, lineInfo, (IList<EdmSchemaError>) this.m_parsingErrors);
        }
      ...
      else
      {
        if (containerType != null)
        {
          EdmMember edmMember;
          structuralType.Members.TryGetValue(resolvedAttributeValue1, false, out edmMember);
          property4 = edmMember as EdmProperty;
        }
        if (property4 == null)
          MappingItemLoader.AddToSchemaErrorsWithMemberInfo(new Func<object, string>(System.Data.Entity.Resources.Strings.Mapping_InvalidContent_Cdm_Member), resolvedAttributeValue1, MappingErrorCode.InvalidEdmMember, this.m_sourceLocation, lineInfo, (IList<EdmSchemaError>) this.m_parsingErrors);
        ...
        if (type == null)
          MappingItemLoader.AddToSchemaErrorsWithMemberInfo(new Func<object, string>(System.Data.Entity.Resources.Strings.Mapping_InvalidContent_Complex_Type), resolvedAttributeValue2, MappingErrorCode.InvalidComplexType, this.m_sourceLocation, lineInfo, (IList<EdmSchemaError>) this.m_parsingErrors);
      }
      ComplexPropertyMapping complexPropertyMapping = new ComplexPropertyMapping(property4);
      ...
      ReadOnlyMetadataCollection<EdmProperty> tableType)
    {
      ...
      else
      {
        ...
        do
        {
          ...
          if (type1 == null)
          {
            MappingItemLoader.AddToSchemaErrorsWithMemberInfo(new Func<object, string>(System.Data.Entity.Resources.Strings.Mapping_InvalidContent_Complex_Type), str2, MappingErrorCode.InvalidComplexType, this.m_sourceLocation, (IXmlLineInfo) nav, (IList<EdmSchemaError>) this.m_parsingErrors);
            length = str1.IndexOf(';');
          }
          else
          {
        ...
        switch (nav.LocalName)
        {
          case "ScalarProperty":
            ...
            if (propertyMapping != null)
            {
              ...
              {
                IXmlLineInfo lineInfo = (IXmlLineInfo) nav;
                MappingItemLoader.AddToSchemaErrorsWithMemberInfo(new Func<object, string>(System.Data.Entity.Resources.Strings.Mapping_InvalidContent_EndProperty), propertyMapping.Property.Name, MappingErrorCode.InvalidEdmMember, this.m_sourceLocation, lineInfo, (IList<EdmSchemaError>) this.m_parsingErrors);
      ...
      ReadOnlyMetadataCollection<EdmProperty> tableProperties)
    {
      ...
      {
        MappingItemLoader.AddToSchemaErrors(System.Data.Entity.Resources.Strings.Mapping_InvalidContent_ConditionMapping_Both_Members, MappingErrorCode.ConditionError, this.m_sourceLocation, lineInfo, (IList<EdmSchemaError>) this.m_parsingErrors);
        return (ConditionPropertyMapping) null;
      }
      if (resolvedAttributeValue1 == null && resolvedAttributeValue2 == null)
      {
        MappingItemLoader.AddToSchemaErrors(System.Data.Entity.Resources.Strings.Mapping_InvalidContent_ConditionMapping_Either_Members, MappingErrorCode.ConditionError, this.m_sourceLocation, lineInfo, (IList<EdmSchemaError>) this.m_parsingErrors);
        return (ConditionPropertyMapping) null;
      }
      EdmProperty edmProperty1 = (EdmProperty) null;
      ...
      {
        MappingItemLoader.AddToSchemaErrorsWithMemberInfo(new Func<object, string>(System.Data.Entity.Resources.Strings.Mapping_InvalidContent_ConditionMapping_InvalidMember), resolvedAttributeValue2 ?? resolvedAttributeValue1, MappingErrorCode.ConditionError, this.m_sourceLocation, lineInfo, (IList<EdmSchemaError>) this.m_parsingErrors);
        return (ConditionPropertyMapping) null;
      }
      ...
      if (Helper.IsPrimitiveType(edmType1))
      {
        ...
        if (propertyOrColumn.DeclaringType.DataSpace == DataSpace.SSpace)
        {
          ...
          if (typeUsage == null)
          {
            MappingItemLoader.AddToSchemaErrorWithMessage(System.Data.Entity.Resources.Strings.Mapping_ProviderReturnsNullType((object) propertyOrColumn.Name), MappingErrorCode.MappingStoreProviderReturnsNullEdmType, this.m_sourceLocation, lineInfo, (IList<EdmSchemaError>) this.m_parsingErrors);
            return (ConditionPropertyMapping) null;
          }
        }
        else
        ...
        {
          MappingItemLoader.AddToSchemaErrorWithMemberAndStructure(new Func<object, object, string>(System.Data.Entity.Resources.Strings.Mapping_InvalidContent_ConditionMapping_InvalidPrimitiveTypeKind), propertyOrColumn.Name, edmType1.FullName, MappingErrorCode.ConditionError, this.m_sourceLocation, lineInfo, (IList<EdmSchemaError>) this.m_parsingErrors);
          return (ConditionPropertyMapping) null;
        }
      ...
      {
        MappingItemLoader.AddToSchemaErrors(System.Data.Entity.Resources.Strings.Mapping_InvalidContent_ConditionMapping_NonScalar, MappingErrorCode.ConditionError, this.m_sourceLocation, lineInfo, (IList<EdmSchemaError>) this.m_parsingErrors);
        return (ConditionPropertyMapping) null;
      }
      if (attributeValue != null && obj != null)
      {
        MappingItemLoader.AddToSchemaErrors(System.Data.Entity.Resources.Strings.Mapping_InvalidContent_ConditionMapping_Both_Values, MappingErrorCode.ConditionError, this.m_sourceLocation, lineInfo, (IList<EdmSchemaError>) this.m_parsingErrors);
        return (ConditionPropertyMapping) null;
      }
      if (attributeValue == null && obj == null)
      {
        MappingItemLoader.AddToSchemaErrors(System.Data.Entity.Resources.Strings.Mapping_InvalidContent_ConditionMapping_Either_Values, MappingErrorCode.ConditionError, this.m_sourceLocation, lineInfo, (IList<EdmSchemaError>) this.m_parsingErrors);
        return (ConditionPropertyMapping) null;
      }
      if (attributeValue != null)
      ...
      {
        MappingItemLoader.AddToSchemaErrorsWithMemberInfo(new Func<object, string>(System.Data.Entity.Resources.Strings.Mapping_InvalidContent_ConditionMapping_Computed), edmProperty2.Name, MappingErrorCode.ConditionError, this.m_sourceLocation, lineInfo, (IList<EdmSchemaError>) this.m_parsingErrors);
        return (ConditionPropertyMapping) null;
      }
      return obj == null ? (ConditionPropertyMapping) new IsNullConditionMapping(propertyOrColumn, nullable.Value) : (ConditionPropertyMapping) new ValueConditionMapping(propertyOrColumn, obj);
    }
    ...
    private string GetAliasResolvedAttributeValue(XPathNavigator nav, string attributeName) => this.GetAliasResolvedValue(MappingItemLoader.GetAttributeValue(nav, attributeName));
    ...
    private static string GetAttributeValue(XPathNavigator nav, string attributeName) => Helper.GetAttributeValue(nav, attributeName);
      ...
      out object value)
    {
      ...
      {
        MappingItemLoader.AddToSchemaErrors(System.Data.Entity.Resources.Strings.Mapping_ConditionValueTypeMismatch, MappingErrorCode.ConditionError, sourceLocation, (IXmlLineInfo) nav, parsingErrors);
        return false;
      }
      return true;
    }
      ...
      IList<EdmSchemaError> parsingErrors)
    {
      ...
      if (string.IsNullOrEmpty(attributeValue))
        MappingItemLoader.AddToSchemaErrorsWithMemberInfo(new Func<object, string>(System.Data.Entity.Resources.Strings.Mapping_Enum_EmptyValue), enumType.FullName, MappingErrorCode.InvalidEnumValue, sourceLocation, lineInfo, parsingErrors);
      EnumMember enumMember;
      if (!enumType.Members.TryGetValue(attributeValue, false, out enumMember))
        MappingItemLoader.AddToSchemaErrorsWithMemberInfo(new Func<object, string>(System.Data.Entity.Resources.Strings.Mapping_Enum_InvalidValue), attributeValue, MappingErrorCode.InvalidEnumValue, sourceLocation, lineInfo, parsingErrors);
      return enumMember;
    }

    private string GetAliasResolvedValue(string aliasedString)
    {
      switch (aliasedString)
      {
        case "":
        case null:
    ...
    private void XsdValidationCallBack(object sender, ValidationEventArgs args)
    {
      ...
      this.m_parsingErrors.Add(new EdmSchemaError(System.Data.Entity.Resources.Strings.Mapping_InvalidMappingSchema_validation((object) args.Exception.Message), 2025, severity, schemaLocation, args.Exception.LineNumber, args.Exception.LinePosition));
    }
      ...
      IXmlLineInfo lineInfo)
    {
      ...
      else
      {
        ...
        if (columnMember.TypeUsage.EdmType != typeUsage.EdmType)
        {
          this.m_parsingErrors.Add(new EdmSchemaError(System.Data.Entity.Resources.Strings.Mapping_StoreTypeMismatch_ScalarPropertyMapping((object) member.Name, (object) typeUsage.EdmType.Name), 2039, EdmSchemaErrorSeverity.Error, this.m_sourceLocation, lineInfo.LineNumber, lineInfo.LinePosition));
        }
        else
        {
    ...
    internal static TypeUsage ResolveTypeUsageForEnums(TypeUsage typeUsage) => !Helper.IsEnumType(typeUsage.EdmType) ? typeUsage : TypeUsage.Create((EdmType) Helper.GetUnderlyingEdmTypeForEnumType(typeUsage.EdmType), (IEnumerable<Facet>) typeUsage.Facets);
    ...
    private class ModificationFunctionMappingLoader
    {
        ...
        System.Data.Entity.Core.Metadata.Edm.EntityType entityType)
      {
        ...
        if (nav.MoveToChild(XPathNodeType.Element))
        {
          do
          {
            if (nav.LocalName == "ResultBinding")
            {
              ...
              {
                MappingItemLoader.AddToSchemaErrorWithMemberAndStructure(new Func<object, object, string>(System.Data.Entity.Resources.Strings.Mapping_ModificationFunction_PropertyNotFound), resolvedAttributeValue1, entityType.Name, MappingErrorCode.InvalidEdmMember, this.m_parentLoader.m_sourceLocation, lineInfo, (IList<EdmSchemaError>) this.m_parentLoader.m_parsingErrors);
        ...
        foreach (EdmProperty key in keyToListMap.Keys)
        {
          ...
          {
            MappingItemLoader.AddToSchemaErrorWithMemberAndStructure(new Func<object, object, string>(System.Data.Entity.Resources.Strings.Mapping_ModificationFunction_AmbiguousResultBinding), key.Name, StringUtil.ToCommaSeparatedString((IEnumerable) readOnlyCollection), MappingErrorCode.AmbiguousResultBindingInModificationFunctionMapping, this.m_parentLoader.m_sourceLocation, lineInfo, (IList<EdmSchemaError>) this.m_parentLoader.m_parsingErrors);
            return (IEnumerable<ModificationFunctionResultBinding>) new List<ModificationFunctionResultBinding>();
          }
        }
        ...
        StructuralType type)
      {
        ...
        MappingItemLoader.AddToSchemaErrorWithMemberAndStructure(new Func<object, object, string>(System.Data.Entity.Resources.Strings.Mapping_ModificationFunction_MissingParameter), this.m_function.FullName, StringUtil.ToCommaSeparatedString((IEnumerable) set), MappingErrorCode.InvalidParameterInModificationFunctionMapping, this.m_parentLoader.m_sourceLocation, (IXmlLineInfo) nav, (IList<EdmSchemaError>) this.m_parentLoader.m_parsingErrors);
        ...
        bool restrictToKeyMembers)
      {
        if (nav.MoveToChild(XPathNodeType.Element))
        {
          do
          {
            ...
            {
              case "ScalarProperty":
                ModificationFunctionParameterBinding parameterBinding1 = this.LoadScalarPropertyParameterBinding(nav.Clone(), type, restrictToKeyMembers);
                ...
                {
                  yield return parameterBinding1;
                  break;
                }
              case "ComplexProperty":
                ComplexType complexType;
                ...
                if (edmMember != null)
                {
                  ...
                  foreach (ModificationFunctionParameterBinding parameterBinding2 in this.LoadParameterBindings(nav.Clone(), (StructuralType) complexType, restrictToKeyMembers))
                    yield return parameterBinding2;
                  this.m_members.Pop();
                  break;
                }
                break;
              case "AssociationEnd":
                AssociationSetEnd associationSetEnd1 = this.LoadAssociationEnd(nav.Clone());
                if (associationSetEnd1 != null)
                {
                  this.m_members.Push((EdmMember) associationSetEnd1.CorrespondingAssociationEndMember);
                  this.m_associationSetNavigation = associationSetEnd1.ParentAssociationSet;
                  foreach (ModificationFunctionParameterBinding parameterBinding2 in this.LoadParameterBindings(nav.Clone(), (StructuralType) associationSetEnd1.EntitySet.ElementType, true))
                    yield return parameterBinding2;
                ...
                break;
              case "EndProperty":
                AssociationSetEnd associationSetEnd2 = this.LoadEndProperty(nav.Clone());
                if (associationSetEnd2 != null)
                {
                  this.m_members.Push((EdmMember) associationSetEnd2.CorrespondingAssociationEndMember);
                  foreach (ModificationFunctionParameterBinding parameterBinding2 in this.LoadParameterBindings(nav.Clone(), (StructuralType) associationSetEnd2.EntitySet.ElementType, true))
                    yield return parameterBinding2;
                  this.m_members.Pop();
                  break;
                }
      ...
      private AssociationSetEnd LoadAssociationEnd(XPathNavigator nav)
      {
        ...
        {
          MappingItemLoader.AddToSchemaErrorsWithMemberInfo(new Func<object, string>(System.Data.Entity.Resources.Strings.Mapping_ModificationFunction_AssociationSetDoesNotExist), resolvedAttributeValue1, MappingErrorCode.InvalidAssociationSet, this.m_parentLoader.m_sourceLocation, lineInfo, (IList<EdmSchemaError>) this.m_parentLoader.m_parsingErrors);
        ...
        {
          MappingItemLoader.AddToSchemaErrorsWithMemberInfo(new Func<object, string>(System.Data.Entity.Resources.Strings.Mapping_ModificationFunction_AssociationSetRoleDoesNotExist), resolvedAttributeValue2, MappingErrorCode.InvalidAssociationSetRoleInModificationFunctionMapping, this.m_parentLoader.m_sourceLocation, lineInfo, (IList<EdmSchemaError>) this.m_parentLoader.m_parsingErrors);
          return (AssociationSetEnd) null;
        }
        ...
        {
          MappingItemLoader.AddToSchemaErrorsWithMemberInfo(new Func<object, string>(System.Data.Entity.Resources.Strings.Mapping_ModificationFunction_AssociationSetFromRoleIsNotEntitySet), resolvedAttributeValue2, MappingErrorCode.InvalidAssociationSetRoleInModificationFunctionMapping, this.m_parentLoader.m_sourceLocation, lineInfo, (IList<EdmSchemaError>) this.m_parentLoader.m_parsingErrors);
          return (AssociationSetEnd) null;
        }
        ...
        {
          MappingItemLoader.AddToSchemaErrorsWithMemberInfo(new Func<object, string>(System.Data.Entity.Resources.Strings.Mapping_ModificationFunction_AssociationSetCardinality), resolvedAttributeValue3, MappingErrorCode.InvalidAssociationSetCardinalityInModificationFunctionMapping, this.m_parentLoader.m_sourceLocation, lineInfo, (IList<EdmSchemaError>) this.m_parentLoader.m_parsingErrors);
          return (AssociationSetEnd) null;
        }
        if (associationSet.ElementType.IsForeignKey)
        {
          ...
          EdmSchemaError errorsWithMemberInfo = MappingItemLoader.AddToSchemaErrorsWithMemberInfo(new Func<object, string>(System.Data.Entity.Resources.Strings.Mapping_ModificationFunction_AssociationEndMappingForeignKeyAssociation), resolvedAttributeValue3, MappingErrorCode.InvalidModificationFunctionMappingAssociationEndForeignKey, this.m_parentLoader.m_sourceLocation, lineInfo, (IList<EdmSchemaError>) this.m_parentLoader.m_parsingErrors);
        ...
        out ComplexType complexType)
      {
        ...
        {
          MappingItemLoader.AddToSchemaErrorWithMemberAndStructure(new Func<object, object, string>(System.Data.Entity.Resources.Strings.Mapping_ModificationFunction_PropertyNotFound), resolvedAttributeValue1, type.Name, MappingErrorCode.InvalidEdmMember, this.m_parentLoader.m_sourceLocation, lineInfo, (IList<EdmSchemaError>) this.m_parentLoader.m_parsingErrors);
        ...
        {
          MappingItemLoader.AddToSchemaErrorsWithMemberInfo(new Func<object, string>(System.Data.Entity.Resources.Strings.Mapping_ModificationFunction_ComplexTypeNotFound), resolvedAttributeValue2, MappingErrorCode.InvalidComplexType, this.m_parentLoader.m_sourceLocation, lineInfo, (IList<EdmSchemaError>) this.m_parentLoader.m_parsingErrors);
          return (EdmMember) null;
        }
        if (edmMember.TypeUsage.EdmType.Equals((object) complexType) || Helper.IsSubtypeOf(edmMember.TypeUsage.EdmType, (EdmType) complexType))
          return edmMember;
        MappingItemLoader.AddToSchemaErrorWithMemberAndStructure(new Func<object, object, string>(System.Data.Entity.Resources.Strings.Mapping_ModificationFunction_WrongComplexType), resolvedAttributeValue2, edmMember.Name, MappingErrorCode.InvalidComplexType, this.m_parentLoader.m_sourceLocation, lineInfo, (IList<EdmSchemaError>) this.m_parentLoader.m_parsingErrors);
        return (EdmMember) null;
      }
        ...
        bool restrictToKeyMembers)
      {
        ...
        if (resolvedAttributeValue3 == null)
        {
          ...
          {
            MappingItemLoader.AddToSchemaErrors(System.Data.Entity.Resources.Strings.Mapping_ModificationFunction_MissingVersion, MappingErrorCode.MissingVersionInModificationFunctionMapping, this.m_parentLoader.m_sourceLocation, lineInfo, (IList<EdmSchemaError>) this.m_parentLoader.m_parsingErrors);
        ...
        {
          MappingItemLoader.AddToSchemaErrors(System.Data.Entity.Resources.Strings.Mapping_ModificationFunction_VersionMustBeOriginal, MappingErrorCode.InvalidVersionInModificationFunctionMapping, this.m_parentLoader.m_sourceLocation, lineInfo, (IList<EdmSchemaError>) this.m_parentLoader.m_parsingErrors);
          return (ModificationFunctionParameterBinding) null;
        }
        if (!isCurrent && !this.m_allowOriginalVersion)
        {
          MappingItemLoader.AddToSchemaErrors(System.Data.Entity.Resources.Strings.Mapping_ModificationFunction_VersionMustBeCurrent, MappingErrorCode.InvalidVersionInModificationFunctionMapping, this.m_parentLoader.m_sourceLocation, lineInfo, (IList<EdmSchemaError>) this.m_parentLoader.m_parsingErrors);
          return (ModificationFunctionParameterBinding) null;
        }
        ...
        {
          MappingItemLoader.AddToSchemaErrorWithMemberAndStructure(new Func<object, object, string>(System.Data.Entity.Resources.Strings.Mapping_ModificationFunction_ParameterNotFound), resolvedAttributeValue1, this.m_function.Name, MappingErrorCode.InvalidParameterInModificationFunctionMapping, this.m_parentLoader.m_sourceLocation, lineInfo, (IList<EdmSchemaError>) this.m_parentLoader.m_parsingErrors);
          return (ModificationFunctionParameterBinding) null;
        }
        EdmMember edmMember = (EdmMember) null;
        if (restrictToKeyMembers)
        {
          ...
          {
            MappingItemLoader.AddToSchemaErrorWithMemberAndStructure(new Func<object, object, string>(System.Data.Entity.Resources.Strings.Mapping_ModificationFunction_PropertyNotKey), resolvedAttributeValue2, type.Name, MappingErrorCode.InvalidEdmMember, this.m_parentLoader.m_sourceLocation, lineInfo, (IList<EdmSchemaError>) this.m_parentLoader.m_parsingErrors);
            return (ModificationFunctionParameterBinding) null;
          }
        }
        else if (resolvedAttributeValue2 == null || !type.Members.TryGetValue(resolvedAttributeValue2, false, out edmMember))
        {
          MappingItemLoader.AddToSchemaErrorWithMemberAndStructure(new Func<object, object, string>(System.Data.Entity.Resources.Strings.Mapping_ModificationFunction_PropertyNotFound), resolvedAttributeValue2, type.Name, MappingErrorCode.InvalidEdmMember, this.m_parentLoader.m_sourceLocation, lineInfo, (IList<EdmSchemaError>) this.m_parentLoader.m_parsingErrors);
          return (ModificationFunctionParameterBinding) null;
        }
        if (this.m_seenParameters.Contains(functionParameter))
        {
          MappingItemLoader.AddToSchemaErrorsWithMemberInfo(new Func<object, string>(System.Data.Entity.Resources.Strings.Mapping_ModificationFunction_ParameterBoundTwice), resolvedAttributeValue1, MappingErrorCode.ParameterBoundTwiceInModificationFunctionMapping, this.m_parentLoader.m_sourceLocation, lineInfo, (IList<EdmSchemaError>) this.m_parentLoader.m_parsingErrors);
          return (ModificationFunctionParameterBinding) null;
        }
        ...
        if (Helper.ValidateAndConvertTypeUsage(edmMember.TypeUsage, functionParameter.TypeUsage) == null && count == this.m_parentLoader.m_parsingErrors.Count)
          MappingItemLoader.AddToSchemaErrorWithMessage(System.Data.Entity.Resources.Strings.Mapping_ModificationFunction_PropertyParameterTypeMismatch((object) edmMember.TypeUsage.EdmType, (object) edmMember.Name, (object) edmMember.DeclaringType.FullName, (object) functionParameter.TypeUsage.EdmType, (object) functionParameter.Name, (object) this.m_function.FullName), MappingErrorCode.InvalidModificationFunctionMappingPropertyParameterTypeMismatch, this.m_parentLoader.m_sourceLocation, lineInfo, (IList<EdmSchemaError>) this.m_parentLoader.m_parsingErrors);
        this.m_members.Push(edmMember);
        ...
        out FunctionParameter rowsAffectedParameter)
      {
        ...
        if (functions.Count == 0)
        {
          MappingItemLoader.AddToSchemaErrorsWithMemberInfo(new Func<object, string>(System.Data.Entity.Resources.Strings.Mapping_ModificationFunction_UnknownFunction), resolvedAttributeValue, MappingErrorCode.InvalidModificationFunctionMappingUnknownFunction, this.m_parentLoader.m_sourceLocation, lineInfo, (IList<EdmSchemaError>) this.m_parentLoader.m_parsingErrors);
          return (EdmFunction) null;
        }
        if (1 < functions.Count)
        {
          MappingItemLoader.AddToSchemaErrorsWithMemberInfo(new Func<object, string>(System.Data.Entity.Resources.Strings.Mapping_ModificationFunction_AmbiguousFunction), resolvedAttributeValue, MappingErrorCode.InvalidModificationFunctionMappingAmbiguousFunction, this.m_parentLoader.m_sourceLocation, lineInfo, (IList<EdmSchemaError>) this.m_parentLoader.m_parsingErrors);
          return (EdmFunction) null;
        }
        EdmFunction function = functions[0];
        if (MetadataHelper.IsComposable(function))
        {
          MappingItemLoader.AddToSchemaErrorsWithMemberInfo(new Func<object, string>(System.Data.Entity.Resources.Strings.Mapping_ModificationFunction_NotValidFunction), resolvedAttributeValue, MappingErrorCode.InvalidModificationFunctionMappingNotValidFunction, this.m_parentLoader.m_sourceLocation, lineInfo, (IList<EdmSchemaError>) this.m_parentLoader.m_parsingErrors);
          return (EdmFunction) null;
        }
        ...
        if (!string.IsNullOrEmpty(attributeValue))
        {
          ...
          {
            MappingItemLoader.AddToSchemaErrorWithMessage(System.Data.Entity.Resources.Strings.Mapping_FunctionImport_RowsAffectedParameterDoesNotExist((object) attributeValue, (object) function.FullName), MappingErrorCode.MappingFunctionImportRowsAffectedParameterDoesNotExist, this.m_parentLoader.m_sourceLocation, lineInfo, (IList<EdmSchemaError>) this.m_parentLoader.m_parsingErrors);
            return (EdmFunction) null;
          }
          if (ParameterMode.Out != rowsAffectedParameter.Mode && ParameterMode.InOut != rowsAffectedParameter.Mode)
          {
            MappingItemLoader.AddToSchemaErrorWithMessage(System.Data.Entity.Resources.Strings.Mapping_FunctionImport_RowsAffectedParameterHasWrongMode((object) attributeValue, (object) rowsAffectedParameter.Mode, (object) ParameterMode.Out, (object) ParameterMode.InOut), MappingErrorCode.MappingFunctionImportRowsAffectedParameterHasWrongMode, this.m_parentLoader.m_sourceLocation, lineInfo, (IList<EdmSchemaError>) this.m_parentLoader.m_parsingErrors);
            return (EdmFunction) null;
          }
          ...
          {
            MappingItemLoader.AddToSchemaErrorWithMessage(System.Data.Entity.Resources.Strings.Mapping_FunctionImport_RowsAffectedParameterHasWrongType((object) attributeValue, (object) edmType.PrimitiveTypeKind), MappingErrorCode.MappingFunctionImportRowsAffectedParameterHasWrongType, this.m_parentLoader.m_sourceLocation, lineInfo, (IList<EdmSchemaError>) this.m_parentLoader.m_parsingErrors);
            return (EdmFunction) null;
          }
