...
namespace System.Data.Entity.Core.Mapping
{
  internal class DefaultObjectMappingItemCollection : MappingItemCollection
  {
    ...
    public ObjectItemCollection ObjectItemCollection => this._objectCollection;

    public EdmItemCollection EdmItemCollection => this._edmCollection;
      ...
      bool ignoreCase)
    {
      ...
      if (!this.TryGetMap(identity, typeSpace, ignoreCase, out map))
        throw new InvalidOperationException(System.Data.Entity.Resources.Strings.Mapping_Object_InvalidType((object) identity));
      return map;
    }
    ...
    internal override MappingBase GetMap(GlobalItem item)
    {
      ...
      if (!this.TryGetMap(item, out map))
        throw new InvalidOperationException(System.Data.Entity.Resources.Strings.Mapping_Object_InvalidType((object) item.Identity));
      return map;
    }
    ...
    private MappingBase GetDefaultMapping(EdmType cdmType, EdmType clrType) => (MappingBase) DefaultObjectMappingItemCollection.LoadObjectMapping(cdmType, clrType, this);
      ...
      Dictionary<string, ObjectTypeMapping> typeMappings)
    {
      if (Helper.IsEnumType(edmType) ^ Helper.IsEnumType(objectType))
        throw new MappingException(System.Data.Entity.Resources.Strings.Mapping_EnumTypeMappingToNonEnumType((object) edmType.FullName, (object) objectType.FullName));
      if (edmType.Abstract != objectType.Abstract)
        throw new MappingException(System.Data.Entity.Resources.Strings.Mapping_AbstractTypeMappingToNonAbstractType((object) edmType.FullName, (object) objectType.FullName));
      ...
      StructuralType objectType)
    {
      ...
      if (!objectType.Members.TryGetValue(edmMember.Name, false, out edmMember1))
        throw new MappingException(System.Data.Entity.Resources.Strings.Mapping_Default_OCMapping_Clr_Member((object) edmMember.Name, (object) edmMember.DeclaringType.FullName, (object) objectType.FullName));
      return edmMember1;
    }
    ...
    private static void ValidateMembersMatch(EdmMember edmMember, EdmMember objectMember)
    {
      if (edmMember.BuiltInTypeKind != objectMember.BuiltInTypeKind)
        throw new MappingException(System.Data.Entity.Resources.Strings.Mapping_Default_OCMapping_MemberKind_Mismatch((object) edmMember.Name, (object) edmMember.DeclaringType.FullName, (object) edmMember.BuiltInTypeKind, (object) objectMember.Name, (object) objectMember.DeclaringType.FullName, (object) objectMember.BuiltInTypeKind));
      if (edmMember.TypeUsage.EdmType.BuiltInTypeKind != objectMember.TypeUsage.EdmType.BuiltInTypeKind)
        throw System.Data.Entity.Resources.Error.Mapping_Default_OCMapping_Member_Type_Mismatch((object) edmMember.TypeUsage.EdmType.Name, (object) edmMember.TypeUsage.EdmType.BuiltInTypeKind, (object) edmMember.Name, (object) edmMember.DeclaringType.FullName, (object) objectMember.TypeUsage.EdmType.Name, (object) objectMember.TypeUsage.EdmType.BuiltInTypeKind, (object) objectMember.Name, (object) objectMember.DeclaringType.FullName);
      ...
      StructuralType objectStructuralType)
    {
      if (cdmStructuralType.Members.Count != objectStructuralType.Members.Count)
        throw new MappingException(System.Data.Entity.Resources.Strings.Mapping_Default_OCMapping_Member_Count_Mismatch((object) cdmStructuralType.FullName, (object) objectStructuralType.FullName));
      foreach (EdmMember member in objectStructuralType.Members)
      {
        if (!cdmStructuralType.Members.Contains(member.Identity))
          throw new MappingException(System.Data.Entity.Resources.Strings.Mapping_Default_OCMapping_Clr_Member2((object) member.Name, (object) objectStructuralType.FullName, (object) cdmStructuralType.FullName));
      }
    }
    ...
    private static void ValidateEnumTypeMapping(EnumType edmEnumType, EnumType objectEnumType)
    {
      if (edmEnumType.UnderlyingType.PrimitiveTypeKind != objectEnumType.UnderlyingType.PrimitiveTypeKind)
        throw new MappingException(System.Data.Entity.Resources.Strings.Mapping_Enum_OCMapping_UnderlyingTypesMismatch((object) edmEnumType.UnderlyingType.Name, (object) edmEnumType.FullName, (object) objectEnumType.UnderlyingType.Name, (object) objectEnumType.FullName));
      ...
      if (enumerator1.MoveNext())
      {
        ...
        throw new MappingException(System.Data.Entity.Resources.Strings.Mapping_Enum_OCMapping_MemberMismatch((object) objectEnumType.FullName, (object) enumerator1.Current.Name, enumerator1.Current.Value, (object) edmEnumType.FullName));
      }
    }
      ...
      Dictionary<string, ObjectTypeMapping> typeMappings)
    {
      ...
      return ocItemCollection != null && ocItemCollection.ContainsMap((GlobalItem) edmType, out map) ? map : DefaultObjectMappingItemCollection.LoadObjectMapping(edmType, objectType, ocItemCollection, typeMappings);
    }
