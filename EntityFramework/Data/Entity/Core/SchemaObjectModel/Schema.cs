...
namespace System.Data.Entity.Core.SchemaObjectModel
{
  ...
  internal class Schema : SchemaElement
  {
    ...
    internal void AddError(EdmSchemaError error) => this._errors.Add(error);
    ...
    internal DbProviderManifest ProviderManifest => this._schemaManager.GetProviderManifest((System.Action<string, ErrorCode, EdmSchemaErrorSeverity>) ((message, code, severity) => this.AddError(code, severity, (object) message)));
    ...
    {
      get => this._namespaceName;
      private set => this._namespaceName = value;
    }
    ...
    public override string FQName => this.Namespace;
    ...
    internal SchemaDataModelOption DataModel => this.SchemaManager.DataModel;

    internal SchemaManager SchemaManager => this._schemaManager;

    internal bool UseStrongSpatialTypes => this._useStrongSpatialTypes ?? true;
    ...
    private void HandleProviderAttribute(XmlReader reader) => this._schemaManager.ProviderNotification(reader.Value, (System.Action<string, ErrorCode, EdmSchemaErrorSeverity>) ((message, code, severity) => this.AddError(code, severity, reader, (object) message)));

    private void HandleProviderManifestTokenAttribute(XmlReader reader) => this._schemaManager.ProviderManifestTokenNotification(reader.Value, (System.Action<string, ErrorCode, EdmSchemaErrorSeverity>) ((message, code, severity) => this.AddError(code, severity, reader, (object) message)));
    ...
    private static class SomSchemaSetHelper
    {
      ...
      internal static XmlSchemaSet GetSchemaSet(SchemaDataModelOption dataModel) => System.Data.Entity.Core.SchemaObjectModel.Schema.SomSchemaSetHelper._cachedSchemaSets.Evaluate(dataModel);
      ...
      private static XmlSchemaSet ComputeSchemaSet(SchemaDataModelOption dataModel)
      {
        ...
        foreach (string key in schemaNamespaces)
        {
          XmlSchemaResource schemaResource = schemaResourceMap[key];
      ...
      private static Stream GetResourceStream(string resourceName) => typeof (System.Data.Entity.Core.SchemaObjectModel.Schema).Assembly().GetManifestResourceStream(resourceName);
    }
  }
}
