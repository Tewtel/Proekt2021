...
namespace System.Data.Entity.Core.SchemaObjectModel
{
  ...
  internal abstract class SchemaElement
  {
    ...
    internal int LinePosition => this._linePosition;
    ...
    public virtual string FQName => this.Name;

    public virtual string Identity => this.Name;
    ...
    internal void AddError(ErrorCode errorCode, EdmSchemaErrorSeverity severity, object message) => this.AddError(errorCode, severity, this.SchemaLocation, this.LineNumber, this.LinePosition, message);
    ...
    internal void GetPositionInfo(XmlReader reader) => SchemaElement.GetPositionInfo(reader, out this._lineNumber, out this._linePosition);
    ...
    internal SchemaElement(SchemaElement parentElement, IDbDependencyResolver resolver = null)
    {
      ...
      {
        if (schemaElement is System.Data.Entity.Core.SchemaObjectModel.Schema schema1)
        {
          this.Schema = schema1;
          break;
        }
    ...
    {
      string name = field;
      Utils.GetUndottedName(this.Schema, reader, out name);
      return name;
    }
    ...
    protected virtual void SkipThroughElement(XmlReader reader) => this.Parse(reader);
    ...
    protected string SchemaLocation => this.Schema != null ? this.Schema.Location : (string) null;

    protected virtual bool HandleText(XmlReader reader) => false;
    ...
    protected virtual void HandleNameAttribute(XmlReader reader) => this.Name = this.HandleUndottedNameAttribute(reader, this.Name);
    ...
    protected virtual bool ProhibitAttribute(string namespaceUri, string localName) => false;

    internal static bool CanHandleAttribute(XmlReader reader, string localName) => reader.NamespaceURI.Length == 0 && reader.LocalName == localName;
    ...
    protected bool CanHandleElement(XmlReader reader, string localName) => reader.NamespaceURI == this.Schema.SchemaXmlNamespace && reader.LocalName == localName;
