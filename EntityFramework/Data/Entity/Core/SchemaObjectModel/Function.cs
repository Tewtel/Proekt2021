...
namespace System.Data.Entity.Core.SchemaObjectModel
{
  internal class Function : SchemaType
  {
    ...
    {
      get => this._isAggregate;
      internal set => this._isAggregate = value;
    }

    public bool IsBuiltIn
    {
      get => this._isBuiltIn;
      internal set => this._isBuiltIn = value;
    }

    public bool IsNiladicFunction
    {
      get => this._isNiladicFunction;
      internal set => this._isNiladicFunction = value;
    }

    public bool IsComposable
    {
      get => this._isComposable;
      internal set => this._isComposable = value;
    }

    public string CommandText => this._commandText != null ? this._commandText.CommandText : (string) null;

    public ParameterTypeSemantics ParameterTypeSemantics
    {
      get => this._parameterTypeSemantics;
      internal set => this._parameterTypeSemantics = value;
    }

    public string StoreFunctionName
    {
      get => this._storeFunctionName;
      internal set => this._storeFunctionName = value;
    }

    public virtual SchemaType Type => this._returnTypeList != null ? this._returnTypeList[0].Type : this._type;

    public IList<ReturnType> ReturnTypeList => this._returnTypeList == null ? (IList<ReturnType>) null : (IList<ReturnType>) new ReadOnlyCollection<ReturnType>((IList<ReturnType>) this._returnTypeList);
    ...
    {
      get => this._returnTypeCollectionKind;
      internal set => this._returnTypeCollectionKind = value;
    }
    ...
    public bool IsReturnAttributeReftype => this._isRefType;
    ...
    internal override SchemaElement Clone(SchemaElement parentElement) => throw Error.NotImplemented();
