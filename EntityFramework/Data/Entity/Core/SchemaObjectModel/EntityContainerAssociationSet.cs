...
namespace System.Data.Entity.Core.SchemaObjectModel
{
  internal sealed class EntityContainerAssociationSet : EntityContainerRelationshipSet
  {
    ...
    internal override IEnumerable<EntityContainerRelationshipSetEnd> Ends
    {
      get
      {
        foreach (EntityContainerRelationshipSetEnd relationshipSetEnd in this._relationshipEnds.Values)
          yield return relationshipSetEnd;
        foreach (EntityContainerRelationshipSetEnd rolelessEnd in this._rolelessEnds)
    ...
    internal override void ResolveTopLevelNames() => base.ResolveTopLevelNames();
    ...
    protected override bool HasEnd(string role) => this._relationshipEnds.ContainsKey(role);
