...
namespace System.Data.Entity.Core.SchemaObjectModel
{
  ...
  internal class SchemaManager
  {
    ...
    {
      if (schemaToBeAdded.SchemaVersion != 0.0 && schemaCollection.Count<Schema>() > 0 && schemaCollection.Any<Schema>((Func<Schema, bool>) (s => s.SchemaVersion != 0.0 && s.SchemaVersion != schemaToBeAdded.SchemaVersion)))
        errorCollection.Add(new EdmSchemaError(System.Data.Entity.Resources.Strings.CannotLoadDifferentVersionOfSchemaInTheSameItemCollection, 194, EdmSchemaErrorSeverity.Error));
      return true;
    }

    public double SchemaVersion => this.effectiveSchemaVersion;
    ...
    public bool IsValidNamespaceName(string namespaceName) => this._namespaceLookUpTable.Contains(namespaceName);
    ...
    internal SchemaElementLookUpTable<SchemaType> SchemaTypes => this._schemaTypes;
    ...
    internal SchemaDataModelOption DataModel => this._dataModel;
    ...
    internal PrimitiveSchema PrimitiveSchema => this._primitiveSchema;

    internal AttributeValueNotification ProviderNotification => this._providerNotification;

    internal AttributeValueNotification ProviderManifestTokenNotification => this._providerManifestTokenNotification;
  }
}
