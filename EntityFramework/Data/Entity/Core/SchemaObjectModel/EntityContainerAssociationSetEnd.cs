...
namespace System.Data.Entity.Core.SchemaObjectModel
{
  internal sealed class EntityContainerAssociationSetEnd : EntityContainerRelationshipSetEnd
  {
    ...
    public string Role
    {
      get => this._unresolvedRelationshipEndRole;
      set => this._unresolvedRelationshipEndRole = value;
    }

    public override string Name => this.Role;
    ...
    private void HandleRoleAttribute(XmlReader reader) => this._unresolvedRelationshipEndRole = this.HandleUndottedNameAttribute(reader, this._unresolvedRelationshipEndRole);
