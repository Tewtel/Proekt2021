...
namespace System.Data.Entity.Core.SchemaObjectModel
{
  internal sealed class RelationshipEnd : SchemaElement, IRelationshipEnd
  {
    ...
    internal override void Validate()
    {
      ...
      if (multiplicity.GetValueOrDefault() == relationshipMultiplicity & multiplicity.HasValue && this.Operations.Count != 0)
    ...
    private void HandleOnDeleteElement(XmlReader reader) => this.HandleOnOperationElement(reader, Operation.Delete);
