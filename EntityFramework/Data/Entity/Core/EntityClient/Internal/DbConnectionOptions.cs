...
namespace System.Data.Entity.Core.EntityClient.Internal
{
  internal class DbConnectionOptions
  {
    ...
    internal string UsersConnectionString => this._usersConnectionString ?? string.Empty;

    internal bool IsEmpty => this.KeyChain == null;

    internal Dictionary<string, string> Parsetable => this._parsetable;
