...
namespace System.Data.Entity.Core.EntityClient
{
  ...
  public sealed class EntityParameterCollection : DbParameterCollection
  {
    ...
    /// </returns>
    public override int Count => this._items == null ? 0 : this._items.Count;
    ...
    /// </returns>
    public override bool IsFixedSize => ((IList) this.InnerList).IsFixedSize;
    ...
    /// </returns>
    public override bool IsReadOnly => ((IList) this.InnerList).IsReadOnly;
    ...
    /// </returns>
    public override bool IsSynchronized => ((ICollection) this.InnerList).IsSynchronized;
    ...
    /// .
    /// </returns>
    public override object SyncRoot => ((ICollection) this.InnerList).SyncRoot;
    ...
    {
      this.OnChange();
      System.Data.Entity.Utilities.Check.NotNull<Array>(values, nameof (values));
    ...
    private int CheckName(string parameterName)
    {
      ...
      return num >= 0 ? num : throw new IndexOutOfRangeException(Strings.EntityParameterCollectionInvalidParameterName((object) parameterName));
    }
    ...
    /// </param>
    public override bool Contains(object value) => -1 != this.IndexOf(value);
    ...
    /// </param>
    public override void CopyTo(Array array, int index) => ((ICollection) this.InnerList).CopyTo(array, index);
    ...
    /// .
    /// </returns>
    public override IEnumerator GetEnumerator() => ((IEnumerable) this.InnerList).GetEnumerator();
    ...
    protected override DbParameter GetParameter(string parameterName)
    {
      ...
      return index >= 0 ? (DbParameter) this.InnerList[index] : throw new IndexOutOfRangeException(Strings.EntityParameterCollectionInvalidParameterName((object) parameterName));
    }
    ...
    /// </param>
    public override int IndexOf(string parameterName) => EntityParameterCollection.IndexOf((IEnumerable) this.InnerList, parameterName);
    ...
    {
      get => (EntityParameter) this.GetParameter(index);
    ...
    {
      get => (EntityParameter) this.GetParameter(parameterName);
    ...
    /// </param>
    public EntityParameter Add(string parameterName, DbType dbType) => this.Add(new EntityParameter(parameterName, dbType));
    ...
    public EntityParameter Add(string parameterName, DbType dbType, int size) => this.Add(new EntityParameter(parameterName, dbType, size));
    ...
    /// </param>
    public void AddRange(EntityParameter[] values) => this.AddRange((Array) values);
    ...
    /// </param>
    public void CopyTo(EntityParameter[] array, int index) => this.CopyTo((Array) array, index);
    ...
    /// </param>
    public int IndexOf(EntityParameter value) => this.IndexOf((object) value);
    ...
    /// .
    /// </param>
    public void Insert(int index, EntityParameter value) => this.Insert(index, (object) value);

    private void OnChange() => this._isDirty = true;
    ...
    public void Remove(EntityParameter value) => this.Remove((object) value);
