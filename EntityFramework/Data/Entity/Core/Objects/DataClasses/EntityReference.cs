...
namespace System.Data.Entity.Core.Objects.DataClasses
{
  ...
  public abstract class EntityReference : RelatedEnd
  {
    ...
    public EntityKey EntityKey
    {
      ...
      set => this.SetEntityKey(value, false);
    }
    ...
    internal void SetEntityKey(EntityKey value, bool forceFixup)
    {
      ...
      if (this.ObjectContext != null && !this.UsingNoTracking)
      {
        if (value != (EntityKey) null && !RelatedEnd.IsValidEntityKeyType(value))
          throw new ArgumentException(System.Data.Entity.Resources.Strings.EntityReference_CannotSetSpecialKeys, nameof (value));
    ...
    internal EntityKey AttachedEntityKey => this.EntityKey;

    internal EntityKey DetachedEntityKey
    {
      get => this._detachedEntityKey;
      set => this._detachedEntityKey = value;
    }
    ...
    internal EntityKey CachedForeignKey
    {
      get
      {
        ...
        return (object) entityKey != null ? entityKey : this._cachedForeignKey;
      }
    }
      ...
      bool checkBothEnds)
    {
      ...
      else if (checkBothEnds && targetEntity != null && (targetEntity.Entity != null && this.GetOtherEndOfRelationship(targetEntity) is EntityReference endOfRelationship2))
        endOfRelationship2.ValidateOwnerWithRIConstraints(this.WrappedOwner, entityKey, false);
      return entityKey;
    }
    ...
    internal override bool CanDeferredLoad => this.IsEmpty();
    ...
    internal object GetDependentEndOfReferentialConstraint(object relatedValue) => !this.IsDependentEndOfReferentialConstraint(false) ? relatedValue : this.WrappedOwner.Entity;

    internal bool NavigationPropertyIsNullOrMissing() => !this.TargetAccessor.HasProperty || this.WrappedOwner.GetNavigationPropertyValue((RelatedEnd) this) == null;
      ...
      bool doAttach)
    {
      ...
      if (this.DetachedEntityKey != (EntityKey) null && this.DetachedEntityKey != wrappedEntity.EntityKey)
        throw new InvalidOperationException(System.Data.Entity.Resources.Strings.EntityReference_EntityKeyValueMismatch);
    }
    ...
    internal override void AddToNavigationPropertyIfCompatible(RelatedEnd otherRelatedEnd)
    {
      if (this.NavigationPropertyIsNullOrMissing())
      {
        ...
        throw System.Data.Entity.Resources.Error.ObjectStateManager_ConflictingChangesOfRelationshipDetected((object) this.RelationshipNavigation.To, (object) this.RelationshipNavigation.RelationshipName);
    }

    internal override bool CachedForeignKeyIsConceptualNull() => ForeignKeyFactory.IsConceptualNullKey(this.CachedForeignKey);
    ...
    internal override void ValidateDetachedEntityKey()
    {
      ...
      if (!RelatedEnd.IsValidEntityKeyType(detachedEntityKey))
        throw System.Data.Entity.Resources.Error.EntityReference_CannotSetSpecialKeys();
    ...
    internal override void VerifyDetachedKeyMatches(EntityKey entityKey)
    {
      ...
      if (entityKey1.IsTemporary)
        throw System.Data.Entity.Resources.Error.RelatedEnd_CannotCreateRelationshipBetweenTrackedAndNoTrackedEntities((object) this.RelationshipNavigation.To);
      throw new InvalidOperationException(System.Data.Entity.Resources.Strings.EntityReference_EntityKeyValueMismatch);
    }
    ...
    internal void NullAllForeignKeys()
    {
      ...
      {
        if (objectStateManager.EntityInvokingFKSetter == this.WrappedOwner.Entity || transactionManager.IsForeignKeyUpdate)
          return;
