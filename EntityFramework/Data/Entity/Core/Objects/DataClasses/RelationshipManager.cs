...
namespace System.Data.Entity.Core.Objects.DataClasses
{
  ...
  public class RelationshipManager
  {
    ...
    internal void SetExpensiveLoader(ExpensiveOSpaceLoader loader) => this._expensiveLoader = loader;
    ...
    {
      get => this._nodeVisited;
      set => this._nodeVisited = value;
    }
    ...
    {
      System.Data.Entity.Utilities.Check.NotNull<IEntityWithRelationships>(owner, nameof (owner));
      return new RelationshipManager() { _owner = owner };
    }

    internal static RelationshipManager Create() => new RelationshipManager();
      ...
      where TTargetEntity : class
    {
      ...
      if (existingRelatedEnd == null)
        return relatedEnd1 != null ? previousCollection : this.CreateRelatedEnd<TSourceEntity, TTargetEntity>(new RelationshipNavigation((AssociationType) sourceMember.DeclaringType, sourceMember.Name, targetMember.Name, sourceAccessor, targetAccessor), relationshipMultiplicity, RelationshipMultiplicity.Many, existingRelatedEnd) as EntityCollection<TTargetEntity>;
      if (relatedEnd1 != null)
        this._relationships.Remove(relatedEnd1);
      if (this.CreateRelatedEnd<TSourceEntity, TTargetEntity>(new RelationshipNavigation((AssociationType) sourceMember.DeclaringType, sourceMember.Name, targetMember.Name, sourceAccessor, targetAccessor), relationshipMultiplicity, RelationshipMultiplicity.Many, existingRelatedEnd) is EntityCollection<TTargetEntity> relatedEnd2)
      {
        bool flag = true;
        try
        {
      ...
      where TTargetEntity : class
    {
      ...
      if (previousCollection != null && num != previousCollection.CountInternal)
        throw new InvalidOperationException(System.Data.Entity.Resources.Strings.Collections_UnableToMergeCollections);
    }
      ...
      where TTargetEntity : class
    {
      ...
      return this.TryGetCachedRelatedEnd(fullName, name, out relatedEnd) ? relatedEnd as EntityReference<TTargetEntity> : this.CreateRelatedEnd<TSourceEntity, TTargetEntity>(new RelationshipNavigation((AssociationType) sourceMember.DeclaringType, sourceMember.Name, targetMember.Name, sourceAccessor, targetAccessor), relationshipMultiplicity, RelationshipMultiplicity.One, existingRelatedEnd) as EntityReference<TTargetEntity>;
    }
      ...
      bool throwArgumentException = false)
    {
      ...
      {
        string message = System.Data.Entity.Resources.Strings.RelationshipManager_NavigationPropertyNotFound((object) navigationProperty);
    ...
    public IRelatedEnd GetRelatedEnd(string relationshipName, string targetRoleName) => (IRelatedEnd) this.GetRelatedEndInternal(this.PrependNamespaceToRelationshipName(relationshipName), targetRoleName);
      ...
      AssociationType relationship)
    {
      ...
      if (!clrType.IsAssignableFrom(wrappedOwner.IdentityType))
        throw new InvalidOperationException(System.Data.Entity.Resources.Strings.RelationshipManager_OwnerIsNotSourceType((object) wrappedOwner.IdentityType.FullName, (object) clrType.FullName, (object) sourceEnd.Name, (object) relationshipName));
      return !this.VerifyRelationship(relationship, sourceEnd.Name) ? (RelatedEnd) null : DelegateFactory.GetRelatedEnd(this, sourceEnd, targetEnd, existingRelatedEnd);
    }
      ...
      AssociationEndMember csTargetEnd)
    {
      ...
      Type clrType = MetadataHelper.GetEntityTypeForEnd(sourceEnd).ClrType;
      if (!clrType.IsAssignableFrom(wrappedOwner.IdentityType))
        throw new InvalidOperationException(System.Data.Entity.Resources.Strings.RelationshipManager_OwnerIsNotSourceType((object) wrappedOwner.IdentityType.FullName, (object) clrType.FullName, (object) sourceEnd.Name, (object) csAssociationType.FullName));
      return !this.VerifyRelationship(relationshipType, csAssociationType, sourceEnd.Name) ? (RelatedEnd) null : DelegateFactory.GetRelatedEnd(this, sourceEnd, targetEnd, (RelatedEnd) null);
    }
      ...
      out AssociationEndMember targetEnd)
    {
      ...
      if (targetEnd.Identity != targetRoleName)
      {
        ...
        if (targetEnd.Identity != targetRoleName)
          throw new InvalidOperationException(System.Data.Entity.Resources.Strings.RelationshipManager_InvalidTargetRole((object) associationType.FullName, (object) targetRoleName));
      }
      else
    ...
    public void InitializeRelatedReference<TTargetEntity>(
      ...
      where TTargetEntity : class
    {
      System.Data.Entity.Utilities.Check.NotNull<string>(relationshipName, nameof (relationshipName));
      System.Data.Entity.Utilities.Check.NotNull<string>(targetRoleName, nameof (targetRoleName));
      System.Data.Entity.Utilities.Check.NotNull<EntityReference<TTargetEntity>>(entityReference, nameof (entityReference));
      if (entityReference.WrappedOwner.Entity != null)
        throw new InvalidOperationException(System.Data.Entity.Resources.Strings.RelationshipManager_ReferenceAlreadyInitialized((object) System.Data.Entity.Resources.Strings.RelationshipManager_InitializeIsForDeserialization));
      IEntityWrapper wrappedOwner = this.WrappedOwner;
      if (wrappedOwner.Context != null && wrappedOwner.MergeOption != MergeOption.NoTracking)
        throw new InvalidOperationException(System.Data.Entity.Resources.Strings.RelationshipManager_RelationshipManagerAttached((object) System.Data.Entity.Resources.Strings.RelationshipManager_InitializeIsForDeserialization));
      ...
      if (!(this.GetRelatedEndInternal(relationshipName, targetRoleName, (RelatedEnd) entityReference, relationshipType) is EntityReference<TTargetEntity>))
        throw new InvalidOperationException(System.Data.Entity.Resources.Strings.EntityReference_ExpectedReferenceGotCollection((object) typeof (TTargetEntity).Name, (object) targetRoleName, (object) relationshipName));
    }
      ...
      where TTargetEntity : class
    {
      System.Data.Entity.Utilities.Check.NotNull<string>(relationshipName, nameof (relationshipName));
      System.Data.Entity.Utilities.Check.NotNull<string>(targetRoleName, nameof (targetRoleName));
      System.Data.Entity.Utilities.Check.NotNull<EntityCollection<TTargetEntity>>(entityCollection, nameof (entityCollection));
      if (entityCollection.WrappedOwner.Entity != null)
        throw new InvalidOperationException(System.Data.Entity.Resources.Strings.RelationshipManager_CollectionAlreadyInitialized((object) System.Data.Entity.Resources.Strings.RelationshipManager_CollectionInitializeIsForDeserialization));
      IEntityWrapper wrappedOwner = this.WrappedOwner;
      if (wrappedOwner.Context != null && wrappedOwner.MergeOption != MergeOption.NoTracking)
        throw new InvalidOperationException(System.Data.Entity.Resources.Strings.RelationshipManager_CollectionRelationshipManagerAttached((object) System.Data.Entity.Resources.Strings.RelationshipManager_CollectionInitializeIsForDeserialization));
      relationshipName = this.PrependNamespaceToRelationshipName(relationshipName);
      AssociationType relationshipType = this.GetRelationshipType(relationshipName);
      if (!(this.GetRelatedEndInternal(relationshipName, targetRoleName, (RelatedEnd) entityCollection, relationshipType) is EntityCollection<TTargetEntity>))
        throw new InvalidOperationException(System.Data.Entity.Resources.Strings.Collections_ExpectedCollectionGotReference((object) typeof (TTargetEntity).Name, (object) targetRoleName, (object) relationshipName));
    }
    ...
    internal string PrependNamespaceToRelationshipName(string relationshipName)
    {
      if (!relationshipName.Contains("."))
      {
        ...
        if (edmType is ClrEntityType clrEntityType2)
          return clrEntityType2.CSpaceNamespaceName + "." + relationshipName;
      }
    ...
    {
      return wrappedOwner.Context != null ? (ObjectItemCollection) wrappedOwner.Context.MetadataWorkspace.GetItemCollection(DataSpace.OSpace) : (ObjectItemCollection) null;
    }
    ...
    internal AssociationType GetRelationshipType(AssociationType csAssociationType)
    {
      ...
      return metadataWorkspace != null ? metadataWorkspace.MetadataOptimization.GetOSpaceAssociationType(csAssociationType, (Func<AssociationType>) (() => this.GetRelationshipType(csAssociationType.FullName))) : this.GetRelationshipType(csAssociationType.FullName);
    }
    ...
    internal AssociationType GetRelationshipType(string relationshipName)
    {
      ...
      return associationType != null ? associationType : throw RelationshipManager.UnableToGetMetadata(this.WrappedOwner, relationshipName);
    }
    ...
    internal static Exception UnableToGetMetadata(
      ...
      string relationshipName)
    {
      ArgumentException argumentException = new ArgumentException(System.Data.Entity.Resources.Strings.RelationshipManager_UnableToFindRelationshipTypeInMetadata((object) relationshipName), nameof (relationshipName));
      return EntityProxyFactory.IsProxyType(wrappedOwner.Entity.GetType()) ? (Exception) new InvalidOperationException(System.Data.Entity.Resources.Strings.EntityProxyTypeInfo_ProxyMetadataIsUnavailable((object) wrappedOwner.IdentityType.FullName), (Exception) argumentException) : (Exception) argumentException;
    }
    ...
    {
      foreach (AssociationSet associationSet in ownerEntitySet.AssociationSets)
      {
        AssociationSet assocSet = associationSet;
        if (assocSet.ElementType.AssociationEndMembers[1].GetEntityType().IsAssignableFrom((EdmType) ownerEntityType))
          yield return assocSet.ElementType.AssociationEndMembers[0];
        if (assocSet.ElementType.AssociationEndMembers[0].GetEntityType().IsAssignableFrom((EdmType) ownerEntityType))
          yield return assocSet.ElementType.AssociationEndMembers[1];
        assocSet = (AssociationSet) null;
      }
    }
    ...
    {
      ObjectItemCollection objectItemCollection = RelationshipManager.GetObjectItemCollection(this.WrappedOwner);
      foreach (AssociationType associationType in objectItemCollection == null ? EntityProxyFactory.TryGetAllAssociationTypesFromProxyInfo(this.WrappedOwner) ?? this._expensiveLoader.GetAllRelationshipTypesExpensiveWay(entityClrType.Assembly()) : (IEnumerable<AssociationType>) objectItemCollection.GetItems<AssociationType>())
      {
        AssociationType association = associationType;
        if (association.AssociationEndMembers[0].TypeUsage.EdmType is RefType edmType5 && edmType5.ElementType.ClrType.IsAssignableFrom(entityClrType))
          yield return association.AssociationEndMembers[1];
        if (association.AssociationEndMembers[1].TypeUsage.EdmType is RefType edmType6 && edmType6.ElementType.ClrType.IsAssignableFrom(entityClrType))
    ...
    private bool VerifyRelationship(AssociationType relationship, string sourceEndName)
    {
      ...
      return entityKey == (EntityKey) null || RelationshipManager.VerifyRelationship(wrappedOwner, entityKey, relationship, sourceEndName);
    }
      ...
      string sourceEndName)
    {
      ...
      if (wrappedOwner.Context.MetadataWorkspace.MetadataOptimization.FindCSpaceAssociationSet(csAssociationType, sourceEndName, entityKey.EntitySetName, entityKey.EntityContainerName, out EntitySet _) == null)
        throw System.Data.Entity.Resources.Error.Collections_NoRelationshipSetMatched((object) osAssociationType.FullName);
      return true;
    }
    ...
    {
      TypeUsage typeUsage;
      if (wrappedOwner.Context.Perspective.TryGetTypeByName(relationship.FullName, false, out typeUsage) && wrappedOwner.Context.MetadataWorkspace.MetadataOptimization.FindCSpaceAssociationSet((AssociationType) typeUsage.EdmType, sourceEndName, ownerKey.EntitySetName, ownerKey.EntityContainerName, out EntitySet _) == null)
        throw System.Data.Entity.Resources.Error.Collections_NoRelationshipSetMatched((object) relationship.FullName);
      return true;
    }
    ...
    public EntityCollection<TTargetEntity> GetRelatedCollection<TTargetEntity>(
      ...
      where TTargetEntity : class
    {
      if (this.GetRelatedEndInternal(this.PrependNamespaceToRelationshipName(relationshipName), targetRoleName) is EntityCollection<TTargetEntity> relatedEndInternal)
    ...
    public EntityReference<TTargetEntity> GetRelatedReference<TTargetEntity>(
      ...
      where TTargetEntity : class
    {
      if (this.GetRelatedEndInternal(this.PrependNamespaceToRelationshipName(relationshipName), targetRoleName) is EntityReference<TTargetEntity> relatedEndInternal)
        return relatedEndInternal;
      throw new InvalidOperationException(System.Data.Entity.Resources.Strings.EntityReference_ExpectedReferenceGotCollection((object) typeof (TTargetEntity).Name, (object) targetRoleName, (object) relationshipName));
    }
    ...
    {
      RelatedEnd relatedEnd;
      return this.TryGetCachedRelatedEnd(navigation.RelationshipName, navigation.To, out relatedEnd) ? relatedEnd : relationshipFixer.CreateSourceEnd(navigation, this);
    }
      ...
      where TTargetEntity : class
    {
      ...
      switch (targetRoleMultiplicity)
      {
        ...
        default:
          ...
          throw new ArgumentOutOfRangeException(type.Name, System.Data.Entity.Resources.Strings.ADP_InvalidEnumerationValue((object) type.Name, (object) ((int) targetRoleMultiplicity).ToString((IFormatProvider) CultureInfo.InvariantCulture)));
      }
      if (wrappedOwner.Context != null)
    ...
    public void OnSerializing(StreamingContext context)
    {
      ...
      if (!(wrappedOwner.Entity is IEntityWithRelationships))
        throw new InvalidOperationException(System.Data.Entity.Resources.Strings.RelatedEnd_CannotSerialize((object) nameof (RelationshipManager)));
      if (wrappedOwner.Context == null || wrappedOwner.MergeOption == MergeOption.NoTracking)
        return;
      foreach (RelatedEnd allRelatedEnd in this.GetAllRelatedEnds())
      {
        if (allRelatedEnd is EntityReference entityReference1 && entityReference1.EntityKey != (EntityKey) null)
          entityReference1.DetachedEntityKey = entityReference1.EntityKey;
      }
    }

    internal bool HasRelationships => this._relationships != null;
      ...
      bool includeOwnValues)
    {
      ...
      if (entityKey.IsTemporary)
      {
        ...
        this.FindNamesOfReferentialConstraintProperties(out propertiesToRetrieve, out bool _, false);
        if (propertiesToRetrieve != null)
        {
          ...
          if (!RelationshipManager.CheckIfAllPropertiesWereRetrieved(properties, propertiesToRetrieve))
          {
            ...
            if (!RelationshipManager.CheckIfAllPropertiesWereRetrieved(properties, propertiesToRetrieve))
              throw new InvalidOperationException(System.Data.Entity.Resources.Strings.RelationshipManager_UnableToRetrieveReferentialConstraintProperties);
          }
        }
      }
      ...
      bool skipFK)
    {
      ...
      if (wrappedOwner.Context == null)
        throw new InvalidOperationException(System.Data.Entity.Resources.Strings.RelationshipManager_UnexpectedNullContext);
    ...
    internal bool HasReferentialConstraintPropertiesToCheck()
    {
      ...
      foreach (AssociationSet associationSet in entitySet.AssociationSets)
      {
        foreach (ReferentialConstraint referentialConstraint in associationSet.ElementType.ReferentialConstraints)
        {
          if (referentialConstraint.ToRole.TypeUsage.EdmType == entitySet.ElementType.GetReferenceType() || referentialConstraint.FromRole.TypeUsage.EdmType == entitySet.ElementType.GetReferenceType())
            return true;
        }
      }
      return false;
      ...
      MergeOption mergeOption)
    {
      ...
      foreach (RelatedEnd relationship in this.Relationships)
      {
        ...
        relationship.FindRelationshipSet(context, entitySet, out EdmType _, out relationshipSet);
