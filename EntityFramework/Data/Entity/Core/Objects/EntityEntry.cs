...
namespace System.Data.Entity.Core.Objects
{
  internal sealed class EntityEntry : ObjectStateEntry
  {
    ...
    public override EntityKey EntityKey
    {
      ...
      internal set => this._entityKey = value;
    }
    ...
    internal IEnumerable<Tuple<AssociationSet, ReferentialConstraint>> ForeignKeyDependents
    {
      get
      {
        EntityEntry entityEntry = this;
        foreach (Tuple<AssociationSet, ReferentialConstraint> foreignKeyDependent in ((EntitySet) entityEntry.EntitySet).ForeignKeyDependents)
        {
          if (MetadataHelper.GetEntityTypeForEnd((AssociationEndMember) foreignKeyDependent.Item2.ToRole).IsAssignableFrom(entityEntry._cacheTypeMetadata.DataRecordInfo.RecordType.EdmType))
    ...
    internal IEnumerable<Tuple<AssociationSet, ReferentialConstraint>> ForeignKeyPrincipals
    {
      ...
      {
        EntityEntry entityEntry = this;
        foreach (Tuple<AssociationSet, ReferentialConstraint> foreignKeyPrincipal in ((EntitySet) entityEntry.EntitySet).ForeignKeyPrincipals)
        {
          if (MetadataHelper.GetEntityTypeForEnd((AssociationEndMember) foreignKeyPrincipal.Item2.FromRole).IsAssignableFrom(entityEntry._cacheTypeMetadata.DataRecordInfo.RecordType.EdmType))
    ...
    {
      EntityEntry entityEntry = this;
      entityEntry.ValidateState();
      if (EntityState.Modified == entityEntry.State && entityEntry._modifiedFields != null)
      {
        for (int i = 0; i < entityEntry._modifiedFields.Length; ++i)
        {
          if (entityEntry._modifiedFields[i])
            yield return entityEntry.GetCLayerName(i, entityEntry._cacheTypeMetadata);
        }
      }
    }
    ...
    private int ValidateAndGetOrdinalForProperty(string propertyName, string methodName)
    {
      this.ValidateState();
      if (this.IsKeyEntry)
        throw new InvalidOperationException(System.Data.Entity.Resources.Strings.ObjectStateEntry_CannotModifyKeyEntryState);
      int olayerMemberName = this._cacheTypeMetadata.GetOrdinalforOLayerMemberName(propertyName);
      if (olayerMemberName == -1)
        throw new ArgumentException(System.Data.Entity.Resources.Strings.ObjectStateEntry_SetModifiedOnInvalidProperty((object) propertyName));
      if (this.State != EntityState.Added && this.State != EntityState.Deleted)
        return olayerMemberName;
      throw new InvalidOperationException(System.Data.Entity.Resources.Strings.ObjectStateEntry_SetModifiedStates((object) methodName));
    }
    ...
    public override DbDataRecord OriginalValues => this.InternalGetOriginalValues(true);

    public override OriginalValueRecord GetUpdatableOriginalValues() => (OriginalValueRecord) this.InternalGetOriginalValues(false);

    private DbDataRecord InternalGetOriginalValues(bool readOnly)
    {
      this.ValidateState();
      if (this.State == EntityState.Added)
        throw new InvalidOperationException(System.Data.Entity.Resources.Strings.ObjectStateEntry_OriginalValuesDoesNotExist);
      if (this.IsKeyEntry)
        throw new InvalidOperationException(System.Data.Entity.Resources.Strings.ObjectStateEntry_CannotAccessKeyEntryValues);
      this.DetectChangesInComplexProperties();
      return readOnly ? (DbDataRecord) new ObjectStateEntryDbDataRecord(this, this._cacheTypeMetadata, this._wrappedEntity.Entity) : (DbDataRecord) new ObjectStateEntryOriginalDbUpdatableDataRecord_Public(this, this._cacheTypeMetadata, this._wrappedEntity.Entity, -1);
    }
    ...
    public override CurrentValueRecord CurrentValues
    {
      get
      {
        ...
        if (this.State == EntityState.Deleted)
          throw new InvalidOperationException(System.Data.Entity.Resources.Strings.ObjectStateEntry_CurrentValuesDoesNotExist);
        if (this.IsKeyEntry)
          throw new InvalidOperationException(System.Data.Entity.Resources.Strings.ObjectStateEntry_CannotAccessKeyEntryValues);
    ...
    public override void AcceptChanges()
    {
      ...
      switch (this.State)
      {
        case EntityState.Added:
          int num = this.RetrieveAndCheckReferentialConstraintValuesInAcceptChanges() ? 1 : 0;
        ...
        case EntityState.Modified:
          ...
          this._originalComplexObjects = (Dictionary<object, Dictionary<int, object>>) null;
          this.State = EntityState.Unchanged;
          this._cache.FixupReferencesByForeignKeys(this);
          this.RelationshipManager.CheckReferentialConstraintProperties(this);
          this._wrappedEntity.TakeSnapshot(this);
          break;
      }
    ...
    public override void SetModified()
    {
      ...
      if (EntityState.Unchanged == this.State)
      {
        ...
        throw new InvalidOperationException(System.Data.Entity.Resources.Strings.ObjectStateEntry_SetModifiedStates((object) nameof (SetModified)));
    }
    ...
    public override RelationshipManager RelationshipManager
    {
      get
      {
        ...
        return this.WrappedEntity.Entity != null ? this.WrappedEntity.RelationshipManager : throw new InvalidOperationException(System.Data.Entity.Resources.Strings.ObjectStateManager_CannotGetRelationshipManagerForDetachedPocoEntity);
      }
    }

    internal override BitArray ModifiedProperties => this._modifiedFields;
    ...
    internal void RemoveRelationshipEnd(RelationshipEntry item)
    {
      ...
      {
        bool flag2 = (object) this.EntityKey == (object) relationshipEntry1.Key0 || (object) this.EntityKey != (object) relationshipEntry1.Key1 && this.EntityKey.Equals(relationshipEntry1.Key0);
        if (item == relationshipEntry1)
        {
    ...
    internal EntityEntry.RelationshipEndEnumerable GetRelationshipEnds() => new EntityEntry.RelationshipEndEnumerable(this);

    internal override bool IsKeyEntry => this._wrappedEntity.Entity == null;

    internal override DataRecordInfo GetDataRecordInfo(
      StateManagerTypeMetadata metadata,
      object userObject)
    {
      return Helper.IsEntityType(metadata.CdmMetadata.EdmType) && (object) this._entityKey != null ? (DataRecordInfo) new EntityRecordInfo(metadata.DataRecordInfo, this._entityKey, (EntitySet) this.EntitySet) : metadata.DataRecordInfo;
    }
    ...
    internal override Type GetFieldType(int ordinal, StateManagerTypeMetadata metadata) => metadata.GetFieldType(ordinal);

    internal override string GetCLayerName(int ordinal, StateManagerTypeMetadata metadata) => metadata.CLayerMemberName(ordinal);

    internal override int GetOrdinalforCLayerName(string name, StateManagerTypeMetadata metadata) => metadata.GetOrdinalforCLayerMemberName(name);
    ...
    internal override int GetFieldCount(StateManagerTypeMetadata metadata) => metadata.FieldCount;
    ...
    internal IEntityWrapper WrappedEntity => this._wrappedEntity;
      ...
      string complexObjectMemberName)
    {
      try
      {
        ...
        if (changingObject != this._cache.ChangingObject || changingMemberName != this._cache.ChangingMember || entityMemberName != this._cache.ChangingEntityMember)
          throw new InvalidOperationException(System.Data.Entity.Resources.Strings.ObjectStateEntry_EntityMemberChangedWithoutEntityMemberChanging);
        if (this.State != this._cache.ChangingState)
          throw new InvalidOperationException(System.Data.Entity.Resources.Strings.ObjectStateEntry_ChangedInDifferentStateFromChanging((object) this._cache.ChangingState, (object) this.State));
    ...
    internal void SetCurrentEntityValue(string memberName, object newValue) => this.SetCurrentEntityValue(this._cacheTypeMetadata, this._cacheTypeMetadata.GetOrdinalforOLayerMemberName(memberName), this._wrappedEntity.Entity, newValue);
    ...
    {
      this.ValidateState();
      int num = this.State != EntityState.Added ? (int) this.State : throw new InvalidOperationException(System.Data.Entity.Resources.Strings.ObjectStateEntry_OriginalValuesDoesNotExist);
      ...
      if (managerMemberMetadata.IsComplex)
      {
        ...
        if (oldComplexObject == null)
          throw new InvalidOperationException(System.Data.Entity.Resources.Strings.ComplexObject_NullableComplexTypesNotSupported((object) managerMemberMetadata.CLayerName));
        if (newValue is IExtendedDataRecord record2)
          newValue = this._cache.ComplexTypeMaterializer.CreateComplex(record2, record2.DataRecordInfo, (object) null);
    ...
    internal object GetOriginalEntityValue(string memberName) => this.GetOriginalEntityValue(this._cacheTypeMetadata, this._cacheTypeMetadata.GetOrdinalforOLayerMemberName(memberName), this._wrappedEntity.Entity, ObjectStateValueRecord.OriginalReadonly);
      ...
      int parentEntityPropertyIndex)
    {
      ...
      return originalValueIndex >= 0 ? this._originalValues[originalValueIndex].OriginalValue ?? (object) DBNull.Value : this.GetCurrentEntityValue(metadata, ordinal, userObject, updatableRecord, parentEntityPropertyIndex);
    }
    ...
    internal int FindOriginalValueIndex(StateManagerMemberMetadata metadata, object instance)
    {
      if (this._originalValues != null)
      {
        ...
        {
          if (this._originalValues[index].UserObject == instance && this._originalValues[index].MemberMetadata == metadata)
            return index;
        }
      }
      return -1;
    ...
    internal EntityEntry GetOtherEndOfRelationship(RelationshipEntry relationshipEntry) => this._cache.GetEntityEntry(relationshipEntry.RelationshipWrapper.GetOtherEntityKey(this.EntityKey));
      ...
      bool useOldComplexObject)
    {
      if (newComplexObject == null)
        throw new InvalidOperationException(System.Data.Entity.Resources.Strings.ComplexObject_NullableComplexTypesNotSupported((object) memberMetadata.CLayerName));
    ...
    {
      System.Data.Entity.Utilities.Check.NotNull<string>(entityMemberName, nameof (entityMemberName));
      ...
      if (olayerMemberName == -1)
      {
        if (!(entityMemberName == "-EntityKey-"))
          throw new ArgumentException(System.Data.Entity.Resources.Strings.ObjectStateEntry_ChangeOnUnmappedProperty((object) entityMemberName));
        if (!this._cache.InRelationshipFixup)
          throw new InvalidOperationException(System.Data.Entity.Resources.Strings.ObjectStateEntry_CantSetEntityKey);
      ...
      if (complexObject != null)
      {
        if (!this._cacheTypeMetadata.Member(olayerMemberName).IsComplex)
          throw new ArgumentException(System.Data.Entity.Resources.Strings.ComplexObject_ComplexChangeRequestedOnScalarProperty((object) entityMemberName));
        ...
        if (olayerMemberName == -1)
          throw new ArgumentException(System.Data.Entity.Resources.Strings.ObjectStateEntry_ChangeOnUnmappedComplexProperty((object) complexObjectMemberName));
    ...
    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    internal OriginalValueRecord EditableOriginalValues => (OriginalValueRecord) new ObjectStateEntryOriginalDbUpdatableDataRecord_Internal(this, this._cacheTypeMetadata, this._wrappedEntity.Entity);
      ...
      foreach (Dictionary<int, object> dictionary in this._originalComplexObjects.Values)
      {
        foreach (object obj in dictionary.Values)
        {
          if (complexObject == obj)
            throw new InvalidOperationException(System.Data.Entity.Resources.Strings.ObjectStateEntry_ComplexObjectUsedMultipleTimes((object) this.Entity.GetType().FullName, (object) complexObject.GetType().FullName));
        }
      }
    }
        ...
        if (!object.Equals(obj, originalValue))
        {
          ...
          if (managerMemberMetadata.IsPartOfKey)
          {
            if (!ByValueEqualityComparer.Default.Equals(obj, originalValue))
              throw new InvalidOperationException(System.Data.Entity.Resources.Strings.ObjectStateEntry_CannotModifyKeyProperty((object) managerMemberMetadata.CLayerName));
          }
      ...
      bool detectOnly)
    {
      if (complexValue == null)
      {
        if (oldComplexValue == null)
          return false;
        throw new InvalidOperationException(System.Data.Entity.Resources.Strings.ComplexObject_NullableComplexTypesNotSupported((object) complexMember.CLayerName));
      }
    ...
    internal void TakeSnapshotOfRelationships()
    {
      ...
      foreach (NavigationProperty navigationProperty in (this._cacheTypeMetadata.CdmMetadata.EdmType as EntityType).NavigationProperties)
      {
        ...
        if (navigationPropertyValue != null)
        {
          ...
          {
            if (!(navigationPropertyValue is IEnumerable enumerable5))
              throw new EntityException(System.Data.Entity.Resources.Strings.ObjectStateEntry_UnableToEnumerateCollection((object) navigationProperty.Name, (object) this.Entity.GetType().FullName));
            foreach (object o in enumerable5)
            {
              if (o != null)
      ...
      object o)
    {
      ...
      if (entityEntry1 != null)
      {
        ...
        if (!relatedEndInternal.ContainsEntity(this._wrappedEntity))
        {
          ...
          if (relatedEndInternal is EntityReference entityReference4 && entityReference4.NavigationPropertyIsNullOrMissing())
            this.ObjectStateManager.TransactionManager.AlignedEntityReferences.Add(entityReference4);
      ...
      foreach (NavigationProperty navigationProperty in (this._cacheTypeMetadata.CdmMetadata.EdmType as EntityType).NavigationProperties)
      {
        ...
        if (navigationPropertyValue != null)
        {
          if (navigationProperty.ToEndMember.RelationshipMultiplicity == RelationshipMultiplicity.Many)
          {
            if (!(navigationPropertyValue is IEnumerable enumerable5))
              throw new EntityException(System.Data.Entity.Resources.Strings.ObjectStateEntry_UnableToEnumerateCollection((object) navigationProperty.Name, (object) this.Entity.GetType().FullName));
            foreach (object obj in enumerable5)
            {
              if (obj != null)
                objectSet.Add(obj);
            }
      ...
      RelatedEnd relatedEnd)
    {
      ...
      if (!dictionary.TryGetValue(relatedEnd, out source))
      {
        ...
        throw new InvalidOperationException(System.Data.Entity.Resources.Strings.EntityReference_CannotAddMoreThanOneEntityToEntityReference((object) relatedEnd.RelationshipNavigation.To, (object) relatedEnd.RelationshipNavigation.RelationshipName));
    ...
    internal void Delete(bool doFixup)
    {
      this.ValidateState();
      if (this.IsKeyEntry)
        throw new InvalidOperationException(System.Data.Entity.Resources.Strings.ObjectStateEntry_CannotDeleteOnKeyEntry);
    ...
    internal object GetCurrentEntityValue(string memberName) => this.GetCurrentEntityValue(this._cacheTypeMetadata, this._cacheTypeMetadata.GetOrdinalforOLayerMemberName(memberName), this._wrappedEntity.Entity, ObjectStateValueRecord.CurrentUpdatable);
    ...
    {
      if (this.State == EntityState.Deleted)
        throw new InvalidOperationException(System.Data.Entity.Resources.Strings.ObjectStateEntry_CantModifyDetachedDeletedEntries);
      if (typeMetadata.Member(ordinal).IsPartOfKey && this.State != EntityState.Added)
        throw new InvalidOperationException(System.Data.Entity.Resources.Strings.ObjectStateEntry_CannotModifyKeyProperty((object) memberName));
    }
      ...
      object newValue)
    {
      ...
      if (member.IsComplex)
      {
        if (newValue == null || newValue == DBNull.Value)
          throw new InvalidOperationException(System.Data.Entity.Resources.Strings.ComplexObject_NullableComplexTypesNotSupported((object) member.CLayerName));
        if (!(newValue is IExtendedDataRecord record2))
          throw new ArgumentException(System.Data.Entity.Resources.Strings.ObjectStateEntry_InvalidTypeForComplexTypeProperty, nameof (newValue));
        newValue = this._cache.ComplexTypeMaterializer.CreateComplex(record2, record2.DataRecordInfo, (object) null);
      }
          ...
          case EntityState.Unchanged:
            switch (requestedState)
            {
              ...
              case EntityState.Modified:
                ...
                return;
              default:
                throw new ArgumentException(System.Data.Entity.Resources.Strings.ObjectContext_InvalidEntityState, nameof (requestedState));
            }
          case EntityState.Added:
            switch (requestedState)
            {
    ...
    internal void UpdateRecordWithoutSetModified(object value, DbUpdatableDataRecord current) => this.UpdateRecord(value, current, EntityEntry.UpdateRecordBehavior.WithoutSetModified, -1);

    internal void UpdateRecordWithSetModified(object value, DbUpdatableDataRecord current) => this.UpdateRecord(value, current, EntityEntry.UpdateRecordBehavior.WithSetModified, -1);
      ...
      int propertyIndex)
    {
      ...
      foreach (FieldMetadata fieldMetadata in metadata.DataRecordInfo.FieldMetadata)
      {
        ...
        if (Helper.IsComplexType(fieldMetadata.FieldType.TypeUsage.EdmType))
        {
          ...
          if (obj == DBNull.Value)
            throw new InvalidOperationException(System.Data.Entity.Resources.Strings.ComplexObject_NullableComplexTypesNotSupported((object) fieldMetadata.FieldType.Name));
      ...
      object newFieldValue)
    {
      ...
      if (x != newFieldValue && (DBNull.Value == newFieldValue || DBNull.Value == x || !ByValueEqualityComparer.Default.Equals(x, newFieldValue)))
        return true;
      return this._cache.EntryHasConceptualNull(this) && this._modifiedFields != null && this._modifiedFields[propertyIndex];
    }
    ...
    internal void ApplyCurrentValuesInternal(IEntityWrapper wrappedCurrentEntity)
    {
      if (this.State != EntityState.Modified && this.State != EntityState.Unchanged)
        throw new InvalidOperationException(System.Data.Entity.Resources.Strings.ObjectContext_EntityMustBeUnchangedOrModified((object) this.State.ToString()));
      if (this.WrappedEntity.IdentityType != wrappedCurrentEntity.IdentityType)
        throw new ArgumentException(System.Data.Entity.Resources.Strings.ObjectContext_EntitiesHaveDifferentType((object) this.Entity.GetType().FullName, (object) wrappedCurrentEntity.Entity.GetType().FullName));
      this.CompareKeyProperties(wrappedCurrentEntity.Entity);
      this.UpdateCurrentValueRecord(wrappedCurrentEntity.Entity);
    }

    internal void UpdateCurrentValueRecord(object value) => this._wrappedEntity.UpdateCurrentValueRecord(value, this);
    ...
    internal void ApplyOriginalValuesInternal(IEntityWrapper wrappedOriginalEntity)
    {
      if (this.State != EntityState.Modified && this.State != EntityState.Unchanged && this.State != EntityState.Deleted)
        throw new InvalidOperationException(System.Data.Entity.Resources.Strings.ObjectContext_EntityMustBeUnchangedOrModifiedOrDeleted((object) this.State.ToString()));
      if (this.WrappedEntity.IdentityType != wrappedOriginalEntity.IdentityType)
        throw new ArgumentException(System.Data.Entity.Resources.Strings.ObjectContext_EntitiesHaveDifferentType((object) this.Entity.GetType().FullName, (object) wrappedOriginalEntity.Entity.GetType().FullName));
    ...
    internal void FixupReferencesByForeignKeys(bool replaceAddedRefs, EntitySetBase restrictTo = null)
    {
      ...
      try
      {
        foreach (Tuple<AssociationSet, ReferentialConstraint> tuple in this.ForeignKeyDependents.Where<Tuple<AssociationSet, ReferentialConstraint>>((Func<Tuple<AssociationSet, ReferentialConstraint>, bool>) (t => restrictTo == null || t.Item1.SourceSet.Identity == restrictTo.Identity || t.Item1.TargetSet.Identity == restrictTo.Identity)))
        {
      ...
      if (foreignKey != (EntityKey) null)
      {
        ...
        if (this._cache.TryGetEntityEntry(foreignKey, out entry) && !entry.IsKeyEntry && entry.State != EntityState.Deleted && ((replaceExistingRef || EntityEntry.WillNotRefSteal(relatedEnd, entry.WrappedEntity)) && relatedEnd.CanSetEntityType(entry.WrappedEntity)))
        {
          if (flag)
          {
            ...
            if (this._cache.TransactionManager.PopulatedEntityReferences != null && relatedEnd.GetOtherEndOfRelationship(entry.WrappedEntity) is EntityReference endOfRelationship6)
              this._cache.TransactionManager.PopulatedEntityReferences.Add(endOfRelationship6);
          }
      ...
      IEntityWrapper wrappedPrincipal)
    {
      ...
      if (refToPrincipal.ReferenceValue.Entity == null && refToPrincipal.NavigationPropertyIsNullOrMissing() && (endOfRelationship == null || endOfRelationship.ReferenceValue.Entity == null && endOfRelationship.NavigationPropertyIsNullOrMissing()) || endOfRelationship != null && (endOfRelationship.ReferenceValue.Entity == refToPrincipal.WrappedOwner.Entity || endOfRelationship.CheckIfNavigationPropertyContainsEntity(refToPrincipal.WrappedOwner)))
        return true;
      if (endOfRelationship == null || refToPrincipal.ReferenceValue.Entity == wrappedPrincipal.Entity || refToPrincipal.CheckIfNavigationPropertyContainsEntity(wrappedPrincipal))
        return false;
      throw new InvalidOperationException(System.Data.Entity.Resources.Strings.EntityReference_CannotAddMoreThanOneEntityToEntityReference((object) endOfRelationship.RelationshipNavigation.To, (object) endOfRelationship.RelationshipNavigation.RelationshipName));
    }
          ...
          if (objectStateEntry != null && objectStateEntry.State == EntityState.Added)
          {
            ...
            if (visited.Contains(this))
            {
              if (!nullable.HasValue)
                nullable = new bool?(relatedEndInternal.GetOtherEndOfRelationship(referenceValue) is EntityReference);
              if (nullable.Value)
                throw new InvalidOperationException(System.Data.Entity.Resources.Strings.RelationshipManager_CircularRelationshipsWithReferentialConstraints);
            }
            else
            {
              visited.Add(this);
...
label_14:
    ...
    internal bool RequiresComplexChangeTracking => this._requiresComplexChangeTracking;

    internal bool RequiresScalarChangeTracking => this._requiresScalarChangeTracking;

    internal bool RequiresAnyChangeTracking => this._requiresAnyChangeTracking;
      ...
      IEnumerable<IEntityStateEntry>
    {
      ...
      internal RelationshipEndEnumerable(EntityEntry entityEntry) => this._entityEntry = entityEntry;

      public EntityEntry.RelationshipEndEnumerator GetEnumerator() => new EntityEntry.RelationshipEndEnumerator(this._entityEntry);

      IEnumerator<IEntityStateEntry> IEnumerable<IEntityStateEntry>.GetEnumerator() => (IEnumerator<IEntityStateEntry>) this.GetEnumerator();

      IEnumerator<RelationshipEntry> IEnumerable<RelationshipEntry>.GetEnumerator() => (IEnumerator<RelationshipEntry>) this.GetEnumerator();
      ...
      IEnumerator<IEntityStateEntry>
    {
      ...
      public RelationshipEntry Current => this._current;

      IEntityStateEntry IEnumerator<IEntityStateEntry>.Current => (IEntityStateEntry) this._current;
