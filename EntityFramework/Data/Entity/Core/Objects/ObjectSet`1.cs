...
namespace System.Data.Entity.Core.Objects
{
    ...
    where TEntity : class
  {
    ...
    public void AddObject(TEntity entity) => this.Context.AddObject(this.FullyQualifiedEntitySetName, (object) entity);
    ...
    public void Attach(TEntity entity) => this.Context.AttachTo(this.FullyQualifiedEntitySetName, (object) entity);
    ...
    /// .
    /// </param>
    public void DeleteObject(TEntity entity) => this.Context.DeleteObject((object) entity, this.EntitySet);
    ...
    /// </param>
    public void Detach(TEntity entity) => this.Context.Detach((object) entity, this.EntitySet);
    ...
    /// .
    /// </param>
    public TEntity ApplyCurrentValues(TEntity currentEntity) => this.Context.ApplyCurrentValues<TEntity>(this.FullyQualifiedEntitySetName, currentEntity);
    ...
    /// .
    /// </param>
    public TEntity ApplyOriginalValues(TEntity originalEntity) => this.Context.ApplyOriginalValues<TEntity>(this.FullyQualifiedEntitySetName, originalEntity);
    ...
    public TEntity CreateObject() => this.Context.CreateObject<TEntity>();
    ...
    public T CreateObject<T>() where T : class, TEntity => this.Context.CreateObject<T>();

    private string FullyQualifiedEntitySetName => string.Format((IFormatProvider) CultureInfo.InvariantCulture, "{0}.{1}", (object) this._entitySet.EntityContainer.Name, (object) this._entitySet.Name);
  }
}
