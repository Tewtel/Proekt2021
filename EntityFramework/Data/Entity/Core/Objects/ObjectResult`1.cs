...
namespace System.Data.Entity.Core.Objects
{
    ...
    IDbAsyncEnumerable
  {
    ...
    public virtual IEnumerator<T> GetEnumerator() => (IEnumerator<T>) this.GetDbEnumerator();
    ...
    /// <inheritdoc />
    IDbAsyncEnumerator<T> IDbAsyncEnumerable<T>.GetAsyncEnumerator() => (IDbAsyncEnumerator<T>) this.GetDbEnumerator();
    ...
    internal override IDbAsyncEnumerator GetAsyncEnumeratorInternal() => (IDbAsyncEnumerator) this.GetDbEnumerator();

    internal override IEnumerator GetEnumeratorInternal() => (IEnumerator) this.GetDbEnumerator();
    ...
    internal override ObjectResult<TElement> GetNextResultInternal<TElement>() => this._nextResultGenerator == null ? (ObjectResult<TElement>) null : this._nextResultGenerator.GetNextResult<TElement>(this._reader);
