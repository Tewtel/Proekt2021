  ...
  internal static class ReflectionUtil
  {
    ...
    static ReflectionUtil()
    {
      ...
      foreach (MethodInfo allLinqOperator in ReflectionUtil.GetAllLinqOperators())
      {
        ...
        {
          ReflectionUtil._methodMap.Add(allLinqOperator, key);
          ReflectionUtil._inverseMap[key] = allLinqOperator;
        }
      }
    }

    internal static Dictionary<MethodInfo, SequenceMethod> MethodMap => ReflectionUtil._methodMap;

    internal static Dictionary<SequenceMethod, MethodInfo> InverseMap => ReflectionUtil._inverseMap;
    ...
    internal static bool TryLookupMethod(SequenceMethod sequenceMethod, out MethodInfo method) => ReflectionUtil._inverseMap.TryGetValue(sequenceMethod, out method);
    ...
    private static IEnumerable<MethodInfo> GetAllLinqOperators() => typeof (Queryable).GetDeclaredMethods().Concat<MethodInfo>(typeof (Enumerable).GetDeclaredMethods());
  }
}
