...
namespace System.Data.Entity.Core.Objects.ELinq
{
  internal static class TypeSystem
  {
    ...
    internal static bool IsSequenceType(Type seqType) => TypeSystem.FindIEnumerable(seqType) != (Type) null;
      ...
      out Type type)
    {
      ...
      if (member.MemberType == MemberTypes.Property)
      {
        ...
        name = propertyInfo.GetIndexParameters().Length == 0 ? propertyInfo.Name : throw new NotSupportedException(System.Data.Entity.Resources.Strings.ELinq_PropertyIndexNotSupported);
        type = propertyInfo.PropertyType;
        return (MemberInfo) propertyInfo;
      }
      MethodInfo methodInfo = member.MemberType == MemberTypes.Method ? (MethodInfo) member : throw new NotSupportedException(System.Data.Entity.Resources.Strings.ELinq_NotPropertyOrField((object) member.Name));
