...
namespace System.Data.Entity.Core.Objects
{
  internal static class DelegateFactory
  {
    ...
    internal static Func<object> GetConstructorDelegateForType(ClrComplexType clrType) => clrType.Constructor ?? (clrType.Constructor = DelegateFactory.CreateConstructor(clrType.ClrType));

    internal static Func<object> GetConstructorDelegateForType(ClrEntityType clrType) => clrType.Constructor ?? (clrType.Constructor = DelegateFactory.CreateConstructor(clrType.ClrType));

    internal static object GetValue(EdmProperty property, object target) => DelegateFactory.GetGetterDelegateForProperty(property)(target);

    internal static Func<object, object> GetGetterDelegateForProperty(EdmProperty property) => property.ValueGetter ?? (property.ValueGetter = DelegateFactory.CreatePropertyGetter(property.EntityDeclaringType, property.PropertyInfo));

    internal static void SetValue(EdmProperty property, object target, object value) => DelegateFactory.GetSetterDelegateForProperty(property)(target, value);
      ...
      PropertyInfo navigationProperty)
    {
      ...
      if (methodInfo == (MethodInfo) null)
        throw new InvalidOperationException(System.Data.Entity.Resources.Strings.CodeGen_PropertyNoSetter);
      if (methodInfo.IsStatic)
        throw new InvalidOperationException(System.Data.Entity.Resources.Strings.CodeGen_PropertyIsStatic);
      if (methodInfo.DeclaringType.IsValueType())
        throw new InvalidOperationException(System.Data.Entity.Resources.Strings.CodeGen_PropertyDeclaringTypeIsValueType);
    ...
    internal static ConstructorInfo GetConstructorForType(Type type)
    {
      ...
      return !((ConstructorInfo) null == declaredConstructor) ? declaredConstructor : throw new InvalidOperationException(System.Data.Entity.Resources.Strings.CodeGen_ConstructorNoParameterless((object) type.FullName));
    }
      ...
      PropertyInfo propertyInfo)
    {
      ...
      if (methodInfo == (MethodInfo) null)
        throw new InvalidOperationException(System.Data.Entity.Resources.Strings.CodeGen_PropertyNoGetter);
      if (methodInfo.IsStatic)
        throw new InvalidOperationException(System.Data.Entity.Resources.Strings.CodeGen_PropertyIsStatic);
      if (propertyInfo.DeclaringType.IsValueType())
        throw new InvalidOperationException(System.Data.Entity.Resources.Strings.CodeGen_PropertyDeclaringTypeIsValueType);
      Type type = !((IEnumerable<ParameterInfo>) propertyInfo.GetIndexParameters()).Any<ParameterInfo>() ? propertyInfo.PropertyType : throw new InvalidOperationException(System.Data.Entity.Resources.Strings.CodeGen_PropertyIsIndexed);
      if (type.IsPointer)
        throw new InvalidOperationException(System.Data.Entity.Resources.Strings.CodeGen_PropertyUnsupportedType);
    ...
    internal static PropertyInfo ValidateSetterProperty(PropertyInfo propertyInfo)
    {
      ...
      if (((IEnumerable<ParameterInfo>) propertyInfoForSet.GetIndexParameters()).Any<ParameterInfo>())
        throw new InvalidOperationException(System.Data.Entity.Resources.Strings.CodeGen_PropertyIsIndexed);
      ...
      where TTarget : class
    {
      switch (targetMember.RelationshipMultiplicity)
      {
        ...
        default:
          ...
          throw new ArgumentOutOfRangeException(type.Name, System.Data.Entity.Resources.Strings.ADP_InvalidEnumerationValue((object) type.Name, (object) ((int) targetMember.RelationshipMultiplicity).ToString((IFormatProvider) CultureInfo.InvariantCulture)));
      }
    }
  }
}
