...
namespace System.Data.Entity.Core.Objects
{
  ...
  public sealed class CompiledQuery
  {
    ...
    private CompiledQuery(LambdaExpression query) => this._query = (LambdaExpression) Funcletizer.CreateCompiledQueryLockdownFuncletizer().Funcletize((Expression) query, out Func<bool> _);
    ...
    {
      bool isSingleton;
      IEnumerable query = (IEnumerable) new CompiledELinqQueryState(CompiledQuery.GetElementType(typeof (TResult), out isSingleton), context, this._query, this._cacheToken, parameterValues).CreateQuery();
      return isSingleton ? ObjectQueryProvider.ExecuteSingle<TResult>(query.Cast<TResult>(), (Expression) this._query) : (TResult) query;
    }
    ...
    private static Type GetElementType(Type resultType, out bool isSingleton)
    {
      ...
      if (!(elementType == resultType))
        ...
        num = 1;
      local = num != 0;
      return isSingleton ? resultType : elementType;
    }
  }
}
