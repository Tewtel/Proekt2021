...
namespace System.Data.Entity.Core.Objects.Internal
{
  internal class LazyLoadImplementor
  {
    ...
    public LazyLoadImplementor(EntityType ospaceEntityType) => this.CheckType(ospaceEntityType);

    public IEnumerable<EdmMember> Members => (IEnumerable<EdmMember>) this._members;
    ...
    public bool CanProxyMember(EdmMember member) => this._members.Contains(member);
    ...
    internal static string GetInterceptorFieldName(string memberName) => "ef_proxy_interceptorFor" + memberName;
  }
}
