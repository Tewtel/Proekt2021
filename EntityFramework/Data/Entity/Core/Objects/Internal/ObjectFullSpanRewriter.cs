...
namespace System.Data.Entity.Core.Objects.Internal
{
  internal class ObjectFullSpanRewriter : ObjectSpanRewriter
  {
    ...
    private void ConvertSpanPath(
      ...
      int pos)
    {
      NavigationProperty navigationProperty = (NavigationProperty) null;
      ...
      if (!parentInfo.Children.TryGetValue(navigationProperty, out parentInfo1))
      {
        parentInfo1 = new ObjectFullSpanRewriter.SpanPathInfo(ObjectFullSpanRewriter.EntityTypeFromResultType(navigationProperty));
        parentInfo.Children[navigationProperty] = parentInfo1;
      }
      ...
      EntityType entityType)
    {
      ...
      if (spanPathInfo.Children != null)
      {
        ...
        foreach (KeyValuePair<NavigationProperty, ObjectFullSpanRewriter.SpanPathInfo> child in spanPathInfo.Children)
        {
          ...
          spanTrackingInfo.SpannedColumns[key] = propertyTargetEnd;
    ...
    private class SpanPathInfo
    {
      ...
      internal SpanPathInfo(EntityType declaringType) => this.DeclaringType = declaringType;
    }
  }
}
