...
namespace System.Data.Entity.Core.Objects.Internal
{
  internal class IPocoImplementor
  {
    ...
    public bool CanProxyMember(EdmMember member) => this._scalarMembers.Contains(member) || this._relationshipMembers.Contains(member);
      ...
      Action<FieldBuilder, bool> registerField)
    {
      ...
      ilGenerator.Emit(OpCodes.Ldfld, (FieldInfo) this._relationshipManagerField);
      ilGenerator.Emit(OpCodes.Ret);
      MethodBuilder relationshipManager = this._getRelationshipManager;
      propertyBuilder.SetGetMethod(relationshipManager);
