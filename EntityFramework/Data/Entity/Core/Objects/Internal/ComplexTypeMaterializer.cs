...
namespace System.Data.Entity.Core.Objects.Internal
{
  internal class ComplexTypeMaterializer
  {
    ...
    internal ComplexTypeMaterializer(MetadataWorkspace workspace) => this._workspace = workspace;
    ...
    private static object ConvertDBNull(object value) => DBNull.Value == value ? (object) null : value;

    private object CreateComplexRecursive(object record, object existing) => DBNull.Value == record ? existing : this.CreateComplexRecursive((IExtendedDataRecord) record, existing);

    private object CreateComplexRecursive(IExtendedDataRecord record, object existing) => this.CreateComplex(record, record.DataRecordInfo, existing);
