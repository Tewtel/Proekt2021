...
namespace System.Data.Entity.Core.Objects
{
  internal sealed class Span
  {
    ...
    internal Span() => this._spanList = new List<Span.SpanPath>();

    internal List<Span.SpanPath> SpanList => this._spanList;

    internal static bool RequiresRelationshipSpan(MergeOption mergeOption) => mergeOption != MergeOption.NoTracking;
    ...
    internal class SpanPath
    {
      ...
      public SpanPath(List<string> navigations) => this.Navigations = navigations;
