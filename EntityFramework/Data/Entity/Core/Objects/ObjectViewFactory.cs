...
namespace System.Data.Entity.Core.Objects
{
  internal static class ObjectViewFactory
  {
      ...
      EntitySet singleEntitySet)
    {
      ...
      {
        Type type2 = typeof (TElement).IsAssignableFrom(clrType) ? ObjectViewFactory._genericObjectViewQueryResultDataType.MakeGenericType(clrType) : throw EntityUtil.ValueInvalidCast(clrType, typeof (TElement));
      ...
      where TElement : class
    {
      ...
      {
        Type type2 = typeof (TElement).IsAssignableFrom(type1) ? ObjectViewFactory._genericObjectViewEntityCollectionDataType.MakeGenericType(type1, typeof (TElement)) : throw EntityUtil.ValueInvalidCast(type1, typeof (TElement));
