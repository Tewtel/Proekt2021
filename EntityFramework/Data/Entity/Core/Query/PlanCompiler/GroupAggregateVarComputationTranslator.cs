...
namespace System.Data.Entity.Core.Query.PlanCompiler
{
  internal class GroupAggregateVarComputationTranslator : BasicOpVisitorOfNode
  {
    ...
    public override System.Data.Entity.Core.Query.InternalTrees.Node Visit(VarRefOp op, System.Data.Entity.Core.Query.InternalTrees.Node n) => this.TranslateOverGroupAggregateVar(op.Var, (EdmMember) null);

    public override System.Data.Entity.Core.Query.InternalTrees.Node Visit(
      PropertyOp op,
      System.Data.Entity.Core.Query.InternalTrees.Node n)
    {
      return n.Child0.Op.OpType != OpType.VarRef ? base.Visit(op, n) : this.TranslateOverGroupAggregateVar(((VarRefOp) n.Child0.Op).Var, op.PropertyInfo);
    }
    ...
    protected override System.Data.Entity.Core.Query.InternalTrees.Node VisitDefault(System.Data.Entity.Core.Query.InternalTrees.Node n)
    {
      ...
      for (int index = 0; index < n.Children.Count; ++index)
      {
        ...
        if (node == null)
          return (System.Data.Entity.Core.Query.InternalTrees.Node) null;
        if (!flag && n.Children[index] != node)
          flag = true;
        args.Add(node);
      }
      return !flag ? n : this._command.CreateNode(n.Op, args);
    }
    ...
    public override System.Data.Entity.Core.Query.InternalTrees.Node Visit(CollectOp op, System.Data.Entity.Core.Query.InternalTrees.Node n) => (System.Data.Entity.Core.Query.InternalTrees.Node) null;

    public override System.Data.Entity.Core.Query.InternalTrees.Node Visit(ElementOp op, System.Data.Entity.Core.Query.InternalTrees.Node n) => (System.Data.Entity.Core.Query.InternalTrees.Node) null;
  }
}
