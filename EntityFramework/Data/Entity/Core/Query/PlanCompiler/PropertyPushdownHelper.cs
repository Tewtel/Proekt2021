...
namespace System.Data.Entity.Core.Query.PlanCompiler
{
  internal class PropertyPushdownHelper : BasicOpVisitor
  {
    ...
    private void Process(System.Data.Entity.Core.Query.InternalTrees.Node rootNode) => rootNode.Op.Accept((BasicOpVisitor) this, rootNode);
    ...
    private void AddPropertyRefs(System.Data.Entity.Core.Query.InternalTrees.Node node, PropertyRefList propertyRefs) => this.GetPropertyRefList(node).Append(propertyRefs);
    ...
    private void AddPropertyRefs(Var v, PropertyRefList propertyRefs) => this.GetPropertyRefList(v).Append(propertyRefs);
    ...
    protected override void VisitDefault(System.Data.Entity.Core.Query.InternalTrees.Node n)
    {
      ...
      {
        if (child.Op is ScalarOp op1 && TypeUtils.IsStructuredType(op1.Type))
    ...
    public override void Visit(CollectOp op, System.Data.Entity.Core.Query.InternalTrees.Node n) => this.VisitChildren(n);
    ...
    public override void Visit(RelPropertyOp op, System.Data.Entity.Core.Query.InternalTrees.Node n) => this.VisitPropertyOp((Op) op, n, (PropertyRef) new RelPropertyRef(op.PropertyInfo));

    public override void Visit(PropertyOp op, System.Data.Entity.Core.Query.InternalTrees.Node n) => this.VisitPropertyOp((Op) op, n, (PropertyRef) new SimplePropertyRef(op.PropertyInfo));
    ...
    public override void Visit(VarDefListOp op, System.Data.Entity.Core.Query.InternalTrees.Node n) => this.VisitChildren(n);
    ...
    public override void Visit(ScanTableOp op, System.Data.Entity.Core.Query.InternalTrees.Node n) => System.Data.Entity.Core.Query.PlanCompiler.PlanCompiler.Assert(!n.HasChild0, "scanTableOp with an input?");
    ...
    public override void Visit(UnnestOp op, System.Data.Entity.Core.Query.InternalTrees.Node n) => this.VisitChildren(n);
    ...
    public override void Visit(MultiStreamNestOp op, System.Data.Entity.Core.Query.InternalTrees.Node n) => throw new NotSupportedException();

    public override void Visit(SingleStreamNestOp op, System.Data.Entity.Core.Query.InternalTrees.Node n) => throw new NotSupportedException();
  }
}
