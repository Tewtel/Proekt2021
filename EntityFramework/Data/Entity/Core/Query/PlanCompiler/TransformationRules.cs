...
namespace System.Data.Entity.Core.Query.PlanCompiler
{
  internal static class TransformationRules
  {
    ...
    private static HashSet<System.Data.Entity.Core.Query.InternalTrees.Rule> InitializeRulesRequiringProjectionPruning() => new HashSet<System.Data.Entity.Core.Query.InternalTrees.Rule>()
    {
    ...
    private static HashSet<System.Data.Entity.Core.Query.InternalTrees.Rule> InitializeRulesRequiringNullabilityRulesToBeReapplied() => new HashSet<System.Data.Entity.Core.Query.InternalTrees.Rule>()
    {
    ...
    internal static bool Process(System.Data.Entity.Core.Query.PlanCompiler.PlanCompiler compilerState, TransformationRulesGroup rulesGroup)
    {
      ...
      if (TransformationRules.Process(compilerState, rulesTable, out projectionPruningRequired1))
      {
        ...
        projectionPruningRequired1 |= projectionPruningRequired2;
      }
