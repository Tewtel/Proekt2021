  ...
  internal static class GroupByOpRules
  {
      ...
      out System.Data.Entity.Core.Query.InternalTrees.Node newNode)
    {
      ...
      foreach (System.Data.Entity.Core.Query.InternalTrees.Node child in n.Child1.Children)
      {
        ...
        if (child.Child0.Op is VarRefOp op5 && !extendedNodeInfo.ExternalReferences.IsSet(op5.Var))
        {
          op1.Outputs.Clear(op2.Var);
          op1.Outputs.Set(op5.Var);
          op1.Keys.Clear(op2.Var);
          op1.Keys.Set(op5.Var);
          transformationRulesContext.AddVarMapping(op2.Var, op5.Var);
        }
        else
          args.Add(child);
      }
    ...
    {
      newNode = n;
      if (!(context.Command.Root.Op is PhysicalProjectOp op1) || op1.Outputs.Count > 1 || (n.Child0.Op.OpType != OpType.ScanTable || n.Child2 == null) || (n.Child2.Child0 == null || n.Child2.Child0.Child0 == null || n.Child2.Child0.Child0.Op.OpType != OpType.Aggregate))
        return false;
      ...
      for (int index = 0; index < table.Keys.Count; ++index)
      {
        ...
        System.Data.Entity.Core.Query.InternalTrees.Node node4 = command.CreateNode((Op) command.CreateComparisonOp(OpType.EQ), command.CreateNode((Op) command.CreateVarRefOp(enumerator1.Current)), command.CreateNode((Op) command.CreateVarRefOp(enumerator2.Current)));
    ...
    internal class VarRefReplacer : BasicOpVisitorOfNode
    {
        ...
        System.Data.Entity.Core.Query.InternalTrees.Node n)
      {
        ...
        return this.m_varReplacementTable.TryGetValue(op.Var, out node) ? node : n;
      }
