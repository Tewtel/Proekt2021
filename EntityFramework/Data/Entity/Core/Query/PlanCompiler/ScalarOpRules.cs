...
namespace System.Data.Entity.Core.Query.PlanCompiler
{
  internal static class ScalarOpRules
  {
      ...
      out System.Data.Entity.Core.Query.InternalTrees.Node newNode)
    {
      ...
      bool? nullable = ScalarOpRules.MatchesPattern((string) ((ConstantBaseOp) n.Child0.Op).Value, (string) op.Value);
      if (!nullable.HasValue)
        return false;
      ...
      out System.Data.Entity.Core.Query.InternalTrees.Node newNode)
    {
      ...
      switch (node.Op.OpType)
      {
        ...
        case OpType.Not:
          ...
          break;
        default:
          System.Data.Entity.Core.Query.PlanCompiler.PlanCompiler.Assert(false, "Unexpected OpType - " + node.Op.OpType.ToString());
    ...
    private static bool PreservesNulls(EdmFunction function) => function.FullName == "Edm.Length";
  }
}
