...
namespace System.Data.Entity.Core.Query.PlanCompiler
{
  internal static class ProjectOpRules
  {
      ...
      out System.Data.Entity.Core.Query.InternalTrees.Node newNode)
    {
      ...
      {
        flag1 = true;
        if (!nullSentinelValue || !TransformationRulesContext.TryGetInt32Var(n.Child1.Children.Where<System.Data.Entity.Core.Query.InternalTrees.Node>((Func<System.Data.Entity.Core.Query.InternalTrees.Node, bool>) (child => child.Child0.Op.OpType == OpType.Constant || child.Child0.Op.OpType == OpType.InternalConstant)).Select<System.Data.Entity.Core.Query.InternalTrees.Node, Var>((Func<System.Data.Entity.Core.Query.InternalTrees.Node, Var>) (child => ((VarDefOp) child.Op).Var)), out int32Var))
        {
