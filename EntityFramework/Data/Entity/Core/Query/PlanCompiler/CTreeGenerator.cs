...
namespace System.Data.Entity.Core.Query.PlanCompiler
{
  internal class CTreeGenerator : BasicOpVisitorOfT<DbExpression>
  {
    ...
    internal static DbCommandTree Generate(Command itree, System.Data.Entity.Core.Query.InternalTrees.Node toConvert) => (DbCommandTree) new CTreeGenerator(itree, toConvert)._queryTree;
    ...
    private CTreeGenerator(Command itree, System.Data.Entity.Core.Query.InternalTrees.Node toConvert)
    {
      ...
      this._queryTree = DbQueryCommandTree.FromValidExpression(itree.MetadataWorkspace, DataSpace.SSpace, query, true, false);
    }

    private void AssertRelOp(DbExpression expr) => System.Data.Entity.Core.Query.PlanCompiler.PlanCompiler.Assert(this._relOpState.ContainsKey(expr), "not a relOp expression?");
    ...
    private CTreeGenerator.RelOpInfo EnterExpressionBindingScope(System.Data.Entity.Core.Query.InternalTrees.Node inputNode) => this.EnterExpressionBindingScope(inputNode, true);
    ...
    private void ExitExpressionBindingScope(CTreeGenerator.RelOpInfo scope) => this.ExitExpressionBindingScope(scope, true);
    ...
    private DbExpression ResolveVar(Var referencedVar)
    {
      ...
      if (referencedVar is ParameterVar key)
      {
      ...
      {
        if (referencedVar is ComputedVar computedVar2 && this._varScopes.Count > 0 && !this._varScopes.Peek().TryResolveVar((Var) computedVar2, out resultExpr1))
    ...
    private static void AssertBinary(System.Data.Entity.Core.Query.InternalTrees.Node n) => System.Data.Entity.Core.Query.PlanCompiler.PlanCompiler.Assert((2 == n.Children.Count ? 1 : 0) != 0, string.Format((IFormatProvider) CultureInfo.InvariantCulture, "Non-Binary {0} encountered", (object) n.Op.GetType().Name));
    ...
    protected override DbExpression VisitConstantOp(ConstantBaseOp op, System.Data.Entity.Core.Query.InternalTrees.Node n) => (DbExpression) op.Type.Constant(op.Value);

    public override DbExpression Visit(ConstantOp op, System.Data.Entity.Core.Query.InternalTrees.Node n) => this.VisitConstantOp((ConstantBaseOp) op, n);

    public override DbExpression Visit(InternalConstantOp op, System.Data.Entity.Core.Query.InternalTrees.Node n) => this.VisitConstantOp((ConstantBaseOp) op, n);

    public override DbExpression Visit(NullOp op, System.Data.Entity.Core.Query.InternalTrees.Node n) => (DbExpression) op.Type.Null();

    public override DbExpression Visit(NullSentinelOp op, System.Data.Entity.Core.Query.InternalTrees.Node n) => this.VisitConstantOp((ConstantBaseOp) op, n);

    public override DbExpression Visit(ConstantPredicateOp op, System.Data.Entity.Core.Query.InternalTrees.Node n) => (DbExpression) DbExpressionBuilder.True.Equal(op.IsTrue ? (DbExpression) DbExpressionBuilder.True : (DbExpression) DbExpressionBuilder.False);

    public override DbExpression Visit(FunctionOp op, System.Data.Entity.Core.Query.InternalTrees.Node n) => (DbExpression) op.Function.Invoke((IEnumerable<DbExpression>) this.VisitChildren(n));

    public override DbExpression Visit(PropertyOp op, System.Data.Entity.Core.Query.InternalTrees.Node n) => throw new NotSupportedException();

    public override DbExpression Visit(RelPropertyOp op, System.Data.Entity.Core.Query.InternalTrees.Node n) => throw new NotSupportedException();
    ...
    public override DbExpression Visit(ConditionalOp op, System.Data.Entity.Core.Query.InternalTrees.Node n)
    {
      ...
      switch (op.OpType)
      {
        ...
        case OpType.In:
          ...
          break;
        case OpType.Not:
          dbExpression = !(left is DbNotExpression dbNotExpression2) ? (DbExpression) left.Not() : dbNotExpression2.Argument;
          break;
        case OpType.IsNull:
    ...
    public override DbExpression Visit(LikeOp op, System.Data.Entity.Core.Query.InternalTrees.Node n) => (DbExpression) this.VisitChild(n, 0).Like(this.VisitChild(n, 1), this.VisitChild(n, 2));
    ...
    public override DbExpression Visit(AggregateOp op, System.Data.Entity.Core.Query.InternalTrees.Node n)
    {
      ...
      throw new NotSupportedException(System.Data.Entity.Resources.Strings.Iqt_CTGen_UnexpectedAggregate);
    }

    public override DbExpression Visit(NavigateOp op, System.Data.Entity.Core.Query.InternalTrees.Node n) => throw new NotSupportedException();

    public override DbExpression Visit(NewEntityOp op, System.Data.Entity.Core.Query.InternalTrees.Node n) => throw new NotSupportedException();

    public override DbExpression Visit(NewInstanceOp op, System.Data.Entity.Core.Query.InternalTrees.Node n) => throw new NotSupportedException();

    public override DbExpression Visit(DiscriminatedNewEntityOp op, System.Data.Entity.Core.Query.InternalTrees.Node n) => throw new NotSupportedException();

    public override DbExpression Visit(NewMultisetOp op, System.Data.Entity.Core.Query.InternalTrees.Node n) => throw new NotSupportedException();

    public override DbExpression Visit(NewRecordOp op, System.Data.Entity.Core.Query.InternalTrees.Node n) => throw new NotSupportedException();

    public override DbExpression Visit(RefOp op, System.Data.Entity.Core.Query.InternalTrees.Node n) => throw new NotSupportedException();

    public override DbExpression Visit(VarRefOp op, System.Data.Entity.Core.Query.InternalTrees.Node n) => this.ResolveVar(op.Var);

    public override DbExpression Visit(TreatOp op, System.Data.Entity.Core.Query.InternalTrees.Node n) => throw new NotSupportedException();

    public override DbExpression Visit(CastOp op, System.Data.Entity.Core.Query.InternalTrees.Node n) => (DbExpression) this.VisitChild(n, 0).CastTo(op.Type);

    public override DbExpression Visit(SoftCastOp op, System.Data.Entity.Core.Query.InternalTrees.Node n) => this.VisitChild(n, 0);

    public override DbExpression Visit(IsOfOp op, System.Data.Entity.Core.Query.InternalTrees.Node n) => op.IsOfOnly ? (DbExpression) this.VisitChild(n, 0).IsOfOnly(op.IsOfType) : (DbExpression) this.VisitChild(n, 0).IsOf(op.IsOfType);
    ...
    public override DbExpression Visit(GetRefKeyOp op, System.Data.Entity.Core.Query.InternalTrees.Node n) => throw new NotSupportedException();

    public override DbExpression Visit(GetEntityRefOp op, System.Data.Entity.Core.Query.InternalTrees.Node n) => throw new NotSupportedException();

    public override DbExpression Visit(CollectOp op, System.Data.Entity.Core.Query.InternalTrees.Node n) => throw new NotSupportedException();
    ...
    public override DbExpression Visit(ScanViewOp op, System.Data.Entity.Core.Query.InternalTrees.Node n) => throw new NotSupportedException();
    ...
    public override DbExpression Visit(ProjectOp op, System.Data.Entity.Core.Query.InternalTrees.Node n) => this.VisitProject(n, (IEnumerable<Var>) op.Outputs);
    ...
    public override DbExpression Visit(GroupByOp op, System.Data.Entity.Core.Query.InternalTrees.Node n)
    {
      ...
      foreach (System.Data.Entity.Core.Query.InternalTrees.Node child in child2.Children)
      {
        ...
        IEnumerable<DbExpression> arguments = child0.Children.Select<System.Data.Entity.Core.Query.InternalTrees.Node, DbExpression>(new Func<System.Data.Entity.Core.Query.InternalTrees.Node, DbExpression>(((BasicOpVisitorOfT<DbExpression>) this).VisitNode));
        ...
        DbFunctionAggregate functionAggregate = !op2.IsDistinctAggregate ? op2.AggFunc.Aggregate(arguments) : op2.AggFunc.AggregateDistinct(arguments);
      ...
      foreach (Var var in varList)
      {
        ...
        keyValuePairList2.Add(new KeyValuePair<string, DbAggregate>(str, dictionary[var]));
    ...
    public override DbExpression Visit(GroupByIntoOp op, System.Data.Entity.Core.Query.InternalTrees.Node n) => throw new NotSupportedException();
    ...
    public override DbExpression Visit(InnerJoinOp op, System.Data.Entity.Core.Query.InternalTrees.Node n) => this.VisitBinaryJoin(n, DbExpressionKind.InnerJoin);

    public override DbExpression Visit(LeftOuterJoinOp op, System.Data.Entity.Core.Query.InternalTrees.Node n) => this.VisitBinaryJoin(n, DbExpressionKind.LeftOuterJoin);

    public override DbExpression Visit(FullOuterJoinOp op, System.Data.Entity.Core.Query.InternalTrees.Node n) => this.VisitBinaryJoin(n, DbExpressionKind.FullOuterJoin);
    ...
    public override DbExpression Visit(CrossApplyOp op, System.Data.Entity.Core.Query.InternalTrees.Node n) => this.VisitApply(n, DbExpressionKind.CrossApply);

    public override DbExpression Visit(OuterApplyOp op, System.Data.Entity.Core.Query.InternalTrees.Node n) => this.VisitApply(n, DbExpressionKind.OuterApply);
    ...
    private DbProviderManifest ProviderManifest => this._providerManifest ?? (this._providerManifest = ((StoreItemCollection) this._iqtCommand.MetadataWorkspace.GetItemCollection(DataSpace.SSpace)).ProviderManifest);
    ...
    {
      CTreeGenerator.AssertBinary(n);
      int num = op.OpType == OpType.UnionAll || op.OpType == OpType.Intersect ? (this.ProviderManifest.SupportsIntersectAndUnionAllFlattening() ? 1 : 0) : 0;
      DbExpression dbExpression1 = num == 0 || n.Child0.Op.OpType != op.OpType ? this.VisitSetOpArgument(n.Child0, op.Outputs, op.VarMap[0]) : this.VisitSetOp((SetOp) n.Child0.Op, n.Child0, alias, setOpExpressionBuilder);
      DbExpression dbExpression2 = num == 0 || n.Child1.Op.OpType != op.OpType ? this.VisitSetOpArgument(n.Child1, op.Outputs, op.VarMap[1]) : this.VisitSetOp((SetOp) n.Child1.Op, n.Child1, alias, setOpExpressionBuilder);
    ...
    public override DbExpression Visit(UnionAllOp op, System.Data.Entity.Core.Query.InternalTrees.Node n) => this.VisitSetOp((SetOp) op, n, this._unionAllAliases, new Func<DbExpression, DbExpression, DbExpression>(DbExpressionBuilder.UnionAll));

    public override DbExpression Visit(IntersectOp op, System.Data.Entity.Core.Query.InternalTrees.Node n) => this.VisitSetOp((SetOp) op, n, this._intersectAliases, new Func<DbExpression, DbExpression, DbExpression>(DbExpressionBuilder.Intersect));

    public override DbExpression Visit(ExceptOp op, System.Data.Entity.Core.Query.InternalTrees.Node n) => this.VisitSetOp((SetOp) op, n, this._exceptAliases, new Func<DbExpression, DbExpression, DbExpression>(DbExpressionBuilder.Except));

    public override DbExpression Visit(DerefOp op, System.Data.Entity.Core.Query.InternalTrees.Node n) => throw new NotSupportedException();
    ...
    public override DbExpression Visit(VarDefOp op, System.Data.Entity.Core.Query.InternalTrees.Node n)
    {
      ...
      throw new NotSupportedException(System.Data.Entity.Resources.Strings.Iqt_CTGen_UnexpectedVarDef);
    }
    ...
    public override DbExpression Visit(VarDefListOp op, System.Data.Entity.Core.Query.InternalTrees.Node n)
    {
      ...
      throw new NotSupportedException(System.Data.Entity.Resources.Strings.Iqt_CTGen_UnexpectedVarDefList);
    }
    ...
    public override DbExpression Visit(SingleStreamNestOp op, System.Data.Entity.Core.Query.InternalTrees.Node n) => throw new NotSupportedException();

    public override DbExpression Visit(MultiStreamNestOp op, System.Data.Entity.Core.Query.InternalTrees.Node n) => throw new NotSupportedException();
    ...
    private class VarInfo
    {
      ...
      internal Var Var => this._var;

      internal List<string> PropertyPath => this._propertyChain;

      internal VarInfo(Var target) => this._var = target;

      internal void PrependProperty(string propName) => this._propertyChain.Insert(0, propName);
    }
    ...
    private abstract class BindingScope : CTreeGenerator.IqtVarScope
    {
      ...
      internal BindingScope(IEnumerable<CTreeGenerator.VarInfo> boundVars) => this._definedVars = new CTreeGenerator.VarInfoList(boundVars);

      internal CTreeGenerator.VarInfoList PublishedVars => this._definedVars;
    ...
    private class RelOpInfo : CTreeGenerator.BindingScope
    {
      ...
      internal string PublisherName => this._binding.VariableName;

      internal DbExpression Publisher => this._binding.Expression;

      internal DbExpressionBinding CreateBinding() => this._binding;

      protected override DbVariableReferenceExpression BindingReference => this._binding.Variable;
    }
    ...
    private class GroupByScope : CTreeGenerator.BindingScope
    {
      ...
      internal DbGroupExpressionBinding Binding => this._binding;
      ...
      protected override DbVariableReferenceExpression BindingReference => !this._referenceGroup ? this._binding.Variable : this._binding.GroupVariable;
    }
    ...
    private class VarDefScope : CTreeGenerator.IqtVarScope
    {
      ...
      internal VarDefScope(Dictionary<Var, DbExpression> definedVars) => this._definedVars = definedVars;
