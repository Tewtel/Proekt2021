...
namespace System.Data.Entity.Core.Query.PlanCompiler
{
  internal class NestPullup : BasicOpVisitorOfNode
  {
    ...
    internal static void Process(System.Data.Entity.Core.Query.PlanCompiler.PlanCompiler compilerState) => new NestPullup(compilerState).Process();
    ...
    private System.Data.Entity.Core.Query.InternalTrees.Node NestingNotSupported(Op op, System.Data.Entity.Core.Query.InternalTrees.Node n)
    {
      ...
      foreach (System.Data.Entity.Core.Query.InternalTrees.Node child in n.Children)
      {
        if (NestPullup.IsNestOpNode(child))
          throw new NotSupportedException(System.Data.Entity.Resources.Strings.ADP_NestingNotSupported((object) op.OpType.ToString(), (object) child.Op.OpType.ToString()));
      }
      return n;
    }
      ...
      Dictionary<Var, Var> varMap)
    {
      ...
      {
        Var var2;
        if (varMap.TryGetValue(var1, out var2))
          yield return var2;
        else
          yield return var1;
      }
    ...
    private static VarList RemapVarList(VarList varList, Dictionary<Var, Var> varMap) => Command.CreateVarList(NestPullup.RemapVars((IEnumerable<Var>) varList, varMap));

    private VarVec RemapVarVec(VarVec varVec, Dictionary<Var, Var> varMap) => this.Command.CreateVarVec(NestPullup.RemapVars((IEnumerable<Var>) varVec, varMap));
    ...
    public override System.Data.Entity.Core.Query.InternalTrees.Node Visit(CaseOp op, System.Data.Entity.Core.Query.InternalTrees.Node n)
    {
      foreach (System.Data.Entity.Core.Query.InternalTrees.Node child in n.Children)
      {
        if (child.Op.OpType == OpType.Collect)
        {
          ...
          string str1 = opType.ToString();
          opType = child.Op.OpType;
          string str2 = opType.ToString();
          throw new NotSupportedException(System.Data.Entity.Resources.Strings.ADP_NestingNotSupported((object) str1, (object) str2));
        }
      ...
      foreach (System.Data.Entity.Core.Query.InternalTrees.Node child in n.Children)
      {
        if (child.Op is NestBaseOp)
        {
          ...
          if (OpType.SingleStreamNest == child.Op.OpType)
            throw new InvalidOperationException(System.Data.Entity.Resources.Strings.ADP_InternalProviderError((object) 1012));
        }
      }
      if (num == 0)
        return n;
      foreach (System.Data.Entity.Core.Query.InternalTrees.Node child in n.Children)
      {
        if (op.OpType != OpType.MultiStreamNest && child.Op.IsRelOp)
        {
          ...
          if (keyVec == null || keyVec.NoKeys)
            throw new NotSupportedException(System.Data.Entity.Resources.Strings.ADP_KeysRequiredForJoinOverNest((object) op.OpType.ToString()));
        }
      }
    ...
    private System.Data.Entity.Core.Query.InternalTrees.Node CapWithIsNotNullFilter(
      ...
      Var var)
    {
      System.Data.Entity.Core.Query.InternalTrees.Node node1 = this.Command.CreateNode((Op) this.Command.CreateVarRefOp(var));
      System.Data.Entity.Core.Query.InternalTrees.Node node2 = this.Command.CreateNode((Op) this.Command.CreateConditionalOp(OpType.Not), this.Command.CreateNode((Op) this.Command.CreateConditionalOp(OpType.IsNull), node1));
      return this.Command.CreateNode((Op) this.Command.CreateFilterOp(), input, node2);
    }
    ...
    public override System.Data.Entity.Core.Query.InternalTrees.Node Visit(GroupByOp op, System.Data.Entity.Core.Query.InternalTrees.Node n) => this.NestingNotSupported((Op) op, n);
    ...
    public override System.Data.Entity.Core.Query.InternalTrees.Node Visit(SortOp op, System.Data.Entity.Core.Query.InternalTrees.Node n)
    {
      this.VisitChildren(n);
      this.m_varRemapper.RemapNode(n);
      if (!(n.Child0.Op is NestBaseOp op1))
        return n;
      ...
      if (newCollectionVarDefinitions.Count != 0)
      {
        ...
        foreach (KeyValuePair<Var, System.Data.Entity.Core.Query.InternalTrees.Node> keyValuePair in newCollectionVarDefinitions)
        {
          ...
          if (this.m_definingNodeMap.TryGetValue(reverseMap[keyValuePair.Key], out node2))
          {
            ...
            System.Data.Entity.Core.Query.InternalTrees.Node node3 = this.Command.CreateNode((Op) this.Command.CreatePhysicalProjectOp(VarRemapper.RemapVarList(this.Command, (IDictionary<Var, Var>) varMap, op.Outputs), (SimpleCollectionColumnMap) ColumnMapCopier.Copy((ColumnMap) op.ColumnMap, varMap)), keyValuePair.Value);
      ...
      System.Data.Entity.Core.Query.InternalTrees.Node n)
    {
      ...
      {
        if (NestPullup.IsNestOpNode(child))
          throw new InvalidOperationException(System.Data.Entity.Resources.Strings.ADP_InternalProviderError((object) 1002));
      }
      return n;
    }
      ...
      out SimpleColumnMap[] parentKeyColumnMaps)
    {
      ...
      for (int index = 1; index < nestNode.Children.Count; ++index)
      {
        ...
        if (child.Op.OpType == OpType.MultiStreamNest)
        {
          ...
          nestNode.Children[index] = this.ConvertToSingleStreamNest(child, varRefReplacementMap, varList, out SimpleColumnMap[] _);
      ...
      if (keyVec.NoKeys)
        throw new NotSupportedException(System.Data.Entity.Resources.Strings.ADP_KeysRequiredForNesting);
      ...
      for (int index2 = 1; index2 < nestNode.Children.Count; ++index2)
      {
        ...
        ColumnMap columnMap = ColumnMapTranslator.Translate(collectionInfo1.ColumnMap, (IDictionary<Var, Var>) varMapList[index2]);
      ...
      out List<List<SortKey>> sortKeys)
    {
      ...
      for (int index = 1; index < nestNode.Children.Count; ++index)
      {
        ...
        if (input.Op is SingleStreamNestOp op6)
        {
          List<SortKey> sortKeyList = this.BuildSortKeyList(op6);
          sortKeys.Add(sortKeyList);
          input = input.Child0;
        }
        else if (input.Op is SortOp op7)
        {
          input = input.Child0;
          sortKeys.Add(op7.Keys);
        }
        else
      ...
      out List<Dictionary<Var, Var>> varMapList)
    {
      ...
      discriminatorVar = enumerator.MoveNext() ? enumerator.Current : throw EntityUtil.InternalError(EntityUtil.InternalErrorCode.ColumnCountMismatch, 4, (object) null);
      for (int index = 0; index < nestNode.Children.Count; ++index)
      {
        Dictionary<Var, Var> dictionary = new Dictionary<Var, Var>();
        foreach (Var key in index == 0 ? (List<Var>) drivingNodeVars : (List<Var>) nestOp.CollectionInfo[index - 1].FlattenedElementVars)
          dictionary[key] = enumerator.MoveNext() ? enumerator.Current : throw EntityUtil.InternalError(EntityUtil.InternalErrorCode.ColumnCountMismatch, 5, (object) null);
    ...
    {
      IDictionary<Var, Var> reverseMap = (IDictionary<Var, Var>) unionOp.VarMap[0].GetReverseMap();
      VarList varList = Command.CreateVarList();
