...
namespace System.Data.Entity.Core.Query.PlanCompiler
{
  internal static class ApplyOpRules
  {
      ...
      out System.Data.Entity.Core.Query.InternalTrees.Node newNode)
    {
      ...
      {
        System.Data.Entity.Core.Query.PlanCompiler.PlanCompiler.Assert(child.Op.OpType == OpType.VarDef, "Expected VarDefOp. Found " + child.Op.OpType.ToString() + " instead");
        if (!(child.Child0.Op is VarRefOp op2) || !extendedNodeInfo1.Definitions.IsSet(op2.Var))
        {
          if (computedVar == null)
          {
    ...
    {
      internal static int CountOutputs(System.Data.Entity.Core.Query.InternalTrees.Node node) => new ApplyOpRules.OutputCountVisitor().VisitNode(node);
      ...
      protected override int VisitDefault(System.Data.Entity.Core.Query.InternalTrees.Node n) => this.VisitChildren(n);

      protected override int VisitSetOp(SetOp op, System.Data.Entity.Core.Query.InternalTrees.Node n) => op.Outputs.Count;

      public override int Visit(DistinctOp op, System.Data.Entity.Core.Query.InternalTrees.Node n) => op.Keys.Count;

      public override int Visit(FilterOp op, System.Data.Entity.Core.Query.InternalTrees.Node n) => this.VisitNode(n.Child0);

      public override int Visit(GroupByOp op, System.Data.Entity.Core.Query.InternalTrees.Node n) => op.Outputs.Count;

      public override int Visit(ProjectOp op, System.Data.Entity.Core.Query.InternalTrees.Node n) => op.Outputs.Count;

      public override int Visit(ScanTableOp op, System.Data.Entity.Core.Query.InternalTrees.Node n) => op.Table.Columns.Count;

      public override int Visit(SingleRowTableOp op, System.Data.Entity.Core.Query.InternalTrees.Node n) => 0;

      protected override int VisitSortOp(SortBaseOp op, System.Data.Entity.Core.Query.InternalTrees.Node n) => this.VisitNode(n.Child0);
    }
    ...
    internal class VarDefinitionRemapper : VarRemapper
    {
      ...
      internal static void RemapSubtree(System.Data.Entity.Core.Query.InternalTrees.Node root, Command command, Var oldVar) => new ApplyOpRules.VarDefinitionRemapper(oldVar, command).RemapSubtree(root);
