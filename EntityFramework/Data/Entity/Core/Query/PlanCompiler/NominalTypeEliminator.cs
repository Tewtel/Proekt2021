...
namespace System.Data.Entity.Core.Query.PlanCompiler
{
  internal class NominalTypeEliminator : BasicOpVisitorOfNode
  {
    ...
    private Command m_command => this.m_compilerState.Command;
    ...
    {
      foreach (ParameterVar oldVar in this.m_command.Vars.OfType<ParameterVar>().Where<ParameterVar>((Func<ParameterVar, bool>) (v => TypeSemantics.IsEnumerationType(v.Type) || TypeSemantics.IsStrongSpatialType(v.Type))).ToArray<ParameterVar>())
      {
    ...
    private TypeUsage DefaultTypeIdType => this.m_command.StringType;
      ...
      EdmProperty property)
    {
      Op op = input.Op;
      int fieldPosition;
      return op is NewRecordOp newRecordOp ? (newRecordOp.GetFieldPosition(property, out fieldPosition) ? this.Copy(input.Children[fieldPosition]) : (System.Data.Entity.Core.Query.InternalTrees.Node) null) : (op.OpType == OpType.Null ? (System.Data.Entity.Core.Query.InternalTrees.Node) null : this.m_command.CreateNode((Op) this.m_command.CreatePropertyOp((EdmMember) property), this.Copy(input)));
    }
    ...
    private System.Data.Entity.Core.Query.InternalTrees.Node Copy(System.Data.Entity.Core.Query.InternalTrees.Node n) => OpCopier.Copy(this.m_command, n);
    ...
    private System.Data.Entity.Core.Query.InternalTrees.Node CreateNullSentinelConstant() => this.m_command.CreateNode((Op) this.m_command.CreateNullSentinelOp());
    ...
    {
      System.Data.Entity.Core.Query.PlanCompiler.PlanCompiler.Assert(opKind == NominalTypeEliminator.OperationKind.IsNull || opKind == NominalTypeEliminator.OperationKind.Equality, "Unexpected opKind: " + opKind.ToString() + "; Can only handle IsNull and Equality");
      TypeUsage type1 = typeInfo.Type;
      RowType type2 = (RowType) null;
      if (TypeHelpers.TryGetEdmType<RowType>(type1, out type2))
      {
        ...
        else
        {
          ...
          {
            EdmProperty m = property;
            if (!TypeUtils.IsStructuredType(Helper.GetModelTypeUsage((EdmMember) m)))
            {
              yield return (PropertyRef) new SimplePropertyRef((EdmMember) m);
            }
            else
            {
              foreach (PropertyRef propertyRef in this.GetPropertyRefs(this.m_typeInfo.GetTypeInfo(Helper.GetModelTypeUsage((EdmMember) m)), opKind))
                yield return propertyRef.CreateNestedPropertyRef((EdmMember) m);
            }
            m = (EdmProperty) null;
          }
        }
      ...
      {
        EntityType type3 = (EntityType) null;
        if (TypeHelpers.TryGetEdmType<EntityType>(type1, out type3))
        {
        ...
        {
          ComplexType type4 = (ComplexType) null;
          if (TypeHelpers.TryGetEdmType<ComplexType>(type1, out type4))
          {
          ...
          {
            RefType type5 = (RefType) null;
            if (TypeHelpers.TryGetEdmType<RefType>(type1, out type5))
            {
      ...
      NominalTypeEliminator.OperationKind opKind)
    {
      ...
      return opKind == NominalTypeEliminator.OperationKind.GetIdentity ? typeInfo.GetIdentityPropertyRefs() : this.GetPropertyRefsForComparisonAndIsNull(typeInfo, opKind);
    }
      ...
      List<System.Data.Entity.Core.Query.InternalTrees.SortKey> keys)
    {
      ...
      foreach (System.Data.Entity.Core.Query.InternalTrees.SortKey key in keys)
      {
        ...
        {
          if (varInfo is StructuredVarInfo structuredVarInfo4 && structuredVarInfo4.NewVarsIncludeNullSentinelVar)
      ...
      out List<Var> newVars)
    {
      ...
      System.Data.Entity.Core.Query.PlanCompiler.PlanCompiler.Assert(edmType != null, "Unexpected TVF return type (must be row): " + unnestOpTableTypeInfo.Type?.ToString());
      ...
      foreach (EdmProperty property in unnestOpTableTypeInfo.FlattenedType.Properties)
      {
        ...
        switch (propertyRef)
        {
          case SimplePropertyRef simplePropertyRef2:
            int index = edmType.Members.IndexOf(simplePropertyRef2.Property);
      ...
      System.Data.Entity.Core.Query.InternalTrees.Node n)
    {
      ...
      foreach (System.Data.Entity.Core.Query.InternalTrees.Node child in n.Children)
      {
        ...
        if (TypeUtils.IsStructuredType(op1.Var.Type) || TypeUtils.IsCollectionType(op1.Var.Type))
        {
          ...
          this.FlattenComputedVar((ComputedVar) op1.Var, child, out newNodes, out TypeUsage _);
    ...
    private static bool IsNullSentinelPropertyRef(PropertyRef propertyRef)
    {
      switch (propertyRef)
      {
        case NullSentinelPropertyRef _:
          return true;
        case NestedPropertyRef nestedPropertyRef:
      ...
      SimpleCollectionColumnMap columnMap)
    {
      ...
      if (TypeUtils.IsStructuredType(element.Var.Type))
      {
        ...
        int num = typeInfo.RootType.FlattenedType.Properties.Count == varInfo.NewVars.Count ? 1 : 0;
        ...
        int count = typeInfo.RootType.FlattenedType.Properties.Count;
    ...
    private VarVec FlattenVarSet(VarVec varSet) => this.m_command.CreateVarVec(this.FlattenVars((IEnumerable<Var>) varSet));

    private VarList FlattenVarList(VarList varList) => Command.CreateVarList(this.FlattenVars((IEnumerable<Var>) varList));
    ...
    internal static Var GetSingletonVar(System.Data.Entity.Core.Query.InternalTrees.Node n)
    {
      switch (n.Op.OpType)
      {
        case OpType.ScanTable:
          ...
          return op1.Table.Columns.Count != 1 ? (Var) null : op1.Table.Columns[0];
        case OpType.Filter:
        case OpType.Sort:
        ...
        case OpType.Project:
          ...
          return op2.Outputs.Count != 1 ? (Var) null : op2.Outputs.First;
        case OpType.Unnest:
          UnnestOp op3 = (UnnestOp) n.Op;
          return op3.Table.Columns.Count != 1 ? (Var) null : op3.Table.Columns[0];
        case OpType.UnionAll:
        case OpType.Intersect:
        case OpType.Except:
          SetOp op4 = (SetOp) n.Op;
          return op4.Outputs.Count != 1 ? (Var) null : op4.Outputs.First;
        case OpType.Distinct:
          DistinctOp op5 = (DistinctOp) n.Op;
          return op5.Keys.Count != 1 ? (Var) null : op5.Keys.First;
        default:
          return (Var) null;
      }
    }
    ...
    public override System.Data.Entity.Core.Query.InternalTrees.Node Visit(UnnestOp op, System.Data.Entity.Core.Query.InternalTrees.Node n)
    {
      ...
      if (n.HasChild0)
      {
        ...
        if (child0.Op is VarDefOp op3 && TypeUtils.IsCollectionType(op3.Var.Type))
        {
          ComputedVar var = (ComputedVar) op3.Var;
          ...
          else
          {
            ...
            this.FlattenComputedVar(var, child0, out newNodes, out TypeUsage _);
      ...
      else
      {
        ...
        if (!this.m_varInfoMap.TryGetVarInfo(op.Var, out varInfo) || varInfo.Kind != VarInfoKind.CollectionVarInfo)
          throw new InvalidOperationException(System.Data.Entity.Resources.Strings.ADP_InternalProviderError((object) 1006));
    ...
    private IEnumerable<EdmProperty> GetTvfResultKeys(EdmFunction tvf)
    {
      ...
      return this.m_tvfResultKeys.TryGetValue(tvf, out edmPropertyArray) ? (IEnumerable<EdmProperty>) edmPropertyArray : Enumerable.Empty<EdmProperty>();
    }
      ...
      System.Data.Entity.Core.Query.InternalTrees.Node n)
    {
      ...
      op.Outputs.Clear();
      foreach (Var key in (IEnumerable<Var>) op.VarMap[0].Keys)
        op.Outputs.Set(key);
      return n;
    }
    ...
    private System.Data.Entity.Core.Query.InternalTrees.Node FixupSetOpChild(
      ...
      List<ComputedVar> newComputedVars)
    {
      System.Data.Entity.Core.Query.PlanCompiler.PlanCompiler.Assert(setOpChild != null, "null setOpChild?");
      System.Data.Entity.Core.Query.PlanCompiler.PlanCompiler.Assert(varMap != null, "null varMap?");
      System.Data.Entity.Core.Query.PlanCompiler.PlanCompiler.Assert(newComputedVars != null, "null newComputedVars?");
      VarVec varVec = this.m_command.CreateVarVec();
      foreach (KeyValuePair<Var, Var> var in varMap)
      ...
      System.Data.Entity.Core.Query.InternalTrees.Node n)
    {
      ...
      {
        System.Data.Entity.Core.Query.PlanCompiler.PlanCompiler.Assert(n.Child0.Op.OpType == OpType.NewRecord, "Expected a record constructor here. Found " + n.Child0.Op.OpType.ToString() + " instead");
    ...
    private System.Data.Entity.Core.Query.InternalTrees.Node RewriteAsCastToUnderlyingType(
      ...
      System.Data.Entity.Core.Query.InternalTrees.Node n)
    {
      return underlyingType.PrimitiveTypeKind == ((PrimitiveType) n.Child0.Op.Type.EdmType).PrimitiveTypeKind ? n.Child0 : this.m_command.CreateNode((Op) this.m_command.CreateCastOp(TypeUsage.Create((EdmType) underlyingType, (IEnumerable<Facet>) op.Type.Facets)), n.Child0);
    }
    ...
    public override System.Data.Entity.Core.Query.InternalTrees.Node Visit(CaseOp op, System.Data.Entity.Core.Query.InternalTrees.Node n)
    {
      ...
      int num = PlanCompilerUtil.IsRowTypeCaseOpWithNullability(op, n, out thenClauseIsNull) ? 1 : 0;
      this.VisitChildren(n);
      System.Data.Entity.Core.Query.InternalTrees.Node rewrittenNode;
      if (num != 0 && this.TryRewriteCaseOp(n, thenClauseIsNull, out rewrittenNode))
      ...
      System.Data.Entity.Core.Query.InternalTrees.Node n)
    {
      ...
      {
        System.Data.Entity.Core.Query.PlanCompiler.PlanCompiler.Assert(op.OpType == OpType.GetEntityRef, "Expected OpType.GetEntityRef: Found " + op.OpType.ToString());
    ...
    private System.Data.Entity.Core.Query.InternalTrees.Node VisitPropertyOp(
      ...
      bool throwIfMissing)
    {
      System.Data.Entity.Core.Query.PlanCompiler.PlanCompiler.Assert(op.OpType == OpType.Property || op.OpType == OpType.RelProperty, "Unexpected optype: " + op.OpType.ToString());
      TypeUsage type1 = n.Child0.Op.Type;
      TypeUsage type2 = op.Type;
      this.VisitChildren(n);
      TypeInfo typeInfo1 = this.m_typeInfo.GetTypeInfo(type1);
    ...
    public override System.Data.Entity.Core.Query.InternalTrees.Node Visit(RefOp op, System.Data.Entity.Core.Query.InternalTrees.Node n)
    {
      ...
      if (typeInfo2.HasEntitySetIdProperty)
      {
        ...
        {
          System.Data.Entity.Core.Query.PlanCompiler.PlanCompiler.Assert(fields.Count == properties.Count, "Mismatched field count: Expected " + properties.Count.ToString() + "; Got " + fields.Count.ToString());
          NominalTypeEliminator.RemoveNullSentinel(typeInfo1, properties, values);
        }
        else
        {
          int num1 = fields.Count == properties.Count + 1 ? 1 : 0;
          int num2 = properties.Count + 1;
          string str1 = num2.ToString();
          num2 = fields.Count;
          string str2 = num2.ToString();
          string message = "Mismatched field count: Expected " + str1 + "; Got " + str2;
          System.Data.Entity.Core.Query.PlanCompiler.PlanCompiler.Assert(num1 != 0, message);
        }
    ...
    public override System.Data.Entity.Core.Query.InternalTrees.Node Visit(VarRefOp op, System.Data.Entity.Core.Query.InternalTrees.Node n)
    {
      ...
      {
        System.Data.Entity.Core.Query.PlanCompiler.PlanCompiler.Assert(!TypeUtils.IsStructuredType(op.Type), "No varInfo for a structured type var: Id = " + op.Var.Id.ToString() + " Type = " + op.Type?.ToString());
        return n;
      }
      ...
      System.Data.Entity.Core.Query.InternalTrees.Node discriminator)
    {
      ...
      for (int index = 0; index < op.DiscriminatorMap.TypeMap.Count; ++index)
      {
        ...
        else
        {
          ...
          System.Data.Entity.Core.Query.InternalTrees.Node node2 = this.m_command.CreateNode((Op) this.m_command.CreateComparisonOp(OpType.EQ), discriminator, node1);
          args.Add(node2);
          args.Add(typeIdConstant);
        }
      }
    ...
    private System.Data.Entity.Core.Query.InternalTrees.Node FlattenConstructor(
      ...
      System.Data.Entity.Core.Query.InternalTrees.Node n)
    {
      System.Data.Entity.Core.Query.PlanCompiler.PlanCompiler.Assert(op.OpType == OpType.NewInstance || op.OpType == OpType.NewRecord || op.OpType == OpType.DiscriminatedNewEntity || op.OpType == OpType.NewEntity, "unexpected op: " + op.OpType.ToString() + "?");
      this.VisitChildren(n);
      ...
      if (typeInfo.HasEntitySetIdProperty)
      {
        ...
        System.Data.Entity.Core.Query.PlanCompiler.PlanCompiler.Assert(op1 != null, "unexpected optype:" + op.OpType.ToString());
      ...
      System.Data.Entity.Core.Query.InternalTrees.Node typeIdProperty)
    {
      ...
      return this.m_command.CreateNode((Op) this.m_command.CreateComparisonOp(OpType.EQ), typeIdProperty, typeIdConstant);
    }
