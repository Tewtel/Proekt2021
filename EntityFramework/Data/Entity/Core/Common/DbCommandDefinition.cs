...
namespace System.Data.Entity.Core.Common
{
  ...
  public class DbCommandDefinition
  {
      ...
      Func<DbCommand, DbCommand> cloneMethod)
    {
      ...
      System.Data.Entity.Utilities.Check.NotNull<Func<DbCommand, DbCommand>>(cloneMethod, nameof (cloneMethod));
    ...
    public virtual DbCommand CreateCommand() => this._cloneMethod(this._prototype);
