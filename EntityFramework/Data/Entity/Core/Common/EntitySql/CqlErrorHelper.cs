...
namespace System.Data.Entity.Core.Common.EntitySql
{
  internal static class CqlErrorHelper
  {
    ...
    private static string GetReadableTypeName(TypeUsage type) => CqlErrorHelper.GetReadableTypeName(type.EdmType);

    private static string GetReadableTypeName(EdmType type) => type.BuiltInTypeKind == BuiltInTypeKind.RowType || type.BuiltInTypeKind == BuiltInTypeKind.CollectionType || type.BuiltInTypeKind == BuiltInTypeKind.RefType ? type.Name : type.FullName;

    private static string GetReadableTypeKind(TypeUsage type) => CqlErrorHelper.GetReadableTypeKind(type.EdmType);
