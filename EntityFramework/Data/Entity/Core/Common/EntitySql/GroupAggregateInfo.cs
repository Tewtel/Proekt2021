...
namespace System.Data.Entity.Core.Common.EntitySql
{
  internal abstract class GroupAggregateInfo
  {
    ...
    internal void DetachFromAstNode() => this.AstNode.AggregateInfo = (GroupAggregateInfo) null;
    ...
    {
      get => this._innermostReferencedScopeRegion;
      set => this._innermostReferencedScopeRegion = value;
    }
    ...
    internal void ValidateAndComputeEvaluatingScopeRegion(SemanticResolver sr)
    {
      ...
      if (!this._evaluatingScopeRegion.IsAggregating)
      {
        ...
        if (this._evaluatingScopeRegion == null)
          throw new EntitySqlException(System.Data.Entity.Resources.Strings.GroupVarNotFoundInScope);
      }
      ...
      int innerBoundaryScopeRegionIndex)
    {
      ...
      foreach (GroupAggregateInfo containedAggregate in this._containedAggregates)
      {
        if (containedAggregate.EvaluatingScopeRegion.ScopeRegionIndex >= outerBoundaryScopeRegionIndex && containedAggregate.EvaluatingScopeRegion.ScopeRegionIndex <= innerBoundaryScopeRegionIndex)
        {
          ...
          throw new EntitySqlException(System.Data.Entity.Resources.Strings.NestedAggregateCannotBeUsedInAggregate((object) EntitySqlException.FormatErrorContext(containedAggregate.ErrCtx.CommandText, containedAggregate.ErrCtx.InputPosition, containedAggregate.ErrCtx.ErrorContextInfo, containedAggregate.ErrCtx.UseContextInfoAsResourceIdentifier, out lineNumber, out columnNumber), (object) str));
        }
    ...
    internal ScopeRegion EvaluatingScopeRegion => this._evaluatingScopeRegion;

    internal GroupAggregateInfo ContainingAggregate => this._containingAggregate;
  }
}
