...
namespace System.Data.Entity.Core.Common.EntitySql
{
  internal static class FunctionOverloadResolver
  {
      ...
      where TFunctionMetadata : class
    {
      ...
      return !isAmbiguous ? functionMetadata : default (TFunctionMetadata);
    }
        ...
        switch (getParameterMode(overloadParamList[index]))
        {
          ...
          case ParameterMode.InOut:
            if (isGroupAggregateFunction)
              type = TypeSemantics.IsCollectionType(type) ? TypeHelpers.GetElementTypeUsage(type) : throw new EntitySqlException(System.Data.Entity.Resources.Strings.InvalidArgumentTypeForAggregateFunction);
