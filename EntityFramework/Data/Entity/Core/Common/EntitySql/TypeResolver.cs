...
namespace System.Data.Entity.Core.Common.EntitySql
{
  internal sealed class TypeResolver
  {
    ...
    internal Perspective Perspective => this._perspective;

    internal ICollection<MetadataNamespace> NamespaceImports => (ICollection<MetadataNamespace>) this._namespaces;
      ...
      ErrorContext errCtx)
    {
      ...
      {
        string errorMessage = System.Data.Entity.Resources.Strings.NamespaceAliasAlreadyUsed((object) alias);
    ...
    internal void AddNamespaceImport(MetadataNamespace @namespace, ErrorContext errCtx)
    {
      ...
      {
        string errorMessage = System.Data.Entity.Resources.Strings.NamespaceAlreadyImported((object) @namespace.Name);
        throw EntitySqlException.Create(errCtx, errorMessage, (Exception) null);
      }
    ...
    internal void DeclareInlineFunction(string name, InlineFunctionInfo functionInfo)
    {
      ...
      if (inlineFunctionInfoList.Exists((Predicate<InlineFunctionInfo>) (overload => overload.Parameters.Select<DbVariableReferenceExpression, TypeUsage>((Func<DbVariableReferenceExpression, TypeUsage>) (p => p.ResultType)).SequenceEqual<TypeUsage>(functionInfo.Parameters.Select<DbVariableReferenceExpression, TypeUsage>((Func<DbVariableReferenceExpression, TypeUsage>) (p => p.ResultType)), (IEqualityComparer<TypeUsage>) TypeResolver.TypeUsageStructuralComparer.Instance))))
        throw EntitySqlException.Create(functionInfo.FunctionDefAst.ErrCtx, System.Data.Entity.Resources.Strings.DuplicatedInlineFunctionOverload((object) name), (Exception) null);
      ...
      ErrorContext errCtx)
    {
      ...
      if (qualifier.MetadataMemberClass == MetadataMemberClass.Namespace)
      {
        ...
        return this.TryGetFunctionFromMetadata(qualifier.Name, name, out functionGroup) ? (MetadataMember) functionGroup : (MetadataMember) new MetadataNamespace(fullName);
      }
      if (qualifier.MetadataMemberClass == MetadataMemberClass.Type)
      {
        ...
        if (TypeSemantics.IsEnumerationType(metadataType.TypeUsage))
        {
          ...
          string errorMessage = System.Data.Entity.Resources.Strings.NotAMemberOfType((object) name, (object) qualifier.Name);
          throw EntitySqlException.Create(errCtx, errorMessage, (Exception) null);
        }
      }
      string errorMessage1 = System.Data.Entity.Resources.Strings.InvalidMetadataMemberClassResolution((object) qualifier.Name, (object) qualifier.MetadataMemberClassName, (object) MetadataNamespace.NamespaceClassName);
      ...
      ErrorContext errCtx)
    {
      ...
      if (!flag1)
      {
        ...
        foreach (MetadataNamespace ns1 in this._namespaces)
        {
          ...
          {
            type1 = type1 == null && functionGroup1 == null ? type2 : throw TypeResolver.AmbiguousMetadataMemberName(errCtx, name, ns1, ns2);
            ns2 = ns1;
          }
          MetadataFunctionGroup functionGroup2;
          if (flag2 && this.TryGetFunctionFromMetadata(ns1.Name, name, out functionGroup2))
          {
            functionGroup1 = type1 == null && functionGroup1 == null ? functionGroup2 : throw TypeResolver.AmbiguousMetadataMemberName(errCtx, name, ns1, ns2);
            ns2 = ns1;
          }
        }
        if (type1 != null)
    ...
    {
      string errorMessage = System.Data.Entity.Resources.Strings.AmbiguousMetadataMemberName((object) name, (object) ns1.Name, (object) ns2?.Name);
      throw EntitySqlException.Create(errCtx, errorMessage, (Exception) null);
    }
    ...
    private sealed class TypeUsageStructuralComparer : IEqualityComparer<TypeUsage>
    {
      ...
      public static TypeResolver.TypeUsageStructuralComparer Instance => TypeResolver.TypeUsageStructuralComparer._instance;

      public bool Equals(TypeUsage x, TypeUsage y) => TypeSemantics.IsStructurallyEqual(x, y);

      public int GetHashCode(TypeUsage obj) => 0;
    }
  }
}
