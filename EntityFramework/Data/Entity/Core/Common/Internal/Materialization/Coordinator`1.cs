...
namespace System.Data.Entity.Core.Common.Internal.Materialization
{
  internal class Coordinator<T> : Coordinator
  {
    ...
    internal virtual T Current => this._current;
    ...
    internal void RegisterCloseHandler(Action<Shaper, List<IEntityWrapper>> closeHandler) => this._handleClose = closeHandler;

    internal void SetCurrentToDefault() => this._current = default (T);

    private IEnumerable<T> GetElements() => (IEnumerable<T>) this._elements;
  }
}
