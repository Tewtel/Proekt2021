...
namespace System.Data.Entity.Core.Common.Internal.Materialization
{
  internal class ColumnMapKeyBuilder : ColumnMapVisitor<int>
  {
    ...
    private ColumnMapKeyBuilder(SpanIndex spanIndex) => this._spanIndex = spanIndex;
    ...
    internal void Append(string value) => this._builder.Append(value);

    internal void Append(string prefix, Type type) => this.Append(prefix, type.AssemblyQualifiedName);
    ...
    private void AppendValue(string prefix, object value) => this.Append(prefix, string.Format((IFormatProvider) CultureInfo.InvariantCulture, "{0}", value));
    ...
    internal override void Visit(ScalarColumnMap columnMap, int dummy) => this.Append(string.Format((IFormatProvider) CultureInfo.InvariantCulture, "S({0}-{1}:{2})", (object) columnMap.CommandId, (object) columnMap.ColumnPos, (object) columnMap.Type.Identity));
