...
namespace System.Data.Entity.Core.Common.Internal.Materialization
{
  internal class CoordinatorFactory<TElement> : CoordinatorFactory
  {
    ...
    private static string DescribeExpression(Expression expression) => expression != null ? expression.ToString() : "undefined";

    internal override Coordinator CreateCoordinator(Coordinator parent, Coordinator next) => (Coordinator) new Coordinator<TElement>(this, parent, next);
