...
namespace System.Data.Entity.Core.Common.Internal.Materialization
{
  internal static class CodeGenEmitter
  {
    ...
    internal static Func<Shaper, TResult> Compile<TResult>(Expression body) => CodeGenEmitter.BuildShaperLambda<TResult>(body).Compile();
    ...
    internal static object Compile(Type resultType, Expression body) => CodeGenEmitter.CodeGenEmitter_Compile.MakeGenericMethod(resultType).Invoke((object) null, new object[1]
    {
      (object) body
    });
    ...
    internal static Expression Emit_NullConstant(Type type) => !type.IsNullable() ? CodeGenEmitter.Emit_EnsureType((Expression) Expression.Constant((object) null, typeof (object)), type) : (Expression) Expression.Constant((object) null, type);

    internal static Expression Emit_WrappedNullConstant() => (Expression) Expression.Property((Expression) null, CodeGenEmitter.EntityWrapperFactory_NullWrapper);
      ...
      bool isProxy)
    {
      ...
      else
      {
        ...
        expression1 = (Expression) Expression.New(type.GetDeclaredConstructor(typeArray), input, keyReader, entitySetReader, CodeGenEmitter.Shaper_Context, (Expression) Expression.Constant((object) mergeOption, typeof (MergeOption)), (Expression) Expression.Constant((object) identityType, typeof (Type)), expression2, expression4, expression3, (Expression) Expression.Constant((object) hashCode, typeof (bool)));
      }
      return (Expression) Expression.Convert(expression1, typeof (IEntityWrapper));
    }

    internal static Expression Emit_UnwrapAndEnsureType(Expression input, Type type) => CodeGenEmitter.Emit_EnsureType((Expression) Expression.Property(input, CodeGenEmitter.IEntityWrapper_Entity), type);
    ...
    internal static TTarget CheckedConvert<TSource, TTarget>(TSource value)
    {
      ...
      {
        throw new InvalidOperationException(System.Data.Entity.Resources.Strings.Materializer_NullReferenceCast((object) typeof (TTarget).Name));
      }
    }

    internal static Expression Emit_Equal(Expression left, Expression right) => !(typeof (byte[]) == left.Type) ? (Expression) Expression.Equal(left, right) : (Expression) Expression.Call(CodeGenEmitter.CodeGenEmitter_BinaryEquals, left, right);

    internal static Expression Emit_EntityKey_HasValue(SimpleColumnMap[] keyColumns) => (Expression) Expression.Not(CodeGenEmitter.Emit_Reader_IsDBNull((ColumnMap) keyColumns[0]));

    internal static Expression Emit_Reader_GetValue(int ordinal, Type type) => CodeGenEmitter.Emit_EnsureType((Expression) Expression.Call(CodeGenEmitter.Shaper_Reader, CodeGenEmitter.DbDataReader_GetValue, (Expression) Expression.Constant((object) ordinal)), type);

    internal static Expression Emit_Reader_IsDBNull(int ordinal) => (Expression) Expression.Call(CodeGenEmitter.Shaper_Reader, CodeGenEmitter.DbDataReader_IsDBNull, (Expression) Expression.Constant((object) ordinal));

    internal static Expression Emit_Reader_IsDBNull(ColumnMap columnMap) => CodeGenEmitter.Emit_Reader_IsDBNull(((ScalarColumnMap) columnMap).ColumnPos);
    ...
    {
      Expression expression;
      if (Helper.IsSpatialType(columnType, out PrimitiveTypeKind _))
      {
    ...
    internal static Expression Emit_Shaper_GetHierarchyIdColumnValue(int ordinal) => (Expression) Expression.Call((Expression) CodeGenEmitter.Shaper_Parameter, CodeGenEmitter.Shaper_GetHierarchyIdColumnValue, (Expression) Expression.Constant((object) ordinal));

    internal static Expression Emit_Shaper_GetGeographyColumnValue(int ordinal) => (Expression) Expression.Call((Expression) CodeGenEmitter.Shaper_Parameter, CodeGenEmitter.Shaper_GetGeographyColumnValue, (Expression) Expression.Constant((object) ordinal));

    internal static Expression Emit_Shaper_GetGeometryColumnValue(int ordinal) => (Expression) Expression.Call((Expression) CodeGenEmitter.Shaper_Parameter, CodeGenEmitter.Shaper_GetGeometryColumnValue, (Expression) Expression.Constant((object) ordinal));

    internal static Expression Emit_Shaper_GetState(int stateSlotNumber, Type type) => CodeGenEmitter.Emit_EnsureType((Expression) Expression.ArrayIndex(CodeGenEmitter.Shaper_State, (Expression) Expression.Constant((object) stateSlotNumber)), type);

    internal static Expression Emit_Shaper_SetState(int stateSlotNumber, Expression value) => (Expression) Expression.Call((Expression) CodeGenEmitter.Shaper_Parameter, CodeGenEmitter.Shaper_SetState.MakeGenericMethod(value.Type), (Expression) Expression.Constant((object) stateSlotNumber), value);
