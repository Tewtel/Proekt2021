...
namespace System.Data.Entity.Core.Common.Utils.Boolean
{
  internal static class NegationPusher
  {
    ...
    private class NonNegatedTreeVisitor<T_Identifier> : BasicVisitor<T_Identifier>
    {
      ...
      internal override BoolExpr<T_Identifier> VisitNot(NotExpr<T_Identifier> expression) => expression.Child.Accept<BoolExpr<T_Identifier>>((Visitor<T_Identifier, BoolExpr<T_Identifier>>) NegationPusher.NegatedTreeVisitor<T_Identifier>.Instance);
    }
    ...
    private class NegatedTreeVisitor<T_Identifier> : Visitor<T_Identifier, BoolExpr<T_Identifier>>
    {
      ...
      internal override BoolExpr<T_Identifier> VisitTrue(TrueExpr<T_Identifier> expression) => (BoolExpr<T_Identifier>) FalseExpr<T_Identifier>.Value;

      internal override BoolExpr<T_Identifier> VisitFalse(FalseExpr<T_Identifier> expression) => (BoolExpr<T_Identifier>) TrueExpr<T_Identifier>.Value;

      internal override BoolExpr<T_Identifier> VisitTerm(TermExpr<T_Identifier> expression) => (BoolExpr<T_Identifier>) new NotExpr<T_Identifier>((BoolExpr<T_Identifier>) expression);

      internal override BoolExpr<T_Identifier> VisitNot(NotExpr<T_Identifier> expression) => expression.Child.Accept<BoolExpr<T_Identifier>>((Visitor<T_Identifier, BoolExpr<T_Identifier>>) NegationPusher.NonNegatedTreeVisitor<T_Identifier>.Instance);

      internal override BoolExpr<T_Identifier> VisitAnd(AndExpr<T_Identifier> expression) => (BoolExpr<T_Identifier>) new OrExpr<T_Identifier>(expression.Children.Select<BoolExpr<T_Identifier>, BoolExpr<T_Identifier>>((Func<BoolExpr<T_Identifier>, BoolExpr<T_Identifier>>) (child => child.Accept<BoolExpr<T_Identifier>>((Visitor<T_Identifier, BoolExpr<T_Identifier>>) this))));

      internal override BoolExpr<T_Identifier> VisitOr(OrExpr<T_Identifier> expression) => (BoolExpr<T_Identifier>) new AndExpr<T_Identifier>(expression.Children.Select<BoolExpr<T_Identifier>, BoolExpr<T_Identifier>>((Func<BoolExpr<T_Identifier>, BoolExpr<T_Identifier>>) (child => child.Accept<BoolExpr<T_Identifier>>((Visitor<T_Identifier, BoolExpr<T_Identifier>>) this))));
    }

    private class NonNegatedDomainConstraintTreeVisitor<T_Variable, T_Element> : 
      NegationPusher.NonNegatedTreeVisitor<DomainConstraint<T_Variable, T_Element>>
    {
    ...
    private class NegatedDomainConstraintTreeVisitor<T_Variable, T_Element> : 
      NegationPusher.NegatedTreeVisitor<DomainConstraint<T_Variable, T_Element>>
    {
