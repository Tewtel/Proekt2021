...
namespace System.Data.Entity.Core.Common.Utils.Boolean
{
  internal abstract class IdentifierService<T_Identifier>
  {
    ...
    {
      internal override Literal<T_Identifier> NegateLiteral(Literal<T_Identifier> literal) => new Literal<T_Identifier>(literal.Term, !literal.IsTermPositive);

      internal override ConversionContext<T_Identifier> CreateConversionContext() => (ConversionContext<T_Identifier>) new GenericConversionContext<T_Identifier>();
      ...
      IdentifierService<DomainConstraint<T_Variable, T_Element>>
    {
      ...
      internal override ConversionContext<DomainConstraint<T_Variable, T_Element>> CreateConversionContext() => (ConversionContext<DomainConstraint<T_Variable, T_Element>>) new DomainConstraintConversionContext<T_Variable, T_Element>();
