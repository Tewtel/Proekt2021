...
namespace System.Data.Entity.Core.Common.Utils.Boolean
{
  internal class KnowledgeBase<T_Identifier>
  {
    ...
    protected IEnumerable<BoolExpr<T_Identifier>> Facts => (IEnumerable<BoolExpr<T_Identifier>>) this._facts;
    ...
    protected class Implication : OrExpr<T_Identifier>
    {
      ...
      internal BoolExpr<T_Identifier> Condition => this._condition;

      internal BoolExpr<T_Identifier> Implies => this._implies;
      ...
      public override string ToString() => StringUtil.FormatInvariant("{0} --> {1}", (object) this._condition, (object) this._implies);
    }
    ...
    protected class Equivalence : AndExpr<T_Identifier>
    {
      ...
      internal BoolExpr<T_Identifier> Left => this._left;

      internal BoolExpr<T_Identifier> Right => this._right;
      ...
      public override string ToString() => StringUtil.FormatInvariant("{0} <--> {1}", (object) this._left, (object) this._right);
    }
  }
}
