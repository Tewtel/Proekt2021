...
namespace System.Data.Entity.Core.Common.Utils
{
  internal static class CommandHelper
  {
      ...
      EntityConnection connection)
    {
      ...
      return Helper.IsGeographicType(parameterType) ? (object) spatialServices.GeographyFromProviderValue(spatialValue) : (object) spatialServices.GeometryFromProviderValue(spatialValue);
    }
      ...
      string functionImportName)
    {
      ...
      return !edmFunction.IsComposableAttribute ? edmFunction : throw new InvalidOperationException(Strings.EntityClient_FunctionImportMustBeNonComposable((object) (containerName + "." + functionImportName)));
    }
  }
}
