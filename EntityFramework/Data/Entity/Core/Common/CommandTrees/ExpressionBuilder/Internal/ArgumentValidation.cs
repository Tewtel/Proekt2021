  ...
  internal static class ArgumentValidation
  {
    ...
    internal static void RequirePolymorphicType(TypeUsage type)
    {
      if (!TypeSemantics.IsPolymorphicType(type))
        throw new ArgumentException(System.Data.Entity.Resources.Strings.Cqt_General_PolymorphicTypeRequired((object) type.ToString()), nameof (type));
    }
      ...
      int argumentIndex)
    {
      if (!TypeSemantics.IsStructurallyEqualOrPromotableTo(expression.ResultType, requiredResultType))
        argumentName = argumentIndex != -1 ? StringUtil.FormatIndex(argumentName, argumentIndex) : throw new ArgumentException(System.Data.Entity.Resources.Strings.Cqt_ExpressionLink_TypeMismatch((object) expression.ResultType.ToString(), (object) requiredResultType.ToString()), argumentName);
    }
      ...
      int index)
    {
      ...
      if (!primitiveTypeKind || typeKind != requiredResultType)
        argumentName = index != -1 ? StringUtil.FormatIndex(argumentName, index) : throw new ArgumentException(System.Data.Entity.Resources.Strings.Cqt_ExpressionLink_TypeMismatch(primitiveTypeKind ? (object) Enum.GetName(typeof (PrimitiveTypeKind), (object) typeKind) : (object) expression.ResultType.ToString(), (object) Enum.GetName(typeof (PrimitiveTypeKind), (object) requiredResultType)), argumentName);
    }
      ...
      bool allowAllRelationshipsInSameTypeHierarchy)
    {
      ...
      if (allowAllRelationshipsInSameTypeHierarchy)
      {
        if (TypeHelpers.GetCommonTypeUsage(typeUsage, from.ResultType) == null)
          throw new ArgumentException(System.Data.Entity.Resources.Strings.Cqt_RelNav_WrongSourceType((object) typeUsage.ToString()), nameof (from));
      }
    ...
    internal static void RequireCollectionArgument<TExpressionType>(DbExpression argument)
    {
      if (!TypeSemantics.IsCollectionType(argument.ResultType))
        throw new ArgumentException(System.Data.Entity.Resources.Strings.Cqt_Unary_CollectionRequired((object) typeof (TExpressionType).Name), nameof (argument));
    }
      ...
      DbExpression right)
    {
      if (!TypeSemantics.IsCollectionType(left.ResultType) || !TypeSemantics.IsCollectionType(right.ResultType))
        throw new ArgumentException(System.Data.Entity.Resources.Strings.Cqt_Binary_CollectionsRequired((object) typeof (TExpressionType).Name));
      return TypeHelpers.GetCommonTypeUsage(left.ResultType, right.ResultType) ?? throw new ArgumentException(System.Data.Entity.Resources.Strings.Cqt_Binary_CollectionsRequired((object) typeof (TExpressionType).Name));
    }
      ...
      DbExpression right)
    {
      ...
      if (!TypeHelpers.IsSetComparableOpType(TypeHelpers.GetElementTypeUsage(left.ResultType)))
        throw new ArgumentException(System.Data.Entity.Resources.Strings.Cqt_InvalidTypeForSetOperation((object) TypeHelpers.GetElementTypeUsage(left.ResultType).Identity, (object) typeof (TExpressionType).Name), nameof (left));
      if (TypeHelpers.IsSetComparableOpType(TypeHelpers.GetElementTypeUsage(right.ResultType)))
        return typeUsage;
      throw new ArgumentException(System.Data.Entity.Resources.Strings.Cqt_InvalidTypeForSetOperation((object) TypeHelpers.GetElementTypeUsage(right.ResultType).Identity, (object) typeof (TExpressionType).Name), nameof (right));
    }
    ...
    private static FunctionParameter[] GetExpectedParameters(EdmFunction function) => function.Parameters.Where<FunctionParameter>((Func<FunctionParameter, bool>) (p => p.Mode == ParameterMode.In || p.Mode == ParameterMode.InOut)).ToArray<FunctionParameter>();
      ...
      IEnumerable<DbExpression> args)
    {
      ...
      FunctionParameter[] expectedParams = TypeSemantics.IsAggregateFunction(function) && function.ReturnParameter != null ? ArgumentValidation.GetExpectedParameters(function) : throw new ArgumentException(System.Data.Entity.Resources.Strings.Cqt_Aggregate_InvalidFunction, nameof (function));
    ...
    internal static void ValidateSortClause(DbExpression key)
    {
      if (!TypeHelpers.IsValidSortOpKeyType(key.ResultType))
        throw new ArgumentException(System.Data.Entity.Resources.Strings.Cqt_Sort_OrderComparable, nameof (key));
    }

    internal static void ValidateSortClause(DbExpression key, string collation)
    {
      ArgumentValidation.ValidateSortClause(key);
      System.Data.Entity.Utilities.Check.NotEmpty(collation, nameof (collation));
      if (!TypeSemantics.IsPrimitiveType(key.ResultType, PrimitiveTypeKind.String))
        throw new ArgumentException(System.Data.Entity.Resources.Strings.Cqt_Sort_NonStringCollationInvalid, nameof (collation));
    }
      ...
      IEnumerable<DbVariableReferenceExpression> variables)
    {
      ...
      {
        return varExp != null ? varExp : throw new ArgumentNullException(StringUtil.FormatIndex(nameof (variables), idx));
      ...
      out TypeUsage resultType)
    {
      ...
      while (enumerator.MoveNext())
      {
        ...
        if (dictionary.TryGetValue(current.VariableName, out num))
          throw new ArgumentException(System.Data.Entity.Resources.Strings.Cqt_CrossJoin_DuplicateVariableNames((object) num, (object) index, (object) current.VariableName));
      ...
      if (expressionBindingList.Count < 2)
        throw new ArgumentException(System.Data.Entity.Resources.Strings.Cqt_CrossJoin_AtLeastTwoInputs, nameof (inputs));
      ...
      DbExpression joinCondition)
    {
      if (left.VariableName.Equals(right.VariableName, StringComparison.Ordinal))
        throw new ArgumentException(System.Data.Entity.Resources.Strings.Cqt_Join_DuplicateVariableNames);
      ...
      out ReadOnlyCollection<DbAggregate> validAggregates)
    {
      ...
      EnumerableValidator<KeyValuePair<string, DbExpression>, DbExpression, DbExpressionList> validator1 = ArgumentValidation.CreateValidator<KeyValuePair<string, DbExpression>, DbExpression, DbExpressionList>(keys, nameof (keys), (Func<KeyValuePair<string, DbExpression>, int, DbExpression>) ((keyInfo, index) =>
      {
        ...
        if (!TypeHelpers.IsValidGroupKeyType(keyInfo.Value.ResultType))
          throw new ArgumentException(System.Data.Entity.Resources.Strings.Cqt_GroupBy_KeyNotEqualityComparable((object) keyInfo.Key));
      ...
      EnumerableValidator<KeyValuePair<string, DbAggregate>, DbAggregate, ReadOnlyCollection<DbAggregate>> validator2 = ArgumentValidation.CreateValidator<KeyValuePair<string, DbAggregate>, DbAggregate, ReadOnlyCollection<DbAggregate>>(aggregates, nameof (aggregates), (Func<KeyValuePair<string, DbAggregate>, int, DbAggregate>) ((aggInfo, idx) =>
      {
        ...
        if (keyNames.Contains(aggInfo.Key))
          throw new ArgumentException(System.Data.Entity.Resources.Strings.Cqt_GroupBy_AggregateColumnExistsAsGroupColumn((object) aggInfo.Key));
        if (aggInfo.Value is DbGroupAggregate)
          hasGroupAggregate = !hasGroupAggregate ? true : throw new ArgumentException(System.Data.Entity.Resources.Strings.Cqt_GroupBy_MoreThanOneGroupAggregate);
      ...
      if (validKeys.Count == 0 && validAggregates.Count == 0)
        throw new ArgumentException(System.Data.Entity.Resources.Strings.Cqt_GroupBy_AtLeastOneKeyOrAggregate);
    ...
    internal static TypeUsage ValidateConstant(Type type)
    {
      ...
      if (!ArgumentValidation.TryGetPrimitiveTypeKind(type, out primitiveTypeKind))
        throw new ArgumentException(System.Data.Entity.Resources.Strings.Cqt_Constant_InvalidType, nameof (type));
      return TypeHelpers.GetLiteralTypeUsage(primitiveTypeKind);
    }

    internal static TypeUsage ValidateConstant(object value) => ArgumentValidation.ValidateConstant(value.GetType());
    ...
    internal static void ValidateConstant(TypeUsage constantType, object value)
    {
      ...
      if (TypeHelpers.TryGetEdmType<EnumType>(constantType, out type1))
      {
        ...
        if (clrEquivalentType != value.GetType() && (!value.GetType().IsEnum() || !ArgumentValidation.ClrEdmEnumTypesMatch(type1, value.GetType())))
          throw new ArgumentException(System.Data.Entity.Resources.Strings.Cqt_Constant_ClrEnumTypeDoesNotMatchEdmEnumType((object) value.GetType().Name, (object) type1.Name, (object) clrEquivalentType.Name), nameof (value));
      }
      else
      {
        PrimitiveType type2;
        if (!TypeHelpers.TryGetEdmType<PrimitiveType>(constantType, out type2))
          throw new ArgumentException(System.Data.Entity.Resources.Strings.Cqt_Constant_InvalidConstantType((object) constantType.ToString()), nameof (constantType));
        PrimitiveTypeKind primitiveTypeKind;
        if ((!ArgumentValidation.TryGetPrimitiveTypeKind(value.GetType(), out primitiveTypeKind) || type2.PrimitiveTypeKind != primitiveTypeKind) && (!Helper.IsGeographicType(type2) || primitiveTypeKind != PrimitiveTypeKind.Geography) && (!Helper.IsGeometricType(type2) || primitiveTypeKind != PrimitiveTypeKind.Geometry))
          throw new ArgumentException(System.Data.Entity.Resources.Strings.Cqt_Constant_InvalidValueForType((object) constantType.ToString()), nameof (value));
      }
    }
      ...
      out DbExpression keyConstructor)
    {
      ...
      if (!TypeSemantics.IsValidPolymorphicCast((EdmType) entitySet.ElementType, (EdmType) entityType))
        throw new ArgumentException(System.Data.Entity.Resources.Strings.Cqt_Ref_PolymorphicArgRequired);
      ...
      out RelationshipEndMember toEnd)
    {
      ...
      if (!type.RelationshipEndMembers.TryGetValue(fromEndName, false, out fromEnd))
        throw new ArgumentOutOfRangeException(fromEndName, System.Data.Entity.Resources.Strings.Cqt_Factory_NoSuchRelationEnd);
      if (!type.RelationshipEndMembers.TryGetValue(toEndName, false, out toEnd))
        throw new ArgumentOutOfRangeException(toEndName, System.Data.Entity.Resources.Strings.Cqt_Factory_NoSuchRelationEnd);
      ...
      bool allowAllRelationshipsInSameTypeHierarchy)
    {
      ...
      if (!relType.Equals((object) toEnd.DeclaringType))
        throw new ArgumentException(System.Data.Entity.Resources.Strings.Cqt_Factory_IncompatibleRelationEnds, nameof (toEnd));
      ...
      out DbExpressionList validThens)
    {
      ...
      validThens = ArgumentValidation.CreateExpressionList(thenExpressions, nameof (thenExpressions), (Action<DbExpression, int>) ((exp, idx) =>
      {
        ...
        else
        {
          ...
          if (commonResultType == null)
            throw new ArgumentException(System.Data.Entity.Resources.Strings.Cqt_Case_InvalidResultType);
        }
      }));
      ...
      if (validWhens.Count != validThens.Count)
        throw new ArgumentException(System.Data.Entity.Resources.Strings.Cqt_Case_WhensMustEqualThens);
      ...
      out DbExpressionList validArgs)
    {
      ...
      if (!function.IsComposableAttribute)
        throw new ArgumentException(System.Data.Entity.Resources.Strings.Cqt_Function_NonComposableInExpression, nameof (function));
      if (!string.IsNullOrEmpty(function.CommandTextAttribute) && !function.HasUserDefinedBody)
        throw new ArgumentException(System.Data.Entity.Resources.Strings.Cqt_Function_CommandTextInExpression, nameof (function));
      FunctionParameter[] expectedParams = function.ReturnParameter != null ? ArgumentValidation.GetExpectedParameters(function) : throw new ArgumentException(System.Data.Entity.Resources.Strings.Cqt_Function_VoidResultInvalid, nameof (function));
      ...
      out DbExpressionList validElements)
    {
      ...
      if (!TypeSemantics.IsCollectionType(collectionType))
        throw new ArgumentException(System.Data.Entity.Resources.Strings.Cqt_NewInstance_CollectionTypeRequired, nameof (collectionType));
    ...
    {
      if (!(instanceType.EdmType is StructuralType edmType))
        throw new ArgumentException(System.Data.Entity.Resources.Strings.Cqt_NewInstance_StructuralTypeRequired, nameof (instanceType));
      IBaseList<EdmMember> baseList = !edmType.Abstract ? TypeHelpers.GetAllStructuralMembers((EdmType) edmType) : throw new ArgumentException(System.Data.Entity.Resources.Strings.Cqt_NewInstance_CannotInstantiateAbstractType((object) instanceType.ToString()), nameof (instanceType));
      List<TypeUsage> typeUsageList = baseList != null && baseList.Count >= 1 ? new List<TypeUsage>(baseList.Count) : throw new ArgumentException(System.Data.Entity.Resources.Strings.Cqt_NewInstance_CannotInstantiateMemberlessType((object) instanceType.ToString()), nameof (instanceType));
      for (int index = 0; index < baseList.Count; ++index)
        typeUsageList.Add(Helper.GetModelTypeUsage(baseList[index]));
      ...
      if (relationships.Count > 0)
      {
        ...
        for (int index = 0; index < relationships.Count; ++index)
        {
          ...
          if (!entityType.EdmEquals((MetadataItem) elementType) && !entityType.IsSubtypeOf((EdmType) elementType))
            throw new ArgumentException(System.Data.Entity.Resources.Strings.Cqt_NewInstance_IncompatibleRelatedEntity_SourceTypeNotValid, StringUtil.FormatIndex(nameof (relationships), index));
      ...
      out EdmMember foundMember)
    {
      ...
      throw new ArgumentOutOfRangeException(nameof (propertyName), System.Data.Entity.Resources.Strings.NoSuchProperty((object) propertyName, (object) instance.ResultType.ToString()));
    }
      ...
      int index)
    {
      if (string.IsNullOrEmpty(element.Key))
        argumentName = index != -1 ? StringUtil.FormatIndex(argumentName, index) : throw new ArgumentNullException(string.Format((IFormatProvider) CultureInfo.InvariantCulture, "{0}.Key", (object) argumentName));
      else if ((object) element.Value == null)
        argumentName = index != -1 ? StringUtil.FormatIndex(argumentName, index) : throw new ArgumentNullException(string.Format((IFormatProvider) CultureInfo.InvariantCulture, "{0}.Value", (object) argumentName));
    }

    private static void CheckReadOnly(GlobalItem item, string varName)
    {
      if (!item.IsReadOnly)
        throw new ArgumentException(System.Data.Entity.Resources.Strings.Cqt_General_MetadataNotReadOnly, varName);
    }
    ...
    private static void CheckType(EdmType type) => ArgumentValidation.CheckType(type, nameof (type));

    private static void CheckType(EdmType type, string argumentName) => ArgumentValidation.CheckReadOnly((GlobalItem) type, argumentName);

    internal static void CheckType(TypeUsage type) => ArgumentValidation.CheckType(type, nameof (type));
    ...
    internal static void CheckType(TypeUsage type, string varName)
    {
      ...
      if (!ArgumentValidation.CheckDataSpace(type))
        throw new ArgumentException(System.Data.Entity.Resources.Strings.Cqt_Metadata_TypeUsageIncorrectSpace, nameof (type));
    }
    ...
    internal static void CheckMember(EdmMember memberMeta, string varName)
    {
      ...
      if (!ArgumentValidation.CheckDataSpace(memberMeta.TypeUsage) || !ArgumentValidation.CheckDataSpace((GlobalItem) memberMeta.DeclaringType))
        throw new ArgumentException(System.Data.Entity.Resources.Strings.Cqt_Metadata_EdmMemberIncorrectSpace, varName);
    }
    ...
    private static void CheckParameter(FunctionParameter paramMeta, string varName)
    {
      ...
      if (!ArgumentValidation.CheckDataSpace(paramMeta.TypeUsage))
        throw new ArgumentException(System.Data.Entity.Resources.Strings.Cqt_Metadata_FunctionParameterIncorrectSpace, varName);
    }
    ...
    private static void CheckFunction(EdmFunction function)
    {
      ...
      if (!ArgumentValidation.CheckDataSpace((GlobalItem) function))
        throw new ArgumentException(System.Data.Entity.Resources.Strings.Cqt_Metadata_FunctionIncorrectSpace, nameof (function));
      if (function.IsComposableAttribute && function.ReturnParameter == null)
        throw new ArgumentException(System.Data.Entity.Resources.Strings.Cqt_Metadata_FunctionReturnParameterNull, nameof (function));
      if (function.ReturnParameter != null && !ArgumentValidation.CheckDataSpace(function.ReturnParameter.TypeUsage))
        throw new ArgumentException(System.Data.Entity.Resources.Strings.Cqt_Metadata_FunctionParameterIncorrectSpace, "function.ReturnParameter");
    ...
    internal static void CheckEntitySet(EntitySetBase entitySet, string varName)
    {
      ...
      if (entitySet.EntityContainer == null)
        throw new ArgumentException(System.Data.Entity.Resources.Strings.Cqt_Metadata_EntitySetEntityContainerNull, varName);
      if (!ArgumentValidation.CheckDataSpace((GlobalItem) entitySet.EntityContainer))
        throw new ArgumentException(System.Data.Entity.Resources.Strings.Cqt_Metadata_EntitySetIncorrectSpace, varName);
      if (!ArgumentValidation.CheckDataSpace((GlobalItem) entitySet.ElementType))
        throw new ArgumentException(System.Data.Entity.Resources.Strings.Cqt_Metadata_EntitySetIncorrectSpace, varName);
    }

    private static bool CheckDataSpace(TypeUsage type) => ArgumentValidation.CheckDataSpace((GlobalItem) type.EdmType);
    ...
    private static TypeUsage CreateResultType(EdmType resultType) => TypeUsage.Create(resultType);
    ...
    internal static TypeUsage CreateReferenceResultType(EntityTypeBase referencedEntityType) => TypeUsage.Create((EdmType) TypeHelpers.CreateReferenceType(referencedEntityType));
