...
namespace System.Data.Entity.Core.Common.CommandTrees.ExpressionBuilder.Internal
{
  internal sealed class EnumerableValidator<TElementIn, TElementOut, TResult>
  {
    ...
    internal TResult Validate() => EnumerableValidator<TElementIn, TElementOut, TResult>.Validate(this.target, this.argumentName, this.ExpectedElementCount, this.AllowEmpty, this.ConvertElement, this.CreateResult, this.GetName);
