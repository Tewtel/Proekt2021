...
namespace System.Data.Entity.Core.Common.CommandTrees.ExpressionBuilder
{
  ...
  public sealed class Row
  {
    ...
    public DbNewInstanceExpression ToExpression() => DbExpressionBuilder.NewRow((IEnumerable<KeyValuePair<string, DbExpression>>) this.arguments);
    ...
    {
      System.Data.Entity.Utilities.Check.NotNull<Row>(row, nameof (row));
