...
namespace System.Data.Entity.Core.Common.CommandTrees.ExpressionBuilder
{
  ...
  public static class DbExpressionBuilder
  {
    ...
    {
      System.Data.Entity.Utilities.Check.NotNull<DbExpression>(input, nameof (input));
      System.Data.Entity.Utilities.Check.NotNull<string>(varName, nameof (varName));
      System.Data.Entity.Utilities.Check.NotEmpty(varName, nameof (varName));
      TypeUsage elementType = (TypeUsage) null;
      if (!TypeHelpers.TryGetCollectionElementType(input.ResultType, out elementType))
        throw new ArgumentException(System.Data.Entity.Resources.Strings.Cqt_Binding_CollectionRequired, nameof (input));
      ...
      string groupVarName)
    {
      ...
      System.Data.Entity.Utilities.Check.NotNull<string>(varName, nameof (varName));
      System.Data.Entity.Utilities.Check.NotEmpty(varName, nameof (varName));
      System.Data.Entity.Utilities.Check.NotNull<string>(groupVarName, nameof (groupVarName));
      System.Data.Entity.Utilities.Check.NotEmpty(groupVarName, nameof (groupVarName));
      TypeUsage elementType = (TypeUsage) null;
      if (!TypeHelpers.TryGetCollectionElementType(input.ResultType, out elementType))
        throw new ArgumentException(System.Data.Entity.Resources.Strings.Cqt_GroupBinding_CollectionRequired, nameof (input));
      ...
      DbExpression argument)
    {
      ...
      System.Data.Entity.Utilities.Check.NotNull<DbExpression>(argument, nameof (argument));
    ...
    {
      System.Data.Entity.Utilities.Check.NotNull<EdmFunction>(function, nameof (function));
      System.Data.Entity.Utilities.Check.NotNull<IEnumerable<DbExpression>>(arguments, "argument");
      return arguments.Any<DbExpression>() ? DbExpressionBuilder.CreateFunctionAggregate(function, arguments, false) : throw new ArgumentNullException(nameof (arguments));
    }
      ...
      IEnumerable<DbExpression> arguments)
    {
      System.Data.Entity.Utilities.Check.NotNull<EdmFunction>(function, nameof (function));
      System.Data.Entity.Utilities.Check.NotNull<IEnumerable<DbExpression>>(arguments, "argument");
      return arguments.Any<DbExpression>() ? DbExpressionBuilder.CreateFunctionAggregate(function, arguments, true) : throw new ArgumentNullException(nameof (arguments));
    }
    ...
    private static DbFunctionAggregate CreateFunctionAggregate(
      ...
      bool isDistinct)
    {
      DbExpressionList arguments1 = ArgumentValidation.ValidateFunctionAggregate(function, arguments);
      return new DbFunctionAggregate(function.ReturnParameter.TypeUsage, arguments1, function, isDistinct);
    }
    ...
    {
      System.Data.Entity.Utilities.Check.NotNull<DbExpression>(body, nameof (body));
      System.Data.Entity.Utilities.Check.NotNull<IEnumerable<DbVariableReferenceExpression>>(variables, nameof (variables));
    ...
    {
      System.Data.Entity.Utilities.Check.NotNull<DbExpression>(body, nameof (body));
      System.Data.Entity.Utilities.Check.NotNull<DbVariableReferenceExpression[]>(variables, nameof (variables));
    ...
    {
      System.Data.Entity.Utilities.Check.NotNull<DbExpression>(key, nameof (key));
    ...
    {
      System.Data.Entity.Utilities.Check.NotNull<DbExpression>(key, nameof (key));
      System.Data.Entity.Utilities.Check.NotNull<string>(collation, nameof (collation));
    ...
    {
      System.Data.Entity.Utilities.Check.NotNull<DbExpression>(predicate, nameof (predicate));
      System.Data.Entity.Utilities.Check.NotNull<DbExpressionBinding>(input, nameof (input));
    ...
    {
      System.Data.Entity.Utilities.Check.NotNull<DbExpressionBinding>(input, nameof (input));
      System.Data.Entity.Utilities.Check.NotNull<DbExpressionBinding>(apply, nameof (apply));
    ...
    private static void ValidateApply(DbExpressionBinding input, DbExpressionBinding apply)
    {
      if (input.VariableName.Equals(apply.VariableName, StringComparison.Ordinal))
        throw new ArgumentException(System.Data.Entity.Resources.Strings.Cqt_Apply_DuplicateVariableNames);
    }
    ...
    {
      System.Data.Entity.Utilities.Check.NotNull<IEnumerable<DbExpressionBinding>>(inputs, nameof (inputs));
    ...
    {
      System.Data.Entity.Utilities.Check.NotNull<DbExpressionBinding>(left, nameof (left));
      System.Data.Entity.Utilities.Check.NotNull<DbExpressionBinding>(right, nameof (right));
      System.Data.Entity.Utilities.Check.NotNull<DbExpression>(joinCondition, nameof (joinCondition));
    ...
    {
      System.Data.Entity.Utilities.Check.NotNull<DbGroupExpressionBinding>(input, nameof (input));
      System.Data.Entity.Utilities.Check.NotNull<IEnumerable<KeyValuePair<string, DbExpression>>>(keys, nameof (keys));
      System.Data.Entity.Utilities.Check.NotNull<IEnumerable<KeyValuePair<string, DbAggregate>>>(aggregates, nameof (aggregates));
    ...
    {
      System.Data.Entity.Utilities.Check.NotNull<DbExpression>(projection, nameof (projection));
      System.Data.Entity.Utilities.Check.NotNull<DbExpressionBinding>(input, nameof (input));
    ...
    {
      System.Data.Entity.Utilities.Check.NotNull<DbExpressionBinding>(input, nameof (input));
      System.Data.Entity.Utilities.Check.NotNull<IEnumerable<DbSortClause>>(sortOrder, nameof (sortOrder));
      System.Data.Entity.Utilities.Check.NotNull<DbExpression>(count, nameof (count));
      ...
      if (!TypeSemantics.IsIntegerNumericType(count.ResultType))
        throw new ArgumentException(System.Data.Entity.Resources.Strings.Cqt_Skip_IntegerRequired, nameof (count));
      if (count.ExpressionKind != DbExpressionKind.Constant && count.ExpressionKind != DbExpressionKind.ParameterReference)
        throw new ArgumentException(System.Data.Entity.Resources.Strings.Cqt_Skip_ConstantOrParameterRefRequired, nameof (count));
      if (DbExpressionBuilder.IsConstantNegativeInteger(count))
        throw new ArgumentException(System.Data.Entity.Resources.Strings.Cqt_Skip_NonNegativeCountRequired, nameof (count));
    ...
    {
      System.Data.Entity.Utilities.Check.NotNull<TypeUsage>(nullType, nameof (nullType));
    ...
    /// </returns>
    public static DbConstantExpression True => DbExpressionBuilder._boolTrue;
    ...
    /// </returns>
    public static DbConstantExpression False => DbExpressionBuilder._boolFalse;
    ...
    public static DbConstantExpression Constant(
      ...
      object value)
    {
      System.Data.Entity.Utilities.Check.NotNull<TypeUsage>(constantType, nameof (constantType));
      System.Data.Entity.Utilities.Check.NotNull<object>(value, nameof (value));
    ...
    public static DbParameterReferenceExpression Parameter(
      ...
      string name)
    {
      System.Data.Entity.Utilities.Check.NotNull<TypeUsage>(type, nameof (type));
      System.Data.Entity.Utilities.Check.NotNull<string>(name, nameof (name));
      ArgumentValidation.CheckType(type);
      return DbCommandTree.IsValidParameterName(name) ? new DbParameterReferenceExpression(type, name) : throw new ArgumentException(System.Data.Entity.Resources.Strings.Cqt_CommandTree_InvalidParameterName((object) name), nameof (name));
    }
    ...
    {
      System.Data.Entity.Utilities.Check.NotNull<EntitySetBase>(targetSet, nameof (targetSet));
    ...
    {
      System.Data.Entity.Utilities.Check.NotNull<DbExpression>(left, nameof (left));
      System.Data.Entity.Utilities.Check.NotNull<DbExpression>(right, nameof (right));
      ...
      if (commonTypeUsage == null || !TypeSemantics.IsPrimitiveType(commonTypeUsage, PrimitiveTypeKind.Boolean))
        throw new ArgumentException(System.Data.Entity.Resources.Strings.Cqt_And_BooleanArgumentsRequired);
    ...
    public static DbOrExpression Or(this DbExpression left, DbExpression right)
    {
      ...
      TypeUsage commonTypeUsage = TypeHelpers.GetCommonTypeUsage(left.ResultType, right.ResultType);
      if (commonTypeUsage == null || !TypeSemantics.IsPrimitiveType(commonTypeUsage, PrimitiveTypeKind.Boolean))
        throw new ArgumentException(System.Data.Entity.Resources.Strings.Cqt_Or_BooleanArgumentsRequired);
      ...
      IList<DbConstantExpression> list)
    {
      ...
      System.Data.Entity.Utilities.Check.NotNull<IList<DbConstantExpression>>(list, nameof (list));
      ...
      foreach (DbConstantExpression constantExpression in (IEnumerable<DbConstantExpression>) list)
      {
        if (!TypeSemantics.IsEqual(expression.ResultType, constantExpression.ResultType))
          throw new ArgumentException(System.Data.Entity.Resources.Strings.Cqt_In_SameResultTypeRequired);
    ...
    {
      System.Data.Entity.Utilities.Check.NotNull<DbExpression>(argument, nameof (argument));
      return TypeSemantics.IsPrimitiveType(argument.ResultType, PrimitiveTypeKind.Boolean) ? new DbNotExpression(argument.ResultType, argument) : throw new ArgumentException(System.Data.Entity.Resources.Strings.Cqt_Not_BooleanArgumentRequired);
    }
      ...
      DbExpression right)
    {
      ...
      if (commonTypeUsage == null || !TypeSemantics.IsNumericType(commonTypeUsage))
        throw new ArgumentException(System.Data.Entity.Resources.Strings.Cqt_Arithmetic_NumericCommonType);
    ...
    public static DbArithmeticExpression UnaryMinus(this DbExpression argument)
    {
      ...
      if (TypeSemantics.IsUnsignedNumericType(argument.ResultType))
      {
        ...
        if (!TypeHelpers.TryGetClosestPromotableType(argument.ResultType, out promotableType))
          throw new ArgumentException(System.Data.Entity.Resources.Strings.Cqt_Arithmetic_InvalidUnsignedTypeForUnaryMinus((object) argument.ResultType.EdmType.FullName));
      }
    ...
    /// <exception cref="T:System.ArgumentNullException">argument is null.</exception>
    /// <exception cref="T:System.ArgumentException">No numeric result type exists for argument.</exception>
    public static DbArithmeticExpression Negate(this DbExpression argument) => argument.UnaryMinus();
      ...
      DbExpression right)
    {
      ...
      if (DbExpressionKind.GreaterThanOrEquals == kind || DbExpressionKind.LessThanOrEquals == kind)
      {
        ...
        flag2 = TypeSemantics.IsOrderComparableTo(left.ResultType, right.ResultType);
      if (!flag1 || !flag2)
        throw new ArgumentException(System.Data.Entity.Resources.Strings.Cqt_Comparison_ComparableRequired);
    ...
    private static void ValidateIsNull(DbExpression argument)
    {
      if (TypeSemantics.IsCollectionType(argument.ResultType))
        throw new ArgumentException(System.Data.Entity.Resources.Strings.Cqt_IsNull_CollectionNotAllowed);
      if (!TypeHelpers.IsValidIsNullOpType(argument.ResultType))
        throw new ArgumentException(System.Data.Entity.Resources.Strings.Cqt_IsNull_InvalidType);
    }
    ...
    {
      System.Data.Entity.Utilities.Check.NotNull<DbExpression>(argument, nameof (argument));
      System.Data.Entity.Utilities.Check.NotNull<DbExpression>(pattern, nameof (pattern));
      ...
      DbExpression escape)
    {
      System.Data.Entity.Utilities.Check.NotNull<DbExpression>(argument, nameof (argument));
      System.Data.Entity.Utilities.Check.NotNull<DbExpression>(pattern, nameof (pattern));
      System.Data.Entity.Utilities.Check.NotNull<DbExpression>(escape, nameof (escape));
    ...
    {
      System.Data.Entity.Utilities.Check.NotNull<DbExpression>(argument, nameof (argument));
      System.Data.Entity.Utilities.Check.NotNull<TypeUsage>(toType, nameof (toType));
      ArgumentValidation.CheckType(toType, nameof (toType));
      if (!TypeSemantics.IsCastAllowed(argument.ResultType, toType))
        throw new ArgumentException(System.Data.Entity.Resources.Strings.Cqt_Cast_InvalidCast((object) argument.ResultType.ToString(), (object) toType.ToString()));
    ...
    {
      System.Data.Entity.Utilities.Check.NotNull<DbExpression>(argument, nameof (argument));
      System.Data.Entity.Utilities.Check.NotNull<TypeUsage>(treatType, nameof (treatType));
      ...
      if (!TypeSemantics.IsValidPolymorphicCast(argument.ResultType, treatType))
        throw new ArgumentException(System.Data.Entity.Resources.Strings.Cqt_General_PolymorphicArgRequired((object) typeof (DbTreatExpression).Name));
    ...
    private static void ValidateOfType(DbExpression argument, TypeUsage type)
    {
      ...
      if (!TypeHelpers.TryGetCollectionElementType(argument.ResultType, out elementType) || !TypeSemantics.IsValidPolymorphicCast(elementType, type))
        throw new ArgumentException(System.Data.Entity.Resources.Strings.Cqt_General_PolymorphicArgRequired((object) typeof (DbOfTypeExpression).Name));
    }
    ...
    private static void ValidateIsOf(DbExpression argument, TypeUsage type)
    {
      ...
      if (!TypeSemantics.IsValidPolymorphicCast(argument.ResultType, type))
        throw new ArgumentException(System.Data.Entity.Resources.Strings.Cqt_General_PolymorphicArgRequired((object) typeof (DbIsOfExpression).Name));
    }
    ...
    public static DbDerefExpression Deref(this DbExpression argument)
    {
      ...
      return TypeHelpers.TryGetRefEntityType(argument.ResultType, out referencedEntityType) ? new DbDerefExpression(TypeUsage.Create((EdmType) referencedEntityType), argument) : throw new ArgumentException(System.Data.Entity.Resources.Strings.Cqt_DeRef_RefRequired, nameof (argument));
    }
    ...
    public static DbEntityRefExpression GetEntityRef(this DbExpression argument)
    {
      ...
      return TypeHelpers.TryGetEdmType<EntityType>(argument.ResultType, out type) ? new DbEntityRefExpression(ArgumentValidation.CreateReferenceResultType((EntityTypeBase) type), argument) : throw new ArgumentException(System.Data.Entity.Resources.Strings.Cqt_GetEntityRef_EntityRequired, nameof (argument));
    }
      ...
      IEnumerable<DbExpression> keyValues)
    {
      ...
      System.Data.Entity.Utilities.Check.NotNull<IEnumerable<DbExpression>>(keyValues, nameof (keyValues));
    ...
    {
      System.Data.Entity.Utilities.Check.NotNull<EntitySet>(entitySet, nameof (entitySet));
      System.Data.Entity.Utilities.Check.NotNull<DbExpression[]>(keyValues, nameof (keyValues));
    ...
    {
      System.Data.Entity.Utilities.Check.NotNull<EntitySet>(entitySet, nameof (entitySet));
      System.Data.Entity.Utilities.Check.NotNull<DbExpression>(keyRow, nameof (keyRow));
    ...
    public static DbRefKeyExpression GetRefKey(this DbExpression argument)
    {
      ...
      if (!TypeHelpers.TryGetEdmType<RefType>(argument.ResultType, out type))
        throw new ArgumentException(System.Data.Entity.Resources.Strings.Cqt_GetRefKey_RefRequired, nameof (argument));
    ...
    {
      System.Data.Entity.Utilities.Check.NotNull<DbExpression>(navigateFrom, nameof (navigateFrom));
      System.Data.Entity.Utilities.Check.NotNull<RelationshipEndMember>(fromEnd, nameof (fromEnd));
      System.Data.Entity.Utilities.Check.NotNull<RelationshipEndMember>(toEnd, nameof (toEnd));
    ...
    {
      System.Data.Entity.Utilities.Check.NotNull<RelationshipType>(type, nameof (type));
      System.Data.Entity.Utilities.Check.NotNull<string>(fromEndName, nameof (fromEndName));
      System.Data.Entity.Utilities.Check.NotNull<string>(toEndName, nameof (toEndName));
      System.Data.Entity.Utilities.Check.NotNull<DbExpression>(navigateFrom, nameof (navigateFrom));
      RelationshipEndMember fromEnd;
      RelationshipEndMember toEnd;
    ...
    public static DbDistinctExpression Distinct(this DbExpression argument)
    {
      ...
      if (!TypeHelpers.IsValidDistinctOpType(TypeHelpers.GetEdmType<CollectionType>(argument.ResultType).TypeUsage))
        throw new ArgumentException(System.Data.Entity.Resources.Strings.Cqt_Distinct_InvalidCollection, nameof (argument));
      ...
      DbExpression count)
    {
      ...
      if (!TypeSemantics.IsIntegerNumericType(count.ResultType))
        throw new ArgumentException(System.Data.Entity.Resources.Strings.Cqt_Limit_IntegerRequired, nameof (count));
      if (count.ExpressionKind != DbExpressionKind.Constant && count.ExpressionKind != DbExpressionKind.ParameterReference)
        throw new ArgumentException(System.Data.Entity.Resources.Strings.Cqt_Limit_ConstantOrParameterRefRequired, nameof (count));
      if (DbExpressionBuilder.IsConstantNegativeInteger(count))
        throw new ArgumentException(System.Data.Entity.Resources.Strings.Cqt_Limit_NonNegativeLimitRequired, nameof (count));
    ...
    {
      System.Data.Entity.Utilities.Check.NotNull<IEnumerable<DbExpression>>(whenExpressions, nameof (whenExpressions));
      System.Data.Entity.Utilities.Check.NotNull<IEnumerable<DbExpression>>(thenExpressions, nameof (thenExpressions));
      System.Data.Entity.Utilities.Check.NotNull<DbExpression>(elseExpression, nameof (elseExpression));
      ...
      IEnumerable<DbExpression> arguments)
    {
      ...
      System.Data.Entity.Utilities.Check.NotNull<IEnumerable<DbExpression>>(arguments, nameof (arguments));
    ...
    {
      System.Data.Entity.Utilities.Check.NotNull<DbLambda>(lambda, nameof (lambda));
      System.Data.Entity.Utilities.Check.NotNull<DbExpression[]>(arguments, nameof (arguments));
    ...
    public static DbNewInstanceExpression New(
      ...
      IEnumerable<DbExpression> arguments)
    {
      System.Data.Entity.Utilities.Check.NotNull<TypeUsage>(instanceType, nameof (instanceType));
    ...
    {
      System.Data.Entity.Utilities.Check.NotNull<DbExpression[]>(elements, nameof (elements));
      ...
      IEnumerable<DbExpression> elements)
    {
      ...
      DbExpressionList expressionList = ArgumentValidation.CreateExpressionList(elements, nameof (elements), (Action<DbExpression, int>) ((exp, idx) =>
      {
        ...
        if (commonElementType == null)
          throw new ArgumentException(System.Data.Entity.Resources.Strings.Cqt_Factory_NewCollectionInvalidCommonType, "collectionElements");
      }));
    ...
    {
      System.Data.Entity.Utilities.Check.NotNull<TypeUsage>(collectionType, nameof (collectionType));
    ...
    {
      System.Data.Entity.Utilities.Check.NotNull<IEnumerable<KeyValuePair<string, DbExpression>>>(columnValues, nameof (columnValues));
      DbExpressionList validElements;
    ...
    {
      System.Data.Entity.Utilities.Check.NotNull<DbExpression>(instance, nameof (instance));
      System.Data.Entity.Utilities.Check.NotNull<EdmProperty>(propertyMetadata, nameof (propertyMetadata));
    ...
    {
      System.Data.Entity.Utilities.Check.NotNull<DbExpression>(instance, nameof (instance));
      System.Data.Entity.Utilities.Check.NotNull<NavigationProperty>(navigationProperty, nameof (navigationProperty));
    ...
    {
      System.Data.Entity.Utilities.Check.NotNull<DbExpression>(instance, nameof (instance));
      System.Data.Entity.Utilities.Check.NotNull<RelationshipEndMember>(relationshipEnd, nameof (relationshipEnd));
      ...
      string propertyArgumentName)
    {
      ...
      if (instance == null)
        throw new ArgumentException(System.Data.Entity.Resources.Strings.Cqt_Property_InstanceRequiredForInstance, nameof (instance));
    ...
    {
      System.Data.Entity.Utilities.Check.NotNull<DbExpression>(instance, nameof (instance));
      System.Data.Entity.Utilities.Check.NotNull<string>(propertyName, nameof (propertyName));
    ...
    {
      System.Data.Entity.Utilities.Check.NotNull<DbExpression>(property, nameof (property));
      System.Data.Entity.Utilities.Check.NotNull<DbExpression>(value, nameof (value));
      return new DbSetClause(property, value);
    }

    private static string ExtractAlias(MethodInfo method) => DbExpressionBuilder.ExtractAliases(method)[0];
    ...
    private static DbExpression ResolveToExpression<TArgument>(TArgument argument)
    {
      ...
      return (DbExpression) DbExpressionBuilder.NewRow((IEnumerable<KeyValuePair<string, DbExpression>>) (DbExpressionBuilder.TryGetAnonymousTypeValues<TArgument, DbExpression>(instance) ?? throw new NotSupportedException(System.Data.Entity.Resources.Strings.Cqt_Factory_MethodResultTypeNotSupported((object) typeof (TArgument).FullName))));
    }
    ...
    {
      System.Data.Entity.Utilities.Check.NotNull<DbExpression>(source, nameof (source));
      System.Data.Entity.Utilities.Check.NotNull<Func<DbExpression, DbExpression>>(predicate, nameof (predicate));
    ...
    /// <exception cref="T:System.ArgumentException">source does not have a collection result type.</exception>
    public static DbExpression Any(this DbExpression source) => source.Exists();
    ...
    /// <exception cref="T:System.ArgumentNullException">argument is null.</exception>
    /// <exception cref="T:System.ArgumentException">argument does not have a collection result type.</exception>
    public static DbExpression Exists(this DbExpression argument) => (DbExpression) argument.IsEmpty().Not();
    ...
    {
      System.Data.Entity.Utilities.Check.NotNull<DbExpression>(source, nameof (source));
      System.Data.Entity.Utilities.Check.NotNull<Func<DbExpression, KeyValuePair<string, DbExpression>>>(apply, nameof (apply));
      ...
      Func<DbExpression, DbExpression, DbExpression> joinCondition)
    {
      System.Data.Entity.Utilities.Check.NotNull<DbExpression>(left, nameof (left));
      System.Data.Entity.Utilities.Check.NotNull<DbExpression>(right, nameof (right));
      System.Data.Entity.Utilities.Check.NotNull<Func<DbExpression, DbExpression, DbExpression>>(joinCondition, nameof (joinCondition));
    ...
    {
      System.Data.Entity.Utilities.Check.NotNull<DbExpression>(outer, nameof (outer));
      System.Data.Entity.Utilities.Check.NotNull<DbExpression>(inner, nameof (inner));
      System.Data.Entity.Utilities.Check.NotNull<Func<DbExpression, DbExpression>>(outerKey, nameof (outerKey));
      System.Data.Entity.Utilities.Check.NotNull<Func<DbExpression, DbExpression>>(innerKey, nameof (innerKey));
      DbExpression argumentResult1;
      DbExpressionBinding binding1 = DbExpressionBuilder.ConvertToBinding<DbExpression>(outer, outerKey, out argumentResult1);
      DbExpression argumentResult2;
      DbExpressionBinding binding2 = DbExpressionBuilder.ConvertToBinding<DbExpression>(inner, innerKey, out argumentResult2);
      DbExpression dbExpression = (DbExpression) argumentResult1.Equal(argumentResult2);
      DbExpressionBinding right = binding2;
      DbExpression joinCondition = dbExpression;
      return binding1.InnerJoin(right, joinCondition);
    }
    ...
    {
      System.Data.Entity.Utilities.Check.NotNull<Func<DbExpression, DbExpression, TSelector>>(selector, nameof (selector));
      ...
      return input2.Project(DbExpressionBuilder.ResolveToExpression<TSelector>(selector(dbExpression1, dbExpression2)));
    }
    ...
    {
      System.Data.Entity.Utilities.Check.NotNull<DbExpression>(source, nameof (source));
      System.Data.Entity.Utilities.Check.NotNull<Func<DbExpression, DbExpression>>(sortKey, nameof (sortKey));
      DbExpression argumentResult;
    ...
    {
      System.Data.Entity.Utilities.Check.NotNull<DbExpression>(source, nameof (source));
      System.Data.Entity.Utilities.Check.NotNull<Func<DbExpression, TProjection>>(projection, nameof (projection));
    ...
    {
      System.Data.Entity.Utilities.Check.NotNull<DbExpression>(source, nameof (source));
      System.Data.Entity.Utilities.Check.NotNull<Func<DbExpression, DbExpression>>(apply, nameof (apply));
      DbExpression argumentResult;
      DbExpressionBinding binding = DbExpressionBuilder.ConvertToBinding<DbExpression>(source, apply, out argumentResult);
      DbExpressionBinding expressionBinding = argumentResult.Bind();
      DbExpressionBinding apply1 = expressionBinding;
      DbExpressionBinding input = binding.CrossApply(apply1).Bind();
      return input.Project((DbExpression) input.Variable.Property(expressionBinding.VariableName));
    }
      ...
      Func<DbExpression, DbExpression, TSelector> selector)
    {
      ...
      return input.Project(DbExpressionBuilder.ResolveToExpression<TSelector>(selector(dbExpression1, dbExpression2)));
    }
    ...
    public static DbSkipExpression Skip(
      ...
      DbExpression count)
    {
      System.Data.Entity.Utilities.Check.NotNull<DbSortExpression>(argument, nameof (argument));
    ...
    public static DbSortExpression ThenBy(
      ...
      Func<DbExpression, DbExpression> sortKey)
    {
      System.Data.Entity.Utilities.Check.NotNull<DbSortExpression>(source, nameof (source));
      System.Data.Entity.Utilities.Check.NotNull<Func<DbExpression, DbExpression>>(sortKey, nameof (sortKey));
    ...
    /// <exception cref="T:System.ArgumentNullException">left or right is null.</exception>
    /// <exception cref="T:System.ArgumentException">No common collection result type with an equality-comparable element type exists between left and right.</exception>
    public static DbExpression Union(this DbExpression left, DbExpression right) => (DbExpression) left.UnionAll(right).Distinct();

    internal static AliasGenerator AliasGenerator => DbExpressionBuilder._bindingAliases;
      ...
      PrimitiveTypeKind primitiveType)
    {
      switch (primitiveType)
      {
        ...
        default:
          ...
          throw new ArgumentOutOfRangeException(name, System.Data.Entity.Resources.Strings.ADP_InvalidEnumerationValue((object) name, (object) ((int) primitiveType).ToString((IFormatProvider) CultureInfo.InvariantCulture)));
      }
    }
      ...
      DbExpressionBinding apply)
    {
      ...
      throw new ArgumentOutOfRangeException(name, System.Data.Entity.Resources.Strings.ADP_InvalidEnumerationValue((object) name, (object) ((int) applyKind).ToString((IFormatProvider) CultureInfo.InvariantCulture)));
    }
      ...
      DbExpressionBinding input2)
    {
      ...
      switch (joinKind)
      {
        ...
        default:
          string name = typeof (DbExpressionKind).Name;
          throw new ArgumentOutOfRangeException(name, System.Data.Entity.Resources.Strings.ADP_InvalidEnumerationValue((object) name, (object) ((int) joinKind).ToString((IFormatProvider) CultureInfo.InvariantCulture)));
      }
    }
      ...
      DbExpression argument)
    {
      ...
      if (properties == null || properties.Count != 1)
        throw new ArgumentException(System.Data.Entity.Resources.Strings.Cqt_Element_InvalidArgumentForUnwrapSingleProperty, nameof (argument));
    ...
    private static TypeUsage CreateCollectionResultType(EdmType type) => TypeUsage.Create((EdmType) TypeHelpers.CreateCollectionType(TypeUsage.Create(type)));

    private static TypeUsage CreateCollectionResultType(TypeUsage elementType) => TypeUsage.Create((EdmType) TypeHelpers.CreateCollectionType(elementType));

    private static bool IsConstantNegativeInteger(DbExpression expression) => expression.ExpressionKind == DbExpressionKind.Constant && TypeSemantics.IsIntegerNumericType(expression.ResultType) && Convert.ToInt64(((DbConstantExpression) expression).Value, (IFormatProvider) CultureInfo.InvariantCulture) < 0L;
  }
}
