  ...
  public static class EdmFunctions
  {
      ...
      TypeUsage[] argumentTypes)
    {
      ...
      if (edmFunctionList.Count > 0)
      {
        ...
        if (isAmbiguous)
          throw new ArgumentException(System.Data.Entity.Resources.Strings.Cqt_Function_CanonicalFunction_AmbiguousMatch((object) functionName));
      }
      return edmFunction != null ? edmFunction : throw new ArgumentException(System.Data.Entity.Resources.Strings.Cqt_Function_CanonicalFunction_NotFound((object) functionName));
    }
    ...
    {
      System.Data.Entity.Utilities.Check.NotNull<DbExpression>(collection, nameof (collection));
    ...
    {
      System.Data.Entity.Utilities.Check.NotNull<DbExpression>(string1, nameof (string1));
      System.Data.Entity.Utilities.Check.NotNull<DbExpression>(string2, nameof (string2));
    ...
    {
      System.Data.Entity.Utilities.Check.NotNull<DbExpression>(searchedString, nameof (searchedString));
      System.Data.Entity.Utilities.Check.NotNull<DbExpression>(searchedForString, nameof (searchedForString));
    ...
    public static DbFunctionExpression EndsWith(
      ...
      DbExpression suffix)
    {
      System.Data.Entity.Utilities.Check.NotNull<DbExpression>(stringArgument, nameof (stringArgument));
      System.Data.Entity.Utilities.Check.NotNull<DbExpression>(suffix, nameof (suffix));
    ...
    {
      System.Data.Entity.Utilities.Check.NotNull<DbExpression>(searchString, nameof (searchString));
      System.Data.Entity.Utilities.Check.NotNull<DbExpression>(stringToFind, nameof (stringToFind));
    ...
    {
      System.Data.Entity.Utilities.Check.NotNull<DbExpression>(stringArgument, nameof (stringArgument));
      System.Data.Entity.Utilities.Check.NotNull<DbExpression>(length, nameof (length));
    ...
    {
      System.Data.Entity.Utilities.Check.NotNull<DbExpression>(stringArgument, nameof (stringArgument));
      System.Data.Entity.Utilities.Check.NotNull<DbExpression>(toReplace, nameof (toReplace));
      System.Data.Entity.Utilities.Check.NotNull<DbExpression>(replacement, nameof (replacement));
    ...
    {
      System.Data.Entity.Utilities.Check.NotNull<DbExpression>(stringArgument, nameof (stringArgument));
      System.Data.Entity.Utilities.Check.NotNull<DbExpression>(prefix, nameof (prefix));
    ...
    {
      System.Data.Entity.Utilities.Check.NotNull<DbExpression>(stringArgument, nameof (stringArgument));
      System.Data.Entity.Utilities.Check.NotNull<DbExpression>(start, nameof (start));
      System.Data.Entity.Utilities.Check.NotNull<DbExpression>(length, nameof (length));
    ...
    {
      System.Data.Entity.Utilities.Check.NotNull<DbExpression>(dateValue, nameof (dateValue));
    ...
    {
      System.Data.Entity.Utilities.Check.NotNull<DbExpression>(timeValue, nameof (timeValue));
    ...
    {
      System.Data.Entity.Utilities.Check.NotNull<DbExpression>(dateTimeOffsetArgument, nameof (dateTimeOffsetArgument));
    ...
    public static DbFunctionExpression LocalDateTime(
      this DbExpression dateTimeOffsetArgument)
    {
      System.Data.Entity.Utilities.Check.NotNull<DbExpression>(dateTimeOffsetArgument, nameof (dateTimeOffsetArgument));
      return EdmFunctions.InvokeCanonicalFunction(nameof (LocalDateTime), dateTimeOffsetArgument);
    }
    ...
    /// <param name="dateTimeOffsetArgument">An expression that specifies the DateTimeOffset value.</param>
    public static DbFunctionExpression UtcDateTime(
      this DbExpression dateTimeOffsetArgument)
    {
      System.Data.Entity.Utilities.Check.NotNull<DbExpression>(dateTimeOffsetArgument, nameof (dateTimeOffsetArgument));
      return EdmFunctions.InvokeCanonicalFunction(nameof (UtcDateTime), dateTimeOffsetArgument);
    }
    ...
    public static DbFunctionExpression CurrentDateTime() => EdmFunctions.InvokeCanonicalFunction(nameof (CurrentDateTime));
    ...
    public static DbFunctionExpression CurrentDateTimeOffset() => EdmFunctions.InvokeCanonicalFunction(nameof (CurrentDateTimeOffset));
    ...
    public static DbFunctionExpression CurrentUtcDateTime() => EdmFunctions.InvokeCanonicalFunction(nameof (CurrentUtcDateTime));
    ...
    public static DbFunctionExpression CreateDateTime(
      ...
      DbExpression second)
    {
      System.Data.Entity.Utilities.Check.NotNull<DbExpression>(year, nameof (year));
      System.Data.Entity.Utilities.Check.NotNull<DbExpression>(month, nameof (month));
      System.Data.Entity.Utilities.Check.NotNull<DbExpression>(day, nameof (day));
      System.Data.Entity.Utilities.Check.NotNull<DbExpression>(hour, nameof (hour));
      System.Data.Entity.Utilities.Check.NotNull<DbExpression>(minute, nameof (minute));
      System.Data.Entity.Utilities.Check.NotNull<DbExpression>(second, nameof (second));
      ...
      DbExpression timeZoneOffset)
    {
      ...
      System.Data.Entity.Utilities.Check.NotNull<DbExpression>(minute, nameof (minute));
      System.Data.Entity.Utilities.Check.NotNull<DbExpression>(second, nameof (second));
      System.Data.Entity.Utilities.Check.NotNull<DbExpression>(timeZoneOffset, nameof (timeZoneOffset));
    ...
    {
      System.Data.Entity.Utilities.Check.NotNull<DbExpression>(dateValue, nameof (dateValue));
      System.Data.Entity.Utilities.Check.NotNull<DbExpression>(addValue, nameof (addValue));
    ...
    {
      System.Data.Entity.Utilities.Check.NotNull<DbExpression>(dateValue1, nameof (dateValue1));
      System.Data.Entity.Utilities.Check.NotNull<DbExpression>(dateValue2, nameof (dateValue2));
    ...
    {
      System.Data.Entity.Utilities.Check.NotNull<DbExpression>(timeValue1, nameof (timeValue1));
      System.Data.Entity.Utilities.Check.NotNull<DbExpression>(timeValue2, nameof (timeValue2));
    ...
    {
      System.Data.Entity.Utilities.Check.NotNull<DbExpression>(value, nameof (value));
      System.Data.Entity.Utilities.Check.NotNull<DbExpression>(digits, nameof (digits));
    ...
    {
      System.Data.Entity.Utilities.Check.NotNull<DbExpression>(baseArgument, nameof (baseArgument));
      System.Data.Entity.Utilities.Check.NotNull<DbExpression>(exponent, nameof (exponent));
    ...
    public static DbFunctionExpression BitwiseAnd(
      ...
      DbExpression value2)
    {
      System.Data.Entity.Utilities.Check.NotNull<DbExpression>(value1, nameof (value1));
      System.Data.Entity.Utilities.Check.NotNull<DbExpression>(value2, nameof (value2));
    ...
    public static DbFunctionExpression NewGuid() => EdmFunctions.InvokeCanonicalFunction(nameof (NewGuid));
  }
}
