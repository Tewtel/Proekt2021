...
namespace System.Data.Entity.Core.Common.CommandTrees
{
  ...
  public abstract class DbExpressionVisitor
  {
    ...
    /// </param>
    public virtual void Visit(DbLambdaExpression expression) => throw new NotSupportedException();
    ...
    /// <summary>Visitor pattern method for DbInExpression.</summary>
    /// <param name="expression"> The DbInExpression that is being visited. </param>
    public virtual void Visit(DbInExpression expression) => throw new NotImplementedException(Strings.VisitDbInExpressionNotImplemented);
  }
}
