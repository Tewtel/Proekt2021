...
// Type: System.Data.Entity.Core.Common.CommandTrees.DbExpressionVisitor`1
...
namespace System.Data.Entity.Core.Common.CommandTrees
{
  ...
  public abstract class DbExpressionVisitor<TResultType>
  {
    ...
    /// <summary>
    /// When overridden in a derived class, implements the visitor pattern for
    /// <see cref="T:System.Data.Entity.Core.Common.CommandTrees.DbArithmeticExpression" />
    /// .
    /// </summary>
    /// <returns>A result value of a specific type.</returns>
    /// <param name="expression">
    ...
    /// <summary>
    /// When overridden in a derived class, implements the visitor pattern for
    /// <see cref="T:System.Data.Entity.Core.Common.CommandTrees.DbCastExpression" />
    /// .
    /// </summary>
    /// <returns>A result value of a specific type.</returns>
    /// <param name="expression">
    ...
    /// <summary>
    /// When overridden in a derived class, implements the visitor pattern for
    /// <see cref="T:System.Data.Entity.Core.Common.CommandTrees.DbCrossJoinExpression" />
    /// .
    /// </summary>
    /// <returns>A result value of a specific type.</returns>
    /// <param name="expression">
    ...
    /// <summary>
    /// When overridden in a derived class, implements the visitor pattern for
    /// <see cref="T:System.Data.Entity.Core.Common.CommandTrees.DbDerefExpression" />
    /// .
    /// </summary>
    /// <returns>A result value of a specific type.</returns>
    /// <param name="expression">
    ...
    /// <summary>
    /// When overridden in a derived class, implements the visitor pattern for
    /// <see cref="T:System.Data.Entity.Core.Common.CommandTrees.DbDistinctExpression" />
    /// .
    /// </summary>
    /// <returns>A result value of a specific type.</returns>
    /// <param name="expression">
    ...
    /// <summary>
    /// When overridden in a derived class, implements the visitor pattern for
    /// <see cref="T:System.Data.Entity.Core.Common.CommandTrees.DbElementExpression" />
    /// .
    /// </summary>
    /// <returns>A result value of a specific type.</returns>
    /// <param name="expression">
    ...
    /// <summary>
    /// When overridden in a derived class, implements the visitor pattern for
    /// <see cref="T:System.Data.Entity.Core.Common.CommandTrees.DbFunctionExpression" />
    /// .
    /// </summary>
    /// <returns>A result value of a specific type.</returns>
    /// <param name="expression">
    ...
    /// <summary>
    /// When overridden in a derived class, implements the visitor pattern for
    /// <see cref="T:System.Data.Entity.Core.Common.CommandTrees.DbEntityRefExpression" />
    /// .
    /// </summary>
    /// <returns>A result value of a specific type.</returns>
    /// <param name="expression">
    ...
    /// <summary>
    /// When overridden in a derived class, implements the visitor pattern for
    /// <see cref="T:System.Data.Entity.Core.Common.CommandTrees.DbRefKeyExpression" />
    /// .
    /// </summary>
    /// <returns>A result value of a specific type.</returns>
    /// <param name="expression">
    ...
    /// <summary>
    /// When overridden in a derived class, implements the visitor pattern for
    /// <see cref="T:System.Data.Entity.Core.Common.CommandTrees.DbIsOfExpression" />
    /// .
    /// </summary>
    /// <returns>A result value of a specific type.</returns>
    /// <param name="expression">
    ...
    /// </param>
    public virtual TResultType Visit(DbLambdaExpression expression) => throw new NotSupportedException();
    ...
    /// <summary>
    /// When overridden in a derived class, implements the visitor pattern for
    /// <see cref="T:System.Data.Entity.Core.Common.CommandTrees.DbNewInstanceExpression" />
    /// .
    /// </summary>
    /// <returns>A result value of a specific type.</returns>
    /// <param name="expression">
    ...
    /// <summary>
    /// When overridden in a derived class, implements the visitor pattern for
    /// <see cref="T:System.Data.Entity.Core.Common.CommandTrees.DbNullExpression" />
    /// .
    /// </summary>
    /// <returns>A result value of a specific type.</returns>
    /// <param name="expression">
    ...
    /// <summary>
    /// When overridden in a derived class, implements the visitor pattern for
    /// <see cref="T:System.Data.Entity.Core.Common.CommandTrees.DbOfTypeExpression" />
    /// .
    /// </summary>
    /// <returns>A result value of a specific type.</returns>
    /// <param name="expression">
    ...
    /// <summary>
    /// When overridden in a derived class, implements the visitor pattern for
    /// <see cref="T:System.Data.Entity.Core.Common.CommandTrees.DbQuantifierExpression" />
    /// .
    /// </summary>
    /// <returns>A result value of a specific type.</returns>
    /// <param name="expression">
    ...
    /// <summary>
    /// When overridden in a derived class, implements the visitor pattern for
    /// <see cref="T:System.Data.Entity.Core.Common.CommandTrees.DbRefExpression" />
    /// .
    /// </summary>
    /// <returns>A result value of a specific type.</returns>
    /// <param name="expression">
    ...
    /// <summary>
    /// When overridden in a derived class, implements the visitor pattern for
    /// <see cref="T:System.Data.Entity.Core.Common.CommandTrees.DbScanExpression" />
    /// .
    /// </summary>
    /// <returns>A result value of a specific type.</returns>
    /// <param name="expression">
    ...
    /// <summary>
    /// When overridden in a derived class, implements the visitor pattern for
    /// <see cref="T:System.Data.Entity.Core.Common.CommandTrees.DbTreatExpression" />
    /// .
    /// </summary>
    /// <returns>A result value of a specific type.</returns>
    /// <param name="expression">
    ...
    /// <summary>Typed visitor pattern method for DbInExpression.</summary>
    /// <param name="expression"> The DbInExpression that is being visited. </param>
    /// <returns> An instance of TResultType. </returns>
    public virtual TResultType Visit(DbInExpression expression) => throw new NotImplementedException(Strings.VisitDbInExpressionNotImplemented);
  }
}
