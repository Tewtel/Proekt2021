...
namespace System.Data.Entity.Infrastructure
{
  ...
  public class DbCollectionEntry : DbMemberEntry
  {
    ...
    {
      get => this._internalCollectionEntry.CurrentValue;
      set => this._internalCollectionEntry.CurrentValue = value;
    }
    ...
    public IQueryable Query() => this._internalCollectionEntry.Query();
    ...
    public override DbEntityEntry EntityEntry => new DbEntityEntry(this._internalCollectionEntry.InternalEntityEntry);
    ...
    public DbCollectionEntry<TEntity, TElement> Cast<TEntity, TElement>() where TEntity : class
    {
      ...
      if (!typeof (TEntity).IsAssignableFrom(entryMetadata.DeclaringType) || !typeof (TElement).IsAssignableFrom(entryMetadata.ElementType))
        throw System.Data.Entity.Resources.Error.DbMember_BadTypeForCast((object) typeof (DbCollectionEntry).Name, (object) typeof (TEntity).Name, (object) typeof (TElement).Name, (object) entryMetadata.DeclaringType.Name, (object) entryMetadata.ElementType.Name);
