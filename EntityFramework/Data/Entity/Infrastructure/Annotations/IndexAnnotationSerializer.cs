...
namespace System.Data.Entity.Infrastructure.Annotations
{
  ...
  public class IndexAnnotationSerializer : IMetadataAnnotationSerializer
  {
    ...
    public virtual string Serialize(string name, object value)
    {
      ...
      if (!(value is IndexAnnotation indexAnnotation))
        throw new ArgumentException(System.Data.Entity.Resources.Strings.AnnotationSerializeWrongType((object) value.GetType().Name, (object) typeof (IndexAnnotationSerializer).Name, (object) typeof (IndexAnnotation).Name));
    ...
    private static FormatException BuildFormatException(string value) => new FormatException(System.Data.Entity.Resources.Strings.AnnotationSerializeBadFormat((object) value, (object) typeof (IndexAnnotationSerializer).Name, (object) "{ Name: MyIndex, Order: 7, IsClustered: True, IsUnique: False } { } { Name: MyOtherIndex }"));
  }
}
