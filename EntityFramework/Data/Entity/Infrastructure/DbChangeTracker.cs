...
namespace System.Data.Entity.Infrastructure
{
  ...
  public class DbChangeTracker
  {
    ...
    internal DbChangeTracker(InternalContext internalContext) => this._internalContext = internalContext;
    ...
    public IEnumerable<DbEntityEntry> Entries() => this._internalContext.GetStateEntries().Select<IEntityStateEntry, DbEntityEntry>((Func<IEntityStateEntry, DbEntityEntry>) (e => new DbEntityEntry(new InternalEntityEntry(this._internalContext, e))));
    ...
    /// <returns> The entries. </returns>
    public IEnumerable<DbEntityEntry<TEntity>> Entries<TEntity>() where TEntity : class => this._internalContext.GetStateEntries<TEntity>().Select<IEntityStateEntry, DbEntityEntry<TEntity>>((Func<IEntityStateEntry, DbEntityEntry<TEntity>>) (e => new DbEntityEntry<TEntity>(new InternalEntityEntry(this._internalContext, e))));
    ...
    {
      this._internalContext.DetectChanges();
    ...
    /// </summary>
    public void DetectChanges() => this._internalContext.DetectChanges(true);
