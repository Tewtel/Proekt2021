...
namespace System.Data.Entity.Infrastructure
{
  ...
  public class DbReferenceEntry : DbMemberEntry
  {
    ...
    {
      get => this._internalReferenceEntry.CurrentValue;
      set => this._internalReferenceEntry.CurrentValue = value;
    }
    ...
    public IQueryable Query() => this._internalReferenceEntry.Query();
    ...
    public override DbEntityEntry EntityEntry => new DbEntityEntry(this._internalReferenceEntry.InternalEntityEntry);
    ...
    public DbReferenceEntry<TEntity, TProperty> Cast<TEntity, TProperty>() where TEntity : class
    {
      ...
      if (!typeof (TEntity).IsAssignableFrom(entryMetadata.DeclaringType) || !typeof (TProperty).IsAssignableFrom(entryMetadata.ElementType))
        throw System.Data.Entity.Resources.Error.DbMember_BadTypeForCast((object) typeof (DbReferenceEntry).Name, (object) typeof (TEntity).Name, (object) typeof (TProperty).Name, (object) entryMetadata.DeclaringType.Name, (object) entryMetadata.MemberType.Name);
