...
namespace System.Data.Entity.Infrastructure
{
  ...
  public class DbSqlQuery<TEntity> : DbRawSqlQuery<TEntity> where TEntity : class
  {
    ...
    public virtual DbSqlQuery<TEntity> AsNoTracking() => this.InternalQuery != null ? new DbSqlQuery<TEntity>(this.InternalQuery.AsNoTracking()) : this;
    ...
    public virtual DbSqlQuery<TEntity> AsStreaming() => this.InternalQuery != null ? new DbSqlQuery<TEntity>(this.InternalQuery.AsStreaming()) : this;
