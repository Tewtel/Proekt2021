...
namespace System.Data.Entity.Infrastructure
{
  ...
  public class DbPropertyEntry : DbMemberEntry
  {
    ...
    {
      get => this._internalPropertyEntry.OriginalValue;
      set => this._internalPropertyEntry.OriginalValue = value;
    }
    ...
    {
      get => this._internalPropertyEntry.CurrentValue;
      set => this._internalPropertyEntry.CurrentValue = value;
    }
    ...
    public override DbEntityEntry EntityEntry => new DbEntityEntry(this._internalPropertyEntry.InternalEntityEntry);
    ...
    internal override InternalMemberEntry InternalMemberEntry => (InternalMemberEntry) this._internalPropertyEntry;
