...
namespace System.Data.Entity.Infrastructure
{
    ...
    IDisposable
  {
    ...
    /// </remarks>
    protected TransactionHandler() => DbInterception.Add((IDbInterceptor) this);
    ...
    public virtual void Initialize(ObjectContext context)
    {
      ...
      if (this.ObjectContext != null || this.DbContext != null || this.Connection != null)
        throw new InvalidOperationException(System.Data.Entity.Resources.Strings.TransactionHandler_AlreadyInitialized);
    ...
    {
      get => this._objectContext == null || !this._objectContext.IsAlive ? (ObjectContext) null : (ObjectContext) this._objectContext.Target;
      private set => this._objectContext = new WeakReference((object) value);
    }
    ...
    {
      get => this._dbContext == null || !this._dbContext.IsAlive ? (DbContext) null : (DbContext) this._dbContext.Target;
      private set => this._dbContext = new WeakReference((object) value);
    }
    ...
    {
      get => this._connection == null || !this._connection.IsAlive ? (DbConnection) null : (DbConnection) this._connection.Target;
      private set => this._connection = new WeakReference((object) value);
    }
    ...
    {
      System.Data.Entity.Utilities.Check.NotNull<DbConnection>(connection, nameof (connection));
      System.Data.Entity.Utilities.Check.NotNull<DbInterceptionContext>(interceptionContext, nameof (interceptionContext));
      if (this.DbContext != null && interceptionContext.DbContexts.Contains<DbContext>(this.DbContext, new Func<DbContext, DbContext, bool>(object.ReferenceEquals)) || this.ObjectContext != null && interceptionContext.ObjectContexts.Contains<ObjectContext>(this.ObjectContext, new Func<ObjectContext, ObjectContext, bool>(object.ReferenceEquals)))
        return true;
      return this.Connection != null && !interceptionContext.ObjectContexts.Any<ObjectContext>() && !interceptionContext.DbContexts.Any<DbContext>() && connection == this.Connection;
    }
