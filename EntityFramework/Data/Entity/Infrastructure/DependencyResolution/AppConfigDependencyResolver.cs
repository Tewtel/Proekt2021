...
namespace System.Data.Entity.Infrastructure.DependencyResolution
{
  internal class AppConfigDependencyResolver : IDbDependencyResolver
  {
    ...
    public virtual object GetService(Type type, object key) => this._serviceFactories.GetOrAdd(Tuple.Create<Type, object>(type, key), (Func<Tuple<Type, object>, Func<object>>) (t => this.GetServiceFactory(type, key as string)))();

    public IEnumerable<object> GetServices(Type type, object key) => (IEnumerable<object>) this._servicesFactories.GetOrAdd(Tuple.Create<Type, object>(type, key), (Func<Tuple<Type, object>, IEnumerable<Func<object>>>) (t => this.GetServicesFactory(type, key))).Select<Func<object>, object>((Func<Func<object>, object>) (f => f())).Where<object>((Func<object, bool>) (s => s != null)).ToList<object>();
    ...
    public virtual Func<object> GetServiceFactory(Type type, string name)
    {
      ...
      if (type == typeof (IDbConnectionFactory))
      {
        ...
        return (Func<object>) (() => !Database.DefaultConnectionFactoryChanged ? (object) null : (object) Database.SetDefaultConnectionFactory);
      }
