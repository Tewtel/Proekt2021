...
namespace System.Data.Entity.Infrastructure.Interception
{
  ...
  public class DbInterceptionContext
  {
    ...
    protected DbInterceptionContext(DbInterceptionContext copyFrom)
    {
      ...
      this._dbContexts = (IList<DbContext>) copyFrom.DbContexts.Where<DbContext>((Func<DbContext, bool>) (c => c.InternalContext == null || !c.InternalContext.IsDisposed)).ToList<DbContext>();
    ...
    /// instances.
    /// </remarks>
    public IEnumerable<DbContext> DbContexts => (IEnumerable<DbContext>) this._dbContexts;
    ...
    /// </remarks>
    public IEnumerable<ObjectContext> ObjectContexts => (IEnumerable<ObjectContext>) this._objectContexts;
    ...
    protected virtual DbInterceptionContext Clone() => new DbInterceptionContext(this);
