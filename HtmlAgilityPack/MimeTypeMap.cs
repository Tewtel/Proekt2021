...
// Type: HtmlAgilityPack.MimeTypeMap
...
namespace HtmlAgilityPack
{
  ...
  {
    public static IDictionary<string, string> Mappings = (IDictionary<string, string>) new Dictionary<string, string>((IEqualityComparer<string>) StringComparer.OrdinalIgnoreCase)
    {
      {
        ".323",
        "text/h323"
