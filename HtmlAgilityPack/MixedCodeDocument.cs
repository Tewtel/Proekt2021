...
namespace HtmlAgilityPack
{
  ...
  public class MixedCodeDocument
  {
    ...
    /// <summary>Gets or sets the token representing code end.</summary>
    public string TokenCodeEnd = "%>";
    /// <summary>Gets or sets the token representing code start.</summary>
    public string TokenCodeStart = "<%";
    /// <summary>Gets or sets the token representing code directive.</summary>
    ...
    /// <summary>Creates a mixed code document instance.</summary>
    ...
    /// <summary>Gets the list of code fragments in the document.</summary>
    public MixedCodeDocumentFragmentList CodeFragments => this._codefragments;

    /// <summary>Gets the list of all fragments in the document.</summary>
    public MixedCodeDocumentFragmentList Fragments => this._fragments;
    ...
    /// <summary>Gets the list of text fragments in the document.</summary>
    public MixedCodeDocumentFragmentList TextFragments => this._textfragments;

    /// <summary>Create a code fragment instances.</summary>
    /// <returns>The newly created code fragment instance.</returns>
    public MixedCodeDocumentCodeFragment CreateCodeFragment() => (MixedCodeDocumentCodeFragment) this.CreateFragment(MixedCodeDocumentFragmentType.Code);

    /// <summary>Create a text fragment instances.</summary>
    /// <returns>The newly created text fragment instance.</returns>
    public MixedCodeDocumentTextFragment CreateTextFragment() => (MixedCodeDocumentTextFragment) this.CreateFragment(MixedCodeDocumentFragmentType.Text);

    /// <summary>Loads a mixed code document from a stream.</summary>
    /// <param name="stream">The input stream.</param>
    public void Load(Stream stream) => this.Load((TextReader) new StreamReader(stream));
    ...
    /// <summary>Loads a mixed code document from a file.</summary>
    /// <param name="path">The complete file path to be read.</param>
    public void Load(string path) => this.Load((TextReader) new StreamReader(path));

    /// <summary>Loads a mixed code document from a file.</summary>
    /// <param name="path">The complete file path to be read.</param>
    /// <param name="detectEncodingFromByteOrderMarks">Indicates whether to look for byte order marks at the beginning of the file.</param>
    public void Load(string path, bool detectEncodingFromByteOrderMarks) => this.Load((TextReader) new StreamReader(path, detectEncodingFromByteOrderMarks));

    /// <summary>Loads a mixed code document from a file.</summary>
    /// <param name="path">The complete file path to be read.</param>
    /// <param name="encoding">The character encoding to use.</param>
    public void Load(string path, Encoding encoding) => this.Load((TextReader) new StreamReader(path, encoding));

    /// <summary>Loads a mixed code document from a file.</summary>
    /// <param name="path">The complete file path to be read.</param>
    /// <param name="encoding">The character encoding to use.</param>
    /// <param name="detectEncodingFromByteOrderMarks">Indicates whether to look for byte order marks at the beginning of the file.</param>
    public void Load(string path, Encoding encoding, bool detectEncodingFromByteOrderMarks) => this.Load((TextReader) new StreamReader(path, encoding, detectEncodingFromByteOrderMarks));
    ...
    /// <summary>Loads a mixed document from a text</summary>
    /// <param name="html">The text to load.</param>
    public void LoadHtml(string html) => this.Load((TextReader) new StringReader(html));

    /// <summary>Saves the mixed document to the specified stream.</summary>
    ...
    /// <param name="outStream">The stream to which you want to save.</param>
    /// <param name="encoding">The character encoding to use.</param>
    public void Save(Stream outStream, Encoding encoding) => this.Save(new StreamWriter(outStream, encoding));

    /// <summary>Saves the mixed document to the specified file.</summary>
    /// <param name="filename">The location of the file where you want to save the document.</param>
    public void Save(string filename) => this.Save(new StreamWriter(filename, false, this.GetOutEncoding()));

    /// <summary>Saves the mixed document to the specified file.</summary>
    /// <param name="filename">The location of the file where you want to save the document.</param>
    /// <param name="encoding">The character encoding to use.</param>
    public void Save(string filename, Encoding encoding) => this.Save(new StreamWriter(filename, false, encoding));
    ...
    /// <summary>Saves the mixed document to the specified TextWriter.</summary>
    /// <param name="writer">The TextWriter to which you want to save.</param>
    public void Save(TextWriter writer) => writer.Flush();

    internal MixedCodeDocumentFragment CreateFragment(
    ...
    internal Encoding GetOutEncoding() => this._streamencoding != null ? this._streamencoding : Encoding.UTF8;
