...
{
  /// <summary>A utility class to compute CRC32.</summary>
  ...
  public class Crc32
  {
    ...
    /// <summary>Compute a checksum for a given array of bytes.</summary>
    ...
    /// <summary>Compute a checksum for a given string.</summary>
    ...
    private static uint UPDC32(byte octet, uint crc) => Crc32.crc_32_tab[((int) crc ^ (int) octet) & (int) byte.MaxValue] ^ crc >> 8;
  }
}
