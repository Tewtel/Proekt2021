...
namespace HtmlAgilityPack
{
  ...
  public class HtmlEntity
  {
    ...
    /// <summary>A collection of entities indexed by name.</summary>
    public static Dictionary<int, string> EntityName => HtmlEntity._entityName;

    /// <summary>A collection of entities indexed by value.</summary>
    ...
    /// <summary>Replace known entities by characters.</summary>
    ...
    /// <summary>Replace characters above 127 by entities.</summary>
    /// <param name="text">The source text.</param>
    /// <returns>The result text.</returns>
    ...
    /// <returns>The result text.</returns>
    public static string Entitize(string text, bool useNames) => HtmlEntity.Entitize(text, useNames, false);
        ...
        default:
          ...
          if (HtmlEntity.UseWebUtility)
          {
            ...
            while (elementEnumerator.MoveNext())
              stringBuilder.Append(WebUtility.HtmlEncode(elementEnumerator.GetTextElement()));
          }
          else
          {
            for (int index = 0; index < text.Length; ++index)
